namespace Six.Gen.Ebnf
{
    public class EbnfGrammar
    {
        ...
        public RuleOp StartRule => Rules.Where(op => op.Name.ToLowerInvariant() == "%start").FirstOrDefault();
        public RuleOp WhitespaceRule => Rules.Where(op => op.Name.ToLowerInvariant() == "%whitespace").FirstOrDefault();
    }
}
