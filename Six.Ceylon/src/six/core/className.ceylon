...
import six.core.meta { type }

"""
Return the name of the concrete class of the given object, in a format native
to the virtual machine. For example, `className(0)` evaluates to:
...
[[ceylon.language.meta::type]] function to obtain a metamodel object, for
example:
...
"""
tagged("Metamodel") see (function type)
