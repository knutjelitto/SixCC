...
"""
Given a [[stream|Iterable]] of streams, return a transposed stream of streams, where the nth element of the transposed
stream is a stream comprising the nth elements of the given streams, padding shorter streams with the
[[given value|padding]]. For example,
        ...
        iterator() => object satisfies Iterator<[Element+]>
        {
            ...
            shared actual [Element+]|Finished next()
            {
                if (nonempty iterators)
                {
                    ...
                    value elements = iterators.collect((iter)
                        {
