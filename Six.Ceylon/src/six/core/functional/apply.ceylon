...
"""
Applies an arbitrary [[Callable]] to the given [[arguments|args]]. The arguments must be packaged into a [[Tuple]]
whose type is compatible with the `Callable` type.
...
In practice, this behaves as if the `Callable` were called with the elements of the tuple as its arguments. The
