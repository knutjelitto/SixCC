...
import six.core.meta.model { Class }
// TODO Do we really need this? Isn't annotations sufficient?
"""
The values of given sequenced annotation type on the given program element, or empty if the
program element was not annotated with that annotation type. For example:
