...
In addition, dedicated [[Stack]] and [[Queue]] interfaces are defined, representing specialized
kinds of lists.
...
- [[PriorityQueue]] is a `Queue` implemented using an [[Array]] where the front of the queue is the
  smallest element
- [[HashSet]] is a mutable hash set implemented using an [[Array]] of singly-linked lists.
- [[HashMap]] is a mutable hash map implemented using an [[Array]] of singly-linked lists of
  [[Entry]]s.
...
The functions [[unmodifiableList]], [[unmodifiableSet]], and [[unmodifiableMap]] may be used to
hide these mutable list, set, and map implementations from clients.

[[SingletonMap]] and [[SingletonSet]] are immutable collections with exactly one element.

Finally, [[IdentitySet]] and [[IdentityMap]] are mutable collections based on
[[identity|Identifiable]] instead of value equality.
"""
