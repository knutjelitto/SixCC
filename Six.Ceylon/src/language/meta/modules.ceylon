...
Since Ceylon supports module isolation at runtime, it is possible that there are more than one
version of a given module loaded at the same time.
...
{
    "Returns the list of all currently loaded modules. This may include modules that were not
     imported directly by your module, and multiple versions of the same module."
    ...
    "Returns the default module, if there is one. This is only the case when you are running the
     default module."
