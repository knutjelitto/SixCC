 ...
 ********************************************************************************/
"""
Sort the given elements according to their [[natural order|Comparable]], returning a new 
[[sequence|Sequential]].

Note that [[Iterable.sort]] may be used to sort any stream according to a given comparator
function.
"""
