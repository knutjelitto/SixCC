...
import ceylon.language.serialization { Member, UninitializedLateValue }

"Implementation of [[Member]], in ceylon.language.impl because although compiled user classes
 depend on it, it is not part of the public API."
shared class MemberImpl satisfies Member
{
    ...
    shared actual String string => "Member [attribute=``attribute``]";
