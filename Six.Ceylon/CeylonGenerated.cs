// <generated from="C:\\Dev\\Knut\\SixCC\\Six.Ceylon\\Ceylon.six" at="01.02.2022 10:58:22" />
    ...
    public partial class CeylonParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Matcher[866])
            {
                ...
                /*  96 PlainRuleOp      */ __Matchers[96] = _methodDefinition = new PlainRule(this, 96, "method-definition") { Builder = nodes => nodes[0] };
                ...
                /* 105 PlainRuleOp      */ __Matchers[105] = _statements = new PlainRule(this, 105, "statements") { Builder = nodes => nodes[0] };
                /* 106 PlainRuleOp      */ __Matchers[106] = _statement = new PlainRule(this, 106, "statement") { Builder = nodes => nodes[0] };
                /* 107 PlainRuleOp      */ __Matchers[107] = _declarationStatement = new PlainRule(this, 107, "declaration-statement") { Builder = nodes => nodes[0] };
                ...
                /* 152 PlainRuleOp      */ __Matchers[152] = _expressionArgument = new PlainRule(this, 152, "expression-argument") { Builder = nodes => nodes[0] };
                ...
                /* 155 PlainRuleOp      */ __Matchers[155] = _switchExpr = new PlainRule(this, 155, "switch-expr") { Builder = nodes => nodes[0] };
                /* 156 PlainRuleOp      */ __Matchers[156] = _switchHeader = new PlainRule(this, 156, "switch-header") { Builder = nodes => nodes[0] };
                /* 157 PlainRuleOp      */ __Matchers[157] = _switched = new PlainRule(this, 157, "switched") { Builder = nodes => nodes[0] };
                ...
                /* 163 PlainRuleOp      */ __Matchers[163] = _functionExpression = new PlainRule(this, 163, "function-expression") { Builder = nodes => nodes[0] };
                /* 164 PlainRuleOp      */ __Matchers[164] = _voidFunctionExpr = new PlainRule(this, 164, "void-function-expr") { Builder = nodes => nodes[0] };
                /* 165 PlainRuleOp      */ __Matchers[165] = _inferredFunctionExpr = new PlainRule(this, 165, "inferred-function-expr") { Builder = nodes => nodes[0] };
                ...
                /* 244 PlainRuleOp      */ __Matchers[244] = _indexedExpr = new PlainRule(this, 244, "indexed-expr") { Builder = nodes => nodes[0] };
                ...
                /* 251 PlainRuleOp      */ __Matchers[251] = _callExpr = new PlainRule(this, 251, "call-expr") { Builder = nodes => nodes[0] };
                ...
                /* 258 PlainRuleOp      */ __Matchers[258] = _objectExpr = new PlainRule(this, 258, "object-expr") { Builder = nodes => nodes[0] };
                /* 259 PlainRuleOp      */ __Matchers[259] = _groupedExpr = new PlainRule(this, 259, "grouped-expr") { Builder = nodes => nodes[0] };
                ...
                /* 267 PlainRuleOp      */ __Matchers[267] = _variadicTypeCore = new PlainRule(this, 267, "variadic-type-core") { Builder = nodes => nodes[0] };
                ...
                /* 301 PlainRuleOp      */ __Matchers[301] = _caseBlock = new PlainRule(this, 301, "case-block") { Builder = nodes => nodes[0] };
                /* 302 PlainRuleOp      */ __Matchers[302] = _caseItem = new PlainRule(this, 302, "case-item") { Builder = nodes => nodes[0] };
                /* 303 PlainRuleOp      */ __Matchers[303] = _isCaseCondition = new PlainRule(this, 303, "is-case-condition") { Builder = nodes => nodes[0] };
                /* 304 PlainRuleOp      */ __Matchers[304] = _satisfiesCaseCondition = new PlainRule(this, 304, "satisfies-case-condition") { Builder = nodes => nodes[0] };
                /* 305 PlainRuleOp      */ __Matchers[305] = _valueCaseList = new PlainRule(this, 305, "value-case-list") { Builder = nodes => nodes[0] };
                /* 306 PlainRuleOp      */ __Matchers[306] = _valueCaseSeparator = new PlainRule(this, 306, "value-case-separator") { Creator = node => new CValueCaseSeparator(node) };
                /* 307 PlainRuleOp      */ __Matchers[307] = _valueCase = new PlainRule(this, 307, "value-case") { Builder = nodes => nodes[0] };
                /* 308 PlainRuleOp      */ __Matchers[308] = _forElseStatement = new PlainRule(this, 308, "for-else-statement") { Builder = nodes => nodes[0] };
                /* 309 PlainRuleOp      */ __Matchers[309] = _forIterator = new PlainRule(this, 309, "for-iterator") { Builder = nodes => nodes[0] };
                /* 310 PlainRuleOp      */ __Matchers[310] = _forVariable = new PlainRule(this, 310, "for-variable") { Builder = nodes => nodes[0] };
                /* 311 PlainRuleOp      */ __Matchers[311] = _containment = new PlainRule(this, 311, "containment") { Builder = nodes => nodes[0] };
                /* 312 PlainRuleOp      */ __Matchers[312] = _containmentOperator = new PlainRule(this, 312, "containment-operator") { Creator = node => new CContainmentOperator(node) };
                /* 313 PlainRuleOp      */ __Matchers[313] = _whileStatement = new PlainRule(this, 313, "while-statement") { Builder = nodes => nodes[0] };
                /* 314 PlainRuleOp      */ __Matchers[314] = _tryStatement = new PlainRule(this, 314, "try-statement") { Builder = nodes => nodes[0] };
                /* 315 PlainRuleOp      */ __Matchers[315] = _catchBlock = new PlainRule(this, 315, "catch-block") { Builder = nodes => nodes[0] };
                /* 316 PlainRuleOp      */ __Matchers[316] = _finallyBlock = new PlainRule(this, 316, "finally-block") { Builder = nodes => nodes[0] };
                /* 317 PlainRuleOp      */ __Matchers[317] = _resources = new PlainRule(this, 317, "resources") { Builder = nodes => nodes[0] };
                /* 318 PlainRuleOp      */ __Matchers[318] = _resourceList = new PlainRule(this, 318, "resource-list") { Builder = nodes => nodes[0] };
                /* 319 PlainRuleOp      */ __Matchers[319] = _resource = new PlainRule(this, 319, "resource") { Builder = nodes => nodes[0] };
                /* 320 PlainRuleOp      */ __Matchers[320] = _specifiedOrExpression = new PlainRule(this, 320, "specified-or-expression") { Builder = nodes => nodes[0] };
                /* 321 PlainRuleOp      */ __Matchers[321] = _specifiedVariable = new PlainRule(this, 321, "specified-variable") { Builder = nodes => nodes[0] };
                /* 322 PlainRuleOp      */ __Matchers[322] = _variable = new PlainRule(this, 322, "variable") { Builder = nodes => nodes[0] };
                /* 323 PlainRuleOp      */ __Matchers[323] = _variableType = new PlainRule(this, 323, "variable-type") { Builder = nodes => nodes[0] };
                /* 324 PlainRuleOp      */ __Matchers[324] = _modelReference = new PlainRule(this, 324, "model-reference") { Builder = nodes => nodes[0] };
                /* 325 PlainRuleOp      */ __Matchers[325] = _metaLiteral = new PlainRule(this, 325, "meta-literal") { Builder = nodes => nodes[0] };
                /* 326 PlainRuleOp      */ __Matchers[326] = _metaExpression = new PlainRule(this, 326, "meta-expression") { Builder = nodes => nodes[0] };
                /* 327 PlainRuleOp      */ __Matchers[327] = _modelExpression = new PlainRule(this, 327, "model-expression") { Builder = nodes => nodes[0] };
                /* 328 PlainRuleOp      */ __Matchers[328] = _memberModelExpression = new PlainRule(this, 328, "member-model-expression") { Builder = nodes => nodes[0] };
                /* 329 PlainRuleOp      */ __Matchers[329] = _packageQualifiedMemberReference = new PlainRule(this, 329, "package-qualified-member-reference") { Builder = nodes => nodes[0] };
                /* 330 PlainRuleOp      */ __Matchers[330] = _typeQualifiedMemberReference = new PlainRule(this, 330, "type-qualified-member-reference") { Builder = nodes => nodes[0] };
                /* 331 PlainRuleOp      */ __Matchers[331] = _typeModelExpression = new PlainRule(this, 331, "type-model-expression") { Builder = nodes => nodes[0] };
                /* 332 PlainRuleOp      */ __Matchers[332] = _declarationReference = new PlainRule(this, 332, "declaration-reference") { Builder = nodes => nodes[0] };
                /* 333 PlainRuleOp      */ __Matchers[333] = _moduleLiteral = new PlainRule(this, 333, "module-literal") { Builder = nodes => nodes[0] };
                /* 334 PlainRuleOp      */ __Matchers[334] = _packageLiteral = new PlainRule(this, 334, "package-literal") { Builder = nodes => nodes[0] };
                /* 335 PlainRuleOp      */ __Matchers[335] = _classLiteral = new PlainRule(this, 335, "class-literal") { Builder = nodes => nodes[0] };
                /* 336 PlainRuleOp      */ __Matchers[336] = _interfaceLiteral = new PlainRule(this, 336, "interface-literal") { Builder = nodes => nodes[0] };
                /* 337 PlainRuleOp      */ __Matchers[337] = _aliasLiteral = new PlainRule(this, 337, "alias-literal") { Builder = nodes => nodes[0] };
                /* 338 PlainRuleOp      */ __Matchers[338] = _typeParameterLiteral = new PlainRule(this, 338, "type-parameter-literal") { Builder = nodes => nodes[0] };
                /* 339 PlainRuleOp      */ __Matchers[339] = _newLiteral = new PlainRule(this, 339, "new-literal") { Builder = nodes => nodes[0] };
                /* 340 PlainRuleOp      */ __Matchers[340] = _valueLiteral = new PlainRule(this, 340, "value-literal") { Builder = nodes => nodes[0] };
                /* 341 PlainRuleOp      */ __Matchers[341] = _objectLiteral = new PlainRule(this, 341, "object-literal") { Builder = nodes => nodes[0] };
                /* 342 PlainRuleOp      */ __Matchers[342] = _functionLiteral = new PlainRule(this, 342, "function-literal") { Builder = nodes => nodes[0] };
                /* 343 PlainRuleOp      */ __Matchers[343] = _packageQualifier = new PlainRule(this, 343, "package-qualifier") { Builder = nodes => nodes[0] };
                /* 344 PlainRuleOp      */ __Matchers[344] = _referencePath = new PlainRule(this, 344, "reference-path") { Builder = nodes => nodes[0] };
                /* 345 PlainRuleOp      */ __Matchers[345] = _referencePathElementList = new PlainRule(this, 345, "reference-path-element-list") { Builder = nodes => nodes[0] };
                /* 346 PlainRuleOp      */ __Matchers[346] = _referencePathElement = new PlainRule(this, 346, "reference-path-element") { Builder = nodes => nodes[0] };
                /* 347 PlainRuleOp      */ __Matchers[347] = _kwVoid = new PlainRule(this, 347, "kw-void") { Creator = node => new CKwVoid(node) };
                /* 348 PlainRuleOp      */ __Matchers[348] = _kwFunction = new PlainRule(this, 348, "kw-function") { Creator = node => new CKwFunction(node) };
                /* 349 PlainRuleOp      */ __Matchers[349] = _kwValue = new PlainRule(this, 349, "kw-value") { Creator = node => new CKwValue(node) };
                /* 350 DfaRuleOp        */ __Matchers[350] = _literalFloat = new DfaRule(this, 350, "literal-float") { Creator = node => new CLiteralFloat(node) };
                /* 351 DfaRuleOp        */ __Matchers[351] = _literalNatural = new DfaRule(this, 351, "literal-natural") { Creator = node => new CLiteralNatural(node) };
                /* 352 DfaRuleOp        */ __Matchers[352] = _literalChar = new DfaRule(this, 352, "literal-char") { Creator = node => new CLiteralChar(node) };
                /* 353 DfaRuleOp        */ __Matchers[353] = _stringStart = new DfaRule(this, 353, "string-start") { Creator = node => new CStringStart(node) };
                /* 354 DfaRuleOp        */ __Matchers[354] = _stringMid = new DfaRule(this, 354, "string-mid") { Creator = node => new CStringMid(node) };
                /* 355 DfaRuleOp        */ __Matchers[355] = _stringEnd = new DfaRule(this, 355, "string-end") { Creator = node => new CStringEnd(node) };
                /* 356 DfaRuleOp        */ __Matchers[356] = _literalString = new DfaRule(this, 356, "literal-string") { Creator = node => new CLiteralString(node) };
                /* 357 DfaRuleOp        */ __Matchers[357] = _verbatimString = new DfaRule(this, 357, "verbatim-string") { Creator = node => new CVerbatimString(node) };
                /* 358 DfaRuleOp        */ __Matchers[358] = _lowerIdentifier = new DfaRule(this, 358, "lower-identifier") { Creator = node => new CLowerIdentifier(node) };
                /* 359 DfaRuleOp        */ __Matchers[359] = _upperIdentifier = new DfaRule(this, 359, "upper-identifier") { Creator = node => new CUpperIdentifier(node) };
                /* 360 DfaRuleOp        */ __Matchers[360] = _identifier = new DfaRule(this, 360, "identifier") { Creator = node => new CIdentifier(node) };
                /* 361 EofOp            */ __Matchers[361] = new Eof(this, 361, "<eof>") { Creator = node => new REof(node) };
                /* 362 SeqOp            */ __Matchers[362] = new Seq(this, 362, "_362:(>compilation-unit,<eof>)") { Builder = nodes => new CXStart(nodes) };
                /* 363 AltOp            */ __Matchers[363] = new Alt(this, 363, "alt(>module-descriptor|>package-descriptor|>code-unit)") { Builder = nodes => nodes[0] };
                /* 364 SeqOp            */ __Matchers[364] = new Seq(this, 364, "_364:(>namespace,>imports,>top-declarations)") { Builder = nodes => new CCodeUnit(nodes) };
                /* 365 StringOp         */ __Matchers[365] = new Keyword(this, 365, "'namespace'", "namespace") { Creator = node => new RLiteral(node) };
                /* 366 StringOp         */ __Matchers[366] = new String(this, 366, "';'", ";") { Creator = node => new RLiteral(node) };
                /* 367 SeqOp            */ __Matchers[367] = new Seq(this, 367, "_367:(>annotations,'namespace',>namespace-path,';')") { Builder = nodes => new CNamespace(nodes) };
                /* 368 StringOp         */ __Matchers[368] = new String(this, 368, "'.'", ".") { Creator = node => new RLiteral(node) };
                /* 369 SeqOp            */ __Matchers[369] = new Seq(this, 369, "_369:('.',>identifier)") { Builder = nodes => new RSequence(nodes) };
                /* 370 StarOp           */ __Matchers[370] = new Star(this, 370, "*(_369:('.',>identifier))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 371 SeqOp            */ __Matchers[371] = new Seq(this, 371, "_371:(>identifier,*(_369:('.',>identifier)))") { Builder = nodes => new CNamespacePath(nodes) };
                /* 372 StarOp           */ __Matchers[372] = new Star(this, 372, "*(>import-declaration)") { Builder = nodes => new CImports(nodes) };
                ...
                /* 389 AltOp            */ __Matchers[389] = new Alt(this, 389, "alt(>inferred-attribute-declaration|>module-import)") { Builder = nodes => nodes[0] };
                /* 390 StringOp         */ __Matchers[390] = new Keyword(this, 390, "'import'", "import") { Creator = node => new RLiteral(node) };
                /* 391 SeqOp            */ __Matchers[391] = new Seq(this, 391, "_391:(>annotations,'import',>module,?(>version),';')") { Builder = nodes => new CModuleImport(nodes) };
                /* 392 StringOp         */ __Matchers[392] = new Keyword(this, 392, "'package'", "package") { Creator = node => new RLiteral(node) };
                /* 393 SeqOp            */ __Matchers[393] = new Seq(this, 393, "_393:(>annotations,'package',>package-path,';')") { Builder = nodes => new CPackageDescriptor(nodes) };
                /* 394 SeqOp            */ __Matchers[394] = new Seq(this, 394, "_394:('import',>package-path,>import-elements)") { Builder = nodes => new CImportDeclaration(nodes) };
                /* 395 OptionalOp       */ __Matchers[395] = new Optional(this, 395, "?(>import-element-list)") { Builder = nodes => new ROptional<CImportElementList>(nodes) };
                /* 396 SeqOp            */ __Matchers[396] = new Seq(this, 396, "_396:('{',?(>import-element-list),'}')") { Builder = nodes => new CImportElements(nodes) };
                /* 397 StringOp         */ __Matchers[397] = new String(this, 397, "','", ",") { Creator = node => new RLiteral(node) };
                /* 398 SeqOp            */ __Matchers[398] = new Seq(this, 398, "_398:(',',>import-element)") { Builder = nodes => new RSequence(nodes) };
                /* 399 StarOp           */ __Matchers[399] = new Star(this, 399, "*(_398:(',',>import-element))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 400 SeqOp            */ __Matchers[400] = new Seq(this, 400, "_400:(>import-element,*(_398:(',',>import-element)))") { Builder = nodes => new CImportElementList(nodes) };
                /* 401 AltOp            */ __Matchers[401] = new Alt(this, 401, "alt(>import-named|>import-wildcard)") { Builder = nodes => nodes[0] };
                /* 402 OptionalOp       */ __Matchers[402] = new Optional(this, 402, "?(>import-name-specifier)") { Builder = nodes => new ROptional<CImportNameSpecifier>(nodes) };
                /* 403 OptionalOp       */ __Matchers[403] = new Optional(this, 403, "?(>import-elements)") { Builder = nodes => new ROptional<CImportElements>(nodes) };
                /* 404 SeqOp            */ __Matchers[404] = new Seq(this, 404, "_404:(>import-name,?(>import-name-specifier),?(>import-elements))") { Builder = nodes => new CImportNamed(nodes) };
                /* 405 StringOp         */ __Matchers[405] = new String(this, 405, "'='", "=") { Creator = node => new RLiteral(node) };
                /* 406 SeqOp            */ __Matchers[406] = new Seq(this, 406, "_406:('=',>identifier)") { Builder = nodes => new CImportNameSpecifier(nodes) };
                /* 407 StringOp         */ __Matchers[407] = new String(this, 407, "'...'", "...") { Creator = node => new CImportWildcard(node) };
                /* 408 SeqOp            */ __Matchers[408] = new Seq(this, 408, "_408:('.',>package-name)") { Builder = nodes => new RSequence(nodes) };
                /* 409 StarOp           */ __Matchers[409] = new Star(this, 409, "*(_408:('.',>package-name))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 410 SeqOp            */ __Matchers[410] = new Seq(this, 410, "_410:(>package-name,*(_408:('.',>package-name)))") { Builder = nodes => new CPackagePath(nodes) };
                /* 411 AltOp            */ __Matchers[411] = new Alt(this, 411, "alt(>entry-pattern|>tuple-pattern|>variable-pattern)") { Builder = nodes => nodes[0] };
                /* 412 StringOp         */ __Matchers[412] = new String(this, 412, "'->'", "->") { Creator = node => new CEntryOperator(node) };
                /* 413 SeqOp            */ __Matchers[413] = new Seq(this, 413, "_413:(>variable-or-tuple-pattern,'->',>variable-or-tuple-pattern)") { Builder = nodes => new CEntryPattern(nodes) };
                /* 414 AltOp            */ __Matchers[414] = new Alt(this, 414, "alt(>tuple-pattern|>variable-pattern)") { Builder = nodes => nodes[0] };
                /* 415 StringOp         */ __Matchers[415] = new String(this, 415, "'['", "[") { Creator = node => new RLiteral(node) };
                /* 416 OptionalOp       */ __Matchers[416] = new Optional(this, 416, "?(>variadic-pattern-list)") { Builder = nodes => new ROptional<CVariadicPatternList>(nodes) };
                /* 417 StringOp         */ __Matchers[417] = new String(this, 417, "']'", "]") { Creator = node => new RLiteral(node) };
                /* 418 SeqOp            */ __Matchers[418] = new Seq(this, 418, "_418:('[',?(>variadic-pattern-list),']')") { Builder = nodes => new CTuplePattern(nodes) };
                /* 419 SeqOp            */ __Matchers[419] = new Seq(this, 419, "_419:(',',>variadic-pattern)") { Builder = nodes => new RSequence(nodes) };
                /* 420 StarOp           */ __Matchers[420] = new Star(this, 420, "*(_419:(',',>variadic-pattern))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 421 SeqOp            */ __Matchers[421] = new Seq(this, 421, "_421:(>variadic-pattern,*(_419:(',',>variadic-pattern)))") { Builder = nodes => new CVariadicPatternList(nodes) };
                /* 422 AltOp            */ __Matchers[422] = new Alt(this, 422, "alt(>variadic-variable|>pattern)") { Builder = nodes => nodes[0] };
                /* 423 OptionalOp       */ __Matchers[423] = new Optional(this, 423, "?(>union-type)") { Builder = nodes => new ROptional<ICUnionType>(nodes) };
                /* 424 SeqOp            */ __Matchers[424] = new Seq(this, 424, "_424:(?(>union-type),>variadic-operator,>member-name)") { Builder = nodes => new CVariadicVariable(nodes) };
                ...
                /* 427 AltOp            */ __Matchers[427] = new Alt(this, 427, "alt('*'|'+')") { Builder = nodes => nodes[0] };
                ...
                /* 432 SeqOp            */ __Matchers[432] = new Seq(this, 432, "_432:(',',>let-variable)") { Builder = nodes => new RSequence(nodes) };
                /* 433 StarOp           */ __Matchers[433] = new Star(this, 433, "*(_432:(',',>let-variable))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 434 SeqOp            */ __Matchers[434] = new Seq(this, 434, "_434:(>let-variable,*(_432:(',',>let-variable)))") { Builder = nodes => new CLetVariableList(nodes) };
                /* 435 SeqOp            */ __Matchers[435] = new Seq(this, 435, "_435:(>pattern,>value-specifier)") { Builder = nodes => new CLetVariable(nodes) };
                /* 436 StringOp         */ __Matchers[436] = new Keyword(this, 436, "'extends'", "extends") { Creator = node => new RLiteral(node) };
                /* 437 SeqOp            */ __Matchers[437] = new Seq(this, 437, "_437:('extends',>class-instantiation)") { Builder = nodes => new CDelegatedConstructor(nodes) };
                ...
                /* 441 SeqOp            */ __Matchers[441] = new Seq(this, 441, "_441:('{',>imports,>statements,'}')") { Builder = nodes => new CBlock(nodes) };
                /* 442 SeqOp            */ __Matchers[442] = new Seq(this, 442, "_442:('extends',>class-instantiation)") { Builder = nodes => new CExtendedType(nodes) };
                /* 443 StringOp         */ __Matchers[443] = new String(this, 443, "'=>'", "=>") { Creator = node => new RLiteral(node) };
                /* 444 SeqOp            */ __Matchers[444] = new Seq(this, 444, "_444:('=>',>class-instantiation)") { Builder = nodes => new CClassSpecifier(nodes) };
                /* 445 OptionalOp       */ __Matchers[445] = new Optional(this, 445, "?(>arguments)") { Builder = nodes => new ROptional<ICArguments>(nodes) };
                /* 446 SeqOp            */ __Matchers[446] = new Seq(this, 446, "_446:(>qualified-class,?(>arguments))") { Builder = nodes => new CClassInstantiation(nodes) };
                ...
                /* 448 SeqOp            */ __Matchers[448] = new Seq(this, 448, "_448:('package','.',>un-qualified-class)") { Builder = nodes => new CPackageQualifiedClass(nodes) };
                /* 449 StringOp         */ __Matchers[449] = new Keyword(this, 449, "'super'", "super") { Creator = node => new RLiteral(node) };
                /* 450 SeqOp            */ __Matchers[450] = new Seq(this, 450, "_450:('super','.',>base-reference)") { Builder = nodes => new CSuperQualifiedClass(nodes) };
                /* 451 AltOp            */ __Matchers[451] = new Alt(this, 451, "alt(>member-path|>type-path|>member-reference)") { Builder = nodes => nodes[0] };
                /* 452 SeqOp            */ __Matchers[452] = new Seq(this, 452, "_452:(>type-path,'.',>member-reference)") { Builder = nodes => new CMemberPath(nodes) };
                /* 453 SeqOp            */ __Matchers[453] = new Seq(this, 453, "_453:('.',>type-reference)") { Builder = nodes => new RSequence(nodes) };
                /* 454 StarOp           */ __Matchers[454] = new Star(this, 454, "*(_453:('.',>type-reference))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 455 SeqOp            */ __Matchers[455] = new Seq(this, 455, "_455:(>type-reference,*(_453:('.',>type-reference)))") { Builder = nodes => new CTypePath(nodes) };
                /* 456 StringOp         */ __Matchers[456] = new Keyword(this, 456, "'satisfies'", "satisfies") { Creator = node => new RLiteral(node) };
                /* 457 SeqOp            */ __Matchers[457] = new Seq(this, 457, "_457:('satisfies',>union-type-list)") { Builder = nodes => new CSatisfiedTypes(nodes) };
                /* 458 SeqOp            */ __Matchers[458] = new Seq(this, 458, "_458:(',',>union-type)") { Builder = nodes => new RSequence(nodes) };
                /* 459 StarOp           */ __Matchers[459] = new Star(this, 459, "*(_458:(',',>union-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 460 SeqOp            */ __Matchers[460] = new Seq(this, 460, "_460:(>union-type,*(_458:(',',>union-type)))") { Builder = nodes => new CUnionTypeList(nodes) };
                /* 461 StringOp         */ __Matchers[461] = new Keyword(this, 461, "'of'", "of") { Creator = node => new RLiteral(node) };
                /* 462 SeqOp            */ __Matchers[462] = new Seq(this, 462, "_462:('of',>case-type-list)") { Builder = nodes => new CCaseTypes(nodes) };
                /* 463 StringOp         */ __Matchers[463] = new String(this, 463, "'|'", "|") { Creator = node => new RLiteral(node) };
                /* 464 SeqOp            */ __Matchers[464] = new Seq(this, 464, "_464:('|',>case-type)") { Builder = nodes => new RSequence(nodes) };
                /* 465 StarOp           */ __Matchers[465] = new Star(this, 465, "*(_464:('|',>case-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 466 SeqOp            */ __Matchers[466] = new Seq(this, 466, "_466:(>case-type,*(_464:('|',>case-type)))") { Builder = nodes => new CCaseTypeList(nodes) };
                /* 467 AltOp            */ __Matchers[467] = new Alt(this, 467, "alt(>primary-type|>qualified-case-type)") { Builder = nodes => nodes[0] };
                /* 468 OptionalOp       */ __Matchers[468] = new Optional(this, 468, "?(>package-qualifier)") { Builder = nodes => new ROptional<CPackageQualifier>(nodes) };
                /* 469 SeqOp            */ __Matchers[469] = new Seq(this, 469, "_469:(?(>package-qualifier),>member-name)") { Builder = nodes => new CQualifiedCaseType(nodes) };
                /* 470 OptionalOp       */ __Matchers[470] = new Optional(this, 470, "?(>parameter-list)") { Builder = nodes => new ROptional<CParameterList>(nodes) };
                /* 471 SeqOp            */ __Matchers[471] = new Seq(this, 471, "_471:('(',?(>parameter-list),')')") { Builder = nodes => new CParameters(nodes) };
                /* 472 SeqOp            */ __Matchers[472] = new Seq(this, 472, "_472:(',',>parameter-declaration-or-ref-pattern)") { Builder = nodes => new RSequence(nodes) };
                /* 473 StarOp           */ __Matchers[473] = new Star(this, 473, "*(_472:(',',>parameter-declaration-or-ref-pattern))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 474 SeqOp            */ __Matchers[474] = new Seq(this, 474, "_474:(>parameter-declaration-or-ref-pattern,*(_472:(',',>parameter-declaration-or-ref-pattern)))") { Builder = nodes => new CParameterList(nodes) };
                /* 475 AltOp            */ __Matchers[475] = new Alt(this, 475, "alt(>entry-pattern|>tuple-pattern|>parameter|>parameter-reference)") { Builder = nodes => nodes[0] };
                /* 476 SeqOp            */ __Matchers[476] = new Seq(this, 476, "_476:(>annotations,>parameter-declaration)") { Builder = nodes => new CParameter(nodes) };
                /* 477 OptionalOp       */ __Matchers[477] = new Optional(this, 477, "?(>value-specifier)") { Builder = nodes => new ROptional<CValueSpecifier>(nodes) };
                /* 478 SeqOp            */ __Matchers[478] = new Seq(this, 478, "_478:(>member-name,?(>value-specifier))") { Builder = nodes => new CParameterReference(nodes) };
                /* 479 AltOp            */ __Matchers[479] = new Alt(this, 479, "alt(>function-parameter-declaration|>value-parameter-declaration)") { Builder = nodes => nodes[0] };
                /* 480 AltOp            */ __Matchers[480] = new Alt(this, 480, "alt(>void-function-parameter|>inferred-function-parameter|>typed-function-parameter)") { Builder = nodes => nodes[0] };
                /* 481 StringOp         */ __Matchers[481] = new Keyword(this, 481, "'void'", "void") { Creator = node => new CKwVoid(node) };
                ...
                /* 485 SeqOp            */ __Matchers[485] = new Seq(this, 485, "_485:('void',>member-name,?(>type-parameters),+(>parameters),?(>function-specifier))") { Builder = nodes => new CVoidFunctionParameter(nodes) };
                /* 486 StringOp         */ __Matchers[486] = new Keyword(this, 486, "'function'", "function") { Creator = node => new CKwFunction(node) };
                /* 487 SeqOp            */ __Matchers[487] = new Seq(this, 487, "_487:('function',>member-name,?(>type-parameters),+(>parameters),?(>function-specifier))") { Builder = nodes => new CInferredFunctionParameter(nodes) };
                /* 488 SeqOp            */ __Matchers[488] = new Seq(this, 488, "_488:(>variadic-type,>member-name,?(>type-parameters),+(>parameters),?(>function-specifier))") { Builder = nodes => new CTypedFunctionParameter(nodes) };
                /* 489 AltOp            */ __Matchers[489] = new Alt(this, 489, "alt(>inferred-value-parameter|>typed-value-parameter)") { Builder = nodes => nodes[0] };
                /* 490 StringOp         */ __Matchers[490] = new Keyword(this, 490, "'value'", "value") { Creator = node => new CKwValue(node) };
                /* 491 SeqOp            */ __Matchers[491] = new Seq(this, 491, "_491:('value',>member-name,?(>value-specifier))") { Builder = nodes => new CInferredValueParameter(nodes) };
                /* 492 SeqOp            */ __Matchers[492] = new Seq(this, 492, "_492:(>variadic-type,>member-name,?(>value-specifier))") { Builder = nodes => new CTypedValueParameter(nodes) };
                ...
                /* 512 StarOp           */ __Matchers[512] = new Star(this, 512, "*(>top-declaration)") { Builder = nodes => new CTopDeclarations(nodes) };
                /* 513 AltOp            */ __Matchers[513] = new Alt(this, 513, "alt(>class-declaration|>interface-declaration|>alias-declaration|>object-declaration|>setter-declaration|>typed-method-declaration|>void-method-declaration|>inferred-method-declaration|>typed-attribute-declaration|>inferred-attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 514 AltOp            */ __Matchers[514] = new Alt(this, 514, "alt(>class-declaration|>interface-declaration|>alias-declaration|>object-declaration|>constructor-declaration|>enumerated-object-declaration|>setter-declaration|>typed-method-declaration|>void-method-declaration|>inferred-method-declaration|>typed-attribute-declaration|>inferred-attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 515 StringOp         */ __Matchers[515] = new Keyword(this, 515, "'new'", "new") { Creator = node => new RLiteral(node) };
                /* 516 OptionalOp       */ __Matchers[516] = new Optional(this, 516, "?(>member-name)") { Builder = nodes => new ROptional<ICMemberName>(nodes) };
                /* 517 OptionalOp       */ __Matchers[517] = new Optional(this, 517, "?(>delegated-constructor)") { Builder = nodes => new ROptional<CDelegatedConstructor>(nodes) };
                /* 518 SeqOp            */ __Matchers[518] = new Seq(this, 518, "_518:(>annotations,'new',?(>member-name),>parameters,?(>delegated-constructor),>block)") { Builder = nodes => new CConstructorDeclaration(nodes) };
                /* 519 StringOp         */ __Matchers[519] = new Keyword(this, 519, "'alias'", "alias") { Creator = node => new RLiteral(node) };
                /* 520 OptionalOp       */ __Matchers[520] = new Optional(this, 520, "?(>type-constraints)") { Builder = nodes => new ROptional<CTypeConstraints>(nodes) };
                /* 521 SeqOp            */ __Matchers[521] = new Seq(this, 521, "_521:(>annotations,'alias',>type-name,?(>type-parameters),?(>type-constraints),>optional-type-specifier)") { Builder = nodes => new CAliasDeclaration(nodes) };
                /* 522 SeqOp            */ __Matchers[522] = new Seq(this, 522, "_522:(>annotations,'new',>member-name,?(>delegated-constructor),>block)") { Builder = nodes => new CEnumeratedObjectDeclaration(nodes) };
                /* 523 StringOp         */ __Matchers[523] = new Keyword(this, 523, "'object'", "object") { Creator = node => new RLiteral(node) };
                /* 524 OptionalOp       */ __Matchers[524] = new Optional(this, 524, "?(>extended-type)") { Builder = nodes => new ROptional<CExtendedType>(nodes) };
                /* 525 SeqOp            */ __Matchers[525] = new Seq(this, 525, "_525:(>annotations,'object',>member-name,?(>extended-type),?(>satisfied-types),>block)") { Builder = nodes => new CObjectDeclaration(nodes) };
                /* 526 StringOp         */ __Matchers[526] = new Keyword(this, 526, "'assign'", "assign") { Creator = node => new RLiteral(node) };
                /* 527 SeqOp            */ __Matchers[527] = new Seq(this, 527, "_527:(>annotations,'assign',>member-name,>setter-definition)") { Builder = nodes => new CSetterDeclaration(nodes) };
                /* 528 AltOp            */ __Matchers[528] = new Alt(this, 528, "alt(>block|>required-function-specifier)") { Builder = nodes => nodes[0] };
                ...
                /* 531 SeqOp            */ __Matchers[531] = new Seq(this, 531, "_531:(>annotations,>variadic-type,>member-name,?(>type-parameters),+(>parameters),?(>type-constraints),>method-definition)") { Builder = nodes => new CTypedMethodDeclaration(nodes) };
                /* 532 AltOp            */ __Matchers[532] = new Alt(this, 532, "alt(>block|>optional-function-specifier)") { Builder = nodes => nodes[0] };
                ...
                /* 548 AltOp            */ __Matchers[548] = new Alt(this, 548, "alt(>return-statement|>throw-statement|>break-statement|>continue-statement|>expression-statement|>specification-statement|>assertion-statement|>let-statement)") { Builder = nodes => nodes[0] };
                ...
                /* 557 SeqOp            */ __Matchers[557] = new Seq(this, 557, "_557:('=',>expression)") { Builder = nodes => new CValueSpecifier(nodes) };
                /* 558 SeqOp            */ __Matchers[558] = new Seq(this, 558, "_558:('=>',>expression)") { Builder = nodes => new CFunctionSpecifier(nodes) };
                /* 559 SeqOp            */ __Matchers[559] = new Seq(this, 559, "_559:(?(>function-specifier),';')") { Builder = nodes => new COptionalFunctionSpecifier(nodes) };
                /* 560 SeqOp            */ __Matchers[560] = new Seq(this, 560, "_560:(>function-specifier,';')") { Builder = nodes => new CRequiredFunctionSpecifier(nodes) };
                /* 561 SeqOp            */ __Matchers[561] = new Seq(this, 561, "_561:('=>',>type)") { Builder = nodes => new CTypeSpecifier(nodes) };
                /* 562 OptionalOp       */ __Matchers[562] = new Optional(this, 562, "?(>type-specifier)") { Builder = nodes => new ROptional<CTypeSpecifier>(nodes) };
                /* 563 SeqOp            */ __Matchers[563] = new Seq(this, 563, "_563:(?(>type-specifier),';')") { Builder = nodes => new COptionalTypeSpecifier(nodes) };
                /* 564 AltOp            */ __Matchers[564] = new Alt(this, 564, "alt(>value-specifier|>function-specifier)") { Builder = nodes => nodes[0] };
                /* 565 OptionalOp       */ __Matchers[565] = new Optional(this, 565, "?(>any-specifier)") { Builder = nodes => new ROptional<ICAnySpecifier>(nodes) };
                /* 566 SeqOp            */ __Matchers[566] = new Seq(this, 566, "_566:(?(>any-specifier),';')") { Builder = nodes => new COptionalAnySpecifier(nodes) };
                /* 567 AltOp            */ __Matchers[567] = new Alt(this, 567, "alt(>base-reference|>self-reference|>parametrized-member|>self-parametrized-member)") { Builder = nodes => nodes[0] };
                ...
                /* 578 OptionalOp       */ __Matchers[578] = new Optional(this, 578, "?(>sequenced-argument-list)") { Builder = nodes => new ROptional<CSequencedArgumentList>(nodes) };
                /* 579 SeqOp            */ __Matchers[579] = new Seq(this, 579, "_579:('{',>statements,?(>sequenced-argument-list),'}')") { Builder = nodes => new CEnumerationExpr(nodes) };
                /* 580 SeqOp            */ __Matchers[580] = new Seq(this, 580, "_580:('[',?(>sequenced-argument-list),']')") { Builder = nodes => new CTupleExpr(nodes) };
                /* 581 AltOp            */ __Matchers[581] = new Alt(this, 581, "alt(>patterned-arguments|>positional-arguments)") { Builder = nodes => nodes[0] };
                /* 582 StarOp           */ __Matchers[582] = new Star(this, 582, "*(>structured-argument)") { Builder = nodes => new RStar<ICStructuredArgument>(nodes) };
                /* 583 SeqOp            */ __Matchers[583] = new Seq(this, 583, "_583:('{',*(>structured-argument),?(>sequenced-argument-list),'}')") { Builder = nodes => new CPatternedArguments(nodes) };
                /* 584 SeqOp            */ __Matchers[584] = new Seq(this, 584, "_584:('(',?(>sequenced-argument-list),')')") { Builder = nodes => new CPositionalArguments(nodes) };
                ...
                /* 591 SeqOp            */ __Matchers[591] = new Seq(this, 591, "_591:(>sequenced-argument,*(_589:(',',>sequenced-argument)))") { Builder = nodes => new CSequencedArgumentList(nodes) };
                ...
                /* 595 SeqOp            */ __Matchers[595] = new Seq(this, 595, "_595:(>type,>parametrized-member,>method-definition)") { Builder = nodes => new CTypedMethodArgument(nodes) };
                /* 596 SeqOp            */ __Matchers[596] = new Seq(this, 596, "_596:('function',?(>member-name),?(>type-parameters),>parameters,>method-definition)") { Builder = nodes => new CInferredMethodArgument(nodes) };
                /* 597 SeqOp            */ __Matchers[597] = new Seq(this, 597, "_597:(>member-name,+(>parameters),>required-function-specifier)") { Builder = nodes => new CUntypedMethodArgument(nodes) };
                /* 598 SeqOp            */ __Matchers[598] = new Seq(this, 598, "_598:(>type,>member-name,>method-definition)") { Builder = nodes => new CTypedGetterArgument(nodes) };
                ...
                /* 601 AltOp            */ __Matchers[601] = new Alt(this, 601, "alt(>expression-argument|>declaration-reference)") { Builder = nodes => nodes[0] };
                /* 602 SeqOp            */ __Matchers[602] = new Seq(this, 602, "_602:('*',>union-expression)") { Builder = nodes => new CSpreadArgument(nodes) };
                /* 603 OptionalOp       */ __Matchers[603] = new Optional(this, 603, "?(>let-variable-list)") { Builder = nodes => new ROptional<CLetVariableList>(nodes) };
                /* 604 SeqOp            */ __Matchers[604] = new Seq(this, 604, "_604:('let','(',?(>let-variable-list),')',>conditional-expression)") { Builder = nodes => new CLetExpr(nodes) };
                /* 605 PlusOp           */ __Matchers[605] = new Plus(this, 605, "+(>case-expression)") { Builder = nodes => new RPlus<CCaseExpression>(nodes) };
                /* 606 OptionalOp       */ __Matchers[606] = new Optional(this, 606, "?(>else-expression)") { Builder = nodes => new ROptional<CElseExpression>(nodes) };
                /* 607 SeqOp            */ __Matchers[607] = new Seq(this, 607, "_607:(>switch-header,+(>case-expression),?(>else-expression))") { Builder = nodes => new CSwitchExpr(nodes) };
                /* 608 StringOp         */ __Matchers[608] = new Keyword(this, 608, "'switch'", "switch") { Creator = node => new RLiteral(node) };
                /* 609 SeqOp            */ __Matchers[609] = new Seq(this, 609, "_609:('switch','(',>switched,')')") { Builder = nodes => new CSwitchHeader(nodes) };
                /* 610 StringOp         */ __Matchers[610] = new Keyword(this, 610, "'else'", "else") { Creator = node => new RLiteral(node) };
                /* 611 OptionalOp       */ __Matchers[611] = new Optional(this, 611, "?('else')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 612 StringOp         */ __Matchers[612] = new Keyword(this, 612, "'case'", "case") { Creator = node => new RLiteral(node) };
                /* 613 SeqOp            */ __Matchers[613] = new Seq(this, 613, "_613:(?('else'),'case','(',>case-item,')',>conditional-expression)") { Builder = nodes => new CCaseExpression(nodes) };
                /* 614 StringOp         */ __Matchers[614] = new Keyword(this, 614, "'if'", "if") { Creator = node => new RLiteral(node) };
                /* 615 SeqOp            */ __Matchers[615] = new Seq(this, 615, "_615:('if',>conditions,>then-expression,>else-expression)") { Builder = nodes => new CIfExpr(nodes) };
                /* 616 SeqOp            */ __Matchers[616] = new Seq(this, 616, "_616:('else',>conditional-expression)") { Builder = nodes => new CElseExpression(nodes) };
                /* 617 StringOp         */ __Matchers[617] = new Keyword(this, 617, "'then'", "then") { Creator = node => new RLiteral(node) };
                /* 618 SeqOp            */ __Matchers[618] = new Seq(this, 618, "_618:('then',>conditional-expression)") { Builder = nodes => new CThenExpression(nodes) };
                /* 619 AltOp            */ __Matchers[619] = new Alt(this, 619, "alt(>if-expr|>let-expr|>disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 620 AltOp            */ __Matchers[620] = new Alt(this, 620, "alt(>void-function-expr|>inferred-function-expr)") { Builder = nodes => nodes[0] };
                /* 621 SeqOp            */ __Matchers[621] = new Seq(this, 621, "_621:('void',?(>type-parameters),+(>parameters),?(>type-constraints),>function-definition)") { Builder = nodes => new CVoidFunctionExpr(nodes) };
                /* 622 OptionalOp       */ __Matchers[622] = new Optional(this, 622, "?('function')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 623 SeqOp            */ __Matchers[623] = new Seq(this, 623, "_623:(?('function'),?(>type-parameters),+(>parameters),?(>type-constraints),>function-definition)") { Builder = nodes => new CInferredFunctionExpr(nodes) };
                ...
                /* 631 AltOp            */ __Matchers[631] = new Alt(this, 631, "alt(>let-expr|>if-expr|>switch-expr|>function-expression|>operator-expression)") { Builder = nodes => nodes[0] };
                ...
                /* 694 AltOp            */ __Matchers[694] = new Alt(this, 694, "alt(>scale-expr|>multiplicative-expression)") { Builder = nodes => nodes[0] };
                /* 695 SeqOp            */ __Matchers[695] = new Seq(this, 695, "_695:(>multiplicative-expression,>scale-operator,>scale-expression)") { Builder = nodes => new CScaleExpr(nodes) };
                /* 696 StringOp         */ __Matchers[696] = new String(this, 696, "'**'", "**") { Creator = node => new CScaleOperator(node) };
                /* 697 AltOp            */ __Matchers[697] = new Alt(this, 697, "alt(>multiplicative-expr|>union-expression)") { Builder = nodes => nodes[0] };
                /* 698 SeqOp            */ __Matchers[698] = new Seq(this, 698, "_698:(>multiplicative-expression,>multiplicative-operator,>union-expression)") { Builder = nodes => new CMultiplicativeExpr(nodes) };
                ...
                /* 702 AltOp            */ __Matchers[702] = new Alt(this, 702, "alt(>union-expr|>exclusive-expression)") { Builder = nodes => nodes[0] };
                /* 703 SeqOp            */ __Matchers[703] = new Seq(this, 703, "_703:(>union-expression,>union-operator,>exclusive-expression)") { Builder = nodes => new CUnionExpr(nodes) };
                /* 704 StringOp         */ __Matchers[704] = new String(this, 704, "'~'", "~") { Creator = node => new CComplementOperator(node) };
                /* 705 AltOp            */ __Matchers[705] = new Alt(this, 705, "alt('|'|'~')") { Builder = nodes => nodes[0] };
                /* 706 AltOp            */ __Matchers[706] = new Alt(this, 706, "alt(>exclusive-expr|>intersection-expression)") { Builder = nodes => nodes[0] };
                /* 707 SeqOp            */ __Matchers[707] = new Seq(this, 707, "_707:(>exclusive-expression,>exclusive-operator,>intersection-expression)") { Builder = nodes => new CExclusiveExpr(nodes) };
                /* 708 StringOp         */ __Matchers[708] = new String(this, 708, "'^'", "^") { Creator = node => new CExclusiveOperator(node) };
                /* 709 AltOp            */ __Matchers[709] = new Alt(this, 709, "alt(>intersection-expr|>negation-or-complement-expression)") { Builder = nodes => nodes[0] };
                /* 710 SeqOp            */ __Matchers[710] = new Seq(this, 710, "_710:(>intersection-expression,>intersection-operator,>negation-or-complement-expression)") { Builder = nodes => new CIntersectionExpr(nodes) };
                /* 711 StringOp         */ __Matchers[711] = new String(this, 711, "'&'", "&") { Creator = node => new CIntersectionOperator(node) };
                /* 712 AltOp            */ __Matchers[712] = new Alt(this, 712, "alt(>negation-or-complement-expr|>prefix-expression)") { Builder = nodes => nodes[0] };
                /* 713 SeqOp            */ __Matchers[713] = new Seq(this, 713, "_713:(>unary-minus-or-complement-operator,>negation-or-complement-expression)") { Builder = nodes => new CNegationOrComplementExpr(nodes) };
                /* 714 AltOp            */ __Matchers[714] = new Alt(this, 714, "alt(>negate-operator|>neutral-operator|>complement-operator)") { Builder = nodes => nodes[0] };
                /* 715 NotOp            */ __Matchers[715] = new Not(this, 715, "!('-')") { Builder = nodes => new RNot<RLiteral>(nodes) };
                /* 716 SeqOp            */ __Matchers[716] = new Seq(this, 716, "_716:('-',!('-'))") { Builder = nodes => new CNegateOperator(nodes) };
                /* 717 NotOp            */ __Matchers[717] = new Not(this, 717, "!('+')") { Builder = nodes => new RNot<RLiteral>(nodes) };
                /* 718 SeqOp            */ __Matchers[718] = new Seq(this, 718, "_718:('+',!('+'))") { Builder = nodes => new CNeutralOperator(nodes) };
                /* 719 AltOp            */ __Matchers[719] = new Alt(this, 719, "alt(>prefix-expr|>postfix-expression)") { Builder = nodes => nodes[0] };
                /* 720 SeqOp            */ __Matchers[720] = new Seq(this, 720, "_720:(>increment-operator,>prefix-expression)") { Builder = nodes => new CPrefixExpr(nodes) };
                /* 721 AltOp            */ __Matchers[721] = new Alt(this, 721, "alt(>postfix-expr|>primary)") { Builder = nodes => nodes[0] };
                /* 722 SeqOp            */ __Matchers[722] = new Seq(this, 722, "_722:(>postfix-expression,>increment-operator)") { Builder = nodes => new CPostfixExpr(nodes) };
                ...
                /* 726 AltOp            */ __Matchers[726] = new Alt(this, 726, "alt(>selection-expr|>indexed-expr|>call-expr|>base-expression)") { Builder = nodes => nodes[0] };
                /* 727 SeqOp            */ __Matchers[727] = new Seq(this, 727, "_727:(>primary,>member-selection-operator,>base-reference)") { Builder = nodes => new CSelectionExpr(nodes) };
                ...
                /* 731 SeqOp            */ __Matchers[731] = new Seq(this, 731, "_731:(>primary,'[',>index,']')") { Builder = nodes => new CIndexedExpr(nodes) };
                /* 732 AltOp            */ __Matchers[732] = new Alt(this, 732, "alt(>lower-spanned|>upper-spanned|>spanned|>measured|>expression)") { Builder = nodes => nodes[0] };
                /* 733 SeqOp            */ __Matchers[733] = new Seq(this, 733, "_733:(>index-expression,'...')") { Builder = nodes => new CUpperSpanned(nodes) };
                /* 734 SeqOp            */ __Matchers[734] = new Seq(this, 734, "_734:('...',>index-expression)") { Builder = nodes => new CLowerSpanned(nodes) };
                /* 735 SeqOp            */ __Matchers[735] = new Seq(this, 735, "_735:(>index-expression,'..',>index-expression)") { Builder = nodes => new CSpanned(nodes) };
                /* 736 SeqOp            */ __Matchers[736] = new Seq(this, 736, "_736:(>index-expression,':',>index-expression)") { Builder = nodes => new CMeasured(nodes) };
                /* 737 SeqOp            */ __Matchers[737] = new Seq(this, 737, "_737:(>primary,>arguments)") { Builder = nodes => new CCallExpr(nodes) };
                /* 738 AltOp            */ __Matchers[738] = new Alt(this, 738, "alt(>nonstring-literal|>string-expression|>meta-literal|>enumeration-expr|>tuple-expr|>object-expr|>grouped-expr|>base-reference-or-parameterized)") { Builder = nodes => nodes[0] };
                /* 739 AltOp            */ __Matchers[739] = new Alt(this, 739, "alt(>literal-natural|>literal-float|>literal-char)") { Builder = nodes => nodes[0] };
                /* 740 AltOp            */ __Matchers[740] = new Alt(this, 740, "alt(>string-literal|>string-interpolation)") { Builder = nodes => nodes[0] };
                /* 741 StarOp           */ __Matchers[741] = new Star(this, 741, "*(>interpolation-part)") { Builder = nodes => new RStar<CInterpolationPart>(nodes) };
                /* 742 SeqOp            */ __Matchers[742] = new Seq(this, 742, "_742:(>string-start,>expression,*(>interpolation-part),>string-end)") { Builder = nodes => new CStringInterpolation(nodes) };
                /* 743 SeqOp            */ __Matchers[743] = new Seq(this, 743, "_743:(>string-mid,>expression)") { Builder = nodes => new CInterpolationPart(nodes) };
                /* 744 AltOp            */ __Matchers[744] = new Alt(this, 744, "alt(>literal-string|>verbatim-string)") { Builder = nodes => nodes[0] };
                /* 745 SeqOp            */ __Matchers[745] = new Seq(this, 745, "_745:('object',?(>extended-type),?(>satisfied-types),>block)") { Builder = nodes => new CObjectExpr(nodes) };
                /* 746 SeqOp            */ __Matchers[746] = new Seq(this, 746, "_746:('(',>expression,')')") { Builder = nodes => new CGroupedExpr(nodes) };
                /* 747 OptionalOp       */ __Matchers[747] = new Optional(this, 747, "?(>type-argument-list)") { Builder = nodes => new ROptional<CTypeArgumentList>(nodes) };
                /* 748 SeqOp            */ __Matchers[748] = new Seq(this, 748, "_748:('<',?(>type-argument-list),'>')") { Builder = nodes => new CTypeArguments(nodes) };
                /* 749 SeqOp            */ __Matchers[749] = new Seq(this, 749, "_749:(',',>varianced-type)") { Builder = nodes => new RSequence(nodes) };
                /* 750 StarOp           */ __Matchers[750] = new Star(this, 750, "*(_749:(',',>varianced-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 751 SeqOp            */ __Matchers[751] = new Seq(this, 751, "_751:(>varianced-type,*(_749:(',',>varianced-type)))") { Builder = nodes => new CTypeArgumentList(nodes) };
                /* 752 SeqOp            */ __Matchers[752] = new Seq(this, 752, "_752:(?(>variance),>type)") { Builder = nodes => new CVariancedType(nodes) };
                /* 753 SeqOp            */ __Matchers[753] = new Seq(this, 753, "_753:(',',>defaulted-type)") { Builder = nodes => new RSequence(nodes) };
                /* 754 StarOp           */ __Matchers[754] = new Star(this, 754, "*(_753:(',',>defaulted-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 755 SeqOp            */ __Matchers[755] = new Seq(this, 755, "_755:(>defaulted-type,*(_753:(',',>defaulted-type)))") { Builder = nodes => new CDefaultedTypeList(nodes) };
                /* 756 AltOp            */ __Matchers[756] = new Alt(this, 756, "alt(>defaulted-type-core|>variadic-type)") { Builder = nodes => nodes[0] };
                /* 757 SeqOp            */ __Matchers[757] = new Seq(this, 757, "_757:(>type,'=')") { Builder = nodes => new CDefaultedTypeCore(nodes) };
                /* 758 AltOp            */ __Matchers[758] = new Alt(this, 758, "alt(>variadic-type-core|>type)") { Builder = nodes => nodes[0] };
                /* 759 SeqOp            */ __Matchers[759] = new Seq(this, 759, "_759:(>union-type,>variadic-operator)") { Builder = nodes => new CVariadicTypeCore(nodes) };
                /* 760 SeqOp            */ __Matchers[760] = new Seq(this, 760, "_760:('*',>union-type)") { Builder = nodes => new CSpreadType(nodes) };
                /* 761 AltOp            */ __Matchers[761] = new Alt(this, 761, "alt(>entry-type|>union-type)") { Builder = nodes => nodes[0] };
                /* 762 SeqOp            */ __Matchers[762] = new Seq(this, 762, "_762:(>union-type,'->',>union-type)") { Builder = nodes => new CEntryType(nodes) };
                /* 763 AltOp            */ __Matchers[763] = new Alt(this, 763, "alt(>union-type-core|>intersection-type)") { Builder = nodes => nodes[0] };
                /* 764 SeqOp            */ __Matchers[764] = new Seq(this, 764, "_764:(>union-type,'|',>intersection-type)") { Builder = nodes => new CUnionTypeCore(nodes) };
                /* 765 AltOp            */ __Matchers[765] = new Alt(this, 765, "alt(>intersection-type-core|>primary-type)") { Builder = nodes => nodes[0] };
                /* 766 SeqOp            */ __Matchers[766] = new Seq(this, 766, "_766:(>intersection-type,'&',>primary-type)") { Builder = nodes => new CIntersectionTypeCore(nodes) };
                /* 767 AltOp            */ __Matchers[767] = new Alt(this, 767, "alt(>nullable-type|>array-type|>function-type|>tuple-type|>iterable-type|>grouped-type|>package-qualified-type|>type-path)") { Builder = nodes => nodes[0] };
                /* 768 StringOp         */ __Matchers[768] = new String(this, 768, "'?'", "?") { Creator = node => new RLiteral(node) };
                /* 769 SeqOp            */ __Matchers[769] = new Seq(this, 769, "_769:(>primary-type,'?')") { Builder = nodes => new CNullableType(nodes) };
                /* 770 OptionalOp       */ __Matchers[770] = new Optional(this, 770, "?(>literal-natural)") { Builder = nodes => new ROptional<CLiteralNatural>(nodes) };
                /* 771 SeqOp            */ __Matchers[771] = new Seq(this, 771, "_771:(>primary-type,'[',?(>literal-natural),']')") { Builder = nodes => new CArrayType(nodes) };
                /* 772 OptionalOp       */ __Matchers[772] = new Optional(this, 772, "?(>type-type-arguments)") { Builder = nodes => new ROptional<ICTypeTypeArguments>(nodes) };
                /* 773 SeqOp            */ __Matchers[773] = new Seq(this, 773, "_773:(>primary-type,'(',?(>type-type-arguments),')')") { Builder = nodes => new CFunctionType(nodes) };
                /* 774 AltOp            */ __Matchers[774] = new Alt(this, 774, "alt(>spread-type|>defaulted-type-list)") { Builder = nodes => nodes[0] };
                /* 775 SeqOp            */ __Matchers[775] = new Seq(this, 775, "_775:('[',?(>type-type-arguments),']')") { Builder = nodes => new CTupleType(nodes) };
                /* 776 OptionalOp       */ __Matchers[776] = new Optional(this, 776, "?(>variadic-type)") { Builder = nodes => new ROptional<ICVariadicType>(nodes) };
                /* 777 SeqOp            */ __Matchers[777] = new Seq(this, 777, "_777:('{',?(>variadic-type),'}')") { Builder = nodes => new CIterableType(nodes) };
                /* 778 SeqOp            */ __Matchers[778] = new Seq(this, 778, "_778:('<',>type,'>')") { Builder = nodes => new CGroupedType(nodes) };
                /* 779 SeqOp            */ __Matchers[779] = new Seq(this, 779, "_779:('package','.',>type-path)") { Builder = nodes => new CPackageQualifiedType(nodes) };
                /* 780 OptionalOp       */ __Matchers[780] = new Optional(this, 780, "?(>string-literal)") { Builder = nodes => new ROptional<ICStringLiteral>(nodes) };
                /* 781 StarOp           */ __Matchers[781] = new Star(this, 781, "*(>annotation)") { Builder = nodes => new RStar<CAnnotation>(nodes) };
                /* 782 SeqOp            */ __Matchers[782] = new Seq(this, 782, "_782:(?(>string-literal),*(>annotation))") { Builder = nodes => new CAnnotations(nodes) };
                /* 783 SeqOp            */ __Matchers[783] = new Seq(this, 783, "_783:(>member-name,?(>arguments))") { Builder = nodes => new CAnnotation(nodes) };
                /* 784 OptionalOp       */ __Matchers[784] = new Optional(this, 784, "?(>condition-list)") { Builder = nodes => new ROptional<CConditionList>(nodes) };
                /* 785 SeqOp            */ __Matchers[785] = new Seq(this, 785, "_785:('(',?(>condition-list),')')") { Builder = nodes => new CConditions(nodes) };
                /* 786 SeqOp            */ __Matchers[786] = new Seq(this, 786, "_786:(',',>condition)") { Builder = nodes => new RSequence(nodes) };
                /* 787 StarOp           */ __Matchers[787] = new Star(this, 787, "*(_786:(',',>condition))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 788 SeqOp            */ __Matchers[788] = new Seq(this, 788, "_788:(>condition,*(_786:(',',>condition)))") { Builder = nodes => new CConditionList(nodes) };
                /* 789 AltOp            */ __Matchers[789] = new Alt(this, 789, "alt(>exists-condition|>nonempty-condition|>is-condition|>satisfies-condition|>boolean-condition)") { Builder = nodes => nodes[0] };
                /* 790 OptionalOp       */ __Matchers[790] = new Optional(this, 790, "?('!')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 791 SeqOp            */ __Matchers[791] = new Seq(this, 791, "_791:(?('!'),'exists',>let-or-expression)") { Builder = nodes => new CExistsCondition(nodes) };
                /* 792 SeqOp            */ __Matchers[792] = new Seq(this, 792, "_792:(?('!'),'nonempty',>let-or-expression)") { Builder = nodes => new CNonemptyCondition(nodes) };
                /* 793 AltOp            */ __Matchers[793] = new Alt(this, 793, "alt(>let-variable|>operator-expression)") { Builder = nodes => nodes[0] };
                /* 794 SeqOp            */ __Matchers[794] = new Seq(this, 794, "_794:(?('!'),'is',>type,>is-condition-variable)") { Builder = nodes => new CIsCondition(nodes) };
                /* 795 SeqOp            */ __Matchers[795] = new Seq(this, 795, "_795:(>member-name,?(>value-specifier))") { Builder = nodes => new CIsConditionVariable(nodes) };
                /* 796 SeqOp            */ __Matchers[796] = new Seq(this, 796, "_796:('satisfies',>type,>type-name)") { Builder = nodes => new CSatisfiesCondition(nodes) };
                /* 797 AltOp            */ __Matchers[797] = new Alt(this, 797, "alt(>if-else-statement|>for-else-statement|>switch-statement|>while-statement|>try-statement)") { Builder = nodes => nodes[0] };
                /* 798 StarOp           */ __Matchers[798] = new Star(this, 798, "*(>else-if)") { Builder = nodes => new RStar<CElseIf>(nodes) };
                /* 799 OptionalOp       */ __Matchers[799] = new Optional(this, 799, "?(>else-block)") { Builder = nodes => new ROptional<CElseBlock>(nodes) };
                /* 800 SeqOp            */ __Matchers[800] = new Seq(this, 800, "_800:('if',>conditions,>block,*(>else-if),?(>else-block))") { Builder = nodes => new CIfElseStatement(nodes) };
                /* 801 SeqOp            */ __Matchers[801] = new Seq(this, 801, "_801:('else','if',>conditions,>block)") { Builder = nodes => new CElseIf(nodes) };
                /* 802 SeqOp            */ __Matchers[802] = new Seq(this, 802, "_802:('else',>block)") { Builder = nodes => new CElseBlock(nodes) };
                /* 803 PlusOp           */ __Matchers[803] = new Plus(this, 803, "+(>case-block)") { Builder = nodes => new RPlus<CCaseBlock>(nodes) };
                /* 804 SeqOp            */ __Matchers[804] = new Seq(this, 804, "_804:(>switch-header,+(>case-block),?(>else-block))") { Builder = nodes => new CSwitchStatement(nodes) };
                /* 805 SeqOp            */ __Matchers[805] = new Seq(this, 805, "_805:(?('else'),'case','(',>case-item,')',>block)") { Builder = nodes => new CCaseBlock(nodes) };
                /* 806 AltOp            */ __Matchers[806] = new Alt(this, 806, "alt(>is-case-condition|>satisfies-case-condition|>value-case-list|>pattern)") { Builder = nodes => nodes[0] };
                /* 807 SeqOp            */ __Matchers[807] = new Seq(this, 807, "_807:('is',>type)") { Builder = nodes => new CIsCaseCondition(nodes) };
                /* 808 SeqOp            */ __Matchers[808] = new Seq(this, 808, "_808:('satisfies',>type)") { Builder = nodes => new CSatisfiesCaseCondition(nodes) };
                /* 809 SeqOp            */ __Matchers[809] = new Seq(this, 809, "_809:(>value-case-separator,>value-case)") { Builder = nodes => new RSequence(nodes) };
                /* 810 StarOp           */ __Matchers[810] = new Star(this, 810, "*(_809:(>value-case-separator,>value-case))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 811 SeqOp            */ __Matchers[811] = new Seq(this, 811, "_811:(>value-case,*(_809:(>value-case-separator,>value-case)))") { Builder = nodes => new CValueCaseList(nodes) };
                /* 812 AltOp            */ __Matchers[812] = new Alt(this, 812, "alt(','|'|')") { Builder = nodes => nodes[0] };
                /* 813 AltOp            */ __Matchers[813] = new Alt(this, 813, "alt(>intersection-type|>intersection-expression)") { Builder = nodes => nodes[0] };
                /* 814 SeqOp            */ __Matchers[814] = new Seq(this, 814, "_814:('for','(',?(>for-iterator),')',>block,?(>else-block))") { Builder = nodes => new CForElseStatement(nodes) };
                /* 815 SeqOp            */ __Matchers[815] = new Seq(this, 815, "_815:(>for-variable,>containment)") { Builder = nodes => new CForIterator(nodes) };
                /* 816 SeqOp            */ __Matchers[816] = new Seq(this, 816, "_816:(>containment-operator,>operator-expression)") { Builder = nodes => new CContainment(nodes) };
                /* 817 AltOp            */ __Matchers[817] = new Alt(this, 817, "alt('in'|':')") { Builder = nodes => nodes[0] };
                /* 818 StringOp         */ __Matchers[818] = new Keyword(this, 818, "'while'", "while") { Creator = node => new RLiteral(node) };
                /* 819 SeqOp            */ __Matchers[819] = new Seq(this, 819, "_819:('while',>conditions,>block)") { Builder = nodes => new CWhileStatement(nodes) };
                /* 820 StringOp         */ __Matchers[820] = new Keyword(this, 820, "'try'", "try") { Creator = node => new RLiteral(node) };
                /* 821 OptionalOp       */ __Matchers[821] = new Optional(this, 821, "?(>resources)") { Builder = nodes => new ROptional<CResources>(nodes) };
                /* 822 StarOp           */ __Matchers[822] = new Star(this, 822, "*(>catch-block)") { Builder = nodes => new RStar<CCatchBlock>(nodes) };
                /* 823 OptionalOp       */ __Matchers[823] = new Optional(this, 823, "?(>finally-block)") { Builder = nodes => new ROptional<CFinallyBlock>(nodes) };
                /* 824 SeqOp            */ __Matchers[824] = new Seq(this, 824, "_824:('try',?(>resources),>block,*(>catch-block),?(>finally-block))") { Builder = nodes => new CTryStatement(nodes) };
                /* 825 StringOp         */ __Matchers[825] = new Keyword(this, 825, "'catch'", "catch") { Creator = node => new RLiteral(node) };
                /* 826 OptionalOp       */ __Matchers[826] = new Optional(this, 826, "?(>variable)") { Builder = nodes => new ROptional<CVariable>(nodes) };
                /* 827 SeqOp            */ __Matchers[827] = new Seq(this, 827, "_827:('catch','(',?(>variable),')',>block)") { Builder = nodes => new CCatchBlock(nodes) };
                /* 828 StringOp         */ __Matchers[828] = new Keyword(this, 828, "'finally'", "finally") { Creator = node => new RLiteral(node) };
                /* 829 SeqOp            */ __Matchers[829] = new Seq(this, 829, "_829:('finally',>block)") { Builder = nodes => new CFinallyBlock(nodes) };
                /* 830 OptionalOp       */ __Matchers[830] = new Optional(this, 830, "?(>resource-list)") { Builder = nodes => new ROptional<CResourceList>(nodes) };
                /* 831 SeqOp            */ __Matchers[831] = new Seq(this, 831, "_831:('(',?(>resource-list),')')") { Builder = nodes => new CResources(nodes) };
                /* 832 SeqOp            */ __Matchers[832] = new Seq(this, 832, "_832:(',',>resource)") { Builder = nodes => new RSequence(nodes) };
                /* 833 StarOp           */ __Matchers[833] = new Star(this, 833, "*(_832:(',',>resource))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 834 SeqOp            */ __Matchers[834] = new Seq(this, 834, "_834:(>resource,*(_832:(',',>resource)))") { Builder = nodes => new CResourceList(nodes) };
                /* 835 AltOp            */ __Matchers[835] = new Alt(this, 835, "alt(>specified-variable|>operator-expression)") { Builder = nodes => nodes[0] };
                /* 836 SeqOp            */ __Matchers[836] = new Seq(this, 836, "_836:(>variable,>value-specifier)") { Builder = nodes => new CSpecifiedVariable(nodes) };
                /* 837 OptionalOp       */ __Matchers[837] = new Optional(this, 837, "?(>variable-type)") { Builder = nodes => new ROptional<ICVariableType>(nodes) };
                /* 838 StarOp           */ __Matchers[838] = new Star(this, 838, "*(>parameters)") { Builder = nodes => new RStar<CParameters>(nodes) };
                /* 839 SeqOp            */ __Matchers[839] = new Seq(this, 839, "_839:(?(>variable-type),>member-name,*(>parameters))") { Builder = nodes => new CVariable(nodes) };
                /* 840 AltOp            */ __Matchers[840] = new Alt(this, 840, "alt(>type|>kw-void|>kw-function|>kw-value)") { Builder = nodes => nodes[0] };
                /* 841 SeqOp            */ __Matchers[841] = new Seq(this, 841, "_841:('^',>model-expression)") { Builder = nodes => new CModelReference(nodes) };
                /* 842 StringOp         */ __Matchers[842] = new String(this, 842, "'`'", "`") { Creator = node => new RLiteral(node) };
                /* 843 SeqOp            */ __Matchers[843] = new Seq(this, 843, "_843:('`',>meta-expression,'`')") { Builder = nodes => new CMetaLiteral(nodes) };
                /* 844 AltOp            */ __Matchers[844] = new Alt(this, 844, "alt(>declaration-reference|>model-expression)") { Builder = nodes => nodes[0] };
                /* 845 AltOp            */ __Matchers[845] = new Alt(this, 845, "alt(>member-model-expression|>type-model-expression)") { Builder = nodes => nodes[0] };
                /* 846 AltOp            */ __Matchers[846] = new Alt(this, 846, "alt(>member-reference|>package-qualified-member-reference|>type-qualified-member-reference)") { Builder = nodes => nodes[0] };
                /* 847 SeqOp            */ __Matchers[847] = new Seq(this, 847, "_847:('package','.',>member-reference)") { Builder = nodes => new CPackageQualifiedMemberReference(nodes) };
                /* 848 SeqOp            */ __Matchers[848] = new Seq(this, 848, "_848:(>primary-type,'.',>member-reference)") { Builder = nodes => new CTypeQualifiedMemberReference(nodes) };
                /* 849 AltOp            */ __Matchers[849] = new Alt(this, 849, "alt(>module-literal|>package-literal|>class-literal|>new-literal|>interface-literal|>alias-literal|>type-parameter-literal|>value-literal|>object-literal|>function-literal)") { Builder = nodes => nodes[0] };
                /* 850 OptionalOp       */ __Matchers[850] = new Optional(this, 850, "?(>package-path)") { Builder = nodes => new ROptional<CPackagePath>(nodes) };
                /* 851 SeqOp            */ __Matchers[851] = new Seq(this, 851, "_851:('module',?(>package-path))") { Builder = nodes => new CModuleLiteral(nodes) };
                /* 852 SeqOp            */ __Matchers[852] = new Seq(this, 852, "_852:('package',?(>package-path))") { Builder = nodes => new CPackageLiteral(nodes) };
                /* 853 SeqOp            */ __Matchers[853] = new Seq(this, 853, "_853:('class',>reference-path)") { Builder = nodes => new CClassLiteral(nodes) };
                /* 854 SeqOp            */ __Matchers[854] = new Seq(this, 854, "_854:('interface',>reference-path)") { Builder = nodes => new CInterfaceLiteral(nodes) };
                /* 855 SeqOp            */ __Matchers[855] = new Seq(this, 855, "_855:('alias',>reference-path)") { Builder = nodes => new CAliasLiteral(nodes) };
                /* 856 SeqOp            */ __Matchers[856] = new Seq(this, 856, "_856:('given',>reference-path)") { Builder = nodes => new CTypeParameterLiteral(nodes) };
                /* 857 SeqOp            */ __Matchers[857] = new Seq(this, 857, "_857:('new',>reference-path)") { Builder = nodes => new CNewLiteral(nodes) };
                /* 858 SeqOp            */ __Matchers[858] = new Seq(this, 858, "_858:('value',>reference-path)") { Builder = nodes => new CValueLiteral(nodes) };
                /* 859 SeqOp            */ __Matchers[859] = new Seq(this, 859, "_859:('object',>reference-path)") { Builder = nodes => new CObjectLiteral(nodes) };
                /* 860 SeqOp            */ __Matchers[860] = new Seq(this, 860, "_860:('function',>reference-path)") { Builder = nodes => new CFunctionLiteral(nodes) };
                /* 861 SeqOp            */ __Matchers[861] = new Seq(this, 861, "_861:('package','.')") { Builder = nodes => new CPackageQualifier(nodes) };
                /* 862 SeqOp            */ __Matchers[862] = new Seq(this, 862, "_862:(?(>package-qualifier),>reference-path-element-list)") { Builder = nodes => new CReferencePath(nodes) };
                /* 863 SeqOp            */ __Matchers[863] = new Seq(this, 863, "_863:('.',>reference-path-element)") { Builder = nodes => new RSequence(nodes) };
                /* 864 StarOp           */ __Matchers[864] = new Star(this, 864, "*(_863:('.',>reference-path-element))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 865 SeqOp            */ __Matchers[865] = new Seq(this, 865, "_865:(>reference-path-element,*(_863:('.',>reference-path-element)))") { Builder = nodes => new CReferencePathElementList(nodes) };

                /*   0 StartRuleOp      */ __Start.Set(__Matchers[362]);
                /*   1 WhiteRuleOp      */ __Whitespace.Set(__Whitespace_DFA);
                /*   2 IdentifierRuleOp */ __Keywords.Set(__Keywords_DFA);
                /*   3 PlainRuleOp      */ _compilationUnit.Set(__Matchers[363]);
                /*   4 PlainRuleOp      */ _codeUnit.Set(__Matchers[364]);
                /*   5 PlainRuleOp      */ _namespace.Set(__Matchers[367]);
                /*   6 PlainRuleOp      */ _namespacePath.Set(__Matchers[371]);
                /*   7 PlainRuleOp      */ _imports.Set(__Matchers[372]);
                /*   8 PlainRuleOp      */ _moduleDescriptor.Set(__Matchers[376]);
                /*   9 PlainRuleOp      */ _moduleSpecifier.Set(__Matchers[379]);
                /*  10 PlainRuleOp      */ _repository.Set(_identifier);
                /*  11 PlainRuleOp      */ _module.Set(__Matchers[380]);
                /*  12 PlainRuleOp      */ _artifactAndClassifier.Set(__Matchers[382]);
                /*  13 PlainRuleOp      */ _artifact.Set(__Matchers[383]);
                /*  14 PlainRuleOp      */ _classifier.Set(__Matchers[384]);
                /*  15 PlainRuleOp      */ _version.Set(_literalString);
                /*  16 PlainRuleOp      */ _moduleName.Set(_packagePath);
                /*  17 PlainRuleOp      */ _moduleBody.Set(__Matchers[388]);
                /*  18 PlainRuleOp      */ _moduleBodyElement.Set(__Matchers[389]);
                /*  19 PlainRuleOp      */ _moduleImport.Set(__Matchers[391]);
                /*  20 PlainRuleOp      */ _packageDescriptor.Set(__Matchers[393]);
                /*  21 PlainRuleOp      */ _importDeclaration.Set(__Matchers[394]);
                /*  22 PlainRuleOp      */ _importElements.Set(__Matchers[396]);
                /*  23 PlainRuleOp      */ _importElementList.Set(__Matchers[400]);
                /*  24 PlainRuleOp      */ _importElement.Set(__Matchers[401]);
                /*  25 PlainRuleOp      */ _importNamed.Set(__Matchers[404]);
                /*  26 PlainRuleOp      */ _importName.Set(_identifier);
                /*  27 PlainRuleOp      */ _importNameSpecifier.Set(__Matchers[406]);
                /*  28 PlainRuleOp      */ _importWildcard.Set(__Matchers[407]);
                /*  29 PlainRuleOp      */ _packageName.Set(_identifier);
                /*  30 PlainRuleOp      */ _packagePath.Set(__Matchers[410]);
                /*  31 PlainRuleOp      */ _memberName.Set(_lowerIdentifier);
                /*  32 PlainRuleOp      */ _typeName.Set(_upperIdentifier);
                /*  33 PlainRuleOp      */ _pattern.Set(__Matchers[411]);
                /*  34 PlainRuleOp      */ _entryPattern.Set(__Matchers[413]);
                /*  35 PlainRuleOp      */ _variableOrTuplePattern.Set(__Matchers[414]);
                /*  36 PlainRuleOp      */ _tuplePattern.Set(__Matchers[418]);
                /*  37 PlainRuleOp      */ _variadicPatternList.Set(__Matchers[421]);
                /*  38 PlainRuleOp      */ _variadicPattern.Set(__Matchers[422]);
                /*  39 PlainRuleOp      */ _variablePattern.Set(_variable);
                /*  40 PlainRuleOp      */ _variadicVariable.Set(__Matchers[424]);
                /*  41 PlainRuleOp      */ _variadicOperator.Set(__Matchers[427]);
                /*  42 PlainRuleOp      */ _letStatement.Set(__Matchers[431]);
                /*  43 PlainRuleOp      */ _letVariableList.Set(__Matchers[434]);
                /*  44 PlainRuleOp      */ _letVariable.Set(__Matchers[435]);
                /*  45 PlainRuleOp      */ _delegatedConstructor.Set(__Matchers[437]);
                /*  46 PlainRuleOp      */ _assertionStatement.Set(__Matchers[440]);
                /*  47 PlainRuleOp      */ _assertionMessage.Set(_stringExpression);
                /*  48 PlainRuleOp      */ _block.Set(__Matchers[441]);
                /*  49 PlainRuleOp      */ _extendedType.Set(__Matchers[442]);
                /*  50 PlainRuleOp      */ _classSpecifier.Set(__Matchers[444]);
                /*  51 PlainRuleOp      */ _classInstantiation.Set(__Matchers[446]);
                /*  52 PlainRuleOp      */ _qualifiedClass.Set(__Matchers[447]);
                /*  53 PlainRuleOp      */ _packageQualifiedClass.Set(__Matchers[448]);
                /*  54 PlainRuleOp      */ _superQualifiedClass.Set(__Matchers[450]);
                /*  55 PlainRuleOp      */ _unQualifiedClass.Set(__Matchers[451]);
                /*  56 PlainRuleOp      */ _memberPath.Set(__Matchers[452]);
                /*  57 PlainRuleOp      */ _typePath.Set(__Matchers[455]);
                /*  58 PlainRuleOp      */ _satisfiedTypes.Set(__Matchers[457]);
                /*  59 PlainRuleOp      */ _unionTypeList.Set(__Matchers[460]);
                /*  60 PlainRuleOp      */ _caseTypes.Set(__Matchers[462]);
                /*  61 PlainRuleOp      */ _caseTypeList.Set(__Matchers[466]);
                /*  62 PlainRuleOp      */ _caseType.Set(__Matchers[467]);
                /*  63 PlainRuleOp      */ _qualifiedCaseType.Set(__Matchers[469]);
                /*  64 PlainRuleOp      */ _parameters.Set(__Matchers[471]);
                /*  65 PlainRuleOp      */ _parameterList.Set(__Matchers[474]);
                /*  66 PlainRuleOp      */ _parameterDeclarationOrRefPattern.Set(__Matchers[475]);
                /*  67 PlainRuleOp      */ _parameter.Set(__Matchers[476]);
                /*  68 PlainRuleOp      */ _parameterReference.Set(__Matchers[478]);
                /*  69 PlainRuleOp      */ _parameterDeclaration.Set(__Matchers[479]);
                /*  70 PlainRuleOp      */ _functionParameterDeclaration.Set(__Matchers[480]);
                /*  71 PlainRuleOp      */ _voidFunctionParameter.Set(__Matchers[485]);
                /*  72 PlainRuleOp      */ _inferredFunctionParameter.Set(__Matchers[487]);
                /*  73 PlainRuleOp      */ _typedFunctionParameter.Set(__Matchers[488]);
                /*  74 PlainRuleOp      */ _valueParameterDeclaration.Set(__Matchers[489]);
                /*  75 PlainRuleOp      */ _inferredValueParameter.Set(__Matchers[491]);
                /*  76 PlainRuleOp      */ _typedValueParameter.Set(__Matchers[492]);
                /*  77 PlainRuleOp      */ _typeParameters.Set(__Matchers[495]);
                /*  78 PlainRuleOp      */ _typeParameterList.Set(__Matchers[498]);
                /*  79 PlainRuleOp      */ _typeParameter.Set(__Matchers[501]);
                /*  80 PlainRuleOp      */ _variance.Set(__Matchers[504]);
                /*  81 PlainRuleOp      */ _typeDefault.Set(__Matchers[505]);
                /*  82 PlainRuleOp      */ _typeConstraint.Set(__Matchers[510]);
                /*  83 PlainRuleOp      */ _typeConstraints.Set(__Matchers[511]);
                /*  84 PlainRuleOp      */ _topDeclarations.Set(__Matchers[512]);
                /*  85 PlainRuleOp      */ _topDeclaration.Set(__Matchers[513]);
                /*  86 PlainRuleOp      */ _declaration.Set(__Matchers[514]);
                /*  87 PlainRuleOp      */ _constructorDeclaration.Set(__Matchers[518]);
                /*  88 PlainRuleOp      */ _aliasDeclaration.Set(__Matchers[521]);
                /*  89 PlainRuleOp      */ _enumeratedObjectDeclaration.Set(__Matchers[522]);
                /*  90 PlainRuleOp      */ _objectDeclaration.Set(__Matchers[525]);
                /*  91 PlainRuleOp      */ _setterDeclaration.Set(__Matchers[527]);
                /*  92 PlainRuleOp      */ _setterDefinition.Set(__Matchers[528]);
                /*  93 PlainRuleOp      */ _voidMethodDeclaration.Set(__Matchers[529]);
                /*  94 PlainRuleOp      */ _inferredMethodDeclaration.Set(__Matchers[530]);
                /*  95 PlainRuleOp      */ _typedMethodDeclaration.Set(__Matchers[531]);
                /*  96 PlainRuleOp      */ _methodDefinition.Set(__Matchers[532]);
                /*  97 PlainRuleOp      */ _typedAttributeDeclaration.Set(__Matchers[533]);
                /*  98 PlainRuleOp      */ _inferredAttributeDeclaration.Set(__Matchers[534]);
                /*  99 PlainRuleOp      */ _attributeDefinition.Set(__Matchers[535]);
                /* 100 PlainRuleOp      */ _classDeclaration.Set(__Matchers[538]);
                /* 101 PlainRuleOp      */ _classDefinition.Set(__Matchers[539]);
                /* 102 PlainRuleOp      */ _optionalClassSpecifier.Set(__Matchers[541]);
                /* 103 PlainRuleOp      */ _interfaceDeclaration.Set(__Matchers[543]);
                /* 104 PlainRuleOp      */ _interfaceDefinition.Set(__Matchers[544]);
                /* 105 PlainRuleOp      */ _statements.Set(__Matchers[545]);
                /* 106 PlainRuleOp      */ _statement.Set(__Matchers[546]);
                /* 107 PlainRuleOp      */ _declarationStatement.Set(_declaration);
                /* 108 PlainRuleOp      */ _unclosedStatement.Set(__Matchers[547]);
                /* 109 PlainRuleOp      */ _openStatement.Set(__Matchers[548]);
                ...
                /* 116 PlainRuleOp      */ _valueSpecifier.Set(__Matchers[557]);
                /* 117 PlainRuleOp      */ _functionSpecifier.Set(__Matchers[558]);
                /* 118 PlainRuleOp      */ _optionalFunctionSpecifier.Set(__Matchers[559]);
                /* 119 PlainRuleOp      */ _requiredFunctionSpecifier.Set(__Matchers[560]);
                /* 120 PlainRuleOp      */ _typeSpecifier.Set(__Matchers[561]);
                /* 121 PlainRuleOp      */ _optionalTypeSpecifier.Set(__Matchers[563]);
                /* 122 PlainRuleOp      */ _anySpecifier.Set(__Matchers[564]);
                /* 123 PlainRuleOp      */ _optionalAnySpecifier.Set(__Matchers[566]);
                /* 124 PlainRuleOp      */ _baseReferenceOrParameterized.Set(__Matchers[567]);
                /* 125 PlainRuleOp      */ _baseReference.Set(__Matchers[568]);
                /* 126 PlainRuleOp      */ _parametrizedMember.Set(__Matchers[569]);
                /* 127 PlainRuleOp      */ _selfParametrizedMember.Set(__Matchers[570]);
                /* 128 PlainRuleOp      */ _memberReference.Set(__Matchers[572]);
                /* 129 PlainRuleOp      */ _typeReference.Set(__Matchers[573]);
                /* 130 PlainRuleOp      */ _selfReferenceSelector.Set(__Matchers[574]);
                /* 131 PlainRuleOp      */ _selfReference.Set(__Matchers[577]);
                /* 132 PlainRuleOp      */ _enumerationExpr.Set(__Matchers[579]);
                /* 133 PlainRuleOp      */ _tupleExpr.Set(__Matchers[580]);
                /* 134 PlainRuleOp      */ _arguments.Set(__Matchers[581]);
                /* 135 PlainRuleOp      */ _patternedArguments.Set(__Matchers[583]);
                /* 136 PlainRuleOp      */ _positionalArguments.Set(__Matchers[584]);
                /* 137 PlainRuleOp      */ _structuredArgument.Set(__Matchers[585]);
                /* 138 PlainRuleOp      */ _anonymousArgument.Set(__Matchers[586]);
                /* 139 PlainRuleOp      */ _namedArgument.Set(__Matchers[587]);
                /* 140 PlainRuleOp      */ _namedSpecifiedArgument.Set(__Matchers[588]);
                /* 141 PlainRuleOp      */ _sequencedArgumentList.Set(__Matchers[591]);
                /* 142 PlainRuleOp      */ _sequencedArgument.Set(__Matchers[592]);
                /* 143 PlainRuleOp      */ _namedArgumentDeclaration.Set(__Matchers[593]);
                /* 144 PlainRuleOp      */ _objectArgument.Set(__Matchers[594]);
                /* 145 PlainRuleOp      */ _typedMethodArgument.Set(__Matchers[595]);
                /* 146 PlainRuleOp      */ _inferredMethodArgument.Set(__Matchers[596]);
                /* 147 PlainRuleOp      */ _untypedMethodArgument.Set(__Matchers[597]);
                /* 148 PlainRuleOp      */ _typedGetterArgument.Set(__Matchers[598]);
                /* 149 PlainRuleOp      */ _inferredGetterArgument.Set(__Matchers[599]);
                /* 150 PlainRuleOp      */ _untypedGetterArgument.Set(__Matchers[600]);
                /* 151 PlainRuleOp      */ _positionalArgument.Set(__Matchers[601]);
                /* 152 PlainRuleOp      */ _expressionArgument.Set(_expression);
                /* 153 PlainRuleOp      */ _spreadArgument.Set(__Matchers[602]);
                /* 154 PlainRuleOp      */ _letExpr.Set(__Matchers[604]);
                /* 155 PlainRuleOp      */ _switchExpr.Set(__Matchers[607]);
                /* 156 PlainRuleOp      */ _switchHeader.Set(__Matchers[609]);
                /* 157 PlainRuleOp      */ _switched.Set(_specifiedOrExpression);
                /* 158 PlainRuleOp      */ _caseExpression.Set(__Matchers[613]);
                /* 159 PlainRuleOp      */ _ifExpr.Set(__Matchers[615]);
                /* 160 PlainRuleOp      */ _elseExpression.Set(__Matchers[616]);
                /* 161 PlainRuleOp      */ _thenExpression.Set(__Matchers[618]);
                /* 162 PlainRuleOp      */ _conditionalExpression.Set(__Matchers[619]);
                /* 163 PlainRuleOp      */ _functionExpression.Set(__Matchers[620]);
                /* 164 PlainRuleOp      */ _voidFunctionExpr.Set(__Matchers[621]);
                /* 165 PlainRuleOp      */ _inferredFunctionExpr.Set(__Matchers[623]);
                /* 166 PlainRuleOp      */ _functionDefinition.Set(__Matchers[624]);
                /* 167 PlainRuleOp      */ _comprehensionArgument.Set(__Matchers[625]);
                /* 168 PlainRuleOp      */ _comprehensionClause.Set(__Matchers[626]);
                /* 169 PlainRuleOp      */ _expressionComprehensionClause.Set(_expression);
                /* 170 PlainRuleOp      */ _forComprehensionClause.Set(__Matchers[629]);
                /* 171 PlainRuleOp      */ _ifComprehensionClause.Set(__Matchers[630]);
                /* 172 PlainRuleOp      */ _expression.Set(__Matchers[631]);
                /* 173 PlainRuleOp      */ _operatorExpression.Set(_assignmentExpression);
                /* 174 PlainRuleOp      */ _assignmentExpression.Set(__Matchers[632]);
                /* 175 PlainRuleOp      */ _assignmentExpr.Set(__Matchers[633]);
                /* 176 PlainRuleOp      */ _assignmentOperator.Set(__Matchers[645]);
                /* 177 PlainRuleOp      */ _thenElseExpression.Set(__Matchers[646]);
                /* 178 PlainRuleOp      */ _thenElseExpr.Set(__Matchers[647]);
                /* 179 PlainRuleOp      */ _thenElseOperator.Set(__Matchers[648]);
                /* 180 PlainRuleOp      */ _disjunctionExpression.Set(__Matchers[649]);
                /* 181 PlainRuleOp      */ _disjunctionExpr.Set(__Matchers[650]);
                /* 182 PlainRuleOp      */ _disjunctionOperator.Set(__Matchers[651]);
                /* 183 PlainRuleOp      */ _conjunctionExpression.Set(__Matchers[652]);
                /* 184 PlainRuleOp      */ _conjunctionExpr.Set(__Matchers[653]);
                /* 185 PlainRuleOp      */ _conjunctionOperator.Set(__Matchers[654]);
                /* 186 PlainRuleOp      */ _logicalNegationExpression.Set(__Matchers[655]);
                /* 187 PlainRuleOp      */ _logicalNegationExpr.Set(__Matchers[656]);
                /* 188 PlainRuleOp      */ _notOperator.Set(__Matchers[657]);
                /* 189 PlainRuleOp      */ _expressionOrMeta.Set(__Matchers[658]);
                /* 190 PlainRuleOp      */ _equalityExpression.Set(__Matchers[659]);
                /* 191 PlainRuleOp      */ _equalityExpr.Set(__Matchers[660]);
                /* 192 PlainRuleOp      */ _equalityOperator.Set(__Matchers[664]);
                /* 193 PlainRuleOp      */ _comparisonExpression.Set(__Matchers[665]);
                /* 194 PlainRuleOp      */ _comparisonExpr.Set(__Matchers[666]);
                /* 195 PlainRuleOp      */ _largerExpr.Set(__Matchers[667]);
                /* 196 PlainRuleOp      */ _smallerExpr.Set(__Matchers[668]);
                /* 197 PlainRuleOp      */ _largerBoundsExpr.Set(__Matchers[669]);
                /* 198 PlainRuleOp      */ _smallerBoundsExpr.Set(__Matchers[670]);
                /* 199 PlainRuleOp      */ _typecheckExpr.Set(__Matchers[671]);
                /* 200 PlainRuleOp      */ _comparisonOperator.Set(__Matchers[673]);
                /* 201 PlainRuleOp      */ _smallerOperator.Set(__Matchers[675]);
                /* 202 PlainRuleOp      */ _largerOperator.Set(__Matchers[677]);
                /* 203 PlainRuleOp      */ _typeOperator.Set(__Matchers[679]);
                /* 204 PlainRuleOp      */ _existsNonemptyExpression.Set(__Matchers[680]);
                /* 205 PlainRuleOp      */ _existsExpr.Set(__Matchers[682]);
                /* 206 PlainRuleOp      */ _nonemptyExpr.Set(__Matchers[684]);
                /* 207 PlainRuleOp      */ _entryRangeExpression.Set(__Matchers[685]);
                /* 208 PlainRuleOp      */ _rangeExpr.Set(__Matchers[686]);
                /* 209 PlainRuleOp      */ _entryExpr.Set(__Matchers[687]);
                /* 210 PlainRuleOp      */ _rangeOperator.Set(__Matchers[689]);
                /* 211 PlainRuleOp      */ _entryOperator.Set(__Matchers[412]);
                /* 212 PlainRuleOp      */ _additiveExpression.Set(__Matchers[690]);
                /* 213 PlainRuleOp      */ _additiveExpr.Set(__Matchers[691]);
                /* 214 PlainRuleOp      */ _additiveOperator.Set(__Matchers[693]);
                /* 215 PlainRuleOp      */ _scaleExpression.Set(__Matchers[694]);
                /* 216 PlainRuleOp      */ _scaleExpr.Set(__Matchers[695]);
                /* 217 PlainRuleOp      */ _scaleOperator.Set(__Matchers[696]);
                /* 218 PlainRuleOp      */ _multiplicativeExpression.Set(__Matchers[697]);
                /* 219 PlainRuleOp      */ _multiplicativeExpr.Set(__Matchers[698]);
                /* 220 PlainRuleOp      */ _multiplicativeOperator.Set(__Matchers[701]);
                /* 221 PlainRuleOp      */ _unionExpression.Set(__Matchers[702]);
                /* 222 PlainRuleOp      */ _unionExpr.Set(__Matchers[703]);
                /* 223 PlainRuleOp      */ _unionOperator.Set(__Matchers[705]);
                /* 224 PlainRuleOp      */ _exclusiveExpression.Set(__Matchers[706]);
                /* 225 PlainRuleOp      */ _exclusiveExpr.Set(__Matchers[707]);
                /* 226 PlainRuleOp      */ _exclusiveOperator.Set(__Matchers[708]);
                /* 227 PlainRuleOp      */ _intersectionExpression.Set(__Matchers[709]);
                /* 228 PlainRuleOp      */ _intersectionExpr.Set(__Matchers[710]);
                /* 229 PlainRuleOp      */ _intersectionOperator.Set(__Matchers[711]);
                /* 230 PlainRuleOp      */ _negationOrComplementExpression.Set(__Matchers[712]);
                /* 231 PlainRuleOp      */ _negationOrComplementExpr.Set(__Matchers[713]);
                /* 232 PlainRuleOp      */ _unaryMinusOrComplementOperator.Set(__Matchers[714]);
                /* 233 PlainRuleOp      */ _negateOperator.Set(__Matchers[716]);
                /* 234 PlainRuleOp      */ _neutralOperator.Set(__Matchers[718]);
                /* 235 PlainRuleOp      */ _complementOperator.Set(__Matchers[704]);
                /* 236 PlainRuleOp      */ _prefixExpression.Set(__Matchers[719]);
                /* 237 PlainRuleOp      */ _prefixExpr.Set(__Matchers[720]);
                /* 238 PlainRuleOp      */ _postfixExpression.Set(__Matchers[721]);
                /* 239 PlainRuleOp      */ _postfixExpr.Set(__Matchers[722]);
                /* 240 PlainRuleOp      */ _incrementOperator.Set(__Matchers[725]);
                /* 241 PlainRuleOp      */ _primary.Set(__Matchers[726]);
                /* 242 PlainRuleOp      */ _selectionExpr.Set(__Matchers[727]);
                /* 243 PlainRuleOp      */ _memberSelectionOperator.Set(__Matchers[730]);
                /* 244 PlainRuleOp      */ _indexedExpr.Set(__Matchers[731]);
                /* 245 PlainRuleOp      */ _index.Set(__Matchers[732]);
                /* 246 PlainRuleOp      */ _upperSpanned.Set(__Matchers[733]);
                /* 247 PlainRuleOp      */ _lowerSpanned.Set(__Matchers[734]);
                /* 248 PlainRuleOp      */ _spanned.Set(__Matchers[735]);
                /* 249 PlainRuleOp      */ _measured.Set(__Matchers[736]);
                /* 250 PlainRuleOp      */ _indexExpression.Set(_additiveExpression);
                /* 251 PlainRuleOp      */ _callExpr.Set(__Matchers[737]);
                /* 252 PlainRuleOp      */ _baseExpression.Set(__Matchers[738]);
                /* 253 PlainRuleOp      */ _nonstringLiteral.Set(__Matchers[739]);
                /* 254 PlainRuleOp      */ _stringExpression.Set(__Matchers[740]);
                /* 255 PlainRuleOp      */ _stringInterpolation.Set(__Matchers[742]);
                /* 256 PlainRuleOp      */ _interpolationPart.Set(__Matchers[743]);
                /* 257 PlainRuleOp      */ _stringLiteral.Set(__Matchers[744]);
                /* 258 PlainRuleOp      */ _objectExpr.Set(__Matchers[745]);
                /* 259 PlainRuleOp      */ _groupedExpr.Set(__Matchers[746]);
                /* 260 PlainRuleOp      */ _typeArguments.Set(__Matchers[748]);
                /* 261 PlainRuleOp      */ _typeArgumentList.Set(__Matchers[751]);
                /* 262 PlainRuleOp      */ _variancedType.Set(__Matchers[752]);
                /* 263 PlainRuleOp      */ _defaultedTypeList.Set(__Matchers[755]);
                /* 264 PlainRuleOp      */ _defaultedType.Set(__Matchers[756]);
                /* 265 PlainRuleOp      */ _defaultedTypeCore.Set(__Matchers[757]);
                /* 266 PlainRuleOp      */ _variadicType.Set(__Matchers[758]);
                /* 267 PlainRuleOp      */ _variadicTypeCore.Set(__Matchers[759]);
                /* 268 PlainRuleOp      */ _spreadType.Set(__Matchers[760]);
                /* 269 PlainRuleOp      */ _type.Set(__Matchers[761]);
                /* 270 PlainRuleOp      */ _entryType.Set(__Matchers[762]);
                /* 271 PlainRuleOp      */ _unionType.Set(__Matchers[763]);
                /* 272 PlainRuleOp      */ _unionTypeCore.Set(__Matchers[764]);
                /* 273 PlainRuleOp      */ _intersectionType.Set(__Matchers[765]);
                /* 274 PlainRuleOp      */ _intersectionTypeCore.Set(__Matchers[766]);
                /* 275 PlainRuleOp      */ _primaryType.Set(__Matchers[767]);
                /* 276 PlainRuleOp      */ _nullableType.Set(__Matchers[769]);
                /* 277 PlainRuleOp      */ _arrayType.Set(__Matchers[771]);
                /* 278 PlainRuleOp      */ _functionType.Set(__Matchers[773]);
                /* 279 PlainRuleOp      */ _typeTypeArguments.Set(__Matchers[774]);
                /* 280 PlainRuleOp      */ _tupleType.Set(__Matchers[775]);
                /* 281 PlainRuleOp      */ _iterableType.Set(__Matchers[777]);
                /* 282 PlainRuleOp      */ _groupedType.Set(__Matchers[778]);
                /* 283 PlainRuleOp      */ _packageQualifiedType.Set(__Matchers[779]);
                /* 284 PlainRuleOp      */ _annotations.Set(__Matchers[782]);
                /* 285 PlainRuleOp      */ _annotation.Set(__Matchers[783]);
                /* 286 PlainRuleOp      */ _conditions.Set(__Matchers[785]);
                /* 287 PlainRuleOp      */ _conditionList.Set(__Matchers[788]);
                /* 288 PlainRuleOp      */ _condition.Set(__Matchers[789]);
                /* 289 PlainRuleOp      */ _existsCondition.Set(__Matchers[791]);
                /* 290 PlainRuleOp      */ _nonemptyCondition.Set(__Matchers[792]);
                /* 291 PlainRuleOp      */ _letOrExpression.Set(__Matchers[793]);
                /* 292 PlainRuleOp      */ _isCondition.Set(__Matchers[794]);
                /* 293 PlainRuleOp      */ _isConditionVariable.Set(__Matchers[795]);
                /* 294 PlainRuleOp      */ _satisfiesCondition.Set(__Matchers[796]);
                /* 295 PlainRuleOp      */ _booleanCondition.Set(_expression);
                /* 296 PlainRuleOp      */ _controlStatement.Set(__Matchers[797]);
                /* 297 PlainRuleOp      */ _ifElseStatement.Set(__Matchers[800]);
                /* 298 PlainRuleOp      */ _elseIf.Set(__Matchers[801]);
                /* 299 PlainRuleOp      */ _elseBlock.Set(__Matchers[802]);
                /* 300 PlainRuleOp      */ _switchStatement.Set(__Matchers[804]);
                /* 301 PlainRuleOp      */ _caseBlock.Set(__Matchers[805]);
                /* 302 PlainRuleOp      */ _caseItem.Set(__Matchers[806]);
                /* 303 PlainRuleOp      */ _isCaseCondition.Set(__Matchers[807]);
                /* 304 PlainRuleOp      */ _satisfiesCaseCondition.Set(__Matchers[808]);
                /* 305 PlainRuleOp      */ _valueCaseList.Set(__Matchers[811]);
                /* 306 PlainRuleOp      */ _valueCaseSeparator.Set(__Matchers[812]);
                /* 307 PlainRuleOp      */ _valueCase.Set(__Matchers[813]);
                /* 308 PlainRuleOp      */ _forElseStatement.Set(__Matchers[814]);
                /* 309 PlainRuleOp      */ _forIterator.Set(__Matchers[815]);
                /* 310 PlainRuleOp      */ _forVariable.Set(_pattern);
                /* 311 PlainRuleOp      */ _containment.Set(__Matchers[816]);
                /* 312 PlainRuleOp      */ _containmentOperator.Set(__Matchers[817]);
                /* 313 PlainRuleOp      */ _whileStatement.Set(__Matchers[819]);
                /* 314 PlainRuleOp      */ _tryStatement.Set(__Matchers[824]);
                /* 315 PlainRuleOp      */ _catchBlock.Set(__Matchers[827]);
                /* 316 PlainRuleOp      */ _finallyBlock.Set(__Matchers[829]);
                /* 317 PlainRuleOp      */ _resources.Set(__Matchers[831]);
                /* 318 PlainRuleOp      */ _resourceList.Set(__Matchers[834]);
                /* 319 PlainRuleOp      */ _resource.Set(_specifiedOrExpression);
                /* 320 PlainRuleOp      */ _specifiedOrExpression.Set(__Matchers[835]);
                /* 321 PlainRuleOp      */ _specifiedVariable.Set(__Matchers[836]);
                /* 322 PlainRuleOp      */ _variable.Set(__Matchers[839]);
                /* 323 PlainRuleOp      */ _variableType.Set(__Matchers[840]);
                /* 324 PlainRuleOp      */ _modelReference.Set(__Matchers[841]);
                /* 325 PlainRuleOp      */ _metaLiteral.Set(__Matchers[843]);
                /* 326 PlainRuleOp      */ _metaExpression.Set(__Matchers[844]);
                /* 327 PlainRuleOp      */ _modelExpression.Set(__Matchers[845]);
                /* 328 PlainRuleOp      */ _memberModelExpression.Set(__Matchers[846]);
                /* 329 PlainRuleOp      */ _packageQualifiedMemberReference.Set(__Matchers[847]);
                /* 330 PlainRuleOp      */ _typeQualifiedMemberReference.Set(__Matchers[848]);
                /* 331 PlainRuleOp      */ _typeModelExpression.Set(_type);
                /* 332 PlainRuleOp      */ _declarationReference.Set(__Matchers[849]);
                /* 333 PlainRuleOp      */ _moduleLiteral.Set(__Matchers[851]);
                /* 334 PlainRuleOp      */ _packageLiteral.Set(__Matchers[852]);
                /* 335 PlainRuleOp      */ _classLiteral.Set(__Matchers[853]);
                /* 336 PlainRuleOp      */ _interfaceLiteral.Set(__Matchers[854]);
                /* 337 PlainRuleOp      */ _aliasLiteral.Set(__Matchers[855]);
                /* 338 PlainRuleOp      */ _typeParameterLiteral.Set(__Matchers[856]);
                /* 339 PlainRuleOp      */ _newLiteral.Set(__Matchers[857]);
                /* 340 PlainRuleOp      */ _valueLiteral.Set(__Matchers[858]);
                /* 341 PlainRuleOp      */ _objectLiteral.Set(__Matchers[859]);
                /* 342 PlainRuleOp      */ _functionLiteral.Set(__Matchers[860]);
                /* 343 PlainRuleOp      */ _packageQualifier.Set(__Matchers[861]);
                /* 344 PlainRuleOp      */ _referencePath.Set(__Matchers[862]);
                /* 345 PlainRuleOp      */ _referencePathElementList.Set(__Matchers[865]);
                /* 346 PlainRuleOp      */ _referencePathElement.Set(_identifier);
                /* 347 PlainRuleOp      */ _kwVoid.Set(__Matchers[481]);
                /* 348 PlainRuleOp      */ _kwFunction.Set(__Matchers[486]);
                /* 349 PlainRuleOp      */ _kwValue.Set(__Matchers[490]);
                /* 350 DfaRuleOp        */ _literalFloat.Set(_literalFloat_DFA);
                /* 351 DfaRuleOp        */ _literalNatural.Set(_literalNatural_DFA);
                /* 352 DfaRuleOp        */ _literalChar.Set(_literalChar_DFA);
                /* 353 DfaRuleOp        */ _stringStart.Set(_stringStart_DFA);
                /* 354 DfaRuleOp        */ _stringMid.Set(_stringMid_DFA);
                /* 355 DfaRuleOp        */ _stringEnd.Set(_stringEnd_DFA);
                /* 356 DfaRuleOp        */ _literalString.Set(_literalString_DFA);
                /* 357 DfaRuleOp        */ _verbatimString.Set(_verbatimString_DFA);
                /* 358 DfaRuleOp        */ _lowerIdentifier.Set(_lowerIdentifier_DFA);
                /* 359 DfaRuleOp        */ _upperIdentifier.Set(_upperIdentifier_DFA);
                /* 360 DfaRuleOp        */ _identifier.Set(_identifier_DFA);
                /* 362 SeqOp            */ __Matchers[362].Set(_compilationUnit, __Matchers[361]);
                /* 363 AltOp            */ __Matchers[363].Set(_moduleDescriptor, _packageDescriptor, _codeUnit);
                /* 364 SeqOp            */ __Matchers[364].Set(_namespace, _imports, _topDeclarations);
                /* 367 SeqOp            */ __Matchers[367].Set(_annotations, __Matchers[365], _namespacePath, __Matchers[366]);
                /* 369 SeqOp            */ __Matchers[369].Set(__Matchers[368], _identifier);
                /* 370 StarOp           */ __Matchers[370].Set(__Matchers[369]);
                /* 371 SeqOp            */ __Matchers[371].Set(_identifier, __Matchers[370]);
                ...
                /* 389 AltOp            */ __Matchers[389].Set(_inferredAttributeDeclaration, _moduleImport);
                /* 391 SeqOp            */ __Matchers[391].Set(_annotations, __Matchers[390], _module, __Matchers[375], __Matchers[366]);
                /* 393 SeqOp            */ __Matchers[393].Set(_annotations, __Matchers[392], _packagePath, __Matchers[366]);
                /* 394 SeqOp            */ __Matchers[394].Set(__Matchers[390], _packagePath, _importElements);
                /* 395 OptionalOp       */ __Matchers[395].Set(_importElementList);
                /* 396 SeqOp            */ __Matchers[396].Set(__Matchers[385], __Matchers[395], __Matchers[387]);
                /* 398 SeqOp            */ __Matchers[398].Set(__Matchers[397], _importElement);
                /* 399 StarOp           */ __Matchers[399].Set(__Matchers[398]);
                /* 400 SeqOp            */ __Matchers[400].Set(_importElement, __Matchers[399]);
                /* 401 AltOp            */ __Matchers[401].Set(_importNamed, _importWildcard);
                /* 402 OptionalOp       */ __Matchers[402].Set(_importNameSpecifier);
                /* 403 OptionalOp       */ __Matchers[403].Set(_importElements);
                /* 404 SeqOp            */ __Matchers[404].Set(_importName, __Matchers[402], __Matchers[403]);
                /* 406 SeqOp            */ __Matchers[406].Set(__Matchers[405], _identifier);
                /* 408 SeqOp            */ __Matchers[408].Set(__Matchers[368], _packageName);
                /* 409 StarOp           */ __Matchers[409].Set(__Matchers[408]);
                /* 410 SeqOp            */ __Matchers[410].Set(_packageName, __Matchers[409]);
                /* 411 AltOp            */ __Matchers[411].Set(_entryPattern, _tuplePattern, _variablePattern);
                /* 413 SeqOp            */ __Matchers[413].Set(_variableOrTuplePattern, __Matchers[412], _variableOrTuplePattern);
                /* 414 AltOp            */ __Matchers[414].Set(_tuplePattern, _variablePattern);
                /* 416 OptionalOp       */ __Matchers[416].Set(_variadicPatternList);
                /* 418 SeqOp            */ __Matchers[418].Set(__Matchers[415], __Matchers[416], __Matchers[417]);
                /* 419 SeqOp            */ __Matchers[419].Set(__Matchers[397], _variadicPattern);
                /* 420 StarOp           */ __Matchers[420].Set(__Matchers[419]);
                /* 421 SeqOp            */ __Matchers[421].Set(_variadicPattern, __Matchers[420]);
                /* 422 AltOp            */ __Matchers[422].Set(_variadicVariable, _pattern);
                /* 423 OptionalOp       */ __Matchers[423].Set(_unionType);
                /* 424 SeqOp            */ __Matchers[424].Set(__Matchers[423], _variadicOperator, _memberName);
                /* 427 AltOp            */ __Matchers[427].Set(__Matchers[425], __Matchers[426]);
                /* 431 SeqOp            */ __Matchers[431].Set(__Matchers[428], __Matchers[429], _letVariableList, __Matchers[430]);
                /* 432 SeqOp            */ __Matchers[432].Set(__Matchers[397], _letVariable);
                /* 433 StarOp           */ __Matchers[433].Set(__Matchers[432]);
                /* 434 SeqOp            */ __Matchers[434].Set(_letVariable, __Matchers[433]);
                /* 435 SeqOp            */ __Matchers[435].Set(_pattern, _valueSpecifier);
                /* 437 SeqOp            */ __Matchers[437].Set(__Matchers[436], _classInstantiation);
                ...
                /* 441 SeqOp            */ __Matchers[441].Set(__Matchers[385], _imports, _statements, __Matchers[387]);
                /* 442 SeqOp            */ __Matchers[442].Set(__Matchers[436], _classInstantiation);
                /* 444 SeqOp            */ __Matchers[444].Set(__Matchers[443], _classInstantiation);
                ...
                /* 448 SeqOp            */ __Matchers[448].Set(__Matchers[392], __Matchers[368], _unQualifiedClass);
                /* 450 SeqOp            */ __Matchers[450].Set(__Matchers[449], __Matchers[368], _baseReference);
                /* 451 AltOp            */ __Matchers[451].Set(_memberPath, _typePath, _memberReference);
                /* 452 SeqOp            */ __Matchers[452].Set(_typePath, __Matchers[368], _memberReference);
                /* 453 SeqOp            */ __Matchers[453].Set(__Matchers[368], _typeReference);
                /* 454 StarOp           */ __Matchers[454].Set(__Matchers[453]);
                /* 455 SeqOp            */ __Matchers[455].Set(_typeReference, __Matchers[454]);
                /* 457 SeqOp            */ __Matchers[457].Set(__Matchers[456], _unionTypeList);
                /* 458 SeqOp            */ __Matchers[458].Set(__Matchers[397], _unionType);
                /* 459 StarOp           */ __Matchers[459].Set(__Matchers[458]);
                /* 460 SeqOp            */ __Matchers[460].Set(_unionType, __Matchers[459]);
                /* 462 SeqOp            */ __Matchers[462].Set(__Matchers[461], _caseTypeList);
                /* 464 SeqOp            */ __Matchers[464].Set(__Matchers[463], _caseType);
                /* 465 StarOp           */ __Matchers[465].Set(__Matchers[464]);
                /* 466 SeqOp            */ __Matchers[466].Set(_caseType, __Matchers[465]);
                /* 467 AltOp            */ __Matchers[467].Set(_primaryType, _qualifiedCaseType);
                /* 468 OptionalOp       */ __Matchers[468].Set(_packageQualifier);
                /* 469 SeqOp            */ __Matchers[469].Set(__Matchers[468], _memberName);
                /* 470 OptionalOp       */ __Matchers[470].Set(_parameterList);
                /* 471 SeqOp            */ __Matchers[471].Set(__Matchers[429], __Matchers[470], __Matchers[430]);
                /* 472 SeqOp            */ __Matchers[472].Set(__Matchers[397], _parameterDeclarationOrRefPattern);
                /* 473 StarOp           */ __Matchers[473].Set(__Matchers[472]);
                /* 474 SeqOp            */ __Matchers[474].Set(_parameterDeclarationOrRefPattern, __Matchers[473]);
                /* 475 AltOp            */ __Matchers[475].Set(_entryPattern, _tuplePattern, _parameter, _parameterReference);
                /* 476 SeqOp            */ __Matchers[476].Set(_annotations, _parameterDeclaration);
                /* 477 OptionalOp       */ __Matchers[477].Set(_valueSpecifier);
                /* 478 SeqOp            */ __Matchers[478].Set(_memberName, __Matchers[477]);
                /* 479 AltOp            */ __Matchers[479].Set(_functionParameterDeclaration, _valueParameterDeclaration);
                /* 480 AltOp            */ __Matchers[480].Set(_voidFunctionParameter, _inferredFunctionParameter, _typedFunctionParameter);
                ...
                /* 485 SeqOp            */ __Matchers[485].Set(__Matchers[481], _memberName, __Matchers[482], __Matchers[483], __Matchers[484]);
                /* 487 SeqOp            */ __Matchers[487].Set(__Matchers[486], _memberName, __Matchers[482], __Matchers[483], __Matchers[484]);
                /* 488 SeqOp            */ __Matchers[488].Set(_variadicType, _memberName, __Matchers[482], __Matchers[483], __Matchers[484]);
                /* 489 AltOp            */ __Matchers[489].Set(_inferredValueParameter, _typedValueParameter);
                /* 491 SeqOp            */ __Matchers[491].Set(__Matchers[490], _memberName, __Matchers[477]);
                /* 492 SeqOp            */ __Matchers[492].Set(_variadicType, _memberName, __Matchers[477]);
                /* 495 SeqOp            */ __Matchers[495].Set(__Matchers[493], _typeParameterList, __Matchers[494]);
                /* 496 SeqOp            */ __Matchers[496].Set(__Matchers[397], _typeParameter);
                ...
                /* 505 SeqOp            */ __Matchers[505].Set(__Matchers[405], _type);
                ...
                /* 510 SeqOp            */ __Matchers[510].Set(__Matchers[506], __Matchers[507], __Matchers[482], __Matchers[508], __Matchers[509]);
                /* 511 PlusOp           */ __Matchers[511].Set(_typeConstraint);
                /* 512 StarOp           */ __Matchers[512].Set(_topDeclaration);
                /* 513 AltOp            */ __Matchers[513].Set(_classDeclaration, _interfaceDeclaration, _aliasDeclaration, _objectDeclaration, _setterDeclaration, _typedMethodDeclaration, _voidMethodDeclaration, _inferredMethodDeclaration, _typedAttributeDeclaration, _inferredAttributeDeclaration);
                /* 514 AltOp            */ __Matchers[514].Set(_classDeclaration, _interfaceDeclaration, _aliasDeclaration, _objectDeclaration, _constructorDeclaration, _enumeratedObjectDeclaration, _setterDeclaration, _typedMethodDeclaration, _voidMethodDeclaration, _inferredMethodDeclaration, _typedAttributeDeclaration, _inferredAttributeDeclaration);
                /* 516 OptionalOp       */ __Matchers[516].Set(_memberName);
                /* 517 OptionalOp       */ __Matchers[517].Set(_delegatedConstructor);
                /* 518 SeqOp            */ __Matchers[518].Set(_annotations, __Matchers[515], __Matchers[516], _parameters, __Matchers[517], _block);
                /* 520 OptionalOp       */ __Matchers[520].Set(_typeConstraints);
                /* 521 SeqOp            */ __Matchers[521].Set(_annotations, __Matchers[519], _typeName, __Matchers[482], __Matchers[520], _optionalTypeSpecifier);
                /* 522 SeqOp            */ __Matchers[522].Set(_annotations, __Matchers[515], _memberName, __Matchers[517], _block);
                /* 524 OptionalOp       */ __Matchers[524].Set(_extendedType);
                /* 525 SeqOp            */ __Matchers[525].Set(_annotations, __Matchers[523], _memberName, __Matchers[524], __Matchers[509], _block);
                /* 527 SeqOp            */ __Matchers[527].Set(_annotations, __Matchers[526], _memberName, _setterDefinition);
                /* 528 AltOp            */ __Matchers[528].Set(_block, _requiredFunctionSpecifier);
                /* 529 SeqOp            */ __Matchers[529].Set(_annotations, __Matchers[481], _memberName, __Matchers[482], __Matchers[483], __Matchers[520], _methodDefinition);
                /* 530 SeqOp            */ __Matchers[530].Set(_annotations, __Matchers[486], _memberName, __Matchers[482], __Matchers[483], __Matchers[520], _methodDefinition);
                /* 531 SeqOp            */ __Matchers[531].Set(_annotations, _variadicType, _memberName, __Matchers[482], __Matchers[483], __Matchers[520], _methodDefinition);
                /* 532 AltOp            */ __Matchers[532].Set(_block, _optionalFunctionSpecifier);
                /* 533 SeqOp            */ __Matchers[533].Set(_annotations, _variadicType, _memberName, _attributeDefinition);
                /* 534 SeqOp            */ __Matchers[534].Set(_annotations, __Matchers[490], _memberName, _attributeDefinition);
                /* 535 AltOp            */ __Matchers[535].Set(_block, _optionalAnySpecifier);
                /* 537 OptionalOp       */ __Matchers[537].Set(_parameters);
                /* 538 SeqOp            */ __Matchers[538].Set(_annotations, __Matchers[536], _typeName, __Matchers[482], __Matchers[537], __Matchers[508], __Matchers[524], __Matchers[509], __Matchers[520], _classDefinition);
                /* 539 AltOp            */ __Matchers[539].Set(_block, _optionalClassSpecifier);
                /* 540 OptionalOp       */ __Matchers[540].Set(_classSpecifier);
                /* 541 SeqOp            */ __Matchers[541].Set(__Matchers[540], __Matchers[366]);
                /* 543 SeqOp            */ __Matchers[543].Set(_annotations, __Matchers[542], _typeName, __Matchers[482], __Matchers[508], __Matchers[509], __Matchers[520], _interfaceDefinition);
                ...
                /* 547 SeqOp            */ __Matchers[547].Set(_openStatement, __Matchers[366]);
                /* 548 AltOp            */ __Matchers[548].Set(_returnStatement, _throwStatement, _breakStatement, _continueStatement, _expressionStatement, _specificationStatement, _assertionStatement, _letStatement);
                ...
                /* 557 SeqOp            */ __Matchers[557].Set(__Matchers[405], _expression);
                /* 558 SeqOp            */ __Matchers[558].Set(__Matchers[443], _expression);
                /* 559 SeqOp            */ __Matchers[559].Set(__Matchers[484], __Matchers[366]);
                /* 560 SeqOp            */ __Matchers[560].Set(_functionSpecifier, __Matchers[366]);
                /* 561 SeqOp            */ __Matchers[561].Set(__Matchers[443], _type);
                /* 562 OptionalOp       */ __Matchers[562].Set(_typeSpecifier);
                /* 563 SeqOp            */ __Matchers[563].Set(__Matchers[562], __Matchers[366]);
                /* 564 AltOp            */ __Matchers[564].Set(_valueSpecifier, _functionSpecifier);
                /* 565 OptionalOp       */ __Matchers[565].Set(_anySpecifier);
                /* 566 SeqOp            */ __Matchers[566].Set(__Matchers[565], __Matchers[366]);
                /* 567 AltOp            */ __Matchers[567].Set(_baseReference, _selfReference, _parametrizedMember, _selfParametrizedMember);
                /* 568 AltOp            */ __Matchers[568].Set(_memberReference, _typeReference);
                /* 569 SeqOp            */ __Matchers[569].Set(_memberName, __Matchers[482], __Matchers[483]);
                ...
                /* 577 AltOp            */ __Matchers[577].Set(__Matchers[575], __Matchers[449], __Matchers[576], __Matchers[392]);
                /* 578 OptionalOp       */ __Matchers[578].Set(_sequencedArgumentList);
                /* 579 SeqOp            */ __Matchers[579].Set(__Matchers[385], _statements, __Matchers[578], __Matchers[387]);
                /* 580 SeqOp            */ __Matchers[580].Set(__Matchers[415], __Matchers[578], __Matchers[417]);
                /* 581 AltOp            */ __Matchers[581].Set(_patternedArguments, _positionalArguments);
                /* 582 StarOp           */ __Matchers[582].Set(_structuredArgument);
                /* 583 SeqOp            */ __Matchers[583].Set(__Matchers[385], __Matchers[582], __Matchers[578], __Matchers[387]);
                /* 584 SeqOp            */ __Matchers[584].Set(__Matchers[429], __Matchers[578], __Matchers[430]);
                /* 585 AltOp            */ __Matchers[585].Set(_anonymousArgument, _namedArgument);
                /* 586 SeqOp            */ __Matchers[586].Set(_expression, __Matchers[366]);
                /* 587 AltOp            */ __Matchers[587].Set(_namedSpecifiedArgument, _namedArgumentDeclaration);
                /* 588 SeqOp            */ __Matchers[588].Set(_memberName, _valueSpecifier, __Matchers[366]);
                /* 589 SeqOp            */ __Matchers[589].Set(__Matchers[397], _sequencedArgument);
                ...
                /* 594 SeqOp            */ __Matchers[594].Set(__Matchers[523], __Matchers[516], __Matchers[524], __Matchers[509], _block);
                /* 595 SeqOp            */ __Matchers[595].Set(_type, _parametrizedMember, _methodDefinition);
                /* 596 SeqOp            */ __Matchers[596].Set(__Matchers[486], __Matchers[516], __Matchers[482], _parameters, _methodDefinition);
                /* 597 SeqOp            */ __Matchers[597].Set(_memberName, __Matchers[483], _requiredFunctionSpecifier);
                /* 598 SeqOp            */ __Matchers[598].Set(_type, _memberName, _methodDefinition);
                /* 599 SeqOp            */ __Matchers[599].Set(__Matchers[490], _memberName, _methodDefinition);
                /* 600 SeqOp            */ __Matchers[600].Set(_memberName, _requiredFunctionSpecifier);
                /* 601 AltOp            */ __Matchers[601].Set(_expressionArgument, _declarationReference);
                /* 602 SeqOp            */ __Matchers[602].Set(__Matchers[425], _unionExpression);
                /* 603 OptionalOp       */ __Matchers[603].Set(_letVariableList);
                /* 604 SeqOp            */ __Matchers[604].Set(__Matchers[428], __Matchers[429], __Matchers[603], __Matchers[430], _conditionalExpression);
                /* 605 PlusOp           */ __Matchers[605].Set(_caseExpression);
                /* 606 OptionalOp       */ __Matchers[606].Set(_elseExpression);
                /* 607 SeqOp            */ __Matchers[607].Set(_switchHeader, __Matchers[605], __Matchers[606]);
                /* 609 SeqOp            */ __Matchers[609].Set(__Matchers[608], __Matchers[429], _switched, __Matchers[430]);
                /* 611 OptionalOp       */ __Matchers[611].Set(__Matchers[610]);
                /* 613 SeqOp            */ __Matchers[613].Set(__Matchers[611], __Matchers[612], __Matchers[429], _caseItem, __Matchers[430], _conditionalExpression);
                /* 615 SeqOp            */ __Matchers[615].Set(__Matchers[614], _conditions, _thenExpression, _elseExpression);
                /* 616 SeqOp            */ __Matchers[616].Set(__Matchers[610], _conditionalExpression);
                /* 618 SeqOp            */ __Matchers[618].Set(__Matchers[617], _conditionalExpression);
                /* 619 AltOp            */ __Matchers[619].Set(_ifExpr, _letExpr, _disjunctionExpression);
                /* 620 AltOp            */ __Matchers[620].Set(_voidFunctionExpr, _inferredFunctionExpr);
                /* 621 SeqOp            */ __Matchers[621].Set(__Matchers[481], __Matchers[482], __Matchers[483], __Matchers[520], _functionDefinition);
                /* 622 OptionalOp       */ __Matchers[622].Set(__Matchers[486]);
                /* 623 SeqOp            */ __Matchers[623].Set(__Matchers[622], __Matchers[482], __Matchers[483], __Matchers[520], _functionDefinition);
                ...
                /* 630 SeqOp            */ __Matchers[630].Set(__Matchers[614], _conditions, _comprehensionClause);
                /* 631 AltOp            */ __Matchers[631].Set(_letExpr, _ifExpr, _switchExpr, _functionExpression, _operatorExpression);
                ...
                /* 645 AltOp            */ __Matchers[645].Set(__Matchers[405], __Matchers[634], __Matchers[635], __Matchers[636], __Matchers[637], __Matchers[638], __Matchers[639], __Matchers[640], __Matchers[641], __Matchers[642], __Matchers[643], __Matchers[644]);
                ...
                /* 648 AltOp            */ __Matchers[648].Set(__Matchers[610], __Matchers[617]);
                ...
                /* 673 AltOp            */ __Matchers[673].Set(__Matchers[672], __Matchers[502]);
                /* 675 AltOp            */ __Matchers[675].Set(__Matchers[674], __Matchers[493]);
                /* 677 AltOp            */ __Matchers[677].Set(__Matchers[676], __Matchers[494]);
                /* 679 AltOp            */ __Matchers[679].Set(__Matchers[678], __Matchers[436], __Matchers[456], __Matchers[461]);
                ...
                /* 693 AltOp            */ __Matchers[693].Set(__Matchers[426], __Matchers[692]);
                /* 694 AltOp            */ __Matchers[694].Set(_scaleExpr, _multiplicativeExpression);
                /* 695 SeqOp            */ __Matchers[695].Set(_multiplicativeExpression, _scaleOperator, _scaleExpression);
                /* 697 AltOp            */ __Matchers[697].Set(_multiplicativeExpr, _unionExpression);
                /* 698 SeqOp            */ __Matchers[698].Set(_multiplicativeExpression, _multiplicativeOperator, _unionExpression);
                /* 701 AltOp            */ __Matchers[701].Set(__Matchers[425], __Matchers[699], __Matchers[700]);
                /* 702 AltOp            */ __Matchers[702].Set(_unionExpr, _exclusiveExpression);
                /* 703 SeqOp            */ __Matchers[703].Set(_unionExpression, _unionOperator, _exclusiveExpression);
                /* 705 AltOp            */ __Matchers[705].Set(__Matchers[463], __Matchers[704]);
                /* 706 AltOp            */ __Matchers[706].Set(_exclusiveExpr, _intersectionExpression);
                /* 707 SeqOp            */ __Matchers[707].Set(_exclusiveExpression, _exclusiveOperator, _intersectionExpression);
                /* 709 AltOp            */ __Matchers[709].Set(_intersectionExpr, _negationOrComplementExpression);
                /* 710 SeqOp            */ __Matchers[710].Set(_intersectionExpression, _intersectionOperator, _negationOrComplementExpression);
                /* 712 AltOp            */ __Matchers[712].Set(_negationOrComplementExpr, _prefixExpression);
                /* 713 SeqOp            */ __Matchers[713].Set(_unaryMinusOrComplementOperator, _negationOrComplementExpression);
                /* 714 AltOp            */ __Matchers[714].Set(_negateOperator, _neutralOperator, _complementOperator);
                /* 715 NotOp            */ __Matchers[715].Set(__Matchers_715_DFA);
                /* 716 SeqOp            */ __Matchers[716].Set(__Matchers[692], __Matchers[715]);
                /* 717 NotOp            */ __Matchers[717].Set(__Matchers_717_DFA);
                /* 718 SeqOp            */ __Matchers[718].Set(__Matchers[426], __Matchers[717]);
                /* 719 AltOp            */ __Matchers[719].Set(_prefixExpr, _postfixExpression);
                /* 720 SeqOp            */ __Matchers[720].Set(_incrementOperator, _prefixExpression);
                /* 721 AltOp            */ __Matchers[721].Set(_postfixExpr, _primary);
                /* 722 SeqOp            */ __Matchers[722].Set(_postfixExpression, _incrementOperator);
                /* 725 AltOp            */ __Matchers[725].Set(__Matchers[723], __Matchers[724]);
                /* 726 AltOp            */ __Matchers[726].Set(_selectionExpr, _indexedExpr, _callExpr, _baseExpression);
                /* 727 SeqOp            */ __Matchers[727].Set(_primary, _memberSelectionOperator, _baseReference);
                /* 730 AltOp            */ __Matchers[730].Set(__Matchers[368], __Matchers[728], __Matchers[729]);
                /* 731 SeqOp            */ __Matchers[731].Set(_primary, __Matchers[415], _index, __Matchers[417]);
                /* 732 AltOp            */ __Matchers[732].Set(_lowerSpanned, _upperSpanned, _spanned, _measured, _expression);
                /* 733 SeqOp            */ __Matchers[733].Set(_indexExpression, __Matchers[407]);
                /* 734 SeqOp            */ __Matchers[734].Set(__Matchers[407], _indexExpression);
                /* 735 SeqOp            */ __Matchers[735].Set(_indexExpression, __Matchers[688], _indexExpression);
                /* 736 SeqOp            */ __Matchers[736].Set(_indexExpression, __Matchers[377], _indexExpression);
                /* 737 SeqOp            */ __Matchers[737].Set(_primary, _arguments);
                /* 738 AltOp            */ __Matchers[738].Set(_nonstringLiteral, _stringExpression, _metaLiteral, _enumerationExpr, _tupleExpr, _objectExpr, _groupedExpr, _baseReferenceOrParameterized);
                /* 739 AltOp            */ __Matchers[739].Set(_literalNatural, _literalFloat, _literalChar);
                /* 740 AltOp            */ __Matchers[740].Set(_stringLiteral, _stringInterpolation);
                /* 741 StarOp           */ __Matchers[741].Set(_interpolationPart);
                /* 742 SeqOp            */ __Matchers[742].Set(_stringStart, _expression, __Matchers[741], _stringEnd);
                /* 743 SeqOp            */ __Matchers[743].Set(_stringMid, _expression);
                /* 744 AltOp            */ __Matchers[744].Set(_literalString, _verbatimString);
                /* 745 SeqOp            */ __Matchers[745].Set(__Matchers[523], __Matchers[524], __Matchers[509], _block);
                /* 746 SeqOp            */ __Matchers[746].Set(__Matchers[429], _expression, __Matchers[430]);
                /* 747 OptionalOp       */ __Matchers[747].Set(_typeArgumentList);
                /* 748 SeqOp            */ __Matchers[748].Set(__Matchers[493], __Matchers[747], __Matchers[494]);
                /* 749 SeqOp            */ __Matchers[749].Set(__Matchers[397], _variancedType);
                /* 750 StarOp           */ __Matchers[750].Set(__Matchers[749]);
                /* 751 SeqOp            */ __Matchers[751].Set(_variancedType, __Matchers[750]);
                /* 752 SeqOp            */ __Matchers[752].Set(__Matchers[499], _type);
                /* 753 SeqOp            */ __Matchers[753].Set(__Matchers[397], _defaultedType);
                /* 754 StarOp           */ __Matchers[754].Set(__Matchers[753]);
                /* 755 SeqOp            */ __Matchers[755].Set(_defaultedType, __Matchers[754]);
                /* 756 AltOp            */ __Matchers[756].Set(_defaultedTypeCore, _variadicType);
                /* 757 SeqOp            */ __Matchers[757].Set(_type, __Matchers[405]);
                /* 758 AltOp            */ __Matchers[758].Set(_variadicTypeCore, _type);
                /* 759 SeqOp            */ __Matchers[759].Set(_unionType, _variadicOperator);
                /* 760 SeqOp            */ __Matchers[760].Set(__Matchers[425], _unionType);
                /* 761 AltOp            */ __Matchers[761].Set(_entryType, _unionType);
                /* 762 SeqOp            */ __Matchers[762].Set(_unionType, __Matchers[412], _unionType);
                /* 763 AltOp            */ __Matchers[763].Set(_unionTypeCore, _intersectionType);
                /* 764 SeqOp            */ __Matchers[764].Set(_unionType, __Matchers[463], _intersectionType);
                /* 765 AltOp            */ __Matchers[765].Set(_intersectionTypeCore, _primaryType);
                /* 766 SeqOp            */ __Matchers[766].Set(_intersectionType, __Matchers[711], _primaryType);
                /* 767 AltOp            */ __Matchers[767].Set(_nullableType, _arrayType, _functionType, _tupleType, _iterableType, _groupedType, _packageQualifiedType, _typePath);
                /* 769 SeqOp            */ __Matchers[769].Set(_primaryType, __Matchers[768]);
                /* 770 OptionalOp       */ __Matchers[770].Set(_literalNatural);
                /* 771 SeqOp            */ __Matchers[771].Set(_primaryType, __Matchers[415], __Matchers[770], __Matchers[417]);
                /* 772 OptionalOp       */ __Matchers[772].Set(_typeTypeArguments);
                /* 773 SeqOp            */ __Matchers[773].Set(_primaryType, __Matchers[429], __Matchers[772], __Matchers[430]);
                /* 774 AltOp            */ __Matchers[774].Set(_spreadType, _defaultedTypeList);
                /* 775 SeqOp            */ __Matchers[775].Set(__Matchers[415], __Matchers[772], __Matchers[417]);
                /* 776 OptionalOp       */ __Matchers[776].Set(_variadicType);
                /* 777 SeqOp            */ __Matchers[777].Set(__Matchers[385], __Matchers[776], __Matchers[387]);
                /* 778 SeqOp            */ __Matchers[778].Set(__Matchers[493], _type, __Matchers[494]);
                /* 779 SeqOp            */ __Matchers[779].Set(__Matchers[392], __Matchers[368], _typePath);
                /* 780 OptionalOp       */ __Matchers[780].Set(_stringLiteral);
                /* 781 StarOp           */ __Matchers[781].Set(_annotation);
                /* 782 SeqOp            */ __Matchers[782].Set(__Matchers[780], __Matchers[781]);
                /* 783 SeqOp            */ __Matchers[783].Set(_memberName, __Matchers[445]);
                /* 784 OptionalOp       */ __Matchers[784].Set(_conditionList);
                /* 785 SeqOp            */ __Matchers[785].Set(__Matchers[429], __Matchers[784], __Matchers[430]);
                /* 786 SeqOp            */ __Matchers[786].Set(__Matchers[397], _condition);
                /* 787 StarOp           */ __Matchers[787].Set(__Matchers[786]);
                /* 788 SeqOp            */ __Matchers[788].Set(_condition, __Matchers[787]);
                /* 789 AltOp            */ __Matchers[789].Set(_existsCondition, _nonemptyCondition, _isCondition, _satisfiesCondition, _booleanCondition);
                /* 790 OptionalOp       */ __Matchers[790].Set(__Matchers[657]);
                /* 791 SeqOp            */ __Matchers[791].Set(__Matchers[790], __Matchers[681], _letOrExpression);
                /* 792 SeqOp            */ __Matchers[792].Set(__Matchers[790], __Matchers[683], _letOrExpression);
                /* 793 AltOp            */ __Matchers[793].Set(_letVariable, _operatorExpression);
                /* 794 SeqOp            */ __Matchers[794].Set(__Matchers[790], __Matchers[678], _type, _isConditionVariable);
                /* 795 SeqOp            */ __Matchers[795].Set(_memberName, __Matchers[477]);
                /* 796 SeqOp            */ __Matchers[796].Set(__Matchers[456], _type, _typeName);
                /* 797 AltOp            */ __Matchers[797].Set(_ifElseStatement, _forElseStatement, _switchStatement, _whileStatement, _tryStatement);
                /* 798 StarOp           */ __Matchers[798].Set(_elseIf);
                /* 799 OptionalOp       */ __Matchers[799].Set(_elseBlock);
                /* 800 SeqOp            */ __Matchers[800].Set(__Matchers[614], _conditions, _block, __Matchers[798], __Matchers[799]);
                /* 801 SeqOp            */ __Matchers[801].Set(__Matchers[610], __Matchers[614], _conditions, _block);
                /* 802 SeqOp            */ __Matchers[802].Set(__Matchers[610], _block);
                /* 803 PlusOp           */ __Matchers[803].Set(_caseBlock);
                /* 804 SeqOp            */ __Matchers[804].Set(_switchHeader, __Matchers[803], __Matchers[799]);
                /* 805 SeqOp            */ __Matchers[805].Set(__Matchers[611], __Matchers[612], __Matchers[429], _caseItem, __Matchers[430], _block);
                /* 806 AltOp            */ __Matchers[806].Set(_isCaseCondition, _satisfiesCaseCondition, _valueCaseList, _pattern);
                /* 807 SeqOp            */ __Matchers[807].Set(__Matchers[678], _type);
                /* 808 SeqOp            */ __Matchers[808].Set(__Matchers[456], _type);
                /* 809 SeqOp            */ __Matchers[809].Set(_valueCaseSeparator, _valueCase);
                /* 810 StarOp           */ __Matchers[810].Set(__Matchers[809]);
                /* 811 SeqOp            */ __Matchers[811].Set(_valueCase, __Matchers[810]);
                /* 812 AltOp            */ __Matchers[812].Set(__Matchers[397], __Matchers[463]);
                /* 813 AltOp            */ __Matchers[813].Set(_intersectionType, _intersectionExpression);
                /* 814 SeqOp            */ __Matchers[814].Set(__Matchers[627], __Matchers[429], __Matchers[628], __Matchers[430], _block, __Matchers[799]);
                /* 815 SeqOp            */ __Matchers[815].Set(_forVariable, _containment);
                /* 816 SeqOp            */ __Matchers[816].Set(_containmentOperator, _operatorExpression);
                /* 817 AltOp            */ __Matchers[817].Set(__Matchers[502], __Matchers[377]);
                /* 819 SeqOp            */ __Matchers[819].Set(__Matchers[818], _conditions, _block);
                /* 821 OptionalOp       */ __Matchers[821].Set(_resources);
                /* 822 StarOp           */ __Matchers[822].Set(_catchBlock);
                /* 823 OptionalOp       */ __Matchers[823].Set(_finallyBlock);
                /* 824 SeqOp            */ __Matchers[824].Set(__Matchers[820], __Matchers[821], _block, __Matchers[822], __Matchers[823]);
                /* 826 OptionalOp       */ __Matchers[826].Set(_variable);
                /* 827 SeqOp            */ __Matchers[827].Set(__Matchers[825], __Matchers[429], __Matchers[826], __Matchers[430], _block);
                /* 829 SeqOp            */ __Matchers[829].Set(__Matchers[828], _block);
                /* 830 OptionalOp       */ __Matchers[830].Set(_resourceList);
                /* 831 SeqOp            */ __Matchers[831].Set(__Matchers[429], __Matchers[830], __Matchers[430]);
                /* 832 SeqOp            */ __Matchers[832].Set(__Matchers[397], _resource);
                /* 833 StarOp           */ __Matchers[833].Set(__Matchers[832]);
                /* 834 SeqOp            */ __Matchers[834].Set(_resource, __Matchers[833]);
                /* 835 AltOp            */ __Matchers[835].Set(_specifiedVariable, _operatorExpression);
                /* 836 SeqOp            */ __Matchers[836].Set(_variable, _valueSpecifier);
                /* 837 OptionalOp       */ __Matchers[837].Set(_variableType);
                /* 838 StarOp           */ __Matchers[838].Set(_parameters);
                /* 839 SeqOp            */ __Matchers[839].Set(__Matchers[837], _memberName, __Matchers[838]);
                /* 840 AltOp            */ __Matchers[840].Set(_type, _kwVoid, _kwFunction, _kwValue);
                /* 841 SeqOp            */ __Matchers[841].Set(__Matchers[708], _modelExpression);
                /* 843 SeqOp            */ __Matchers[843].Set(__Matchers[842], _metaExpression, __Matchers[842]);
                /* 844 AltOp            */ __Matchers[844].Set(_declarationReference, _modelExpression);
                /* 845 AltOp            */ __Matchers[845].Set(_memberModelExpression, _typeModelExpression);
                /* 846 AltOp            */ __Matchers[846].Set(_memberReference, _packageQualifiedMemberReference, _typeQualifiedMemberReference);
                /* 847 SeqOp            */ __Matchers[847].Set(__Matchers[392], __Matchers[368], _memberReference);
                /* 848 SeqOp            */ __Matchers[848].Set(_primaryType, __Matchers[368], _memberReference);
                /* 849 AltOp            */ __Matchers[849].Set(_moduleLiteral, _packageLiteral, _classLiteral, _newLiteral, _interfaceLiteral, _aliasLiteral, _typeParameterLiteral, _valueLiteral, _objectLiteral, _functionLiteral);
                /* 850 OptionalOp       */ __Matchers[850].Set(_packagePath);
                /* 851 SeqOp            */ __Matchers[851].Set(__Matchers[373], __Matchers[850]);
                /* 852 SeqOp            */ __Matchers[852].Set(__Matchers[392], __Matchers[850]);
                /* 853 SeqOp            */ __Matchers[853].Set(__Matchers[536], _referencePath);
                /* 854 SeqOp            */ __Matchers[854].Set(__Matchers[542], _referencePath);
                /* 855 SeqOp            */ __Matchers[855].Set(__Matchers[519], _referencePath);
                /* 856 SeqOp            */ __Matchers[856].Set(__Matchers[506], _referencePath);
                /* 857 SeqOp            */ __Matchers[857].Set(__Matchers[515], _referencePath);
                /* 858 SeqOp            */ __Matchers[858].Set(__Matchers[490], _referencePath);
                /* 859 SeqOp            */ __Matchers[859].Set(__Matchers[523], _referencePath);
                /* 860 SeqOp            */ __Matchers[860].Set(__Matchers[486], _referencePath);
                /* 861 SeqOp            */ __Matchers[861].Set(__Matchers[392], __Matchers[368]);
                /* 862 SeqOp            */ __Matchers[862].Set(__Matchers[468], _referencePathElementList);
                /* 863 SeqOp            */ __Matchers[863].Set(__Matchers[368], _referencePathElement);
                /* 864 StarOp           */ __Matchers[864].Set(__Matchers[863]);
                /* 865 SeqOp            */ __Matchers[865].Set(_referencePathElement, __Matchers[864]);
                ...
                __Matchers_715_DFA.Set(
                    new DfaState(0, false),
                    new DfaState(1, true)
                );
                __Matchers_715_DFA.States[0].Set(
                    new DfaTrans(__Matchers_715_DFA.States[1], new DfaInterval(45, 45))
                );
                __Matchers_715_DFA.States[1].Set(
                );
                ...
                __Matchers_717_DFA.States[0].Set(
                    new DfaTrans(__Matchers_717_DFA.States[1], new DfaInterval(43, 43))
                );
            ...
            private Dfa __Matchers_715_DFA = new Dfa("__Matchers_715_DFA");
