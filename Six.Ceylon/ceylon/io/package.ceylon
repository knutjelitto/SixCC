 ...
 ********************************************************************************/
"This package lets you create [[FileDescriptor]] objects, which represent open streams, such as
 files, sockets, or pipes. You can read and write bytes from and to those streams in synchronous or
 asynchronous mode, using  [[Buffer|ceylon.buffer::Buffer]] objects, and you can convert bytes to
 [[String]] objects using [[Charset|ceylon.buffer.charset::Charset]] objects.
