...
"""This module defines APIs for representing and manipulating URIs.
   ...
   The [[ceylon.uri::Uri]] class supports parsing and creating URI as defined by
   [RFC 3986](https://tools.ietf.org/html/rfc3986). A new `Uri` may be obtained
   using [[ceylon.uri::parse]].
