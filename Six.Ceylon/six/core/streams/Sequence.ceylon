...
{    
    ...
    class Reverse() extends Object() satisfies [Element+]
    {        
        size => outer.size;
        first => outer.last;
        last => outer.first;
    ...
    class Repeat(Integer times) extends Object() satisfies [Element+]
    {        
        assert (times > 1);
    ...
    class Subsequence(Integer from, Integer to) extends Object() satisfies [Element+]
    {
