...
"""
Sort the given elements according to their [[natural order|Comparable]], returning a new [[sequence|Sequential]].
...
shared [Element+] | []&Iterable<Element,Absent> sort<Element,Absent>(
