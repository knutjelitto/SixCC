...
Since Ceylon supports module isolation at runtime, it is possible that there are more than one version of a given
...
{
    """
    Returns the list of all currently loaded modules. This may include modules that were not imported directly by your
    module, and multiple versions of the same module.
    """
