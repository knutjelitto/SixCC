// <generated from="C:\\Dev\\Knut\\SixCC\\Six.Sax\\Sax.six" at="03.02.2022 16:11:02" />
    ...
    public partial class SaxParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[850])
            {
                ...
                /*   6 PlainRuleOp      */ __Matchers[6] = _namespacePath = new Mx.PlainRule(this, 6, "namespace-path") { Builder = nodes => nodes[0] };
                /*   7 PlainRuleOp      */ __Matchers[7] = _imports = new Mx.PlainRule(this, 7, "imports") { Builder = nodes => nodes[0] };
                /*   8 PlainRuleOp      */ __Matchers[8] = _moduleDescriptor = new Mx.PlainRule(this, 8, "module-descriptor") { Builder = nodes => nodes[0] };
                /*   9 PlainRuleOp      */ __Matchers[9] = _version = new Mx.PlainRule(this, 9, "version") { Builder = nodes => nodes[0] };
                /*  10 PlainRuleOp      */ __Matchers[10] = _moduleName = new Mx.PlainRule(this, 10, "module-name") { Builder = nodes => nodes[0] };
                /*  11 PlainRuleOp      */ __Matchers[11] = _moduleBody = new Mx.PlainRule(this, 11, "module-body") { Builder = nodes => nodes[0] };
                /*  12 PlainRuleOp      */ __Matchers[12] = _moduleBodyElement = new Mx.PlainRule(this, 12, "module-body-element") { Builder = nodes => nodes[0] };
                /*  13 PlainRuleOp      */ __Matchers[13] = _moduleImport = new Mx.PlainRule(this, 13, "module-import") { Builder = nodes => nodes[0] };
                /*  14 PlainRuleOp      */ __Matchers[14] = _importDeclaration = new Mx.PlainRule(this, 14, "import-declaration") { Builder = nodes => nodes[0] };
                /*  15 PlainRuleOp      */ __Matchers[15] = _importElements = new Mx.PlainRule(this, 15, "import-elements") { Builder = nodes => nodes[0] };
                /*  16 PlainRuleOp      */ __Matchers[16] = _importElementList = new Mx.PlainRule(this, 16, "import-element-list") { Builder = nodes => nodes[0] };
                /*  17 PlainRuleOp      */ __Matchers[17] = _importElement = new Mx.PlainRule(this, 17, "import-element") { Builder = nodes => nodes[0] };
                /*  18 PlainRuleOp      */ __Matchers[18] = _importNamed = new Mx.PlainRule(this, 18, "import-named") { Builder = nodes => nodes[0] };
                /*  19 PlainRuleOp      */ __Matchers[19] = _importName = new Mx.PlainRule(this, 19, "import-name") { Builder = nodes => nodes[0] };
                /*  20 PlainRuleOp      */ __Matchers[20] = _importNameSpecifier = new Mx.PlainRule(this, 20, "import-name-specifier") { Builder = nodes => nodes[0] };
                /*  21 PlainRuleOp      */ __Matchers[21] = _importWildcard = new Mx.PlainRule(this, 21, "import-wildcard") { Creator = node => new CImportWildcard(node) };
                /*  22 PlainRuleOp      */ __Matchers[22] = _packageName = new Mx.PlainRule(this, 22, "package-name") { Builder = nodes => nodes[0] };
                /*  23 PlainRuleOp      */ __Matchers[23] = _packagePath = new Mx.PlainRule(this, 23, "package-path") { Builder = nodes => nodes[0] };
                /*  24 PlainRuleOp      */ __Matchers[24] = _memberName = new Mx.PlainRule(this, 24, "member-name") { Builder = nodes => nodes[0] };
                /*  25 PlainRuleOp      */ __Matchers[25] = _typeName = new Mx.PlainRule(this, 25, "type-name") { Builder = nodes => nodes[0] };
                /*  26 PlainRuleOp      */ __Matchers[26] = _pattern = new Mx.PlainRule(this, 26, "pattern") { Builder = nodes => nodes[0] };
                /*  27 PlainRuleOp      */ __Matchers[27] = _entryPattern = new Mx.PlainRule(this, 27, "entry-pattern") { Builder = nodes => nodes[0] };
                /*  28 PlainRuleOp      */ __Matchers[28] = _variableOrTuplePattern = new Mx.PlainRule(this, 28, "variable-or-tuple-pattern") { Builder = nodes => nodes[0] };
                /*  29 PlainRuleOp      */ __Matchers[29] = _tuplePattern = new Mx.PlainRule(this, 29, "tuple-pattern") { Builder = nodes => nodes[0] };
                /*  30 PlainRuleOp      */ __Matchers[30] = _variadicPatternList = new Mx.PlainRule(this, 30, "variadic-pattern-list") { Builder = nodes => nodes[0] };
                /*  31 PlainRuleOp      */ __Matchers[31] = _variadicPattern = new Mx.PlainRule(this, 31, "variadic-pattern") { Builder = nodes => nodes[0] };
                /*  32 PlainRuleOp      */ __Matchers[32] = _variablePattern = new Mx.PlainRule(this, 32, "variable-pattern") { Builder = nodes => nodes[0] };
                /*  33 PlainRuleOp      */ __Matchers[33] = _variadicVariable = new Mx.PlainRule(this, 33, "variadic-variable") { Builder = nodes => nodes[0] };
                /*  34 PlainRuleOp      */ __Matchers[34] = _variadicOperator = new Mx.PlainRule(this, 34, "variadic-operator") { Creator = node => new CVariadicOperator(node) };
                /*  35 PlainRuleOp      */ __Matchers[35] = _letStatement = new Mx.PlainRule(this, 35, "let-statement") { Builder = nodes => nodes[0] };
                /*  36 PlainRuleOp      */ __Matchers[36] = _letVariableList = new Mx.PlainRule(this, 36, "let-variable-list") { Builder = nodes => nodes[0] };
                /*  37 PlainRuleOp      */ __Matchers[37] = _letVariable = new Mx.PlainRule(this, 37, "let-variable") { Builder = nodes => nodes[0] };
                /*  38 PlainRuleOp      */ __Matchers[38] = _delegatedConstructor = new Mx.PlainRule(this, 38, "delegated-constructor") { Builder = nodes => nodes[0] };
                /*  39 PlainRuleOp      */ __Matchers[39] = _assertionStatement = new Mx.PlainRule(this, 39, "assertion-statement") { Builder = nodes => nodes[0] };
                /*  40 PlainRuleOp      */ __Matchers[40] = _assertionMessage = new Mx.PlainRule(this, 40, "assertion-message") { Builder = nodes => nodes[0] };
                /*  41 PlainRuleOp      */ __Matchers[41] = _block = new Mx.PlainRule(this, 41, "block") { Builder = nodes => nodes[0] };
                /*  42 PlainRuleOp      */ __Matchers[42] = _extendedType = new Mx.PlainRule(this, 42, "extended-type") { Builder = nodes => nodes[0] };
                /*  43 PlainRuleOp      */ __Matchers[43] = _classSpecifier = new Mx.PlainRule(this, 43, "class-specifier") { Builder = nodes => nodes[0] };
                /*  44 PlainRuleOp      */ __Matchers[44] = _classInstantiation = new Mx.PlainRule(this, 44, "class-instantiation") { Builder = nodes => nodes[0] };
                /*  45 PlainRuleOp      */ __Matchers[45] = _qualifiedClass = new Mx.PlainRule(this, 45, "qualified-class") { Builder = nodes => nodes[0] };
                /*  46 PlainRuleOp      */ __Matchers[46] = _packageQualifiedClass = new Mx.PlainRule(this, 46, "package-qualified-class") { Builder = nodes => nodes[0] };
                /*  47 PlainRuleOp      */ __Matchers[47] = _superQualifiedClass = new Mx.PlainRule(this, 47, "super-qualified-class") { Builder = nodes => nodes[0] };
                /*  48 PlainRuleOp      */ __Matchers[48] = _unQualifiedClass = new Mx.PlainRule(this, 48, "un-qualified-class") { Builder = nodes => nodes[0] };
                /*  49 PlainRuleOp      */ __Matchers[49] = _memberPath = new Mx.PlainRule(this, 49, "member-path") { Builder = nodes => nodes[0] };
                /*  50 PlainRuleOp      */ __Matchers[50] = _typePath = new Mx.PlainRule(this, 50, "type-path") { Builder = nodes => nodes[0] };
                /*  51 PlainRuleOp      */ __Matchers[51] = _satisfiedTypes = new Mx.PlainRule(this, 51, "satisfied-types") { Builder = nodes => nodes[0] };
                /*  52 PlainRuleOp      */ __Matchers[52] = _unionTypeList = new Mx.PlainRule(this, 52, "union-type-list") { Builder = nodes => nodes[0] };
                /*  53 PlainRuleOp      */ __Matchers[53] = _caseTypes = new Mx.PlainRule(this, 53, "case-types") { Builder = nodes => nodes[0] };
                /*  54 PlainRuleOp      */ __Matchers[54] = _caseTypeList = new Mx.PlainRule(this, 54, "case-type-list") { Builder = nodes => nodes[0] };
                /*  55 PlainRuleOp      */ __Matchers[55] = _caseType = new Mx.PlainRule(this, 55, "case-type") { Builder = nodes => nodes[0] };
                /*  56 PlainRuleOp      */ __Matchers[56] = _qualifiedCaseType = new Mx.PlainRule(this, 56, "qualified-case-type") { Builder = nodes => nodes[0] };
                ...
                /*  59 PlainRuleOp      */ __Matchers[59] = _parameterDeclarationOrRefPattern = new Mx.PlainRule(this, 59, "parameter-declaration-or-ref-pattern") { Builder = nodes => nodes[0] };
                /*  60 PlainRuleOp      */ __Matchers[60] = _parameter = new Mx.PlainRule(this, 60, "parameter") { Builder = nodes => nodes[0] };
                /*  61 PlainRuleOp      */ __Matchers[61] = _parameterReference = new Mx.PlainRule(this, 61, "parameter-reference") { Builder = nodes => nodes[0] };
                /*  62 PlainRuleOp      */ __Matchers[62] = _parameterDeclaration = new Mx.PlainRule(this, 62, "parameter-declaration") { Builder = nodes => nodes[0] };
                /*  63 PlainRuleOp      */ __Matchers[63] = _functionParameterDeclaration = new Mx.PlainRule(this, 63, "function-parameter-declaration") { Builder = nodes => nodes[0] };
                /*  64 PlainRuleOp      */ __Matchers[64] = _voidFunctionParameter = new Mx.PlainRule(this, 64, "void-function-parameter") { Builder = nodes => nodes[0] };
                /*  65 PlainRuleOp      */ __Matchers[65] = _inferredFunctionParameter = new Mx.PlainRule(this, 65, "inferred-function-parameter") { Builder = nodes => nodes[0] };
                /*  66 PlainRuleOp      */ __Matchers[66] = _typedFunctionParameter = new Mx.PlainRule(this, 66, "typed-function-parameter") { Builder = nodes => nodes[0] };
                /*  67 PlainRuleOp      */ __Matchers[67] = _valueParameterDeclaration = new Mx.PlainRule(this, 67, "value-parameter-declaration") { Builder = nodes => nodes[0] };
                /*  68 PlainRuleOp      */ __Matchers[68] = _inferredValueParameter = new Mx.PlainRule(this, 68, "inferred-value-parameter") { Builder = nodes => nodes[0] };
                /*  69 PlainRuleOp      */ __Matchers[69] = _typedValueParameter = new Mx.PlainRule(this, 69, "typed-value-parameter") { Builder = nodes => nodes[0] };
                /*  70 PlainRuleOp      */ __Matchers[70] = _typeParameters = new Mx.PlainRule(this, 70, "type-parameters") { Builder = nodes => nodes[0] };
                /*  71 PlainRuleOp      */ __Matchers[71] = _typeParameterList = new Mx.PlainRule(this, 71, "type-parameter-list") { Builder = nodes => nodes[0] };
                /*  72 PlainRuleOp      */ __Matchers[72] = _typeParameter = new Mx.PlainRule(this, 72, "type-parameter") { Builder = nodes => nodes[0] };
                /*  73 PlainRuleOp      */ __Matchers[73] = _variance = new Mx.PlainRule(this, 73, "variance") { Creator = node => new CVariance(node) };
                /*  74 PlainRuleOp      */ __Matchers[74] = _typeDefault = new Mx.PlainRule(this, 74, "type-default") { Builder = nodes => nodes[0] };
                /*  75 PlainRuleOp      */ __Matchers[75] = _typeConstraint = new Mx.PlainRule(this, 75, "type-constraint") { Builder = nodes => nodes[0] };
                /*  76 PlainRuleOp      */ __Matchers[76] = _typeConstraints = new Mx.PlainRule(this, 76, "type-constraints") { Builder = nodes => nodes[0] };
                /*  77 PlainRuleOp      */ __Matchers[77] = _topDeclarations = new Mx.PlainRule(this, 77, "top-declarations") { Builder = nodes => nodes[0] };
                /*  78 PlainRuleOp      */ __Matchers[78] = _topDeclaration = new Mx.PlainRule(this, 78, "top-declaration") { Builder = nodes => nodes[0] };
                /*  79 PlainRuleOp      */ __Matchers[79] = _declaration = new Mx.PlainRule(this, 79, "declaration") { Builder = nodes => nodes[0] };
                /*  80 PlainRuleOp      */ __Matchers[80] = _constructorDeclaration = new Mx.PlainRule(this, 80, "constructor-declaration") { Builder = nodes => nodes[0] };
                /*  81 PlainRuleOp      */ __Matchers[81] = _aliasDeclaration = new Mx.PlainRule(this, 81, "alias-declaration") { Builder = nodes => nodes[0] };
                /*  82 PlainRuleOp      */ __Matchers[82] = _enumeratedObjectDeclaration = new Mx.PlainRule(this, 82, "enumerated-object-declaration") { Builder = nodes => nodes[0] };
                /*  83 PlainRuleOp      */ __Matchers[83] = _objectDeclaration = new Mx.PlainRule(this, 83, "object-declaration") { Builder = nodes => nodes[0] };
                /*  84 PlainRuleOp      */ __Matchers[84] = _setterDeclaration = new Mx.PlainRule(this, 84, "setter-declaration") { Builder = nodes => nodes[0] };
                /*  85 PlainRuleOp      */ __Matchers[85] = _setterDefinition = new Mx.PlainRule(this, 85, "setter-definition") { Builder = nodes => nodes[0] };
                /*  86 PlainRuleOp      */ __Matchers[86] = _voidMethodDeclaration = new Mx.PlainRule(this, 86, "void-method-declaration") { Builder = nodes => nodes[0] };
                /*  87 PlainRuleOp      */ __Matchers[87] = _inferredMethodDeclaration = new Mx.PlainRule(this, 87, "inferred-method-declaration") { Builder = nodes => nodes[0] };
                /*  88 PlainRuleOp      */ __Matchers[88] = _typedMethodDeclaration = new Mx.PlainRule(this, 88, "typed-method-declaration") { Builder = nodes => nodes[0] };
                /*  89 PlainRuleOp      */ __Matchers[89] = _methodDefinition = new Mx.PlainRule(this, 89, "method-definition") { Builder = nodes => nodes[0] };
                /*  90 PlainRuleOp      */ __Matchers[90] = _typedAttributeDeclaration = new Mx.PlainRule(this, 90, "typed-attribute-declaration") { Builder = nodes => nodes[0] };
                /*  91 PlainRuleOp      */ __Matchers[91] = _inferredAttributeDeclaration = new Mx.PlainRule(this, 91, "inferred-attribute-declaration") { Builder = nodes => nodes[0] };
                /*  92 PlainRuleOp      */ __Matchers[92] = _attributeDefinition = new Mx.PlainRule(this, 92, "attribute-definition") { Builder = nodes => nodes[0] };
                /*  93 PlainRuleOp      */ __Matchers[93] = _classDeclaration = new Mx.PlainRule(this, 93, "class-declaration") { Builder = nodes => nodes[0] };
                /*  94 PlainRuleOp      */ __Matchers[94] = _classDefinition = new Mx.PlainRule(this, 94, "class-definition") { Builder = nodes => nodes[0] };
                /*  95 PlainRuleOp      */ __Matchers[95] = _optionalClassSpecifier = new Mx.PlainRule(this, 95, "optional-class-specifier") { Builder = nodes => nodes[0] };
                /*  96 PlainRuleOp      */ __Matchers[96] = _interfaceDeclaration = new Mx.PlainRule(this, 96, "interface-declaration") { Builder = nodes => nodes[0] };
                /*  97 PlainRuleOp      */ __Matchers[97] = _interfaceDefinition = new Mx.PlainRule(this, 97, "interface-definition") { Builder = nodes => nodes[0] };
                /*  98 PlainRuleOp      */ __Matchers[98] = _statements = new Mx.PlainRule(this, 98, "statements") { Builder = nodes => nodes[0] };
                /*  99 PlainRuleOp      */ __Matchers[99] = _statement = new Mx.PlainRule(this, 99, "statement") { Builder = nodes => nodes[0] };
                /* 100 PlainRuleOp      */ __Matchers[100] = _declarationStatement = new Mx.PlainRule(this, 100, "declaration-statement") { Builder = nodes => nodes[0] };
                /* 101 PlainRuleOp      */ __Matchers[101] = _unclosedStatement = new Mx.PlainRule(this, 101, "unclosed-statement") { Builder = nodes => nodes[0] };
                /* 102 PlainRuleOp      */ __Matchers[102] = _openStatement = new Mx.PlainRule(this, 102, "open-statement") { Builder = nodes => nodes[0] };
                /* 103 PlainRuleOp      */ __Matchers[103] = _expressionStatement = new Mx.PlainRule(this, 103, "expression-statement") { Builder = nodes => nodes[0] };
                /* 104 PlainRuleOp      */ __Matchers[104] = _specificationStatement = new Mx.PlainRule(this, 104, "specification-statement") { Builder = nodes => nodes[0] };
                ...
                /* 107 PlainRuleOp      */ __Matchers[107] = _breakStatement = new Mx.PlainRule(this, 107, "break-statement") { Creator = node => new CBreakStatement(node) };
                /* 108 PlainRuleOp      */ __Matchers[108] = _continueStatement = new Mx.PlainRule(this, 108, "continue-statement") { Creator = node => new CContinueStatement(node) };
                /* 109 PlainRuleOp      */ __Matchers[109] = _valueSpecifier = new Mx.PlainRule(this, 109, "value-specifier") { Builder = nodes => nodes[0] };
                /* 110 PlainRuleOp      */ __Matchers[110] = _functionSpecifier = new Mx.PlainRule(this, 110, "function-specifier") { Builder = nodes => nodes[0] };
                /* 111 PlainRuleOp      */ __Matchers[111] = _optionalFunctionSpecifier = new Mx.PlainRule(this, 111, "optional-function-specifier") { Builder = nodes => nodes[0] };
                /* 112 PlainRuleOp      */ __Matchers[112] = _requiredFunctionSpecifier = new Mx.PlainRule(this, 112, "required-function-specifier") { Builder = nodes => nodes[0] };
                /* 113 PlainRuleOp      */ __Matchers[113] = _typeSpecifier = new Mx.PlainRule(this, 113, "type-specifier") { Builder = nodes => nodes[0] };
                /* 114 PlainRuleOp      */ __Matchers[114] = _optionalTypeSpecifier = new Mx.PlainRule(this, 114, "optional-type-specifier") { Builder = nodes => nodes[0] };
                /* 115 PlainRuleOp      */ __Matchers[115] = _anySpecifier = new Mx.PlainRule(this, 115, "any-specifier") { Builder = nodes => nodes[0] };
                /* 116 PlainRuleOp      */ __Matchers[116] = _optionalAnySpecifier = new Mx.PlainRule(this, 116, "optional-any-specifier") { Builder = nodes => nodes[0] };
                /* 117 PlainRuleOp      */ __Matchers[117] = _baseReferenceOrParameterized = new Mx.PlainRule(this, 117, "base-reference-or-parameterized") { Builder = nodes => nodes[0] };
                /* 118 PlainRuleOp      */ __Matchers[118] = _baseReference = new Mx.PlainRule(this, 118, "base-reference") { Builder = nodes => nodes[0] };
                /* 119 PlainRuleOp      */ __Matchers[119] = _parametrizedMember = new Mx.PlainRule(this, 119, "parametrized-member") { Builder = nodes => nodes[0] };
                /* 120 PlainRuleOp      */ __Matchers[120] = _selfParametrizedMember = new Mx.PlainRule(this, 120, "self-parametrized-member") { Builder = nodes => nodes[0] };
                /* 121 PlainRuleOp      */ __Matchers[121] = _memberReference = new Mx.PlainRule(this, 121, "member-reference") { Builder = nodes => nodes[0] };
                /* 122 PlainRuleOp      */ __Matchers[122] = _typeReference = new Mx.PlainRule(this, 122, "type-reference") { Builder = nodes => nodes[0] };
                /* 123 PlainRuleOp      */ __Matchers[123] = _selfReferenceSelector = new Mx.PlainRule(this, 123, "self-reference-selector") { Builder = nodes => nodes[0] };
                /* 124 PlainRuleOp      */ __Matchers[124] = _selfReference = new Mx.PlainRule(this, 124, "self-reference") { Creator = node => new CSelfReference(node) };
                /* 125 PlainRuleOp      */ __Matchers[125] = _enumerationExpr = new Mx.PlainRule(this, 125, "enumeration-expr") { Builder = nodes => nodes[0] };
                /* 126 PlainRuleOp      */ __Matchers[126] = _tupleExpr = new Mx.PlainRule(this, 126, "tuple-expr") { Builder = nodes => nodes[0] };
                /* 127 PlainRuleOp      */ __Matchers[127] = _arguments = new Mx.PlainRule(this, 127, "arguments") { Builder = nodes => nodes[0] };
                /* 128 PlainRuleOp      */ __Matchers[128] = _patternedArguments = new Mx.PlainRule(this, 128, "patterned-arguments") { Builder = nodes => nodes[0] };
                /* 129 PlainRuleOp      */ __Matchers[129] = _positionalArguments = new Mx.PlainRule(this, 129, "positional-arguments") { Builder = nodes => nodes[0] };
                /* 130 PlainRuleOp      */ __Matchers[130] = _structuredArgument = new Mx.PlainRule(this, 130, "structured-argument") { Builder = nodes => nodes[0] };
                /* 131 PlainRuleOp      */ __Matchers[131] = _anonymousArgument = new Mx.PlainRule(this, 131, "anonymous-argument") { Builder = nodes => nodes[0] };
                /* 132 PlainRuleOp      */ __Matchers[132] = _namedArgument = new Mx.PlainRule(this, 132, "named-argument") { Builder = nodes => nodes[0] };
                /* 133 PlainRuleOp      */ __Matchers[133] = _namedSpecifiedArgument = new Mx.PlainRule(this, 133, "named-specified-argument") { Builder = nodes => nodes[0] };
                /* 134 PlainRuleOp      */ __Matchers[134] = _sequencedArgumentList = new Mx.PlainRule(this, 134, "sequenced-argument-list") { Builder = nodes => nodes[0] };
                /* 135 PlainRuleOp      */ __Matchers[135] = _sequencedArgument = new Mx.PlainRule(this, 135, "sequenced-argument") { Builder = nodes => nodes[0] };
                /* 136 PlainRuleOp      */ __Matchers[136] = _namedArgumentDeclaration = new Mx.PlainRule(this, 136, "named-argument-declaration") { Builder = nodes => nodes[0] };
                /* 137 PlainRuleOp      */ __Matchers[137] = _objectArgument = new Mx.PlainRule(this, 137, "object-argument") { Builder = nodes => nodes[0] };
                /* 138 PlainRuleOp      */ __Matchers[138] = _typedMethodArgument = new Mx.PlainRule(this, 138, "typed-method-argument") { Builder = nodes => nodes[0] };
                /* 139 PlainRuleOp      */ __Matchers[139] = _inferredMethodArgument = new Mx.PlainRule(this, 139, "inferred-method-argument") { Builder = nodes => nodes[0] };
                /* 140 PlainRuleOp      */ __Matchers[140] = _untypedMethodArgument = new Mx.PlainRule(this, 140, "untyped-method-argument") { Builder = nodes => nodes[0] };
                /* 141 PlainRuleOp      */ __Matchers[141] = _typedGetterArgument = new Mx.PlainRule(this, 141, "typed-getter-argument") { Builder = nodes => nodes[0] };
                /* 142 PlainRuleOp      */ __Matchers[142] = _inferredGetterArgument = new Mx.PlainRule(this, 142, "inferred-getter-argument") { Builder = nodes => nodes[0] };
                /* 143 PlainRuleOp      */ __Matchers[143] = _untypedGetterArgument = new Mx.PlainRule(this, 143, "untyped-getter-argument") { Builder = nodes => nodes[0] };
                /* 144 PlainRuleOp      */ __Matchers[144] = _positionalArgument = new Mx.PlainRule(this, 144, "positional-argument") { Builder = nodes => nodes[0] };
                /* 145 PlainRuleOp      */ __Matchers[145] = _expressionArgument = new Mx.PlainRule(this, 145, "expression-argument") { Builder = nodes => nodes[0] };
                /* 146 PlainRuleOp      */ __Matchers[146] = _spreadArgument = new Mx.PlainRule(this, 146, "spread-argument") { Builder = nodes => nodes[0] };
                /* 147 PlainRuleOp      */ __Matchers[147] = _letExpr = new Mx.PlainRule(this, 147, "let-expr") { Builder = nodes => nodes[0] };
                /* 148 PlainRuleOp      */ __Matchers[148] = _switchExpr = new Mx.PlainRule(this, 148, "switch-expr") { Builder = nodes => nodes[0] };
                /* 149 PlainRuleOp      */ __Matchers[149] = _switchHeader = new Mx.PlainRule(this, 149, "switch-header") { Builder = nodes => nodes[0] };
                /* 150 PlainRuleOp      */ __Matchers[150] = _switched = new Mx.PlainRule(this, 150, "switched") { Builder = nodes => nodes[0] };
                /* 151 PlainRuleOp      */ __Matchers[151] = _caseExpression = new Mx.PlainRule(this, 151, "case-expression") { Builder = nodes => nodes[0] };
                /* 152 PlainRuleOp      */ __Matchers[152] = _ifExpr = new Mx.PlainRule(this, 152, "if-expr") { Builder = nodes => nodes[0] };
                /* 153 PlainRuleOp      */ __Matchers[153] = _elseExpression = new Mx.PlainRule(this, 153, "else-expression") { Builder = nodes => nodes[0] };
                /* 154 PlainRuleOp      */ __Matchers[154] = _thenExpression = new Mx.PlainRule(this, 154, "then-expression") { Builder = nodes => nodes[0] };
                ...
                /* 156 PlainRuleOp      */ __Matchers[156] = _functionExpression = new Mx.PlainRule(this, 156, "function-expression") { Builder = nodes => nodes[0] };
                /* 157 PlainRuleOp      */ __Matchers[157] = _voidFunctionExpr = new Mx.PlainRule(this, 157, "void-function-expr") { Builder = nodes => nodes[0] };
                /* 158 PlainRuleOp      */ __Matchers[158] = _inferredFunctionExpr = new Mx.PlainRule(this, 158, "inferred-function-expr") { Builder = nodes => nodes[0] };
                /* 159 PlainRuleOp      */ __Matchers[159] = _functionDefinition = new Mx.PlainRule(this, 159, "function-definition") { Builder = nodes => nodes[0] };
                /* 160 PlainRuleOp      */ __Matchers[160] = _comprehensionArgument = new Mx.PlainRule(this, 160, "comprehension-argument") { Builder = nodes => nodes[0] };
                /* 161 PlainRuleOp      */ __Matchers[161] = _comprehensionClause = new Mx.PlainRule(this, 161, "comprehension-clause") { Builder = nodes => nodes[0] };
                /* 162 PlainRuleOp      */ __Matchers[162] = _expressionComprehensionClause = new Mx.PlainRule(this, 162, "expression-comprehension-clause") { Builder = nodes => nodes[0] };
                /* 163 PlainRuleOp      */ __Matchers[163] = _forComprehensionClause = new Mx.PlainRule(this, 163, "for-comprehension-clause") { Builder = nodes => nodes[0] };
                /* 164 PlainRuleOp      */ __Matchers[164] = _ifComprehensionClause = new Mx.PlainRule(this, 164, "if-comprehension-clause") { Builder = nodes => nodes[0] };
                /* 165 PlainRuleOp      */ __Matchers[165] = _expression = new Mx.PlainRule(this, 165, "expression") { Builder = nodes => nodes[0] };
                /* 166 PlainRuleOp      */ __Matchers[166] = _operatorExpression = new Mx.PlainRule(this, 166, "operator-expression") { Builder = nodes => nodes[0] };
                /* 167 PlainRuleOp      */ __Matchers[167] = _assignmentExpression = new Mx.PlainRule(this, 167, "assignment-expression") { Builder = nodes => nodes[0] };
                /* 168 PlainRuleOp      */ __Matchers[168] = _assignmentExpr = new Mx.PlainRule(this, 168, "assignment-expr") { Builder = nodes => nodes[0] };
                /* 169 PlainRuleOp      */ __Matchers[169] = _assignmentOperator = new Mx.PlainRule(this, 169, "assignment-operator") { Creator = node => new CAssignmentOperator(node) };
                /* 170 PlainRuleOp      */ __Matchers[170] = _thenElseExpression = new Mx.PlainRule(this, 170, "then-else-expression") { Builder = nodes => nodes[0] };
                /* 171 PlainRuleOp      */ __Matchers[171] = _thenElseExpr = new Mx.PlainRule(this, 171, "then-else-expr") { Builder = nodes => nodes[0] };
                /* 172 PlainRuleOp      */ __Matchers[172] = _thenElseOperator = new Mx.PlainRule(this, 172, "then-else-operator") { Creator = node => new CThenElseOperator(node) };
                /* 173 PlainRuleOp      */ __Matchers[173] = _disjunctionExpression = new Mx.PlainRule(this, 173, "disjunction-expression") { Builder = nodes => nodes[0] };
                /* 174 PlainRuleOp      */ __Matchers[174] = _disjunctionExpr = new Mx.PlainRule(this, 174, "disjunction-expr") { Builder = nodes => nodes[0] };
                /* 175 PlainRuleOp      */ __Matchers[175] = _disjunctionOperator = new Mx.PlainRule(this, 175, "disjunction-operator") { Creator = node => new CDisjunctionOperator(node) };
                /* 176 PlainRuleOp      */ __Matchers[176] = _conjunctionExpression = new Mx.PlainRule(this, 176, "conjunction-expression") { Builder = nodes => nodes[0] };
                /* 177 PlainRuleOp      */ __Matchers[177] = _conjunctionExpr = new Mx.PlainRule(this, 177, "conjunction-expr") { Builder = nodes => nodes[0] };
                /* 178 PlainRuleOp      */ __Matchers[178] = _conjunctionOperator = new Mx.PlainRule(this, 178, "conjunction-operator") { Creator = node => new CConjunctionOperator(node) };
                /* 179 PlainRuleOp      */ __Matchers[179] = _logicalNegationExpression = new Mx.PlainRule(this, 179, "logical-negation-expression") { Builder = nodes => nodes[0] };
                /* 180 PlainRuleOp      */ __Matchers[180] = _logicalNegationExpr = new Mx.PlainRule(this, 180, "logical-negation-expr") { Builder = nodes => nodes[0] };
                /* 181 PlainRuleOp      */ __Matchers[181] = _notOperator = new Mx.PlainRule(this, 181, "not-operator") { Creator = node => new CNotOperator(node) };
                /* 182 PlainRuleOp      */ __Matchers[182] = _expressionOrMeta = new Mx.PlainRule(this, 182, "expression-or-meta") { Builder = nodes => nodes[0] };
                /* 183 PlainRuleOp      */ __Matchers[183] = _equalityExpression = new Mx.PlainRule(this, 183, "equality-expression") { Builder = nodes => nodes[0] };
                /* 184 PlainRuleOp      */ __Matchers[184] = _equalityExpr = new Mx.PlainRule(this, 184, "equality-expr") { Builder = nodes => nodes[0] };
                /* 185 PlainRuleOp      */ __Matchers[185] = _equalityOperator = new Mx.PlainRule(this, 185, "equality-operator") { Creator = node => new CEqualityOperator(node) };
                /* 186 PlainRuleOp      */ __Matchers[186] = _comparisonExpression = new Mx.PlainRule(this, 186, "comparison-expression") { Builder = nodes => nodes[0] };
                /* 187 PlainRuleOp      */ __Matchers[187] = _comparisonExpr = new Mx.PlainRule(this, 187, "comparison-expr") { Builder = nodes => nodes[0] };
                /* 188 PlainRuleOp      */ __Matchers[188] = _largerExpr = new Mx.PlainRule(this, 188, "larger-expr") { Builder = nodes => nodes[0] };
                /* 189 PlainRuleOp      */ __Matchers[189] = _smallerExpr = new Mx.PlainRule(this, 189, "smaller-expr") { Builder = nodes => nodes[0] };
                /* 190 PlainRuleOp      */ __Matchers[190] = _largerBoundsExpr = new Mx.PlainRule(this, 190, "larger-bounds-expr") { Builder = nodes => nodes[0] };
                /* 191 PlainRuleOp      */ __Matchers[191] = _smallerBoundsExpr = new Mx.PlainRule(this, 191, "smaller-bounds-expr") { Builder = nodes => nodes[0] };
                /* 192 PlainRuleOp      */ __Matchers[192] = _typecheckExpr = new Mx.PlainRule(this, 192, "typecheck-expr") { Builder = nodes => nodes[0] };
                /* 193 PlainRuleOp      */ __Matchers[193] = _comparisonOperator = new Mx.PlainRule(this, 193, "comparison-operator") { Creator = node => new CComparisonOperator(node) };
                /* 194 PlainRuleOp      */ __Matchers[194] = _smallerOperator = new Mx.PlainRule(this, 194, "smaller-operator") { Creator = node => new CSmallerOperator(node) };
                /* 195 PlainRuleOp      */ __Matchers[195] = _largerOperator = new Mx.PlainRule(this, 195, "larger-operator") { Creator = node => new CLargerOperator(node) };
                /* 196 PlainRuleOp      */ __Matchers[196] = _typeOperator = new Mx.PlainRule(this, 196, "type-operator") { Creator = node => new CTypeOperator(node) };
                /* 197 PlainRuleOp      */ __Matchers[197] = _existsNonemptyExpression = new Mx.PlainRule(this, 197, "exists-nonempty-expression") { Builder = nodes => nodes[0] };
                /* 198 PlainRuleOp      */ __Matchers[198] = _existsExpr = new Mx.PlainRule(this, 198, "exists-expr") { Builder = nodes => nodes[0] };
                /* 199 PlainRuleOp      */ __Matchers[199] = _nonemptyExpr = new Mx.PlainRule(this, 199, "nonempty-expr") { Builder = nodes => nodes[0] };
                /* 200 PlainRuleOp      */ __Matchers[200] = _entryRangeExpression = new Mx.PlainRule(this, 200, "entry-range-expression") { Builder = nodes => nodes[0] };
                /* 201 PlainRuleOp      */ __Matchers[201] = _rangeExpr = new Mx.PlainRule(this, 201, "range-expr") { Builder = nodes => nodes[0] };
                /* 202 PlainRuleOp      */ __Matchers[202] = _entryExpr = new Mx.PlainRule(this, 202, "entry-expr") { Builder = nodes => nodes[0] };
                /* 203 PlainRuleOp      */ __Matchers[203] = _rangeOperator = new Mx.PlainRule(this, 203, "range-operator") { Creator = node => new CRangeOperator(node) };
                /* 204 PlainRuleOp      */ __Matchers[204] = _entryOperator = new Mx.PlainRule(this, 204, "entry-operator") { Creator = node => new CEntryOperator(node) };
                /* 205 PlainRuleOp      */ __Matchers[205] = _additiveExpression = new Mx.PlainRule(this, 205, "additive-expression") { Builder = nodes => nodes[0] };
                /* 206 PlainRuleOp      */ __Matchers[206] = _additiveExpr = new Mx.PlainRule(this, 206, "additive-expr") { Builder = nodes => nodes[0] };
                /* 207 PlainRuleOp      */ __Matchers[207] = _additiveOperator = new Mx.PlainRule(this, 207, "additive-operator") { Creator = node => new CAdditiveOperator(node) };
                /* 208 PlainRuleOp      */ __Matchers[208] = _scaleExpression = new Mx.PlainRule(this, 208, "scale-expression") { Builder = nodes => nodes[0] };
                /* 209 PlainRuleOp      */ __Matchers[209] = _scaleExpr = new Mx.PlainRule(this, 209, "scale-expr") { Builder = nodes => nodes[0] };
                /* 210 PlainRuleOp      */ __Matchers[210] = _scaleOperator = new Mx.PlainRule(this, 210, "scale-operator") { Creator = node => new CScaleOperator(node) };
                /* 211 PlainRuleOp      */ __Matchers[211] = _multiplicativeExpression = new Mx.PlainRule(this, 211, "multiplicative-expression") { Builder = nodes => nodes[0] };
                /* 212 PlainRuleOp      */ __Matchers[212] = _multiplicativeExpr = new Mx.PlainRule(this, 212, "multiplicative-expr") { Builder = nodes => nodes[0] };
                /* 213 PlainRuleOp      */ __Matchers[213] = _multiplicativeOperator = new Mx.PlainRule(this, 213, "multiplicative-operator") { Creator = node => new CMultiplicativeOperator(node) };
                /* 214 PlainRuleOp      */ __Matchers[214] = _unionExpression = new Mx.PlainRule(this, 214, "union-expression") { Builder = nodes => nodes[0] };
                /* 215 PlainRuleOp      */ __Matchers[215] = _unionExpr = new Mx.PlainRule(this, 215, "union-expr") { Builder = nodes => nodes[0] };
                /* 216 PlainRuleOp      */ __Matchers[216] = _unionOperator = new Mx.PlainRule(this, 216, "union-operator") { Creator = node => new CUnionOperator(node) };
                /* 217 PlainRuleOp      */ __Matchers[217] = _exclusiveExpression = new Mx.PlainRule(this, 217, "exclusive-expression") { Builder = nodes => nodes[0] };
                /* 218 PlainRuleOp      */ __Matchers[218] = _exclusiveExpr = new Mx.PlainRule(this, 218, "exclusive-expr") { Builder = nodes => nodes[0] };
                /* 219 PlainRuleOp      */ __Matchers[219] = _exclusiveOperator = new Mx.PlainRule(this, 219, "exclusive-operator") { Creator = node => new CExclusiveOperator(node) };
                /* 220 PlainRuleOp      */ __Matchers[220] = _intersectionExpression = new Mx.PlainRule(this, 220, "intersection-expression") { Builder = nodes => nodes[0] };
                /* 221 PlainRuleOp      */ __Matchers[221] = _intersectionExpr = new Mx.PlainRule(this, 221, "intersection-expr") { Builder = nodes => nodes[0] };
                /* 222 PlainRuleOp      */ __Matchers[222] = _intersectionOperator = new Mx.PlainRule(this, 222, "intersection-operator") { Creator = node => new CIntersectionOperator(node) };
                /* 223 PlainRuleOp      */ __Matchers[223] = _negationOrComplementExpression = new Mx.PlainRule(this, 223, "negation-or-complement-expression") { Builder = nodes => nodes[0] };
                /* 224 PlainRuleOp      */ __Matchers[224] = _negationOrComplementExpr = new Mx.PlainRule(this, 224, "negation-or-complement-expr") { Builder = nodes => nodes[0] };
                /* 225 PlainRuleOp      */ __Matchers[225] = _unaryMinusOrComplementOperator = new Mx.PlainRule(this, 225, "unary-minus-or-complement-operator") { Builder = nodes => nodes[0] };
                /* 226 PlainRuleOp      */ __Matchers[226] = _negateOperator = new Mx.PlainRule(this, 226, "negate-operator") { Builder = nodes => nodes[0] };
                /* 227 PlainRuleOp      */ __Matchers[227] = _neutralOperator = new Mx.PlainRule(this, 227, "neutral-operator") { Builder = nodes => nodes[0] };
                /* 228 PlainRuleOp      */ __Matchers[228] = _complementOperator = new Mx.PlainRule(this, 228, "complement-operator") { Creator = node => new CComplementOperator(node) };
                /* 229 PlainRuleOp      */ __Matchers[229] = _prefixExpression = new Mx.PlainRule(this, 229, "prefix-expression") { Builder = nodes => nodes[0] };
                /* 230 PlainRuleOp      */ __Matchers[230] = _prefixExpr = new Mx.PlainRule(this, 230, "prefix-expr") { Builder = nodes => nodes[0] };
                /* 231 PlainRuleOp      */ __Matchers[231] = _postfixExpression = new Mx.PlainRule(this, 231, "postfix-expression") { Builder = nodes => nodes[0] };
                /* 232 PlainRuleOp      */ __Matchers[232] = _postfixExpr = new Mx.PlainRule(this, 232, "postfix-expr") { Builder = nodes => nodes[0] };
                /* 233 PlainRuleOp      */ __Matchers[233] = _incrementOperator = new Mx.PlainRule(this, 233, "increment-operator") { Creator = node => new CIncrementOperator(node) };
                /* 234 PlainRuleOp      */ __Matchers[234] = _primary = new Mx.PlainRule(this, 234, "primary") { Builder = nodes => nodes[0] };
                /* 235 PlainRuleOp      */ __Matchers[235] = _selectionExpr = new Mx.PlainRule(this, 235, "selection-expr") { Builder = nodes => nodes[0] };
                /* 236 PlainRuleOp      */ __Matchers[236] = _memberSelectionOperator = new Mx.PlainRule(this, 236, "member-selection-operator") { Creator = node => new CMemberSelectionOperator(node) };
                /* 237 PlainRuleOp      */ __Matchers[237] = _indexedExpr = new Mx.PlainRule(this, 237, "indexed-expr") { Builder = nodes => nodes[0] };
                /* 238 PlainRuleOp      */ __Matchers[238] = _index = new Mx.PlainRule(this, 238, "index") { Builder = nodes => nodes[0] };
                /* 239 PlainRuleOp      */ __Matchers[239] = _upperSpanned = new Mx.PlainRule(this, 239, "upper-spanned") { Builder = nodes => nodes[0] };
                /* 240 PlainRuleOp      */ __Matchers[240] = _lowerSpanned = new Mx.PlainRule(this, 240, "lower-spanned") { Builder = nodes => nodes[0] };
                /* 241 PlainRuleOp      */ __Matchers[241] = _spanned = new Mx.PlainRule(this, 241, "spanned") { Builder = nodes => nodes[0] };
                /* 242 PlainRuleOp      */ __Matchers[242] = _measured = new Mx.PlainRule(this, 242, "measured") { Builder = nodes => nodes[0] };
                /* 243 PlainRuleOp      */ __Matchers[243] = _indexExpression = new Mx.PlainRule(this, 243, "index-expression") { Builder = nodes => nodes[0] };
                /* 244 PlainRuleOp      */ __Matchers[244] = _callExpr = new Mx.PlainRule(this, 244, "call-expr") { Builder = nodes => nodes[0] };
                /* 245 PlainRuleOp      */ __Matchers[245] = _baseExpression = new Mx.PlainRule(this, 245, "base-expression") { Builder = nodes => nodes[0] };
                /* 246 PlainRuleOp      */ __Matchers[246] = _nonstringLiteral = new Mx.PlainRule(this, 246, "nonstring-literal") { Builder = nodes => nodes[0] };
                /* 247 PlainRuleOp      */ __Matchers[247] = _stringExpression = new Mx.PlainRule(this, 247, "string-expression") { Builder = nodes => nodes[0] };
                /* 248 PlainRuleOp      */ __Matchers[248] = _stringInterpolation = new Mx.PlainRule(this, 248, "string-interpolation") { Builder = nodes => nodes[0] };
                /* 249 PlainRuleOp      */ __Matchers[249] = _interpolationPart = new Mx.PlainRule(this, 249, "interpolation-part") { Builder = nodes => nodes[0] };
                /* 250 PlainRuleOp      */ __Matchers[250] = _stringLiteral = new Mx.PlainRule(this, 250, "string-literal") { Builder = nodes => nodes[0] };
                /* 251 PlainRuleOp      */ __Matchers[251] = _objectExpr = new Mx.PlainRule(this, 251, "object-expr") { Builder = nodes => nodes[0] };
                /* 252 PlainRuleOp      */ __Matchers[252] = _groupedExpr = new Mx.PlainRule(this, 252, "grouped-expr") { Builder = nodes => nodes[0] };
                /* 253 PlainRuleOp      */ __Matchers[253] = _typeArguments = new Mx.PlainRule(this, 253, "type-arguments") { Builder = nodes => nodes[0] };
                /* 254 PlainRuleOp      */ __Matchers[254] = _typeArgumentList = new Mx.PlainRule(this, 254, "type-argument-list") { Builder = nodes => nodes[0] };
                /* 255 PlainRuleOp      */ __Matchers[255] = _variancedType = new Mx.PlainRule(this, 255, "varianced-type") { Builder = nodes => nodes[0] };
                /* 256 PlainRuleOp      */ __Matchers[256] = _defaultedTypeList = new Mx.PlainRule(this, 256, "defaulted-type-list") { Builder = nodes => nodes[0] };
                /* 257 PlainRuleOp      */ __Matchers[257] = _defaultedType = new Mx.PlainRule(this, 257, "defaulted-type") { Builder = nodes => nodes[0] };
                /* 258 PlainRuleOp      */ __Matchers[258] = _defaultedTypeCore = new Mx.PlainRule(this, 258, "defaulted-type-core") { Builder = nodes => nodes[0] };
                /* 259 PlainRuleOp      */ __Matchers[259] = _variadicType = new Mx.PlainRule(this, 259, "variadic-type") { Builder = nodes => nodes[0] };
                /* 260 PlainRuleOp      */ __Matchers[260] = _variadicTypeCore = new Mx.PlainRule(this, 260, "variadic-type-core") { Builder = nodes => nodes[0] };
                /* 261 PlainRuleOp      */ __Matchers[261] = _spreadType = new Mx.PlainRule(this, 261, "spread-type") { Builder = nodes => nodes[0] };
                /* 262 PlainRuleOp      */ __Matchers[262] = _type = new Mx.PlainRule(this, 262, "type") { Builder = nodes => nodes[0] };
                /* 263 PlainRuleOp      */ __Matchers[263] = _entryType = new Mx.PlainRule(this, 263, "entry-type") { Builder = nodes => nodes[0] };
                /* 264 PlainRuleOp      */ __Matchers[264] = _unionType = new Mx.PlainRule(this, 264, "union-type") { Builder = nodes => nodes[0] };
                /* 265 PlainRuleOp      */ __Matchers[265] = _unionTypeCore = new Mx.PlainRule(this, 265, "union-type-core") { Builder = nodes => nodes[0] };
                /* 266 PlainRuleOp      */ __Matchers[266] = _intersectionType = new Mx.PlainRule(this, 266, "intersection-type") { Builder = nodes => nodes[0] };
                /* 267 PlainRuleOp      */ __Matchers[267] = _intersectionTypeCore = new Mx.PlainRule(this, 267, "intersection-type-core") { Builder = nodes => nodes[0] };
                /* 268 PlainRuleOp      */ __Matchers[268] = _primaryType = new Mx.PlainRule(this, 268, "primary-type") { Builder = nodes => nodes[0] };
                /* 269 PlainRuleOp      */ __Matchers[269] = _nullableType = new Mx.PlainRule(this, 269, "nullable-type") { Builder = nodes => nodes[0] };
                /* 270 PlainRuleOp      */ __Matchers[270] = _arrayType = new Mx.PlainRule(this, 270, "array-type") { Builder = nodes => nodes[0] };
                /* 271 PlainRuleOp      */ __Matchers[271] = _functionType = new Mx.PlainRule(this, 271, "function-type") { Builder = nodes => nodes[0] };
                /* 272 PlainRuleOp      */ __Matchers[272] = _typeTypeArguments = new Mx.PlainRule(this, 272, "type-type-arguments") { Builder = nodes => nodes[0] };
                /* 273 PlainRuleOp      */ __Matchers[273] = _tupleType = new Mx.PlainRule(this, 273, "tuple-type") { Builder = nodes => nodes[0] };
                /* 274 PlainRuleOp      */ __Matchers[274] = _iterableType = new Mx.PlainRule(this, 274, "iterable-type") { Builder = nodes => nodes[0] };
                /* 275 PlainRuleOp      */ __Matchers[275] = _groupedType = new Mx.PlainRule(this, 275, "grouped-type") { Builder = nodes => nodes[0] };
                /* 276 PlainRuleOp      */ __Matchers[276] = _packageQualifiedType = new Mx.PlainRule(this, 276, "package-qualified-type") { Builder = nodes => nodes[0] };
                /* 277 PlainRuleOp      */ __Matchers[277] = _annotations = new Mx.PlainRule(this, 277, "annotations") { Builder = nodes => nodes[0] };
                /* 278 PlainRuleOp      */ __Matchers[278] = _annotation = new Mx.PlainRule(this, 278, "annotation") { Builder = nodes => nodes[0] };
                /* 279 PlainRuleOp      */ __Matchers[279] = _conditions = new Mx.PlainRule(this, 279, "conditions") { Builder = nodes => nodes[0] };
                /* 280 PlainRuleOp      */ __Matchers[280] = _conditionList = new Mx.PlainRule(this, 280, "condition-list") { Builder = nodes => nodes[0] };
                /* 281 PlainRuleOp      */ __Matchers[281] = _condition = new Mx.PlainRule(this, 281, "condition") { Builder = nodes => nodes[0] };
                /* 282 PlainRuleOp      */ __Matchers[282] = _existsCondition = new Mx.PlainRule(this, 282, "exists-condition") { Builder = nodes => nodes[0] };
                /* 283 PlainRuleOp      */ __Matchers[283] = _nonemptyCondition = new Mx.PlainRule(this, 283, "nonempty-condition") { Builder = nodes => nodes[0] };
                /* 284 PlainRuleOp      */ __Matchers[284] = _letOrExpression = new Mx.PlainRule(this, 284, "let-or-expression") { Builder = nodes => nodes[0] };
                /* 285 PlainRuleOp      */ __Matchers[285] = _isCondition = new Mx.PlainRule(this, 285, "is-condition") { Builder = nodes => nodes[0] };
                /* 286 PlainRuleOp      */ __Matchers[286] = _isConditionVariable = new Mx.PlainRule(this, 286, "is-condition-variable") { Builder = nodes => nodes[0] };
                /* 287 PlainRuleOp      */ __Matchers[287] = _satisfiesCondition = new Mx.PlainRule(this, 287, "satisfies-condition") { Builder = nodes => nodes[0] };
                /* 288 PlainRuleOp      */ __Matchers[288] = _booleanCondition = new Mx.PlainRule(this, 288, "boolean-condition") { Builder = nodes => nodes[0] };
                /* 289 PlainRuleOp      */ __Matchers[289] = _controlStatement = new Mx.PlainRule(this, 289, "control-statement") { Builder = nodes => nodes[0] };
                /* 290 PlainRuleOp      */ __Matchers[290] = _ifElseStatement = new Mx.PlainRule(this, 290, "if-else-statement") { Builder = nodes => nodes[0] };
                /* 291 PlainRuleOp      */ __Matchers[291] = _elseIf = new Mx.PlainRule(this, 291, "else-if") { Builder = nodes => nodes[0] };
                /* 292 PlainRuleOp      */ __Matchers[292] = _elseBlock = new Mx.PlainRule(this, 292, "else-block") { Builder = nodes => nodes[0] };
                /* 293 PlainRuleOp      */ __Matchers[293] = _switchStatement = new Mx.PlainRule(this, 293, "switch-statement") { Builder = nodes => nodes[0] };
                /* 294 PlainRuleOp      */ __Matchers[294] = _caseBlock = new Mx.PlainRule(this, 294, "case-block") { Builder = nodes => nodes[0] };
                /* 295 PlainRuleOp      */ __Matchers[295] = _caseItem = new Mx.PlainRule(this, 295, "case-item") { Builder = nodes => nodes[0] };
                /* 296 PlainRuleOp      */ __Matchers[296] = _isCaseCondition = new Mx.PlainRule(this, 296, "is-case-condition") { Builder = nodes => nodes[0] };
                /* 297 PlainRuleOp      */ __Matchers[297] = _satisfiesCaseCondition = new Mx.PlainRule(this, 297, "satisfies-case-condition") { Builder = nodes => nodes[0] };
                /* 298 PlainRuleOp      */ __Matchers[298] = _valueCaseList = new Mx.PlainRule(this, 298, "value-case-list") { Builder = nodes => nodes[0] };
                /* 299 PlainRuleOp      */ __Matchers[299] = _valueCaseSeparator = new Mx.PlainRule(this, 299, "value-case-separator") { Creator = node => new CValueCaseSeparator(node) };
                /* 300 PlainRuleOp      */ __Matchers[300] = _valueCase = new Mx.PlainRule(this, 300, "value-case") { Builder = nodes => nodes[0] };
                /* 301 PlainRuleOp      */ __Matchers[301] = _forElseStatement = new Mx.PlainRule(this, 301, "for-else-statement") { Builder = nodes => nodes[0] };
                /* 302 PlainRuleOp      */ __Matchers[302] = _forIterator = new Mx.PlainRule(this, 302, "for-iterator") { Builder = nodes => nodes[0] };
                /* 303 PlainRuleOp      */ __Matchers[303] = _forVariable = new Mx.PlainRule(this, 303, "for-variable") { Builder = nodes => nodes[0] };
                /* 304 PlainRuleOp      */ __Matchers[304] = _containment = new Mx.PlainRule(this, 304, "containment") { Builder = nodes => nodes[0] };
                /* 305 PlainRuleOp      */ __Matchers[305] = _containmentOperator = new Mx.PlainRule(this, 305, "containment-operator") { Creator = node => new CContainmentOperator(node) };
                /* 306 PlainRuleOp      */ __Matchers[306] = _whileStatement = new Mx.PlainRule(this, 306, "while-statement") { Builder = nodes => nodes[0] };
                /* 307 PlainRuleOp      */ __Matchers[307] = _tryStatement = new Mx.PlainRule(this, 307, "try-statement") { Builder = nodes => nodes[0] };
                /* 308 PlainRuleOp      */ __Matchers[308] = _catchBlock = new Mx.PlainRule(this, 308, "catch-block") { Builder = nodes => nodes[0] };
                /* 309 PlainRuleOp      */ __Matchers[309] = _finallyBlock = new Mx.PlainRule(this, 309, "finally-block") { Builder = nodes => nodes[0] };
                /* 310 PlainRuleOp      */ __Matchers[310] = _resources = new Mx.PlainRule(this, 310, "resources") { Builder = nodes => nodes[0] };
                /* 311 PlainRuleOp      */ __Matchers[311] = _resourceList = new Mx.PlainRule(this, 311, "resource-list") { Builder = nodes => nodes[0] };
                /* 312 PlainRuleOp      */ __Matchers[312] = _resource = new Mx.PlainRule(this, 312, "resource") { Builder = nodes => nodes[0] };
                /* 313 PlainRuleOp      */ __Matchers[313] = _specifiedOrExpression = new Mx.PlainRule(this, 313, "specified-or-expression") { Builder = nodes => nodes[0] };
                /* 314 PlainRuleOp      */ __Matchers[314] = _specifiedVariable = new Mx.PlainRule(this, 314, "specified-variable") { Builder = nodes => nodes[0] };
                /* 315 PlainRuleOp      */ __Matchers[315] = _variable = new Mx.PlainRule(this, 315, "variable") { Builder = nodes => nodes[0] };
                /* 316 PlainRuleOp      */ __Matchers[316] = _variableType = new Mx.PlainRule(this, 316, "variable-type") { Builder = nodes => nodes[0] };
                /* 317 PlainRuleOp      */ __Matchers[317] = _modelReference = new Mx.PlainRule(this, 317, "model-reference") { Builder = nodes => nodes[0] };
                /* 318 PlainRuleOp      */ __Matchers[318] = _metaLiteral = new Mx.PlainRule(this, 318, "meta-literal") { Builder = nodes => nodes[0] };
                /* 319 PlainRuleOp      */ __Matchers[319] = _metaExpression = new Mx.PlainRule(this, 319, "meta-expression") { Builder = nodes => nodes[0] };
                /* 320 PlainRuleOp      */ __Matchers[320] = _modelExpression = new Mx.PlainRule(this, 320, "model-expression") { Builder = nodes => nodes[0] };
                /* 321 PlainRuleOp      */ __Matchers[321] = _memberModelExpression = new Mx.PlainRule(this, 321, "member-model-expression") { Builder = nodes => nodes[0] };
                /* 322 PlainRuleOp      */ __Matchers[322] = _packageQualifiedMemberReference = new Mx.PlainRule(this, 322, "package-qualified-member-reference") { Builder = nodes => nodes[0] };
                /* 323 PlainRuleOp      */ __Matchers[323] = _typeQualifiedMemberReference = new Mx.PlainRule(this, 323, "type-qualified-member-reference") { Builder = nodes => nodes[0] };
                /* 324 PlainRuleOp      */ __Matchers[324] = _typeModelExpression = new Mx.PlainRule(this, 324, "type-model-expression") { Builder = nodes => nodes[0] };
                /* 325 PlainRuleOp      */ __Matchers[325] = _declarationReference = new Mx.PlainRule(this, 325, "declaration-reference") { Builder = nodes => nodes[0] };
                /* 326 PlainRuleOp      */ __Matchers[326] = _moduleLiteral = new Mx.PlainRule(this, 326, "module-literal") { Builder = nodes => nodes[0] };
                /* 327 PlainRuleOp      */ __Matchers[327] = _packageLiteral = new Mx.PlainRule(this, 327, "package-literal") { Builder = nodes => nodes[0] };
                /* 328 PlainRuleOp      */ __Matchers[328] = _classLiteral = new Mx.PlainRule(this, 328, "class-literal") { Builder = nodes => nodes[0] };
                /* 329 PlainRuleOp      */ __Matchers[329] = _interfaceLiteral = new Mx.PlainRule(this, 329, "interface-literal") { Builder = nodes => nodes[0] };
                /* 330 PlainRuleOp      */ __Matchers[330] = _aliasLiteral = new Mx.PlainRule(this, 330, "alias-literal") { Builder = nodes => nodes[0] };
                /* 331 PlainRuleOp      */ __Matchers[331] = _typeParameterLiteral = new Mx.PlainRule(this, 331, "type-parameter-literal") { Builder = nodes => nodes[0] };
                /* 332 PlainRuleOp      */ __Matchers[332] = _newLiteral = new Mx.PlainRule(this, 332, "new-literal") { Builder = nodes => nodes[0] };
                /* 333 PlainRuleOp      */ __Matchers[333] = _valueLiteral = new Mx.PlainRule(this, 333, "value-literal") { Builder = nodes => nodes[0] };
                /* 334 PlainRuleOp      */ __Matchers[334] = _objectLiteral = new Mx.PlainRule(this, 334, "object-literal") { Builder = nodes => nodes[0] };
                /* 335 PlainRuleOp      */ __Matchers[335] = _functionLiteral = new Mx.PlainRule(this, 335, "function-literal") { Builder = nodes => nodes[0] };
                /* 336 PlainRuleOp      */ __Matchers[336] = _packageQualifier = new Mx.PlainRule(this, 336, "package-qualifier") { Builder = nodes => nodes[0] };
                /* 337 PlainRuleOp      */ __Matchers[337] = _referencePath = new Mx.PlainRule(this, 337, "reference-path") { Builder = nodes => nodes[0] };
                /* 338 PlainRuleOp      */ __Matchers[338] = _referencePathElementList = new Mx.PlainRule(this, 338, "reference-path-element-list") { Builder = nodes => nodes[0] };
                /* 339 PlainRuleOp      */ __Matchers[339] = _referencePathElement = new Mx.PlainRule(this, 339, "reference-path-element") { Builder = nodes => nodes[0] };
                /* 340 PlainRuleOp      */ __Matchers[340] = _kwVoid = new Mx.PlainRule(this, 340, "kw-void") { Creator = node => new CKwVoid(node) };
                /* 341 PlainRuleOp      */ __Matchers[341] = _kwFunction = new Mx.PlainRule(this, 341, "kw-function") { Creator = node => new CKwFunction(node) };
                /* 342 PlainRuleOp      */ __Matchers[342] = _kwValue = new Mx.PlainRule(this, 342, "kw-value") { Creator = node => new CKwValue(node) };
                /* 343 DfaRuleOp        */ __Matchers[343] = _literalFloat = new Mx.DfaRule(this, 343, "literal-float") { Creator = node => new CLiteralFloat(node) };
                /* 344 DfaRuleOp        */ __Matchers[344] = _literalNatural = new Mx.DfaRule(this, 344, "literal-natural") { Creator = node => new CLiteralNatural(node) };
                /* 345 DfaRuleOp        */ __Matchers[345] = _literalChar = new Mx.DfaRule(this, 345, "literal-char") { Creator = node => new CLiteralChar(node) };
                /* 346 DfaRuleOp        */ __Matchers[346] = _stringStart = new Mx.DfaRule(this, 346, "string-start") { Creator = node => new CStringStart(node) };
                /* 347 DfaRuleOp        */ __Matchers[347] = _stringMid = new Mx.DfaRule(this, 347, "string-mid") { Creator = node => new CStringMid(node) };
                /* 348 DfaRuleOp        */ __Matchers[348] = _stringEnd = new Mx.DfaRule(this, 348, "string-end") { Creator = node => new CStringEnd(node) };
                /* 349 DfaRuleOp        */ __Matchers[349] = _literalString = new Mx.DfaRule(this, 349, "literal-string") { Creator = node => new CLiteralString(node) };
                /* 350 DfaRuleOp        */ __Matchers[350] = _verbatimString = new Mx.DfaRule(this, 350, "verbatim-string") { Creator = node => new CVerbatimString(node) };
                /* 351 DfaRuleOp        */ __Matchers[351] = _lowerIdentifier = new Mx.DfaRule(this, 351, "lower-identifier") { Creator = node => new CLowerIdentifier(node) };
                /* 352 DfaRuleOp        */ __Matchers[352] = _upperIdentifier = new Mx.DfaRule(this, 352, "upper-identifier") { Creator = node => new CUpperIdentifier(node) };
                /* 353 DfaRuleOp        */ __Matchers[353] = _identifier = new Mx.DfaRule(this, 353, "identifier") { Creator = node => new CIdentifier(node) };
                /* 354 EofOp            */ __Matchers[354] = new Mx.Eof(this, 354, "<eof>") { Creator = node => new REof(node) };
                /* 355 SeqOp            */ __Matchers[355] = new Mx.Seq(this, 355, "_355:(>compilation-unit,<eof>)") { Builder = nodes => new CXStart(nodes) };
                /* 356 AltOp            */ __Matchers[356] = new Mx.Alt(this, 356, "alt(>module-descriptor|>code-unit)") { Builder = nodes => nodes[0] };
                /* 357 SeqOp            */ __Matchers[357] = new Mx.Seq(this, 357, "_357:(>namespace,>imports,>top-declarations)") { Builder = nodes => new CCodeUnit(nodes) };
                /* 358 StringOp         */ __Matchers[358] = new Mx.Keyword(this, 358, "'namespace'", "namespace") { Creator = node => new RLiteral(node) };
                /* 359 StringOp         */ __Matchers[359] = new Mx.String(this, 359, "';'", ";") { Creator = node => new RLiteral(node) };
                /* 360 SeqOp            */ __Matchers[360] = new Mx.Seq(this, 360, "_360:(>annotations,'namespace',>namespace-path,';')") { Builder = nodes => new CNamespace(nodes) };
                /* 361 StringOp         */ __Matchers[361] = new Mx.String(this, 361, "'.'", ".") { Creator = node => new RLiteral(node) };
                /* 362 SeqOp            */ __Matchers[362] = new Mx.Seq(this, 362, "_362:('.',>identifier)") { Builder = nodes => new RSequence(nodes) };
                /* 363 StarOp           */ __Matchers[363] = new Mx.Star(this, 363, "*(_362:('.',>identifier))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 364 SeqOp            */ __Matchers[364] = new Mx.Seq(this, 364, "_364:(>identifier,*(_362:('.',>identifier)))") { Builder = nodes => new CNamespacePath(nodes) };
                /* 365 StarOp           */ __Matchers[365] = new Mx.Star(this, 365, "*(>import-declaration)") { Builder = nodes => new CImports(nodes) };
                /* 366 StringOp         */ __Matchers[366] = new Mx.Keyword(this, 366, "'module'", "module") { Creator = node => new RLiteral(node) };
                /* 367 OptionalOp       */ __Matchers[367] = new Mx.Optional(this, 367, "?(>version)") { Builder = nodes => new ROptional<ICVersion>(nodes) };
                /* 368 SeqOp            */ __Matchers[368] = new Mx.Seq(this, 368, "_368:(>annotations,'module',>module-name,?(>version),>module-body)") { Builder = nodes => new CModuleDescriptor(nodes) };
                /* 369 StringOp         */ __Matchers[369] = new Mx.String(this, 369, "'{'", "{") { Creator = node => new RLiteral(node) };
                /* 370 StarOp           */ __Matchers[370] = new Mx.Star(this, 370, "*(>module-body-element)") { Builder = nodes => new RStar<ICModuleBodyElement>(nodes) };
                /* 371 StringOp         */ __Matchers[371] = new Mx.String(this, 371, "'}'", "}") { Creator = node => new RLiteral(node) };
                /* 372 SeqOp            */ __Matchers[372] = new Mx.Seq(this, 372, "_372:('{',*(>module-body-element),'}')") { Builder = nodes => new CModuleBody(nodes) };
                /* 373 AltOp            */ __Matchers[373] = new Mx.Alt(this, 373, "alt(>inferred-attribute-declaration|>module-import)") { Builder = nodes => nodes[0] };
                /* 374 StringOp         */ __Matchers[374] = new Mx.Keyword(this, 374, "'import'", "import") { Creator = node => new RLiteral(node) };
                /* 375 SeqOp            */ __Matchers[375] = new Mx.Seq(this, 375, "_375:(>annotations,'import',>module-name,?(>version),';')") { Builder = nodes => new CModuleImport(nodes) };
                /* 376 StringOp         */ __Matchers[376] = new Mx.Keyword(this, 376, "'package'", "package") { Creator = node => new RLiteral(node) };
                /* 377 StringOp         */ __Matchers[377] = new Mx.String(this, 377, "':'", ":") { Creator = node => new RLiteral(node) };
                /* 378 SeqOp            */ __Matchers[378] = new Mx.Seq(this, 378, "_378:('import',>package-path,>import-elements)") { Builder = nodes => new CImportDeclaration(nodes) };
                /* 379 OptionalOp       */ __Matchers[379] = new Mx.Optional(this, 379, "?(>import-element-list)") { Builder = nodes => new ROptional<CImportElementList>(nodes) };
                /* 380 SeqOp            */ __Matchers[380] = new Mx.Seq(this, 380, "_380:('{',?(>import-element-list),'}')") { Builder = nodes => new CImportElements(nodes) };
                /* 381 StringOp         */ __Matchers[381] = new Mx.String(this, 381, "','", ",") { Creator = node => new RLiteral(node) };
                /* 382 SeqOp            */ __Matchers[382] = new Mx.Seq(this, 382, "_382:(',',>import-element)") { Builder = nodes => new RSequence(nodes) };
                /* 383 StarOp           */ __Matchers[383] = new Mx.Star(this, 383, "*(_382:(',',>import-element))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 384 SeqOp            */ __Matchers[384] = new Mx.Seq(this, 384, "_384:(>import-element,*(_382:(',',>import-element)))") { Builder = nodes => new CImportElementList(nodes) };
                /* 385 AltOp            */ __Matchers[385] = new Mx.Alt(this, 385, "alt(>import-named|>import-wildcard)") { Builder = nodes => nodes[0] };
                /* 386 OptionalOp       */ __Matchers[386] = new Mx.Optional(this, 386, "?(>import-name-specifier)") { Builder = nodes => new ROptional<CImportNameSpecifier>(nodes) };
                /* 387 OptionalOp       */ __Matchers[387] = new Mx.Optional(this, 387, "?(>import-elements)") { Builder = nodes => new ROptional<CImportElements>(nodes) };
                /* 388 SeqOp            */ __Matchers[388] = new Mx.Seq(this, 388, "_388:(>import-name,?(>import-name-specifier),?(>import-elements))") { Builder = nodes => new CImportNamed(nodes) };
                /* 389 StringOp         */ __Matchers[389] = new Mx.String(this, 389, "'='", "=") { Creator = node => new RLiteral(node) };
                /* 390 SeqOp            */ __Matchers[390] = new Mx.Seq(this, 390, "_390:('=',>identifier)") { Builder = nodes => new CImportNameSpecifier(nodes) };
                /* 391 StringOp         */ __Matchers[391] = new Mx.String(this, 391, "'...'", "...") { Creator = node => new CImportWildcard(node) };
                /* 392 SeqOp            */ __Matchers[392] = new Mx.Seq(this, 392, "_392:('.',>package-name)") { Builder = nodes => new RSequence(nodes) };
                /* 393 StarOp           */ __Matchers[393] = new Mx.Star(this, 393, "*(_392:('.',>package-name))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 394 SeqOp            */ __Matchers[394] = new Mx.Seq(this, 394, "_394:(>package-name,*(_392:('.',>package-name)))") { Builder = nodes => new CPackagePath(nodes) };
                /* 395 AltOp            */ __Matchers[395] = new Mx.Alt(this, 395, "alt(>entry-pattern|>tuple-pattern|>variable-pattern)") { Builder = nodes => nodes[0] };
                /* 396 StringOp         */ __Matchers[396] = new Mx.String(this, 396, "'->'", "->") { Creator = node => new CEntryOperator(node) };
                /* 397 SeqOp            */ __Matchers[397] = new Mx.Seq(this, 397, "_397:(>variable-or-tuple-pattern,'->',>variable-or-tuple-pattern)") { Builder = nodes => new CEntryPattern(nodes) };
                /* 398 AltOp            */ __Matchers[398] = new Mx.Alt(this, 398, "alt(>tuple-pattern|>variable-pattern)") { Builder = nodes => nodes[0] };
                /* 399 StringOp         */ __Matchers[399] = new Mx.String(this, 399, "'['", "[") { Creator = node => new RLiteral(node) };
                /* 400 OptionalOp       */ __Matchers[400] = new Mx.Optional(this, 400, "?(>variadic-pattern-list)") { Builder = nodes => new ROptional<CVariadicPatternList>(nodes) };
                /* 401 StringOp         */ __Matchers[401] = new Mx.String(this, 401, "']'", "]") { Creator = node => new RLiteral(node) };
                /* 402 SeqOp            */ __Matchers[402] = new Mx.Seq(this, 402, "_402:('[',?(>variadic-pattern-list),']')") { Builder = nodes => new CTuplePattern(nodes) };
                /* 403 SeqOp            */ __Matchers[403] = new Mx.Seq(this, 403, "_403:(',',>variadic-pattern)") { Builder = nodes => new RSequence(nodes) };
                /* 404 StarOp           */ __Matchers[404] = new Mx.Star(this, 404, "*(_403:(',',>variadic-pattern))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 405 SeqOp            */ __Matchers[405] = new Mx.Seq(this, 405, "_405:(>variadic-pattern,*(_403:(',',>variadic-pattern)))") { Builder = nodes => new CVariadicPatternList(nodes) };
                /* 406 AltOp            */ __Matchers[406] = new Mx.Alt(this, 406, "alt(>variadic-variable|>pattern)") { Builder = nodes => nodes[0] };
                /* 407 OptionalOp       */ __Matchers[407] = new Mx.Optional(this, 407, "?(>union-type)") { Builder = nodes => new ROptional<ICUnionType>(nodes) };
                /* 408 SeqOp            */ __Matchers[408] = new Mx.Seq(this, 408, "_408:(?(>union-type),>variadic-operator,>member-name)") { Builder = nodes => new CVariadicVariable(nodes) };
                /* 409 StringOp         */ __Matchers[409] = new Mx.String(this, 409, "'*'", "*") { Creator = node => new RLiteral(node) };
                /* 410 StringOp         */ __Matchers[410] = new Mx.String(this, 410, "'+'", "+") { Creator = node => new RLiteral(node) };
                /* 411 AltOp            */ __Matchers[411] = new Mx.Alt(this, 411, "alt('*'|'+')") { Builder = nodes => nodes[0] };
                /* 412 StringOp         */ __Matchers[412] = new Mx.Keyword(this, 412, "'let'", "let") { Creator = node => new RLiteral(node) };
                ...
                /* 415 SeqOp            */ __Matchers[415] = new Mx.Seq(this, 415, "_415:('let','(',>let-variable-list,')')") { Builder = nodes => new CLetStatement(nodes) };
                /* 416 SeqOp            */ __Matchers[416] = new Mx.Seq(this, 416, "_416:(',',>let-variable)") { Builder = nodes => new RSequence(nodes) };
                /* 417 StarOp           */ __Matchers[417] = new Mx.Star(this, 417, "*(_416:(',',>let-variable))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 418 SeqOp            */ __Matchers[418] = new Mx.Seq(this, 418, "_418:(>let-variable,*(_416:(',',>let-variable)))") { Builder = nodes => new CLetVariableList(nodes) };
                /* 419 SeqOp            */ __Matchers[419] = new Mx.Seq(this, 419, "_419:(>pattern,>value-specifier)") { Builder = nodes => new CLetVariable(nodes) };
                /* 420 StringOp         */ __Matchers[420] = new Mx.Keyword(this, 420, "'extends'", "extends") { Creator = node => new RLiteral(node) };
                /* 421 SeqOp            */ __Matchers[421] = new Mx.Seq(this, 421, "_421:('extends',>class-instantiation)") { Builder = nodes => new CDelegatedConstructor(nodes) };
                /* 422 OptionalOp       */ __Matchers[422] = new Mx.Optional(this, 422, "?(>assertion-message)") { Builder = nodes => new ROptional<ICAssertionMessage>(nodes) };
                /* 423 StringOp         */ __Matchers[423] = new Mx.Keyword(this, 423, "'assert'", "assert") { Creator = node => new RLiteral(node) };
                /* 424 SeqOp            */ __Matchers[424] = new Mx.Seq(this, 424, "_424:(?(>assertion-message),'assert',>conditions)") { Builder = nodes => new CAssertionStatement(nodes) };
                /* 425 SeqOp            */ __Matchers[425] = new Mx.Seq(this, 425, "_425:('{',>imports,>statements,'}')") { Builder = nodes => new CBlock(nodes) };
                /* 426 SeqOp            */ __Matchers[426] = new Mx.Seq(this, 426, "_426:('extends',>class-instantiation)") { Builder = nodes => new CExtendedType(nodes) };
                /* 427 StringOp         */ __Matchers[427] = new Mx.String(this, 427, "'=>'", "=>") { Creator = node => new RLiteral(node) };
                /* 428 SeqOp            */ __Matchers[428] = new Mx.Seq(this, 428, "_428:('=>',>class-instantiation)") { Builder = nodes => new CClassSpecifier(nodes) };
                /* 429 OptionalOp       */ __Matchers[429] = new Mx.Optional(this, 429, "?(>arguments)") { Builder = nodes => new ROptional<ICArguments>(nodes) };
                /* 430 SeqOp            */ __Matchers[430] = new Mx.Seq(this, 430, "_430:(>qualified-class,?(>arguments))") { Builder = nodes => new CClassInstantiation(nodes) };
                /* 431 AltOp            */ __Matchers[431] = new Mx.Alt(this, 431, "alt(>package-qualified-class|>super-qualified-class|>un-qualified-class)") { Builder = nodes => nodes[0] };
                /* 432 SeqOp            */ __Matchers[432] = new Mx.Seq(this, 432, "_432:('package','.',>un-qualified-class)") { Builder = nodes => new CPackageQualifiedClass(nodes) };
                /* 433 StringOp         */ __Matchers[433] = new Mx.Keyword(this, 433, "'super'", "super") { Creator = node => new RLiteral(node) };
                /* 434 SeqOp            */ __Matchers[434] = new Mx.Seq(this, 434, "_434:('super','.',>base-reference)") { Builder = nodes => new CSuperQualifiedClass(nodes) };
                /* 435 AltOp            */ __Matchers[435] = new Mx.Alt(this, 435, "alt(>member-path|>type-path|>member-reference)") { Builder = nodes => nodes[0] };
                /* 436 SeqOp            */ __Matchers[436] = new Mx.Seq(this, 436, "_436:(>type-path,'.',>member-reference)") { Builder = nodes => new CMemberPath(nodes) };
                /* 437 SeqOp            */ __Matchers[437] = new Mx.Seq(this, 437, "_437:('.',>type-reference)") { Builder = nodes => new RSequence(nodes) };
                /* 438 StarOp           */ __Matchers[438] = new Mx.Star(this, 438, "*(_437:('.',>type-reference))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 439 SeqOp            */ __Matchers[439] = new Mx.Seq(this, 439, "_439:(>type-reference,*(_437:('.',>type-reference)))") { Builder = nodes => new CTypePath(nodes) };
                /* 440 StringOp         */ __Matchers[440] = new Mx.Keyword(this, 440, "'satisfies'", "satisfies") { Creator = node => new RLiteral(node) };
                /* 441 SeqOp            */ __Matchers[441] = new Mx.Seq(this, 441, "_441:('satisfies',>union-type-list)") { Builder = nodes => new CSatisfiedTypes(nodes) };
                /* 442 SeqOp            */ __Matchers[442] = new Mx.Seq(this, 442, "_442:(',',>union-type)") { Builder = nodes => new RSequence(nodes) };
                /* 443 StarOp           */ __Matchers[443] = new Mx.Star(this, 443, "*(_442:(',',>union-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 444 SeqOp            */ __Matchers[444] = new Mx.Seq(this, 444, "_444:(>union-type,*(_442:(',',>union-type)))") { Builder = nodes => new CUnionTypeList(nodes) };
                /* 445 StringOp         */ __Matchers[445] = new Mx.Keyword(this, 445, "'of'", "of") { Creator = node => new RLiteral(node) };
                /* 446 SeqOp            */ __Matchers[446] = new Mx.Seq(this, 446, "_446:('of',>case-type-list)") { Builder = nodes => new CCaseTypes(nodes) };
                /* 447 StringOp         */ __Matchers[447] = new Mx.String(this, 447, "'|'", "|") { Creator = node => new RLiteral(node) };
                /* 448 SeqOp            */ __Matchers[448] = new Mx.Seq(this, 448, "_448:('|',>case-type)") { Builder = nodes => new RSequence(nodes) };
                /* 449 StarOp           */ __Matchers[449] = new Mx.Star(this, 449, "*(_448:('|',>case-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 450 SeqOp            */ __Matchers[450] = new Mx.Seq(this, 450, "_450:(>case-type,*(_448:('|',>case-type)))") { Builder = nodes => new CCaseTypeList(nodes) };
                /* 451 AltOp            */ __Matchers[451] = new Mx.Alt(this, 451, "alt(>primary-type|>qualified-case-type)") { Builder = nodes => nodes[0] };
                /* 452 OptionalOp       */ __Matchers[452] = new Mx.Optional(this, 452, "?(>package-qualifier)") { Builder = nodes => new ROptional<CPackageQualifier>(nodes) };
                /* 453 SeqOp            */ __Matchers[453] = new Mx.Seq(this, 453, "_453:(?(>package-qualifier),>member-name)") { Builder = nodes => new CQualifiedCaseType(nodes) };
                /* 454 OptionalOp       */ __Matchers[454] = new Mx.Optional(this, 454, "?(>parameter-list)") { Builder = nodes => new ROptional<CParameterList>(nodes) };
                /* 455 SeqOp            */ __Matchers[455] = new Mx.Seq(this, 455, "_455:('(',?(>parameter-list),')')") { Builder = nodes => new CParameters(nodes) };
                /* 456 SeqOp            */ __Matchers[456] = new Mx.Seq(this, 456, "_456:(',',>parameter-declaration-or-ref-pattern)") { Builder = nodes => new RSequence(nodes) };
                /* 457 StarOp           */ __Matchers[457] = new Mx.Star(this, 457, "*(_456:(',',>parameter-declaration-or-ref-pattern))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 458 SeqOp            */ __Matchers[458] = new Mx.Seq(this, 458, "_458:(>parameter-declaration-or-ref-pattern,*(_456:(',',>parameter-declaration-or-ref-pattern)))") { Builder = nodes => new CParameterList(nodes) };
                /* 459 AltOp            */ __Matchers[459] = new Mx.Alt(this, 459, "alt(>entry-pattern|>tuple-pattern|>parameter|>parameter-reference)") { Builder = nodes => nodes[0] };
                /* 460 SeqOp            */ __Matchers[460] = new Mx.Seq(this, 460, "_460:(>annotations,>parameter-declaration)") { Builder = nodes => new CParameter(nodes) };
                /* 461 OptionalOp       */ __Matchers[461] = new Mx.Optional(this, 461, "?(>value-specifier)") { Builder = nodes => new ROptional<CValueSpecifier>(nodes) };
                /* 462 SeqOp            */ __Matchers[462] = new Mx.Seq(this, 462, "_462:(>member-name,?(>value-specifier))") { Builder = nodes => new CParameterReference(nodes) };
                /* 463 AltOp            */ __Matchers[463] = new Mx.Alt(this, 463, "alt(>function-parameter-declaration|>value-parameter-declaration)") { Builder = nodes => nodes[0] };
                /* 464 AltOp            */ __Matchers[464] = new Mx.Alt(this, 464, "alt(>void-function-parameter|>inferred-function-parameter|>typed-function-parameter)") { Builder = nodes => nodes[0] };
                /* 465 StringOp         */ __Matchers[465] = new Mx.Keyword(this, 465, "'void'", "void") { Creator = node => new CKwVoid(node) };
                /* 466 OptionalOp       */ __Matchers[466] = new Mx.Optional(this, 466, "?(>type-parameters)") { Builder = nodes => new ROptional<CTypeParameters>(nodes) };
                /* 467 PlusOp           */ __Matchers[467] = new Mx.Plus(this, 467, "+(>parameters)") { Builder = nodes => new RPlus<CParameters>(nodes) };
                /* 468 OptionalOp       */ __Matchers[468] = new Mx.Optional(this, 468, "?(>function-specifier)") { Builder = nodes => new ROptional<CFunctionSpecifier>(nodes) };
                /* 469 SeqOp            */ __Matchers[469] = new Mx.Seq(this, 469, "_469:('void',>member-name,?(>type-parameters),+(>parameters),?(>function-specifier))") { Builder = nodes => new CVoidFunctionParameter(nodes) };
                /* 470 StringOp         */ __Matchers[470] = new Mx.Keyword(this, 470, "'function'", "function") { Creator = node => new CKwFunction(node) };
                /* 471 SeqOp            */ __Matchers[471] = new Mx.Seq(this, 471, "_471:('function',>member-name,?(>type-parameters),+(>parameters),?(>function-specifier))") { Builder = nodes => new CInferredFunctionParameter(nodes) };
                /* 472 SeqOp            */ __Matchers[472] = new Mx.Seq(this, 472, "_472:(>variadic-type,>member-name,?(>type-parameters),+(>parameters),?(>function-specifier))") { Builder = nodes => new CTypedFunctionParameter(nodes) };
                /* 473 AltOp            */ __Matchers[473] = new Mx.Alt(this, 473, "alt(>inferred-value-parameter|>typed-value-parameter)") { Builder = nodes => nodes[0] };
                /* 474 StringOp         */ __Matchers[474] = new Mx.Keyword(this, 474, "'value'", "value") { Creator = node => new CKwValue(node) };
                /* 475 SeqOp            */ __Matchers[475] = new Mx.Seq(this, 475, "_475:('value',>member-name,?(>value-specifier))") { Builder = nodes => new CInferredValueParameter(nodes) };
                /* 476 SeqOp            */ __Matchers[476] = new Mx.Seq(this, 476, "_476:(>variadic-type,>member-name,?(>value-specifier))") { Builder = nodes => new CTypedValueParameter(nodes) };
                /* 477 StringOp         */ __Matchers[477] = new Mx.String(this, 477, "'<'", "<") { Creator = node => new RLiteral(node) };
                /* 478 StringOp         */ __Matchers[478] = new Mx.String(this, 478, "'>'", ">") { Creator = node => new RLiteral(node) };
                /* 479 SeqOp            */ __Matchers[479] = new Mx.Seq(this, 479, "_479:('<',>type-parameter-list,'>')") { Builder = nodes => new CTypeParameters(nodes) };
                /* 480 SeqOp            */ __Matchers[480] = new Mx.Seq(this, 480, "_480:(',',>type-parameter)") { Builder = nodes => new RSequence(nodes) };
                /* 481 StarOp           */ __Matchers[481] = new Mx.Star(this, 481, "*(_480:(',',>type-parameter))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 482 SeqOp            */ __Matchers[482] = new Mx.Seq(this, 482, "_482:(>type-parameter,*(_480:(',',>type-parameter)))") { Builder = nodes => new CTypeParameterList(nodes) };
                /* 483 OptionalOp       */ __Matchers[483] = new Mx.Optional(this, 483, "?(>variance)") { Builder = nodes => new ROptional<ICVariance>(nodes) };
                /* 484 OptionalOp       */ __Matchers[484] = new Mx.Optional(this, 484, "?(>type-default)") { Builder = nodes => new ROptional<CTypeDefault>(nodes) };
                /* 485 SeqOp            */ __Matchers[485] = new Mx.Seq(this, 485, "_485:(?(>variance),>type-name,?(>type-default))") { Builder = nodes => new CTypeParameter(nodes) };
                /* 486 StringOp         */ __Matchers[486] = new Mx.Keyword(this, 486, "'in'", "in") { Creator = node => new RLiteral(node) };
                /* 487 StringOp         */ __Matchers[487] = new Mx.Keyword(this, 487, "'out'", "out") { Creator = node => new RLiteral(node) };
                /* 488 AltOp            */ __Matchers[488] = new Mx.Alt(this, 488, "alt('in'|'out')") { Builder = nodes => nodes[0] };
                /* 489 SeqOp            */ __Matchers[489] = new Mx.Seq(this, 489, "_489:('=',>type)") { Builder = nodes => new CTypeDefault(nodes) };
                /* 490 StringOp         */ __Matchers[490] = new Mx.Keyword(this, 490, "'given'", "given") { Creator = node => new RLiteral(node) };
                /* 491 OptionalOp       */ __Matchers[491] = new Mx.Optional(this, 491, "?(>type-name)") { Builder = nodes => new ROptional<ICTypeName>(nodes) };
                /* 492 OptionalOp       */ __Matchers[492] = new Mx.Optional(this, 492, "?(>case-types)") { Builder = nodes => new ROptional<CCaseTypes>(nodes) };
                /* 493 OptionalOp       */ __Matchers[493] = new Mx.Optional(this, 493, "?(>satisfied-types)") { Builder = nodes => new ROptional<CSatisfiedTypes>(nodes) };
                /* 494 SeqOp            */ __Matchers[494] = new Mx.Seq(this, 494, "_494:('given',?(>type-name),?(>type-parameters),?(>case-types),?(>satisfied-types))") { Builder = nodes => new CTypeConstraint(nodes) };
                /* 495 PlusOp           */ __Matchers[495] = new Mx.Plus(this, 495, "+(>type-constraint)") { Builder = nodes => new CTypeConstraints(nodes) };
                /* 496 StarOp           */ __Matchers[496] = new Mx.Star(this, 496, "*(>top-declaration)") { Builder = nodes => new CTopDeclarations(nodes) };
                /* 497 AltOp            */ __Matchers[497] = new Mx.Alt(this, 497, "alt(>class-declaration|>interface-declaration|>alias-declaration|>object-declaration|>setter-declaration|>typed-method-declaration|>void-method-declaration|>inferred-method-declaration|>typed-attribute-declaration|>inferred-attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 498 AltOp            */ __Matchers[498] = new Mx.Alt(this, 498, "alt(>class-declaration|>interface-declaration|>alias-declaration|>object-declaration|>constructor-declaration|>enumerated-object-declaration|>setter-declaration|>typed-method-declaration|>void-method-declaration|>inferred-method-declaration|>typed-attribute-declaration|>inferred-attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 499 StringOp         */ __Matchers[499] = new Mx.Keyword(this, 499, "'new'", "new") { Creator = node => new RLiteral(node) };
                /* 500 OptionalOp       */ __Matchers[500] = new Mx.Optional(this, 500, "?(>member-name)") { Builder = nodes => new ROptional<ICMemberName>(nodes) };
                /* 501 OptionalOp       */ __Matchers[501] = new Mx.Optional(this, 501, "?(>delegated-constructor)") { Builder = nodes => new ROptional<CDelegatedConstructor>(nodes) };
                /* 502 SeqOp            */ __Matchers[502] = new Mx.Seq(this, 502, "_502:(>annotations,'new',?(>member-name),>parameters,?(>delegated-constructor),>block)") { Builder = nodes => new CConstructorDeclaration(nodes) };
                /* 503 StringOp         */ __Matchers[503] = new Mx.Keyword(this, 503, "'alias'", "alias") { Creator = node => new RLiteral(node) };
                /* 504 OptionalOp       */ __Matchers[504] = new Mx.Optional(this, 504, "?(>type-constraints)") { Builder = nodes => new ROptional<CTypeConstraints>(nodes) };
                /* 505 SeqOp            */ __Matchers[505] = new Mx.Seq(this, 505, "_505:(>annotations,'alias',>type-name,?(>type-parameters),?(>type-constraints),>optional-type-specifier)") { Builder = nodes => new CAliasDeclaration(nodes) };
                /* 506 SeqOp            */ __Matchers[506] = new Mx.Seq(this, 506, "_506:(>annotations,'new',>member-name,?(>delegated-constructor),>block)") { Builder = nodes => new CEnumeratedObjectDeclaration(nodes) };
                /* 507 StringOp         */ __Matchers[507] = new Mx.Keyword(this, 507, "'object'", "object") { Creator = node => new RLiteral(node) };
                /* 508 OptionalOp       */ __Matchers[508] = new Mx.Optional(this, 508, "?(>extended-type)") { Builder = nodes => new ROptional<CExtendedType>(nodes) };
                /* 509 SeqOp            */ __Matchers[509] = new Mx.Seq(this, 509, "_509:(>annotations,'object',>member-name,?(>extended-type),?(>satisfied-types),>block)") { Builder = nodes => new CObjectDeclaration(nodes) };
                /* 510 StringOp         */ __Matchers[510] = new Mx.Keyword(this, 510, "'assign'", "assign") { Creator = node => new RLiteral(node) };
                /* 511 SeqOp            */ __Matchers[511] = new Mx.Seq(this, 511, "_511:(>annotations,'assign',>member-name,>setter-definition)") { Builder = nodes => new CSetterDeclaration(nodes) };
                /* 512 AltOp            */ __Matchers[512] = new Mx.Alt(this, 512, "alt(>block|>required-function-specifier)") { Builder = nodes => nodes[0] };
                /* 513 SeqOp            */ __Matchers[513] = new Mx.Seq(this, 513, "_513:(>annotations,'void',>member-name,?(>type-parameters),+(>parameters),?(>type-constraints),>method-definition)") { Builder = nodes => new CVoidMethodDeclaration(nodes) };
                /* 514 SeqOp            */ __Matchers[514] = new Mx.Seq(this, 514, "_514:(>annotations,'function',>member-name,?(>type-parameters),+(>parameters),?(>type-constraints),>method-definition)") { Builder = nodes => new CInferredMethodDeclaration(nodes) };
                /* 515 SeqOp            */ __Matchers[515] = new Mx.Seq(this, 515, "_515:(>annotations,>variadic-type,>member-name,?(>type-parameters),+(>parameters),?(>type-constraints),>method-definition)") { Builder = nodes => new CTypedMethodDeclaration(nodes) };
                /* 516 AltOp            */ __Matchers[516] = new Mx.Alt(this, 516, "alt(>block|>optional-function-specifier)") { Builder = nodes => nodes[0] };
                /* 517 SeqOp            */ __Matchers[517] = new Mx.Seq(this, 517, "_517:(>annotations,>variadic-type,>member-name,>attribute-definition)") { Builder = nodes => new CTypedAttributeDeclaration(nodes) };
                /* 518 SeqOp            */ __Matchers[518] = new Mx.Seq(this, 518, "_518:(>annotations,'value',>member-name,>attribute-definition)") { Builder = nodes => new CInferredAttributeDeclaration(nodes) };
                /* 519 AltOp            */ __Matchers[519] = new Mx.Alt(this, 519, "alt(>block|>optional-any-specifier)") { Builder = nodes => nodes[0] };
                /* 520 StringOp         */ __Matchers[520] = new Mx.Keyword(this, 520, "'class'", "class") { Creator = node => new RLiteral(node) };
                /* 521 OptionalOp       */ __Matchers[521] = new Mx.Optional(this, 521, "?(>parameters)") { Builder = nodes => new ROptional<CParameters>(nodes) };
                /* 522 SeqOp            */ __Matchers[522] = new Mx.Seq(this, 522, "_522:(>annotations,'class',>type-name,?(>type-parameters),?(>parameters),?(>case-types),?(>extended-type),?(>satisfied-types),?(>type-constraints),>class-definition)") { Builder = nodes => new CClassDeclaration(nodes) };
                /* 523 AltOp            */ __Matchers[523] = new Mx.Alt(this, 523, "alt(>block|>optional-class-specifier)") { Builder = nodes => nodes[0] };
                /* 524 OptionalOp       */ __Matchers[524] = new Mx.Optional(this, 524, "?(>class-specifier)") { Builder = nodes => new ROptional<CClassSpecifier>(nodes) };
                /* 525 SeqOp            */ __Matchers[525] = new Mx.Seq(this, 525, "_525:(?(>class-specifier),';')") { Builder = nodes => new COptionalClassSpecifier(nodes) };
                /* 526 StringOp         */ __Matchers[526] = new Mx.Keyword(this, 526, "'interface'", "interface") { Creator = node => new RLiteral(node) };
                /* 527 SeqOp            */ __Matchers[527] = new Mx.Seq(this, 527, "_527:(>annotations,'interface',>type-name,?(>type-parameters),?(>case-types),?(>satisfied-types),?(>type-constraints),>interface-definition)") { Builder = nodes => new CInterfaceDeclaration(nodes) };
                /* 528 AltOp            */ __Matchers[528] = new Mx.Alt(this, 528, "alt(>block|>optional-type-specifier)") { Builder = nodes => nodes[0] };
                /* 529 StarOp           */ __Matchers[529] = new Mx.Star(this, 529, "*(>statement)") { Builder = nodes => new CStatements(nodes) };
                /* 530 AltOp            */ __Matchers[530] = new Mx.Alt(this, 530, "alt(>declaration-statement|>unclosed-statement|>control-statement)") { Builder = nodes => nodes[0] };
                /* 531 SeqOp            */ __Matchers[531] = new Mx.Seq(this, 531, "_531:(>open-statement,';')") { Builder = nodes => new CUnclosedStatement(nodes) };
                /* 532 AltOp            */ __Matchers[532] = new Mx.Alt(this, 532, "alt(>return-statement|>throw-statement|>break-statement|>continue-statement|>expression-statement|>specification-statement|>assertion-statement|>let-statement)") { Builder = nodes => nodes[0] };
                /* 533 SeqOp            */ __Matchers[533] = new Mx.Seq(this, 533, "_533:(>primary,>function-specifier)") { Builder = nodes => new CSpecificationStatement(nodes) };
                /* 534 StringOp         */ __Matchers[534] = new Mx.Keyword(this, 534, "'return'", "return") { Creator = node => new RLiteral(node) };
                /* 535 OptionalOp       */ __Matchers[535] = new Mx.Optional(this, 535, "?(>expression)") { Builder = nodes => new ROptional<ICExpression>(nodes) };
                /* 536 SeqOp            */ __Matchers[536] = new Mx.Seq(this, 536, "_536:('return',?(>expression))") { Builder = nodes => new CReturnStatement(nodes) };
                /* 537 StringOp         */ __Matchers[537] = new Mx.Keyword(this, 537, "'throw'", "throw") { Creator = node => new RLiteral(node) };
                /* 538 SeqOp            */ __Matchers[538] = new Mx.Seq(this, 538, "_538:('throw',?(>expression))") { Builder = nodes => new CThrowStatement(nodes) };
                /* 539 StringOp         */ __Matchers[539] = new Mx.Keyword(this, 539, "'break'", "break") { Creator = node => new CBreakStatement(node) };
                /* 540 StringOp         */ __Matchers[540] = new Mx.Keyword(this, 540, "'continue'", "continue") { Creator = node => new CContinueStatement(node) };
                /* 541 SeqOp            */ __Matchers[541] = new Mx.Seq(this, 541, "_541:('=',>expression)") { Builder = nodes => new CValueSpecifier(nodes) };
                /* 542 SeqOp            */ __Matchers[542] = new Mx.Seq(this, 542, "_542:('=>',>expression)") { Builder = nodes => new CFunctionSpecifier(nodes) };
                /* 543 SeqOp            */ __Matchers[543] = new Mx.Seq(this, 543, "_543:(?(>function-specifier),';')") { Builder = nodes => new COptionalFunctionSpecifier(nodes) };
                /* 544 SeqOp            */ __Matchers[544] = new Mx.Seq(this, 544, "_544:(>function-specifier,';')") { Builder = nodes => new CRequiredFunctionSpecifier(nodes) };
                /* 545 SeqOp            */ __Matchers[545] = new Mx.Seq(this, 545, "_545:('=>',>type)") { Builder = nodes => new CTypeSpecifier(nodes) };
                /* 546 OptionalOp       */ __Matchers[546] = new Mx.Optional(this, 546, "?(>type-specifier)") { Builder = nodes => new ROptional<CTypeSpecifier>(nodes) };
                /* 547 SeqOp            */ __Matchers[547] = new Mx.Seq(this, 547, "_547:(?(>type-specifier),';')") { Builder = nodes => new COptionalTypeSpecifier(nodes) };
                /* 548 AltOp            */ __Matchers[548] = new Mx.Alt(this, 548, "alt(>value-specifier|>function-specifier)") { Builder = nodes => nodes[0] };
                /* 549 OptionalOp       */ __Matchers[549] = new Mx.Optional(this, 549, "?(>any-specifier)") { Builder = nodes => new ROptional<ICAnySpecifier>(nodes) };
                /* 550 SeqOp            */ __Matchers[550] = new Mx.Seq(this, 550, "_550:(?(>any-specifier),';')") { Builder = nodes => new COptionalAnySpecifier(nodes) };
                /* 551 AltOp            */ __Matchers[551] = new Mx.Alt(this, 551, "alt(>base-reference|>self-reference|>parametrized-member|>self-parametrized-member)") { Builder = nodes => nodes[0] };
                /* 552 AltOp            */ __Matchers[552] = new Mx.Alt(this, 552, "alt(>member-reference|>type-reference)") { Builder = nodes => nodes[0] };
                /* 553 SeqOp            */ __Matchers[553] = new Mx.Seq(this, 553, "_553:(>member-name,?(>type-parameters),+(>parameters))") { Builder = nodes => new CParametrizedMember(nodes) };
                /* 554 SeqOp            */ __Matchers[554] = new Mx.Seq(this, 554, "_554:(>self-reference-selector,>parametrized-member)") { Builder = nodes => new CSelfParametrizedMember(nodes) };
                /* 555 OptionalOp       */ __Matchers[555] = new Mx.Optional(this, 555, "?(>type-arguments)") { Builder = nodes => new ROptional<CTypeArguments>(nodes) };
                /* 556 SeqOp            */ __Matchers[556] = new Mx.Seq(this, 556, "_556:(>member-name,?(>type-arguments))") { Builder = nodes => new CMemberReference(nodes) };
                /* 557 SeqOp            */ __Matchers[557] = new Mx.Seq(this, 557, "_557:(>type-name,?(>type-arguments))") { Builder = nodes => new CTypeReference(nodes) };
                /* 558 SeqOp            */ __Matchers[558] = new Mx.Seq(this, 558, "_558:(>self-reference,>member-selection-operator)") { Builder = nodes => new CSelfReferenceSelector(nodes) };
                /* 559 StringOp         */ __Matchers[559] = new Mx.Keyword(this, 559, "'this'", "this") { Creator = node => new RLiteral(node) };
                /* 560 StringOp         */ __Matchers[560] = new Mx.Keyword(this, 560, "'outer'", "outer") { Creator = node => new RLiteral(node) };
                /* 561 AltOp            */ __Matchers[561] = new Mx.Alt(this, 561, "alt('this'|'super'|'outer'|'package')") { Builder = nodes => nodes[0] };
                /* 562 OptionalOp       */ __Matchers[562] = new Mx.Optional(this, 562, "?(>sequenced-argument-list)") { Builder = nodes => new ROptional<CSequencedArgumentList>(nodes) };
                /* 563 SeqOp            */ __Matchers[563] = new Mx.Seq(this, 563, "_563:('{',>statements,?(>sequenced-argument-list),'}')") { Builder = nodes => new CEnumerationExpr(nodes) };
                /* 564 SeqOp            */ __Matchers[564] = new Mx.Seq(this, 564, "_564:('[',?(>sequenced-argument-list),']')") { Builder = nodes => new CTupleExpr(nodes) };
                /* 565 AltOp            */ __Matchers[565] = new Mx.Alt(this, 565, "alt(>patterned-arguments|>positional-arguments)") { Builder = nodes => nodes[0] };
                /* 566 StarOp           */ __Matchers[566] = new Mx.Star(this, 566, "*(>structured-argument)") { Builder = nodes => new RStar<ICStructuredArgument>(nodes) };
                /* 567 SeqOp            */ __Matchers[567] = new Mx.Seq(this, 567, "_567:('{',*(>structured-argument),?(>sequenced-argument-list),'}')") { Builder = nodes => new CPatternedArguments(nodes) };
                /* 568 SeqOp            */ __Matchers[568] = new Mx.Seq(this, 568, "_568:('(',?(>sequenced-argument-list),')')") { Builder = nodes => new CPositionalArguments(nodes) };
                /* 569 AltOp            */ __Matchers[569] = new Mx.Alt(this, 569, "alt(>anonymous-argument|>named-argument)") { Builder = nodes => nodes[0] };
                /* 570 SeqOp            */ __Matchers[570] = new Mx.Seq(this, 570, "_570:(>expression,';')") { Builder = nodes => new CAnonymousArgument(nodes) };
                /* 571 AltOp            */ __Matchers[571] = new Mx.Alt(this, 571, "alt(>named-specified-argument|>named-argument-declaration)") { Builder = nodes => nodes[0] };
                /* 572 SeqOp            */ __Matchers[572] = new Mx.Seq(this, 572, "_572:(>member-name,>value-specifier,';')") { Builder = nodes => new CNamedSpecifiedArgument(nodes) };
                /* 573 SeqOp            */ __Matchers[573] = new Mx.Seq(this, 573, "_573:(',',>sequenced-argument)") { Builder = nodes => new RSequence(nodes) };
                /* 574 StarOp           */ __Matchers[574] = new Mx.Star(this, 574, "*(_573:(',',>sequenced-argument))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 575 SeqOp            */ __Matchers[575] = new Mx.Seq(this, 575, "_575:(>sequenced-argument,*(_573:(',',>sequenced-argument)))") { Builder = nodes => new CSequencedArgumentList(nodes) };
                /* 576 AltOp            */ __Matchers[576] = new Mx.Alt(this, 576, "alt(>comprehension-argument|>positional-argument|>spread-argument)") { Builder = nodes => nodes[0] };
                /* 577 AltOp            */ __Matchers[577] = new Mx.Alt(this, 577, "alt(>object-argument|>typed-method-argument|>inferred-method-argument|>untyped-method-argument|>typed-getter-argument|>inferred-getter-argument|>untyped-getter-argument)") { Builder = nodes => nodes[0] };
                /* 578 SeqOp            */ __Matchers[578] = new Mx.Seq(this, 578, "_578:('object',?(>member-name),?(>extended-type),?(>satisfied-types),>block)") { Builder = nodes => new CObjectArgument(nodes) };
                /* 579 SeqOp            */ __Matchers[579] = new Mx.Seq(this, 579, "_579:(>type,>parametrized-member,>method-definition)") { Builder = nodes => new CTypedMethodArgument(nodes) };
                /* 580 SeqOp            */ __Matchers[580] = new Mx.Seq(this, 580, "_580:('function',?(>member-name),?(>type-parameters),>parameters,>method-definition)") { Builder = nodes => new CInferredMethodArgument(nodes) };
                /* 581 SeqOp            */ __Matchers[581] = new Mx.Seq(this, 581, "_581:(>member-name,+(>parameters),>required-function-specifier)") { Builder = nodes => new CUntypedMethodArgument(nodes) };
                /* 582 SeqOp            */ __Matchers[582] = new Mx.Seq(this, 582, "_582:(>type,>member-name,>method-definition)") { Builder = nodes => new CTypedGetterArgument(nodes) };
                /* 583 SeqOp            */ __Matchers[583] = new Mx.Seq(this, 583, "_583:('value',>member-name,>method-definition)") { Builder = nodes => new CInferredGetterArgument(nodes) };
                /* 584 SeqOp            */ __Matchers[584] = new Mx.Seq(this, 584, "_584:(>member-name,>required-function-specifier)") { Builder = nodes => new CUntypedGetterArgument(nodes) };
                /* 585 AltOp            */ __Matchers[585] = new Mx.Alt(this, 585, "alt(>expression-argument|>declaration-reference)") { Builder = nodes => nodes[0] };
                /* 586 SeqOp            */ __Matchers[586] = new Mx.Seq(this, 586, "_586:('*',>union-expression)") { Builder = nodes => new CSpreadArgument(nodes) };
                /* 587 OptionalOp       */ __Matchers[587] = new Mx.Optional(this, 587, "?(>let-variable-list)") { Builder = nodes => new ROptional<CLetVariableList>(nodes) };
                /* 588 SeqOp            */ __Matchers[588] = new Mx.Seq(this, 588, "_588:('let','(',?(>let-variable-list),')',>conditional-expression)") { Builder = nodes => new CLetExpr(nodes) };
                /* 589 PlusOp           */ __Matchers[589] = new Mx.Plus(this, 589, "+(>case-expression)") { Builder = nodes => new RPlus<CCaseExpression>(nodes) };
                /* 590 OptionalOp       */ __Matchers[590] = new Mx.Optional(this, 590, "?(>else-expression)") { Builder = nodes => new ROptional<CElseExpression>(nodes) };
                /* 591 SeqOp            */ __Matchers[591] = new Mx.Seq(this, 591, "_591:(>switch-header,+(>case-expression),?(>else-expression))") { Builder = nodes => new CSwitchExpr(nodes) };
                /* 592 StringOp         */ __Matchers[592] = new Mx.Keyword(this, 592, "'switch'", "switch") { Creator = node => new RLiteral(node) };
                /* 593 SeqOp            */ __Matchers[593] = new Mx.Seq(this, 593, "_593:('switch','(',>switched,')')") { Builder = nodes => new CSwitchHeader(nodes) };
                /* 594 StringOp         */ __Matchers[594] = new Mx.Keyword(this, 594, "'else'", "else") { Creator = node => new RLiteral(node) };
                /* 595 OptionalOp       */ __Matchers[595] = new Mx.Optional(this, 595, "?('else')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 596 StringOp         */ __Matchers[596] = new Mx.Keyword(this, 596, "'case'", "case") { Creator = node => new RLiteral(node) };
                /* 597 SeqOp            */ __Matchers[597] = new Mx.Seq(this, 597, "_597:(?('else'),'case','(',>case-item,')',>conditional-expression)") { Builder = nodes => new CCaseExpression(nodes) };
                /* 598 StringOp         */ __Matchers[598] = new Mx.Keyword(this, 598, "'if'", "if") { Creator = node => new RLiteral(node) };
                /* 599 SeqOp            */ __Matchers[599] = new Mx.Seq(this, 599, "_599:('if',>conditions,>then-expression,>else-expression)") { Builder = nodes => new CIfExpr(nodes) };
                /* 600 SeqOp            */ __Matchers[600] = new Mx.Seq(this, 600, "_600:('else',>conditional-expression)") { Builder = nodes => new CElseExpression(nodes) };
                /* 601 StringOp         */ __Matchers[601] = new Mx.Keyword(this, 601, "'then'", "then") { Creator = node => new RLiteral(node) };
                /* 602 SeqOp            */ __Matchers[602] = new Mx.Seq(this, 602, "_602:('then',>conditional-expression)") { Builder = nodes => new CThenExpression(nodes) };
                /* 603 AltOp            */ __Matchers[603] = new Mx.Alt(this, 603, "alt(>if-expr|>let-expr|>disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 604 AltOp            */ __Matchers[604] = new Mx.Alt(this, 604, "alt(>void-function-expr|>inferred-function-expr)") { Builder = nodes => nodes[0] };
                /* 605 SeqOp            */ __Matchers[605] = new Mx.Seq(this, 605, "_605:('void',?(>type-parameters),+(>parameters),?(>type-constraints),>function-definition)") { Builder = nodes => new CVoidFunctionExpr(nodes) };
                /* 606 OptionalOp       */ __Matchers[606] = new Mx.Optional(this, 606, "?('function')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 607 SeqOp            */ __Matchers[607] = new Mx.Seq(this, 607, "_607:(?('function'),?(>type-parameters),+(>parameters),?(>type-constraints),>function-definition)") { Builder = nodes => new CInferredFunctionExpr(nodes) };
                /* 608 AltOp            */ __Matchers[608] = new Mx.Alt(this, 608, "alt(>block|>function-specifier)") { Builder = nodes => nodes[0] };
                /* 609 AltOp            */ __Matchers[609] = new Mx.Alt(this, 609, "alt(>for-comprehension-clause|>if-comprehension-clause)") { Builder = nodes => nodes[0] };
                /* 610 AltOp            */ __Matchers[610] = new Mx.Alt(this, 610, "alt(>for-comprehension-clause|>if-comprehension-clause|>expression-comprehension-clause)") { Builder = nodes => nodes[0] };
                /* 611 StringOp         */ __Matchers[611] = new Mx.Keyword(this, 611, "'for'", "for") { Creator = node => new RLiteral(node) };
                /* 612 OptionalOp       */ __Matchers[612] = new Mx.Optional(this, 612, "?(>for-iterator)") { Builder = nodes => new ROptional<CForIterator>(nodes) };
                /* 613 SeqOp            */ __Matchers[613] = new Mx.Seq(this, 613, "_613:('for','(',?(>for-iterator),')',>comprehension-clause)") { Builder = nodes => new CForComprehensionClause(nodes) };
                /* 614 SeqOp            */ __Matchers[614] = new Mx.Seq(this, 614, "_614:('if',>conditions,>comprehension-clause)") { Builder = nodes => new CIfComprehensionClause(nodes) };
                /* 615 AltOp            */ __Matchers[615] = new Mx.Alt(this, 615, "alt(>let-expr|>if-expr|>switch-expr|>function-expression|>operator-expression)") { Builder = nodes => nodes[0] };
                /* 616 AltOp            */ __Matchers[616] = new Mx.Alt(this, 616, "alt(>assignment-expr|>then-else-expression)") { Builder = nodes => nodes[0] };
                /* 617 SeqOp            */ __Matchers[617] = new Mx.Seq(this, 617, "_617:(>then-else-expression,>assignment-operator,>expression)") { Builder = nodes => new CAssignmentExpr(nodes) };
                /* 618 StringOp         */ __Matchers[618] = new Mx.String(this, 618, "'+='", "+=") { Creator = node => new RLiteral(node) };
                /* 619 StringOp         */ __Matchers[619] = new Mx.String(this, 619, "'-='", "-=") { Creator = node => new RLiteral(node) };
                /* 620 StringOp         */ __Matchers[620] = new Mx.String(this, 620, "'*='", "*=") { Creator = node => new RLiteral(node) };
                /* 621 StringOp         */ __Matchers[621] = new Mx.String(this, 621, "'/='", "/=") { Creator = node => new RLiteral(node) };
                /* 622 StringOp         */ __Matchers[622] = new Mx.String(this, 622, "'%='", "%=") { Creator = node => new RLiteral(node) };
                /* 623 StringOp         */ __Matchers[623] = new Mx.String(this, 623, "'&='", "&=") { Creator = node => new RLiteral(node) };
                /* 624 StringOp         */ __Matchers[624] = new Mx.String(this, 624, "'|='", "|=") { Creator = node => new RLiteral(node) };
                /* 625 StringOp         */ __Matchers[625] = new Mx.String(this, 625, "'^='", "^=") { Creator = node => new RLiteral(node) };
                /* 626 StringOp         */ __Matchers[626] = new Mx.String(this, 626, "'~='", "~=") { Creator = node => new RLiteral(node) };
                /* 627 StringOp         */ __Matchers[627] = new Mx.String(this, 627, "'&&='", "&&=") { Creator = node => new RLiteral(node) };
                /* 628 StringOp         */ __Matchers[628] = new Mx.String(this, 628, "'||='", "||=") { Creator = node => new RLiteral(node) };
                /* 629 AltOp            */ __Matchers[629] = new Mx.Alt(this, 629, "alt('='|'+='|'-='|'*='|'/='|'%='|'&='|'|='|'^='|'~='|'&&='|'||=')") { Builder = nodes => nodes[0] };
                /* 630 AltOp            */ __Matchers[630] = new Mx.Alt(this, 630, "alt(>then-else-expr|>disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 631 SeqOp            */ __Matchers[631] = new Mx.Seq(this, 631, "_631:(>then-else-expression,>then-else-operator,>disjunction-expression)") { Builder = nodes => new CThenElseExpr(nodes) };
                /* 632 AltOp            */ __Matchers[632] = new Mx.Alt(this, 632, "alt('else'|'then')") { Builder = nodes => nodes[0] };
                /* 633 AltOp            */ __Matchers[633] = new Mx.Alt(this, 633, "alt(>disjunction-expr|>conjunction-expression)") { Builder = nodes => nodes[0] };
                /* 634 SeqOp            */ __Matchers[634] = new Mx.Seq(this, 634, "_634:(>disjunction-expression,>disjunction-operator,>conjunction-expression)") { Builder = nodes => new CDisjunctionExpr(nodes) };
                /* 635 StringOp         */ __Matchers[635] = new Mx.String(this, 635, "'||'", "||") { Creator = node => new CDisjunctionOperator(node) };
                /* 636 AltOp            */ __Matchers[636] = new Mx.Alt(this, 636, "alt(>conjunction-expr|>logical-negation-expression)") { Builder = nodes => nodes[0] };
                /* 637 SeqOp            */ __Matchers[637] = new Mx.Seq(this, 637, "_637:(>conjunction-expression,>conjunction-operator,>logical-negation-expression)") { Builder = nodes => new CConjunctionExpr(nodes) };
                /* 638 StringOp         */ __Matchers[638] = new Mx.String(this, 638, "'&&'", "&&") { Creator = node => new CConjunctionOperator(node) };
                /* 639 AltOp            */ __Matchers[639] = new Mx.Alt(this, 639, "alt(>logical-negation-expr|>expression-or-meta)") { Builder = nodes => nodes[0] };
                /* 640 SeqOp            */ __Matchers[640] = new Mx.Seq(this, 640, "_640:(>not-operator,>logical-negation-expression)") { Builder = nodes => new CLogicalNegationExpr(nodes) };
                /* 641 StringOp         */ __Matchers[641] = new Mx.String(this, 641, "'!'", "!") { Creator = node => new CNotOperator(node) };
                /* 642 AltOp            */ __Matchers[642] = new Mx.Alt(this, 642, "alt(>equality-expression|>model-reference)") { Builder = nodes => nodes[0] };
                /* 643 AltOp            */ __Matchers[643] = new Mx.Alt(this, 643, "alt(>equality-expr|>comparison-expression)") { Builder = nodes => nodes[0] };
                /* 644 SeqOp            */ __Matchers[644] = new Mx.Seq(this, 644, "_644:(>comparison-expression,>equality-operator,>comparison-expression)") { Builder = nodes => new CEqualityExpr(nodes) };
                /* 645 StringOp         */ __Matchers[645] = new Mx.String(this, 645, "'=='", "==") { Creator = node => new RLiteral(node) };
                /* 646 StringOp         */ __Matchers[646] = new Mx.String(this, 646, "'!='", "!=") { Creator = node => new RLiteral(node) };
                /* 647 StringOp         */ __Matchers[647] = new Mx.String(this, 647, "'==='", "===") { Creator = node => new RLiteral(node) };
                /* 648 AltOp            */ __Matchers[648] = new Mx.Alt(this, 648, "alt('=='|'!='|'===')") { Builder = nodes => nodes[0] };
                /* 649 AltOp            */ __Matchers[649] = new Mx.Alt(this, 649, "alt(>comparison-expr|>larger-expr|>smaller-expr|>larger-bounds-expr|>smaller-bounds-expr|>typecheck-expr|>exists-nonempty-expression)") { Builder = nodes => nodes[0] };
                /* 650 SeqOp            */ __Matchers[650] = new Mx.Seq(this, 650, "_650:(>exists-nonempty-expression,>comparison-operator,>exists-nonempty-expression)") { Builder = nodes => new CComparisonExpr(nodes) };
                /* 651 SeqOp            */ __Matchers[651] = new Mx.Seq(this, 651, "_651:(>exists-nonempty-expression,>larger-operator,>exists-nonempty-expression)") { Builder = nodes => new CLargerExpr(nodes) };
                /* 652 SeqOp            */ __Matchers[652] = new Mx.Seq(this, 652, "_652:(>exists-nonempty-expression,>smaller-operator,>exists-nonempty-expression)") { Builder = nodes => new CSmallerExpr(nodes) };
                /* 653 SeqOp            */ __Matchers[653] = new Mx.Seq(this, 653, "_653:(>exists-nonempty-expression,>larger-operator,>exists-nonempty-expression,>larger-operator,>exists-nonempty-expression)") { Builder = nodes => new CLargerBoundsExpr(nodes) };
                /* 654 SeqOp            */ __Matchers[654] = new Mx.Seq(this, 654, "_654:(>exists-nonempty-expression,>smaller-operator,>exists-nonempty-expression,>smaller-operator,>exists-nonempty-expression)") { Builder = nodes => new CSmallerBoundsExpr(nodes) };
                /* 655 SeqOp            */ __Matchers[655] = new Mx.Seq(this, 655, "_655:(>exists-nonempty-expression,>type-operator,>type)") { Builder = nodes => new CTypecheckExpr(nodes) };
                /* 656 StringOp         */ __Matchers[656] = new Mx.String(this, 656, "'<=>'", "<=>") { Creator = node => new RLiteral(node) };
                /* 657 AltOp            */ __Matchers[657] = new Mx.Alt(this, 657, "alt('<=>'|'in')") { Builder = nodes => nodes[0] };
                /* 658 StringOp         */ __Matchers[658] = new Mx.String(this, 658, "'<='", "<=") { Creator = node => new RLiteral(node) };
                /* 659 AltOp            */ __Matchers[659] = new Mx.Alt(this, 659, "alt('<='|'<')") { Builder = nodes => nodes[0] };
                /* 660 StringOp         */ __Matchers[660] = new Mx.String(this, 660, "'>='", ">=") { Creator = node => new RLiteral(node) };
                /* 661 AltOp            */ __Matchers[661] = new Mx.Alt(this, 661, "alt('>='|'>')") { Builder = nodes => nodes[0] };
                /* 662 StringOp         */ __Matchers[662] = new Mx.Keyword(this, 662, "'is'", "is") { Creator = node => new RLiteral(node) };
                /* 663 AltOp            */ __Matchers[663] = new Mx.Alt(this, 663, "alt('is'|'extends'|'satisfies'|'of')") { Builder = nodes => nodes[0] };
                /* 664 AltOp            */ __Matchers[664] = new Mx.Alt(this, 664, "alt(>exists-expr|>nonempty-expr|>entry-range-expression)") { Builder = nodes => nodes[0] };
                /* 665 StringOp         */ __Matchers[665] = new Mx.Keyword(this, 665, "'exists'", "exists") { Creator = node => new RLiteral(node) };
                /* 666 SeqOp            */ __Matchers[666] = new Mx.Seq(this, 666, "_666:(>entry-range-expression,'exists')") { Builder = nodes => new CExistsExpr(nodes) };
                /* 667 StringOp         */ __Matchers[667] = new Mx.Keyword(this, 667, "'nonempty'", "nonempty") { Creator = node => new RLiteral(node) };
                /* 668 SeqOp            */ __Matchers[668] = new Mx.Seq(this, 668, "_668:(>entry-range-expression,'nonempty')") { Builder = nodes => new CNonemptyExpr(nodes) };
                /* 669 AltOp            */ __Matchers[669] = new Mx.Alt(this, 669, "alt(>range-expr|>entry-expr|>additive-expression)") { Builder = nodes => nodes[0] };
                /* 670 SeqOp            */ __Matchers[670] = new Mx.Seq(this, 670, "_670:(>additive-expression,>range-operator,>additive-expression)") { Builder = nodes => new CRangeExpr(nodes) };
                /* 671 SeqOp            */ __Matchers[671] = new Mx.Seq(this, 671, "_671:(>additive-expression,>entry-operator,>additive-expression)") { Builder = nodes => new CEntryExpr(nodes) };
                /* 672 StringOp         */ __Matchers[672] = new Mx.String(this, 672, "'..'", "..") { Creator = node => new RLiteral(node) };
                /* 673 AltOp            */ __Matchers[673] = new Mx.Alt(this, 673, "alt('..'|':')") { Builder = nodes => nodes[0] };
                /* 674 AltOp            */ __Matchers[674] = new Mx.Alt(this, 674, "alt(>additive-expr|>scale-expression)") { Builder = nodes => nodes[0] };
                /* 675 SeqOp            */ __Matchers[675] = new Mx.Seq(this, 675, "_675:(>additive-expression,>additive-operator,>scale-expression)") { Builder = nodes => new CAdditiveExpr(nodes) };
                /* 676 StringOp         */ __Matchers[676] = new Mx.String(this, 676, "'-'", "-") { Creator = node => new RLiteral(node) };
                /* 677 AltOp            */ __Matchers[677] = new Mx.Alt(this, 677, "alt('+'|'-')") { Builder = nodes => nodes[0] };
                /* 678 AltOp            */ __Matchers[678] = new Mx.Alt(this, 678, "alt(>scale-expr|>multiplicative-expression)") { Builder = nodes => nodes[0] };
                /* 679 SeqOp            */ __Matchers[679] = new Mx.Seq(this, 679, "_679:(>multiplicative-expression,>scale-operator,>scale-expression)") { Builder = nodes => new CScaleExpr(nodes) };
                /* 680 StringOp         */ __Matchers[680] = new Mx.String(this, 680, "'**'", "**") { Creator = node => new CScaleOperator(node) };
                /* 681 AltOp            */ __Matchers[681] = new Mx.Alt(this, 681, "alt(>multiplicative-expr|>union-expression)") { Builder = nodes => nodes[0] };
                /* 682 SeqOp            */ __Matchers[682] = new Mx.Seq(this, 682, "_682:(>multiplicative-expression,>multiplicative-operator,>union-expression)") { Builder = nodes => new CMultiplicativeExpr(nodes) };
                /* 683 StringOp         */ __Matchers[683] = new Mx.String(this, 683, "'/'", "/") { Creator = node => new RLiteral(node) };
                /* 684 StringOp         */ __Matchers[684] = new Mx.String(this, 684, "'%'", "%") { Creator = node => new RLiteral(node) };
                /* 685 AltOp            */ __Matchers[685] = new Mx.Alt(this, 685, "alt('*'|'/'|'%')") { Builder = nodes => nodes[0] };
                /* 686 AltOp            */ __Matchers[686] = new Mx.Alt(this, 686, "alt(>union-expr|>exclusive-expression)") { Builder = nodes => nodes[0] };
                /* 687 SeqOp            */ __Matchers[687] = new Mx.Seq(this, 687, "_687:(>union-expression,>union-operator,>exclusive-expression)") { Builder = nodes => new CUnionExpr(nodes) };
                /* 688 StringOp         */ __Matchers[688] = new Mx.String(this, 688, "'~'", "~") { Creator = node => new CComplementOperator(node) };
                /* 689 AltOp            */ __Matchers[689] = new Mx.Alt(this, 689, "alt('|'|'~')") { Builder = nodes => nodes[0] };
                /* 690 AltOp            */ __Matchers[690] = new Mx.Alt(this, 690, "alt(>exclusive-expr|>intersection-expression)") { Builder = nodes => nodes[0] };
                /* 691 SeqOp            */ __Matchers[691] = new Mx.Seq(this, 691, "_691:(>exclusive-expression,>exclusive-operator,>intersection-expression)") { Builder = nodes => new CExclusiveExpr(nodes) };
                /* 692 StringOp         */ __Matchers[692] = new Mx.String(this, 692, "'^'", "^") { Creator = node => new CExclusiveOperator(node) };
                /* 693 AltOp            */ __Matchers[693] = new Mx.Alt(this, 693, "alt(>intersection-expr|>negation-or-complement-expression)") { Builder = nodes => nodes[0] };
                /* 694 SeqOp            */ __Matchers[694] = new Mx.Seq(this, 694, "_694:(>intersection-expression,>intersection-operator,>negation-or-complement-expression)") { Builder = nodes => new CIntersectionExpr(nodes) };
                /* 695 StringOp         */ __Matchers[695] = new Mx.String(this, 695, "'&'", "&") { Creator = node => new CIntersectionOperator(node) };
                /* 696 AltOp            */ __Matchers[696] = new Mx.Alt(this, 696, "alt(>negation-or-complement-expr|>prefix-expression)") { Builder = nodes => nodes[0] };
                /* 697 SeqOp            */ __Matchers[697] = new Mx.Seq(this, 697, "_697:(>unary-minus-or-complement-operator,>negation-or-complement-expression)") { Builder = nodes => new CNegationOrComplementExpr(nodes) };
                /* 698 AltOp            */ __Matchers[698] = new Mx.Alt(this, 698, "alt(>negate-operator|>neutral-operator|>complement-operator)") { Builder = nodes => nodes[0] };
                /* 699 NotOp            */ __Matchers[699] = new Mx.Not(this, 699, "!('-')") { Builder = nodes => new RNot<RLiteral>(nodes) };
                /* 700 SeqOp            */ __Matchers[700] = new Mx.Seq(this, 700, "_700:('-',!('-'))") { Builder = nodes => new CNegateOperator(nodes) };
                /* 701 NotOp            */ __Matchers[701] = new Mx.Not(this, 701, "!('+')") { Builder = nodes => new RNot<RLiteral>(nodes) };
                /* 702 SeqOp            */ __Matchers[702] = new Mx.Seq(this, 702, "_702:('+',!('+'))") { Builder = nodes => new CNeutralOperator(nodes) };
                /* 703 AltOp            */ __Matchers[703] = new Mx.Alt(this, 703, "alt(>prefix-expr|>postfix-expression)") { Builder = nodes => nodes[0] };
                /* 704 SeqOp            */ __Matchers[704] = new Mx.Seq(this, 704, "_704:(>increment-operator,>prefix-expression)") { Builder = nodes => new CPrefixExpr(nodes) };
                /* 705 AltOp            */ __Matchers[705] = new Mx.Alt(this, 705, "alt(>postfix-expr|>primary)") { Builder = nodes => nodes[0] };
                /* 706 SeqOp            */ __Matchers[706] = new Mx.Seq(this, 706, "_706:(>postfix-expression,>increment-operator)") { Builder = nodes => new CPostfixExpr(nodes) };
                /* 707 StringOp         */ __Matchers[707] = new Mx.String(this, 707, "'++'", "++") { Creator = node => new RLiteral(node) };
                /* 708 StringOp         */ __Matchers[708] = new Mx.String(this, 708, "'--'", "--") { Creator = node => new RLiteral(node) };
                /* 709 AltOp            */ __Matchers[709] = new Mx.Alt(this, 709, "alt('++'|'--')") { Builder = nodes => nodes[0] };
                /* 710 AltOp            */ __Matchers[710] = new Mx.Alt(this, 710, "alt(>selection-expr|>indexed-expr|>call-expr|>base-expression)") { Builder = nodes => nodes[0] };
                /* 711 SeqOp            */ __Matchers[711] = new Mx.Seq(this, 711, "_711:(>primary,>member-selection-operator,>base-reference)") { Builder = nodes => new CSelectionExpr(nodes) };
                /* 712 StringOp         */ __Matchers[712] = new Mx.String(this, 712, "'?.'", "?.") { Creator = node => new RLiteral(node) };
                /* 713 StringOp         */ __Matchers[713] = new Mx.String(this, 713, "'*.'", "*.") { Creator = node => new RLiteral(node) };
                /* 714 AltOp            */ __Matchers[714] = new Mx.Alt(this, 714, "alt('.'|'?.'|'*.')") { Builder = nodes => nodes[0] };
                /* 715 SeqOp            */ __Matchers[715] = new Mx.Seq(this, 715, "_715:(>primary,'[',>index,']')") { Builder = nodes => new CIndexedExpr(nodes) };
                /* 716 AltOp            */ __Matchers[716] = new Mx.Alt(this, 716, "alt(>lower-spanned|>upper-spanned|>spanned|>measured|>expression)") { Builder = nodes => nodes[0] };
                /* 717 SeqOp            */ __Matchers[717] = new Mx.Seq(this, 717, "_717:(>index-expression,'...')") { Builder = nodes => new CUpperSpanned(nodes) };
                /* 718 SeqOp            */ __Matchers[718] = new Mx.Seq(this, 718, "_718:('...',>index-expression)") { Builder = nodes => new CLowerSpanned(nodes) };
                /* 719 SeqOp            */ __Matchers[719] = new Mx.Seq(this, 719, "_719:(>index-expression,'..',>index-expression)") { Builder = nodes => new CSpanned(nodes) };
                /* 720 SeqOp            */ __Matchers[720] = new Mx.Seq(this, 720, "_720:(>index-expression,':',>index-expression)") { Builder = nodes => new CMeasured(nodes) };
                /* 721 SeqOp            */ __Matchers[721] = new Mx.Seq(this, 721, "_721:(>primary,>arguments)") { Builder = nodes => new CCallExpr(nodes) };
                /* 722 AltOp            */ __Matchers[722] = new Mx.Alt(this, 722, "alt(>nonstring-literal|>string-expression|>meta-literal|>enumeration-expr|>tuple-expr|>object-expr|>grouped-expr|>base-reference-or-parameterized)") { Builder = nodes => nodes[0] };
                /* 723 AltOp            */ __Matchers[723] = new Mx.Alt(this, 723, "alt(>literal-natural|>literal-float|>literal-char)") { Builder = nodes => nodes[0] };
                /* 724 AltOp            */ __Matchers[724] = new Mx.Alt(this, 724, "alt(>string-literal|>string-interpolation)") { Builder = nodes => nodes[0] };
                /* 725 StarOp           */ __Matchers[725] = new Mx.Star(this, 725, "*(>interpolation-part)") { Builder = nodes => new RStar<CInterpolationPart>(nodes) };
                /* 726 SeqOp            */ __Matchers[726] = new Mx.Seq(this, 726, "_726:(>string-start,>expression,*(>interpolation-part),>string-end)") { Builder = nodes => new CStringInterpolation(nodes) };
                /* 727 SeqOp            */ __Matchers[727] = new Mx.Seq(this, 727, "_727:(>string-mid,>expression)") { Builder = nodes => new CInterpolationPart(nodes) };
                /* 728 AltOp            */ __Matchers[728] = new Mx.Alt(this, 728, "alt(>literal-string|>verbatim-string)") { Builder = nodes => nodes[0] };
                /* 729 SeqOp            */ __Matchers[729] = new Mx.Seq(this, 729, "_729:('object',?(>extended-type),?(>satisfied-types),>block)") { Builder = nodes => new CObjectExpr(nodes) };
                /* 730 SeqOp            */ __Matchers[730] = new Mx.Seq(this, 730, "_730:('(',>expression,')')") { Builder = nodes => new CGroupedExpr(nodes) };
                /* 731 OptionalOp       */ __Matchers[731] = new Mx.Optional(this, 731, "?(>type-argument-list)") { Builder = nodes => new ROptional<CTypeArgumentList>(nodes) };
                /* 732 SeqOp            */ __Matchers[732] = new Mx.Seq(this, 732, "_732:('<',?(>type-argument-list),'>')") { Builder = nodes => new CTypeArguments(nodes) };
                /* 733 SeqOp            */ __Matchers[733] = new Mx.Seq(this, 733, "_733:(',',>varianced-type)") { Builder = nodes => new RSequence(nodes) };
                /* 734 StarOp           */ __Matchers[734] = new Mx.Star(this, 734, "*(_733:(',',>varianced-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 735 SeqOp            */ __Matchers[735] = new Mx.Seq(this, 735, "_735:(>varianced-type,*(_733:(',',>varianced-type)))") { Builder = nodes => new CTypeArgumentList(nodes) };
                /* 736 SeqOp            */ __Matchers[736] = new Mx.Seq(this, 736, "_736:(?(>variance),>type)") { Builder = nodes => new CVariancedType(nodes) };
                /* 737 SeqOp            */ __Matchers[737] = new Mx.Seq(this, 737, "_737:(',',>defaulted-type)") { Builder = nodes => new RSequence(nodes) };
                /* 738 StarOp           */ __Matchers[738] = new Mx.Star(this, 738, "*(_737:(',',>defaulted-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 739 SeqOp            */ __Matchers[739] = new Mx.Seq(this, 739, "_739:(>defaulted-type,*(_737:(',',>defaulted-type)))") { Builder = nodes => new CDefaultedTypeList(nodes) };
                /* 740 AltOp            */ __Matchers[740] = new Mx.Alt(this, 740, "alt(>defaulted-type-core|>variadic-type)") { Builder = nodes => nodes[0] };
                /* 741 SeqOp            */ __Matchers[741] = new Mx.Seq(this, 741, "_741:(>type,'=')") { Builder = nodes => new CDefaultedTypeCore(nodes) };
                /* 742 AltOp            */ __Matchers[742] = new Mx.Alt(this, 742, "alt(>variadic-type-core|>type)") { Builder = nodes => nodes[0] };
                /* 743 SeqOp            */ __Matchers[743] = new Mx.Seq(this, 743, "_743:(>union-type,>variadic-operator)") { Builder = nodes => new CVariadicTypeCore(nodes) };
                /* 744 SeqOp            */ __Matchers[744] = new Mx.Seq(this, 744, "_744:('*',>union-type)") { Builder = nodes => new CSpreadType(nodes) };
                /* 745 AltOp            */ __Matchers[745] = new Mx.Alt(this, 745, "alt(>entry-type|>union-type)") { Builder = nodes => nodes[0] };
                /* 746 SeqOp            */ __Matchers[746] = new Mx.Seq(this, 746, "_746:(>union-type,'->',>union-type)") { Builder = nodes => new CEntryType(nodes) };
                /* 747 AltOp            */ __Matchers[747] = new Mx.Alt(this, 747, "alt(>union-type-core|>intersection-type)") { Builder = nodes => nodes[0] };
                /* 748 SeqOp            */ __Matchers[748] = new Mx.Seq(this, 748, "_748:(>union-type,'|',>intersection-type)") { Builder = nodes => new CUnionTypeCore(nodes) };
                /* 749 AltOp            */ __Matchers[749] = new Mx.Alt(this, 749, "alt(>intersection-type-core|>primary-type)") { Builder = nodes => nodes[0] };
                /* 750 SeqOp            */ __Matchers[750] = new Mx.Seq(this, 750, "_750:(>intersection-type,'&',>primary-type)") { Builder = nodes => new CIntersectionTypeCore(nodes) };
                /* 751 AltOp            */ __Matchers[751] = new Mx.Alt(this, 751, "alt(>nullable-type|>array-type|>function-type|>tuple-type|>iterable-type|>grouped-type|>package-qualified-type|>type-path)") { Builder = nodes => nodes[0] };
                /* 752 StringOp         */ __Matchers[752] = new Mx.String(this, 752, "'?'", "?") { Creator = node => new RLiteral(node) };
                /* 753 SeqOp            */ __Matchers[753] = new Mx.Seq(this, 753, "_753:(>primary-type,'?')") { Builder = nodes => new CNullableType(nodes) };
                /* 754 OptionalOp       */ __Matchers[754] = new Mx.Optional(this, 754, "?(>literal-natural)") { Builder = nodes => new ROptional<CLiteralNatural>(nodes) };
                /* 755 SeqOp            */ __Matchers[755] = new Mx.Seq(this, 755, "_755:(>primary-type,'[',?(>literal-natural),']')") { Builder = nodes => new CArrayType(nodes) };
                /* 756 OptionalOp       */ __Matchers[756] = new Mx.Optional(this, 756, "?(>type-type-arguments)") { Builder = nodes => new ROptional<ICTypeTypeArguments>(nodes) };
                /* 757 SeqOp            */ __Matchers[757] = new Mx.Seq(this, 757, "_757:(>primary-type,'(',?(>type-type-arguments),')')") { Builder = nodes => new CFunctionType(nodes) };
                /* 758 AltOp            */ __Matchers[758] = new Mx.Alt(this, 758, "alt(>spread-type|>defaulted-type-list)") { Builder = nodes => nodes[0] };
                /* 759 SeqOp            */ __Matchers[759] = new Mx.Seq(this, 759, "_759:('[',?(>type-type-arguments),']')") { Builder = nodes => new CTupleType(nodes) };
                /* 760 OptionalOp       */ __Matchers[760] = new Mx.Optional(this, 760, "?(>variadic-type)") { Builder = nodes => new ROptional<ICVariadicType>(nodes) };
                /* 761 SeqOp            */ __Matchers[761] = new Mx.Seq(this, 761, "_761:('{',?(>variadic-type),'}')") { Builder = nodes => new CIterableType(nodes) };
                /* 762 SeqOp            */ __Matchers[762] = new Mx.Seq(this, 762, "_762:('<',>type,'>')") { Builder = nodes => new CGroupedType(nodes) };
                /* 763 SeqOp            */ __Matchers[763] = new Mx.Seq(this, 763, "_763:('package','.',>type-path)") { Builder = nodes => new CPackageQualifiedType(nodes) };
                /* 764 OptionalOp       */ __Matchers[764] = new Mx.Optional(this, 764, "?(>string-literal)") { Builder = nodes => new ROptional<ICStringLiteral>(nodes) };
                /* 765 StarOp           */ __Matchers[765] = new Mx.Star(this, 765, "*(>annotation)") { Builder = nodes => new RStar<CAnnotation>(nodes) };
                /* 766 SeqOp            */ __Matchers[766] = new Mx.Seq(this, 766, "_766:(?(>string-literal),*(>annotation))") { Builder = nodes => new CAnnotations(nodes) };
                /* 767 SeqOp            */ __Matchers[767] = new Mx.Seq(this, 767, "_767:(>member-name,?(>arguments))") { Builder = nodes => new CAnnotation(nodes) };
                /* 768 OptionalOp       */ __Matchers[768] = new Mx.Optional(this, 768, "?(>condition-list)") { Builder = nodes => new ROptional<CConditionList>(nodes) };
                /* 769 SeqOp            */ __Matchers[769] = new Mx.Seq(this, 769, "_769:('(',?(>condition-list),')')") { Builder = nodes => new CConditions(nodes) };
                /* 770 SeqOp            */ __Matchers[770] = new Mx.Seq(this, 770, "_770:(',',>condition)") { Builder = nodes => new RSequence(nodes) };
                /* 771 StarOp           */ __Matchers[771] = new Mx.Star(this, 771, "*(_770:(',',>condition))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 772 SeqOp            */ __Matchers[772] = new Mx.Seq(this, 772, "_772:(>condition,*(_770:(',',>condition)))") { Builder = nodes => new CConditionList(nodes) };
                /* 773 AltOp            */ __Matchers[773] = new Mx.Alt(this, 773, "alt(>exists-condition|>nonempty-condition|>is-condition|>satisfies-condition|>boolean-condition)") { Builder = nodes => nodes[0] };
                /* 774 OptionalOp       */ __Matchers[774] = new Mx.Optional(this, 774, "?('!')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 775 SeqOp            */ __Matchers[775] = new Mx.Seq(this, 775, "_775:(?('!'),'exists',>let-or-expression)") { Builder = nodes => new CExistsCondition(nodes) };
                /* 776 SeqOp            */ __Matchers[776] = new Mx.Seq(this, 776, "_776:(?('!'),'nonempty',>let-or-expression)") { Builder = nodes => new CNonemptyCondition(nodes) };
                /* 777 AltOp            */ __Matchers[777] = new Mx.Alt(this, 777, "alt(>let-variable|>operator-expression)") { Builder = nodes => nodes[0] };
                /* 778 SeqOp            */ __Matchers[778] = new Mx.Seq(this, 778, "_778:(?('!'),'is',>type,>is-condition-variable)") { Builder = nodes => new CIsCondition(nodes) };
                /* 779 SeqOp            */ __Matchers[779] = new Mx.Seq(this, 779, "_779:(>member-name,?(>value-specifier))") { Builder = nodes => new CIsConditionVariable(nodes) };
                /* 780 SeqOp            */ __Matchers[780] = new Mx.Seq(this, 780, "_780:('satisfies',>type,>type-name)") { Builder = nodes => new CSatisfiesCondition(nodes) };
                /* 781 AltOp            */ __Matchers[781] = new Mx.Alt(this, 781, "alt(>if-else-statement|>for-else-statement|>switch-statement|>while-statement|>try-statement)") { Builder = nodes => nodes[0] };
                /* 782 StarOp           */ __Matchers[782] = new Mx.Star(this, 782, "*(>else-if)") { Builder = nodes => new RStar<CElseIf>(nodes) };
                /* 783 OptionalOp       */ __Matchers[783] = new Mx.Optional(this, 783, "?(>else-block)") { Builder = nodes => new ROptional<CElseBlock>(nodes) };
                /* 784 SeqOp            */ __Matchers[784] = new Mx.Seq(this, 784, "_784:('if',>conditions,>block,*(>else-if),?(>else-block))") { Builder = nodes => new CIfElseStatement(nodes) };
                /* 785 SeqOp            */ __Matchers[785] = new Mx.Seq(this, 785, "_785:('else','if',>conditions,>block)") { Builder = nodes => new CElseIf(nodes) };
                /* 786 SeqOp            */ __Matchers[786] = new Mx.Seq(this, 786, "_786:('else',>block)") { Builder = nodes => new CElseBlock(nodes) };
                /* 787 PlusOp           */ __Matchers[787] = new Mx.Plus(this, 787, "+(>case-block)") { Builder = nodes => new RPlus<CCaseBlock>(nodes) };
                /* 788 SeqOp            */ __Matchers[788] = new Mx.Seq(this, 788, "_788:(>switch-header,+(>case-block),?(>else-block))") { Builder = nodes => new CSwitchStatement(nodes) };
                /* 789 SeqOp            */ __Matchers[789] = new Mx.Seq(this, 789, "_789:(?('else'),'case','(',>case-item,')',>block)") { Builder = nodes => new CCaseBlock(nodes) };
                /* 790 AltOp            */ __Matchers[790] = new Mx.Alt(this, 790, "alt(>is-case-condition|>satisfies-case-condition|>value-case-list|>pattern)") { Builder = nodes => nodes[0] };
                /* 791 SeqOp            */ __Matchers[791] = new Mx.Seq(this, 791, "_791:('is',>type)") { Builder = nodes => new CIsCaseCondition(nodes) };
                /* 792 SeqOp            */ __Matchers[792] = new Mx.Seq(this, 792, "_792:('satisfies',>type)") { Builder = nodes => new CSatisfiesCaseCondition(nodes) };
                /* 793 SeqOp            */ __Matchers[793] = new Mx.Seq(this, 793, "_793:(>value-case-separator,>value-case)") { Builder = nodes => new RSequence(nodes) };
                /* 794 StarOp           */ __Matchers[794] = new Mx.Star(this, 794, "*(_793:(>value-case-separator,>value-case))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 795 SeqOp            */ __Matchers[795] = new Mx.Seq(this, 795, "_795:(>value-case,*(_793:(>value-case-separator,>value-case)))") { Builder = nodes => new CValueCaseList(nodes) };
                /* 796 AltOp            */ __Matchers[796] = new Mx.Alt(this, 796, "alt(','|'|')") { Builder = nodes => nodes[0] };
                /* 797 AltOp            */ __Matchers[797] = new Mx.Alt(this, 797, "alt(>intersection-type|>intersection-expression)") { Builder = nodes => nodes[0] };
                /* 798 SeqOp            */ __Matchers[798] = new Mx.Seq(this, 798, "_798:('for','(',?(>for-iterator),')',>block,?(>else-block))") { Builder = nodes => new CForElseStatement(nodes) };
                /* 799 SeqOp            */ __Matchers[799] = new Mx.Seq(this, 799, "_799:(>for-variable,>containment)") { Builder = nodes => new CForIterator(nodes) };
                /* 800 SeqOp            */ __Matchers[800] = new Mx.Seq(this, 800, "_800:(>containment-operator,>operator-expression)") { Builder = nodes => new CContainment(nodes) };
                /* 801 AltOp            */ __Matchers[801] = new Mx.Alt(this, 801, "alt('in'|':')") { Builder = nodes => nodes[0] };
                /* 802 StringOp         */ __Matchers[802] = new Mx.Keyword(this, 802, "'while'", "while") { Creator = node => new RLiteral(node) };
                /* 803 SeqOp            */ __Matchers[803] = new Mx.Seq(this, 803, "_803:('while',>conditions,>block)") { Builder = nodes => new CWhileStatement(nodes) };
                /* 804 StringOp         */ __Matchers[804] = new Mx.Keyword(this, 804, "'try'", "try") { Creator = node => new RLiteral(node) };
                /* 805 OptionalOp       */ __Matchers[805] = new Mx.Optional(this, 805, "?(>resources)") { Builder = nodes => new ROptional<CResources>(nodes) };
                /* 806 StarOp           */ __Matchers[806] = new Mx.Star(this, 806, "*(>catch-block)") { Builder = nodes => new RStar<CCatchBlock>(nodes) };
                /* 807 OptionalOp       */ __Matchers[807] = new Mx.Optional(this, 807, "?(>finally-block)") { Builder = nodes => new ROptional<CFinallyBlock>(nodes) };
                /* 808 SeqOp            */ __Matchers[808] = new Mx.Seq(this, 808, "_808:('try',?(>resources),>block,*(>catch-block),?(>finally-block))") { Builder = nodes => new CTryStatement(nodes) };
                /* 809 StringOp         */ __Matchers[809] = new Mx.Keyword(this, 809, "'catch'", "catch") { Creator = node => new RLiteral(node) };
                /* 810 OptionalOp       */ __Matchers[810] = new Mx.Optional(this, 810, "?(>variable)") { Builder = nodes => new ROptional<CVariable>(nodes) };
                /* 811 SeqOp            */ __Matchers[811] = new Mx.Seq(this, 811, "_811:('catch','(',?(>variable),')',>block)") { Builder = nodes => new CCatchBlock(nodes) };
                /* 812 StringOp         */ __Matchers[812] = new Mx.Keyword(this, 812, "'finally'", "finally") { Creator = node => new RLiteral(node) };
                /* 813 SeqOp            */ __Matchers[813] = new Mx.Seq(this, 813, "_813:('finally',>block)") { Builder = nodes => new CFinallyBlock(nodes) };
                /* 814 OptionalOp       */ __Matchers[814] = new Mx.Optional(this, 814, "?(>resource-list)") { Builder = nodes => new ROptional<CResourceList>(nodes) };
                /* 815 SeqOp            */ __Matchers[815] = new Mx.Seq(this, 815, "_815:('(',?(>resource-list),')')") { Builder = nodes => new CResources(nodes) };
                /* 816 SeqOp            */ __Matchers[816] = new Mx.Seq(this, 816, "_816:(',',>resource)") { Builder = nodes => new RSequence(nodes) };
                /* 817 StarOp           */ __Matchers[817] = new Mx.Star(this, 817, "*(_816:(',',>resource))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 818 SeqOp            */ __Matchers[818] = new Mx.Seq(this, 818, "_818:(>resource,*(_816:(',',>resource)))") { Builder = nodes => new CResourceList(nodes) };
                /* 819 AltOp            */ __Matchers[819] = new Mx.Alt(this, 819, "alt(>specified-variable|>operator-expression)") { Builder = nodes => nodes[0] };
                /* 820 SeqOp            */ __Matchers[820] = new Mx.Seq(this, 820, "_820:(>variable,>value-specifier)") { Builder = nodes => new CSpecifiedVariable(nodes) };
                /* 821 OptionalOp       */ __Matchers[821] = new Mx.Optional(this, 821, "?(>variable-type)") { Builder = nodes => new ROptional<ICVariableType>(nodes) };
                /* 822 StarOp           */ __Matchers[822] = new Mx.Star(this, 822, "*(>parameters)") { Builder = nodes => new RStar<CParameters>(nodes) };
                /* 823 SeqOp            */ __Matchers[823] = new Mx.Seq(this, 823, "_823:(?(>variable-type),>member-name,*(>parameters))") { Builder = nodes => new CVariable(nodes) };
                /* 824 AltOp            */ __Matchers[824] = new Mx.Alt(this, 824, "alt(>type|>kw-void|>kw-function|>kw-value)") { Builder = nodes => nodes[0] };
                /* 825 SeqOp            */ __Matchers[825] = new Mx.Seq(this, 825, "_825:('^',>model-expression)") { Builder = nodes => new CModelReference(nodes) };
                /* 826 StringOp         */ __Matchers[826] = new Mx.String(this, 826, "'`'", "`") { Creator = node => new RLiteral(node) };
                /* 827 SeqOp            */ __Matchers[827] = new Mx.Seq(this, 827, "_827:('`',>meta-expression,'`')") { Builder = nodes => new CMetaLiteral(nodes) };
                /* 828 AltOp            */ __Matchers[828] = new Mx.Alt(this, 828, "alt(>declaration-reference|>model-expression)") { Builder = nodes => nodes[0] };
                /* 829 AltOp            */ __Matchers[829] = new Mx.Alt(this, 829, "alt(>member-model-expression|>type-model-expression)") { Builder = nodes => nodes[0] };
                /* 830 AltOp            */ __Matchers[830] = new Mx.Alt(this, 830, "alt(>member-reference|>package-qualified-member-reference|>type-qualified-member-reference)") { Builder = nodes => nodes[0] };
                /* 831 SeqOp            */ __Matchers[831] = new Mx.Seq(this, 831, "_831:('package','.',>member-reference)") { Builder = nodes => new CPackageQualifiedMemberReference(nodes) };
                /* 832 SeqOp            */ __Matchers[832] = new Mx.Seq(this, 832, "_832:(>primary-type,'.',>member-reference)") { Builder = nodes => new CTypeQualifiedMemberReference(nodes) };
                /* 833 AltOp            */ __Matchers[833] = new Mx.Alt(this, 833, "alt(>module-literal|>package-literal|>class-literal|>new-literal|>interface-literal|>alias-literal|>type-parameter-literal|>value-literal|>object-literal|>function-literal)") { Builder = nodes => nodes[0] };
                /* 834 OptionalOp       */ __Matchers[834] = new Mx.Optional(this, 834, "?(>package-path)") { Builder = nodes => new ROptional<CPackagePath>(nodes) };
                /* 835 SeqOp            */ __Matchers[835] = new Mx.Seq(this, 835, "_835:('module',?(>package-path))") { Builder = nodes => new CModuleLiteral(nodes) };
                /* 836 SeqOp            */ __Matchers[836] = new Mx.Seq(this, 836, "_836:('package',?(>package-path))") { Builder = nodes => new CPackageLiteral(nodes) };
                /* 837 SeqOp            */ __Matchers[837] = new Mx.Seq(this, 837, "_837:('class',>reference-path)") { Builder = nodes => new CClassLiteral(nodes) };
                /* 838 SeqOp            */ __Matchers[838] = new Mx.Seq(this, 838, "_838:('interface',>reference-path)") { Builder = nodes => new CInterfaceLiteral(nodes) };
                /* 839 SeqOp            */ __Matchers[839] = new Mx.Seq(this, 839, "_839:('alias',>reference-path)") { Builder = nodes => new CAliasLiteral(nodes) };
                /* 840 SeqOp            */ __Matchers[840] = new Mx.Seq(this, 840, "_840:('given',>reference-path)") { Builder = nodes => new CTypeParameterLiteral(nodes) };
                /* 841 SeqOp            */ __Matchers[841] = new Mx.Seq(this, 841, "_841:('new',>reference-path)") { Builder = nodes => new CNewLiteral(nodes) };
                /* 842 SeqOp            */ __Matchers[842] = new Mx.Seq(this, 842, "_842:('value',>reference-path)") { Builder = nodes => new CValueLiteral(nodes) };
                /* 843 SeqOp            */ __Matchers[843] = new Mx.Seq(this, 843, "_843:('object',>reference-path)") { Builder = nodes => new CObjectLiteral(nodes) };
                /* 844 SeqOp            */ __Matchers[844] = new Mx.Seq(this, 844, "_844:('function',>reference-path)") { Builder = nodes => new CFunctionLiteral(nodes) };
                /* 845 SeqOp            */ __Matchers[845] = new Mx.Seq(this, 845, "_845:('package','.')") { Builder = nodes => new CPackageQualifier(nodes) };
                /* 846 SeqOp            */ __Matchers[846] = new Mx.Seq(this, 846, "_846:(?(>package-qualifier),>reference-path-element-list)") { Builder = nodes => new CReferencePath(nodes) };
                /* 847 SeqOp            */ __Matchers[847] = new Mx.Seq(this, 847, "_847:('.',>reference-path-element)") { Builder = nodes => new RSequence(nodes) };
                /* 848 StarOp           */ __Matchers[848] = new Mx.Star(this, 848, "*(_847:('.',>reference-path-element))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 849 SeqOp            */ __Matchers[849] = new Mx.Seq(this, 849, "_849:(>reference-path-element,*(_847:('.',>reference-path-element)))") { Builder = nodes => new CReferencePathElementList(nodes) };
            ...
            private readonly Mx.PlainRule _imports;
            private readonly Mx.PlainRule _moduleDescriptor;
            private readonly Mx.PlainRule _version;
            ...
            private readonly Mx.PlainRule _importDeclaration;
            private readonly Mx.PlainRule _importElements;
            private readonly Mx.PlainRule _importElementList;
            private readonly Mx.PlainRule _importElement;
            private readonly Mx.PlainRule _importNamed;
            private readonly Mx.PlainRule _importName;
            private readonly Mx.PlainRule _importNameSpecifier;
            private readonly Mx.PlainRule _importWildcard;
            private readonly Mx.PlainRule _packageName;
            private readonly Mx.PlainRule _packagePath;
            private readonly Mx.PlainRule _memberName;
            private readonly Mx.PlainRule _typeName;
            private readonly Mx.PlainRule _pattern;
            private readonly Mx.PlainRule _entryPattern;
            private readonly Mx.PlainRule _variableOrTuplePattern;
            private readonly Mx.PlainRule _tuplePattern;
            private readonly Mx.PlainRule _variadicPatternList;
            private readonly Mx.PlainRule _variadicPattern;
            private readonly Mx.PlainRule _variablePattern;
            private readonly Mx.PlainRule _variadicVariable;
            private readonly Mx.PlainRule _variadicOperator;
            private readonly Mx.PlainRule _letStatement;
            private readonly Mx.PlainRule _letVariableList;
            private readonly Mx.PlainRule _letVariable;
            private readonly Mx.PlainRule _delegatedConstructor;
            private readonly Mx.PlainRule _assertionStatement;
            private readonly Mx.PlainRule _assertionMessage;
            private readonly Mx.PlainRule _block;
            private readonly Mx.PlainRule _extendedType;
            private readonly Mx.PlainRule _classSpecifier;
            private readonly Mx.PlainRule _classInstantiation;
            private readonly Mx.PlainRule _qualifiedClass;
            private readonly Mx.PlainRule _packageQualifiedClass;
            private readonly Mx.PlainRule _superQualifiedClass;
            private readonly Mx.PlainRule _unQualifiedClass;
            private readonly Mx.PlainRule _memberPath;
            private readonly Mx.PlainRule _typePath;
            private readonly Mx.PlainRule _satisfiedTypes;
            ...
            private readonly Mx.PlainRule _caseType;
            private readonly Mx.PlainRule _qualifiedCaseType;
            private readonly Mx.PlainRule _parameters;
            private readonly Mx.PlainRule _parameterList;
            private readonly Mx.PlainRule _parameterDeclarationOrRefPattern;
            private readonly Mx.PlainRule _parameter;
            private readonly Mx.PlainRule _parameterReference;
            private readonly Mx.PlainRule _parameterDeclaration;
            private readonly Mx.PlainRule _functionParameterDeclaration;
            private readonly Mx.PlainRule _voidFunctionParameter;
            private readonly Mx.PlainRule _inferredFunctionParameter;
            private readonly Mx.PlainRule _typedFunctionParameter;
            private readonly Mx.PlainRule _valueParameterDeclaration;
            private readonly Mx.PlainRule _inferredValueParameter;
            private readonly Mx.PlainRule _typedValueParameter;
            private readonly Mx.PlainRule _typeParameters;
            private readonly Mx.PlainRule _typeParameterList;
            private readonly Mx.PlainRule _typeParameter;
            private readonly Mx.PlainRule _variance;
            private readonly Mx.PlainRule _typeDefault;
            private readonly Mx.PlainRule _typeConstraint;
            private readonly Mx.PlainRule _typeConstraints;
            ...
            private readonly Mx.PlainRule _enumeratedObjectDeclaration;
            private readonly Mx.PlainRule _objectDeclaration;
            private readonly Mx.PlainRule _setterDeclaration;
            private readonly Mx.PlainRule _setterDefinition;
            private readonly Mx.PlainRule _voidMethodDeclaration;
            private readonly Mx.PlainRule _inferredMethodDeclaration;
            private readonly Mx.PlainRule _typedMethodDeclaration;
            private readonly Mx.PlainRule _methodDefinition;
            private readonly Mx.PlainRule _typedAttributeDeclaration;
            private readonly Mx.PlainRule _inferredAttributeDeclaration;
            private readonly Mx.PlainRule _attributeDefinition;
            private readonly Mx.PlainRule _classDeclaration;
            private readonly Mx.PlainRule _classDefinition;
            private readonly Mx.PlainRule _optionalClassSpecifier;
            private readonly Mx.PlainRule _interfaceDeclaration;
            private readonly Mx.PlainRule _interfaceDefinition;
            private readonly Mx.PlainRule _statements;
            private readonly Mx.PlainRule _statement;
            private readonly Mx.PlainRule _declarationStatement;
            private readonly Mx.PlainRule _unclosedStatement;
            private readonly Mx.PlainRule _openStatement;
            private readonly Mx.PlainRule _expressionStatement;
            private readonly Mx.PlainRule _specificationStatement;
            private readonly Mx.PlainRule _returnStatement;
            private readonly Mx.PlainRule _throwStatement;
            private readonly Mx.PlainRule _breakStatement;
            private readonly Mx.PlainRule _continueStatement;
            private readonly Mx.PlainRule _valueSpecifier;
            private readonly Mx.PlainRule _functionSpecifier;
            private readonly Mx.PlainRule _optionalFunctionSpecifier;
            private readonly Mx.PlainRule _requiredFunctionSpecifier;
            private readonly Mx.PlainRule _typeSpecifier;
            private readonly Mx.PlainRule _optionalTypeSpecifier;
            private readonly Mx.PlainRule _anySpecifier;
            private readonly Mx.PlainRule _optionalAnySpecifier;
            private readonly Mx.PlainRule _baseReferenceOrParameterized;
            private readonly Mx.PlainRule _baseReference;
            private readonly Mx.PlainRule _parametrizedMember;
            private readonly Mx.PlainRule _selfParametrizedMember;
            private readonly Mx.PlainRule _memberReference;
            private readonly Mx.PlainRule _typeReference;
            private readonly Mx.PlainRule _selfReferenceSelector;
            private readonly Mx.PlainRule _selfReference;
            private readonly Mx.PlainRule _enumerationExpr;
            private readonly Mx.PlainRule _tupleExpr;
            private readonly Mx.PlainRule _arguments;
            private readonly Mx.PlainRule _patternedArguments;
            private readonly Mx.PlainRule _positionalArguments;
            private readonly Mx.PlainRule _structuredArgument;
            private readonly Mx.PlainRule _anonymousArgument;
            private readonly Mx.PlainRule _namedArgument;
            private readonly Mx.PlainRule _namedSpecifiedArgument;
            private readonly Mx.PlainRule _sequencedArgumentList;
            private readonly Mx.PlainRule _sequencedArgument;
            private readonly Mx.PlainRule _namedArgumentDeclaration;
            private readonly Mx.PlainRule _objectArgument;
            private readonly Mx.PlainRule _typedMethodArgument;
            private readonly Mx.PlainRule _inferredMethodArgument;
            private readonly Mx.PlainRule _untypedMethodArgument;
            private readonly Mx.PlainRule _typedGetterArgument;
            private readonly Mx.PlainRule _inferredGetterArgument;
            private readonly Mx.PlainRule _untypedGetterArgument;
            private readonly Mx.PlainRule _positionalArgument;
            private readonly Mx.PlainRule _expressionArgument;
            private readonly Mx.PlainRule _spreadArgument;
            private readonly Mx.PlainRule _letExpr;
            private readonly Mx.PlainRule _switchExpr;
            private readonly Mx.PlainRule _switchHeader;
            private readonly Mx.PlainRule _switched;
            private readonly Mx.PlainRule _caseExpression;
            private readonly Mx.PlainRule _ifExpr;
            ...
            private readonly Mx.PlainRule _functionExpression;
            private readonly Mx.PlainRule _voidFunctionExpr;
            private readonly Mx.PlainRule _inferredFunctionExpr;
            private readonly Mx.PlainRule _functionDefinition;
            private readonly Mx.PlainRule _comprehensionArgument;
            private readonly Mx.PlainRule _comprehensionClause;
            private readonly Mx.PlainRule _expressionComprehensionClause;
            private readonly Mx.PlainRule _forComprehensionClause;
            private readonly Mx.PlainRule _ifComprehensionClause;
            private readonly Mx.PlainRule _expression;
            private readonly Mx.PlainRule _operatorExpression;
            private readonly Mx.PlainRule _assignmentExpression;
            private readonly Mx.PlainRule _assignmentExpr;
            private readonly Mx.PlainRule _assignmentOperator;
            private readonly Mx.PlainRule _thenElseExpression;
            private readonly Mx.PlainRule _thenElseExpr;
            private readonly Mx.PlainRule _thenElseOperator;
            private readonly Mx.PlainRule _disjunctionExpression;
            private readonly Mx.PlainRule _disjunctionExpr;
            private readonly Mx.PlainRule _disjunctionOperator;
            private readonly Mx.PlainRule _conjunctionExpression;
            private readonly Mx.PlainRule _conjunctionExpr;
            private readonly Mx.PlainRule _conjunctionOperator;
            private readonly Mx.PlainRule _logicalNegationExpression;
            private readonly Mx.PlainRule _logicalNegationExpr;
            private readonly Mx.PlainRule _notOperator;
            private readonly Mx.PlainRule _expressionOrMeta;
            private readonly Mx.PlainRule _equalityExpression;
            private readonly Mx.PlainRule _equalityExpr;
            private readonly Mx.PlainRule _equalityOperator;
            private readonly Mx.PlainRule _comparisonExpression;
            private readonly Mx.PlainRule _comparisonExpr;
            private readonly Mx.PlainRule _largerExpr;
            private readonly Mx.PlainRule _smallerExpr;
            private readonly Mx.PlainRule _largerBoundsExpr;
            private readonly Mx.PlainRule _smallerBoundsExpr;
            private readonly Mx.PlainRule _typecheckExpr;
            private readonly Mx.PlainRule _comparisonOperator;
            private readonly Mx.PlainRule _smallerOperator;
            private readonly Mx.PlainRule _largerOperator;
            private readonly Mx.PlainRule _typeOperator;
            private readonly Mx.PlainRule _existsNonemptyExpression;
            private readonly Mx.PlainRule _existsExpr;
            private readonly Mx.PlainRule _nonemptyExpr;
            private readonly Mx.PlainRule _entryRangeExpression;
            private readonly Mx.PlainRule _rangeExpr;
            private readonly Mx.PlainRule _entryExpr;
            private readonly Mx.PlainRule _rangeOperator;
            private readonly Mx.PlainRule _entryOperator;
            private readonly Mx.PlainRule _additiveExpression;
            private readonly Mx.PlainRule _additiveExpr;
            private readonly Mx.PlainRule _additiveOperator;
            private readonly Mx.PlainRule _scaleExpression;
            private readonly Mx.PlainRule _scaleExpr;
            private readonly Mx.PlainRule _scaleOperator;
            private readonly Mx.PlainRule _multiplicativeExpression;
            private readonly Mx.PlainRule _multiplicativeExpr;
            private readonly Mx.PlainRule _multiplicativeOperator;
            private readonly Mx.PlainRule _unionExpression;
            private readonly Mx.PlainRule _unionExpr;
            private readonly Mx.PlainRule _unionOperator;
            private readonly Mx.PlainRule _exclusiveExpression;
            private readonly Mx.PlainRule _exclusiveExpr;
            private readonly Mx.PlainRule _exclusiveOperator;
            private readonly Mx.PlainRule _intersectionExpression;
            private readonly Mx.PlainRule _intersectionExpr;
            private readonly Mx.PlainRule _intersectionOperator;
            private readonly Mx.PlainRule _negationOrComplementExpression;
            private readonly Mx.PlainRule _negationOrComplementExpr;
            private readonly Mx.PlainRule _unaryMinusOrComplementOperator;
            private readonly Mx.PlainRule _negateOperator;
            private readonly Mx.PlainRule _neutralOperator;
            private readonly Mx.PlainRule _complementOperator;
            private readonly Mx.PlainRule _prefixExpression;
            private readonly Mx.PlainRule _prefixExpr;
            private readonly Mx.PlainRule _postfixExpression;
            private readonly Mx.PlainRule _postfixExpr;
            private readonly Mx.PlainRule _incrementOperator;
            private readonly Mx.PlainRule _primary;
            private readonly Mx.PlainRule _selectionExpr;
            private readonly Mx.PlainRule _memberSelectionOperator;
            private readonly Mx.PlainRule _indexedExpr;
            private readonly Mx.PlainRule _index;
            private readonly Mx.PlainRule _upperSpanned;
            private readonly Mx.PlainRule _lowerSpanned;
            private readonly Mx.PlainRule _spanned;
            private readonly Mx.PlainRule _measured;
            private readonly Mx.PlainRule _indexExpression;
            private readonly Mx.PlainRule _callExpr;
            private readonly Mx.PlainRule _baseExpression;
            private readonly Mx.PlainRule _nonstringLiteral;
            ...
            private readonly Mx.PlainRule _objectExpr;
            private readonly Mx.PlainRule _groupedExpr;
            private readonly Mx.PlainRule _typeArguments;
            private readonly Mx.PlainRule _typeArgumentList;
            private readonly Mx.PlainRule _variancedType;
            private readonly Mx.PlainRule _defaultedTypeList;
            private readonly Mx.PlainRule _defaultedType;
            private readonly Mx.PlainRule _defaultedTypeCore;
            private readonly Mx.PlainRule _variadicType;
            private readonly Mx.PlainRule _variadicTypeCore;
            ...
            private readonly Mx.PlainRule _unionTypeCore;
            private readonly Mx.PlainRule _intersectionType;
            private readonly Mx.PlainRule _intersectionTypeCore;
            ...
            private readonly Mx.PlainRule _functionType;
            private readonly Mx.PlainRule _typeTypeArguments;
            private readonly Mx.PlainRule _tupleType;
            private readonly Mx.PlainRule _iterableType;
            private readonly Mx.PlainRule _groupedType;
            private readonly Mx.PlainRule _packageQualifiedType;
            private readonly Mx.PlainRule _annotations;
            private readonly Mx.PlainRule _annotation;
            ...
            private readonly Mx.PlainRule _existsCondition;
            private readonly Mx.PlainRule _nonemptyCondition;
            private readonly Mx.PlainRule _letOrExpression;
            private readonly Mx.PlainRule _isCondition;
            private readonly Mx.PlainRule _isConditionVariable;
            private readonly Mx.PlainRule _satisfiesCondition;
            private readonly Mx.PlainRule _booleanCondition;
            private readonly Mx.PlainRule _controlStatement;
            private readonly Mx.PlainRule _ifElseStatement;
            private readonly Mx.PlainRule _elseIf;
            private readonly Mx.PlainRule _elseBlock;
            private readonly Mx.PlainRule _switchStatement;
            private readonly Mx.PlainRule _caseBlock;
            private readonly Mx.PlainRule _caseItem;
            private readonly Mx.PlainRule _isCaseCondition;
            private readonly Mx.PlainRule _satisfiesCaseCondition;
            private readonly Mx.PlainRule _valueCaseList;
            private readonly Mx.PlainRule _valueCaseSeparator;
            private readonly Mx.PlainRule _valueCase;
            private readonly Mx.PlainRule _forElseStatement;
            private readonly Mx.PlainRule _forIterator;
            private readonly Mx.PlainRule _forVariable;
            private readonly Mx.PlainRule _containment;
            private readonly Mx.PlainRule _containmentOperator;
            private readonly Mx.PlainRule _whileStatement;
            private readonly Mx.PlainRule _tryStatement;
            private readonly Mx.PlainRule _catchBlock;
            private readonly Mx.PlainRule _finallyBlock;
            private readonly Mx.PlainRule _resources;
            private readonly Mx.PlainRule _resourceList;
            private readonly Mx.PlainRule _resource;
            private readonly Mx.PlainRule _specifiedOrExpression;
            private readonly Mx.PlainRule _specifiedVariable;
            private readonly Mx.PlainRule _variable;
            private readonly Mx.PlainRule _variableType;
            private readonly Mx.PlainRule _modelReference;
            private readonly Mx.PlainRule _metaLiteral;
            private readonly Mx.PlainRule _metaExpression;
            private readonly Mx.PlainRule _modelExpression;
            private readonly Mx.PlainRule _memberModelExpression;
            private readonly Mx.PlainRule _packageQualifiedMemberReference;
            private readonly Mx.PlainRule _typeQualifiedMemberReference;
            private readonly Mx.PlainRule _typeModelExpression;
            private readonly Mx.PlainRule _declarationReference;
            private readonly Mx.PlainRule _moduleLiteral;
            private readonly Mx.PlainRule _packageLiteral;
            private readonly Mx.PlainRule _classLiteral;
            private readonly Mx.PlainRule _interfaceLiteral;
            private readonly Mx.PlainRule _aliasLiteral;
            private readonly Mx.PlainRule _typeParameterLiteral;
            private readonly Mx.PlainRule _newLiteral;
            private readonly Mx.PlainRule _valueLiteral;
            private readonly Mx.PlainRule _objectLiteral;
            private readonly Mx.PlainRule _functionLiteral;
            private readonly Mx.PlainRule _packageQualifier;
            private readonly Mx.PlainRule _referencePath;
            private readonly Mx.PlainRule _referencePathElementList;
            private readonly Mx.PlainRule _referencePathElement;
            private readonly Mx.PlainRule _kwVoid;
            private readonly Mx.PlainRule _kwFunction;
            private readonly Mx.PlainRule _kwValue;
            private readonly Mx.DfaRule _literalFloat;
            private readonly Mx.DfaRule _literalNatural;
            private readonly Mx.DfaRule _literalChar;
            private readonly Mx.DfaRule _stringStart;
            private readonly Mx.DfaRule _stringMid;
            private readonly Mx.DfaRule _stringEnd;
            private readonly Mx.DfaRule _literalString;
            private readonly Mx.DfaRule _verbatimString;
            private readonly Mx.DfaRule _lowerIdentifier;
            private readonly Mx.DfaRule _upperIdentifier;
            private readonly Mx.DfaRule _identifier;

            private readonly Dfa __Whitespace_DFA = new("%whitespace");
            private readonly Dfa __Keywords_DFA = new("%keywords");
            private readonly Dfa _literalFloat_DFA = new("literal-float");
            private readonly Dfa _literalNatural_DFA = new("literal-natural");
            private readonly Dfa _literalChar_DFA = new("literal-char");
            private readonly Dfa _stringStart_DFA = new("string-start");
            private readonly Dfa _stringMid_DFA = new("string-mid");
            private readonly Dfa _stringEnd_DFA = new("string-end");
            private readonly Dfa _literalString_DFA = new("literal-string");
            private readonly Dfa _verbatimString_DFA = new("verbatim-string");
            private readonly Dfa _lowerIdentifier_DFA = new("lower-identifier");
            private readonly Dfa _upperIdentifier_DFA = new("upper-identifier");
            private readonly Dfa _identifier_DFA = new("identifier");
            private readonly Dfa __Matchers_699_DFA = new("__Matchers_699_DFA");
            private readonly Dfa __Matchers_701_DFA = new("__Matchers_701_DFA");
        }
    }
