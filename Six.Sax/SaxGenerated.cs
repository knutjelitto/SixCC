// <generated from="D:\\Six\\Six.Sax\\Sax.six" at="04.02.2022 07:34:16" />
    ...
    public partial class SaxParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[143])
            {
                ...
                /* 104 OptionalOp       */ __Matchers[104] = new Mx.Optional(this, 104, "?(>extends)") { Builder = nodes => new ROptional<CExtends>(nodes) };
                /* 105 OptionalOp       */ __Matchers[105] = new Mx.Optional(this, 105, "?(>case-types)") { Builder = nodes => new ROptional<CCaseTypes>(nodes) };
                /* 106 SeqOp            */ __Matchers[106] = new Mx.Seq(this, 106, "_106:(>prelude,'class',>name,>parameters,?(>extends),?(>case-types),>class-body)") { Builder = nodes => new CClassDeclaration(nodes) };
                /* 107 StringOp         */ __Matchers[107] = new Mx.String(this, 107, "':'", ":") { Creator = node => new RLiteral(node) };
                /* 108 SeqOp            */ __Matchers[108] = new Mx.Seq(this, 108, "_108:(':',>type)") { Builder = nodes => new CExtends(nodes) };
                /* 109 StringOp         */ __Matchers[109] = new Mx.Keyword(this, 109, "'of'", "of") { Creator = node => new RLiteral(node) };
                /* 110 SeqOp            */ __Matchers[110] = new Mx.Seq(this, 110, "_110:('of',>case-type-list)") { Builder = nodes => new CCaseTypes(nodes) };
                /* 111 StringOp         */ __Matchers[111] = new Mx.String(this, 111, "'|'", "|") { Creator = node => new RLiteral(node) };
                /* 112 SeqOp            */ __Matchers[112] = new Mx.Seq(this, 112, "_112:('|',>type)") { Builder = nodes => new RSequence(nodes) };
                /* 113 StarOp           */ __Matchers[113] = new Mx.Star(this, 113, "*(_112:('|',>type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 114 SeqOp            */ __Matchers[114] = new Mx.Seq(this, 114, "_114:(>type,*(_112:('|',>type)))") { Builder = nodes => new CCaseTypeList(nodes) };
                /* 115 SeqOp            */ __Matchers[115] = new Mx.Seq(this, 115, "_115:('{',>usings,>declarations,'}')") { Builder = nodes => new CClassBody(nodes) };
                /* 116 StringOp         */ __Matchers[116] = new Mx.Keyword(this, 116, "'object'", "object") { Creator = node => new RLiteral(node) };
                /* 117 SeqOp            */ __Matchers[117] = new Mx.Seq(this, 117, "_117:(>prelude,'object',>name,?(>extends),>class-body)") { Builder = nodes => new CObjectDeclaration(nodes) };
                /* 118 StarOp           */ __Matchers[118] = new Mx.Star(this, 118, "*(>attribute)") { Builder = nodes => new CPrelude(nodes) };
                /* 119 OptionalOp       */ __Matchers[119] = new Mx.Optional(this, 119, "?(>attribute-arguments)") { Builder = nodes => new ROptional<CAttributeArguments>(nodes) };
                /* 120 SeqOp            */ __Matchers[120] = new Mx.Seq(this, 120, "_120:(>name,?(>attribute-arguments))") { Builder = nodes => new CAttribute(nodes) };
                /* 121 StringOp         */ __Matchers[121] = new Mx.String(this, 121, "'('", "(") { Creator = node => new RLiteral(node) };
                /* 122 StringOp         */ __Matchers[122] = new Mx.String(this, 122, "')'", ")") { Creator = node => new RLiteral(node) };
                /* 123 SeqOp            */ __Matchers[123] = new Mx.Seq(this, 123, "_123:('(',')')") { Builder = nodes => new CAttributeArguments(nodes) };
                /* 124 AltOp            */ __Matchers[124] = new Mx.Alt(this, 124, "alt(>union-type|>intersectionlevel-type)") { Builder = nodes => nodes[0] };
                /* 125 SeqOp            */ __Matchers[125] = new Mx.Seq(this, 125, "_125:(>unionlevel-type,'|',>intersectionlevel-type)") { Builder = nodes => new CUnionType(nodes) };
                /* 126 AltOp            */ __Matchers[126] = new Mx.Alt(this, 126, "alt(>intersection-type|>primary-type)") { Builder = nodes => nodes[0] };
                /* 127 StringOp         */ __Matchers[127] = new Mx.String(this, 127, "'&'", "&") { Creator = node => new RLiteral(node) };
                /* 128 SeqOp            */ __Matchers[128] = new Mx.Seq(this, 128, "_128:(>intersectionlevel-type,'&',>primary-type)") { Builder = nodes => new CIntersectionType(nodes) };
                /* 129 OptionalOp       */ __Matchers[129] = new Mx.Optional(this, 129, "?(>parameter-list)") { Builder = nodes => new ROptional<CParameterList>(nodes) };
                /* 130 SeqOp            */ __Matchers[130] = new Mx.Seq(this, 130, "_130:('(',?(>parameter-list),')')") { Builder = nodes => new CParameters(nodes) };
                /* 131 SeqOp            */ __Matchers[131] = new Mx.Seq(this, 131, "_131:(',',>parameter)") { Builder = nodes => new RSequence(nodes) };
                /* 132 StarOp           */ __Matchers[132] = new Mx.Star(this, 132, "*(_131:(',',>parameter))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 133 SeqOp            */ __Matchers[133] = new Mx.Seq(this, 133, "_133:(>parameter,*(_131:(',',>parameter)))") { Builder = nodes => new CParameterList(nodes) };
                /* 134 SeqOp            */ __Matchers[134] = new Mx.Seq(this, 134, "_134:(>type,>name)") { Builder = nodes => new CParameter(nodes) };
                /* 135 StarOp           */ __Matchers[135] = new Mx.Star(this, 135, "*(>statement)") { Builder = nodes => new CStatements(nodes) };
                /* 136 StringOp         */ __Matchers[136] = new Mx.Keyword(this, 136, "'return'", "return") { Creator = node => new RLiteral(node) };
                /* 137 SeqOp            */ __Matchers[137] = new Mx.Seq(this, 137, "_137:('return',>expression,';')") { Builder = nodes => new CReturnStatement(nodes) };
                /* 138 AltOp            */ __Matchers[138] = new Mx.Alt(this, 138, "alt(>add-expression|>sub-expression|>primary-expression)") { Builder = nodes => nodes[0] };
                /* 139 StringOp         */ __Matchers[139] = new Mx.String(this, 139, "'+'", "+") { Creator = node => new RLiteral(node) };
                /* 140 SeqOp            */ __Matchers[140] = new Mx.Seq(this, 140, "_140:(>addlevel-expression,'+',>primary-expression)") { Builder = nodes => new CAddExpression(nodes) };
                /* 141 StringOp         */ __Matchers[141] = new Mx.String(this, 141, "'-'", "-") { Creator = node => new RLiteral(node) };
                /* 142 SeqOp            */ __Matchers[142] = new Mx.Seq(this, 142, "_142:(>addlevel-expression,'-',>primary-expression)") { Builder = nodes => new CSubExpression(nodes) };
                ...
                /*  30 PlainRuleOp      */ _classDeclaration.Set(__Matchers[106]);
                /*  31 PlainRuleOp      */ _extends.Set(__Matchers[108]);
                /*  32 PlainRuleOp      */ _caseTypes.Set(__Matchers[110]);
                /*  33 PlainRuleOp      */ _caseTypeList.Set(__Matchers[114]);
                /*  34 PlainRuleOp      */ _classBody.Set(__Matchers[115]);
                /*  35 PlainRuleOp      */ _objectDeclaration.Set(__Matchers[117]);
                /*  36 PlainRuleOp      */ _prelude.Set(__Matchers[118]);
                /*  37 PlainRuleOp      */ _attribute.Set(__Matchers[120]);
                /*  38 PlainRuleOp      */ _attributeArguments.Set(__Matchers[123]);
                /*  39 PlainRuleOp      */ _type.Set(_unionlevelType);
                /*  40 PlainRuleOp      */ _unionlevelType.Set(__Matchers[124]);
                /*  41 PlainRuleOp      */ _unionType.Set(__Matchers[125]);
                /*  42 PlainRuleOp      */ _intersectionlevelType.Set(__Matchers[126]);
                /*  43 PlainRuleOp      */ _intersectionType.Set(__Matchers[128]);
                /*  44 PlainRuleOp      */ _primaryType.Set(_name);
                /*  45 PlainRuleOp      */ _parameters.Set(__Matchers[130]);
                /*  46 PlainRuleOp      */ _parameterList.Set(__Matchers[133]);
                /*  47 PlainRuleOp      */ _parameter.Set(__Matchers[134]);
                /*  48 PlainRuleOp      */ _statements.Set(__Matchers[135]);
                /*  49 PlainRuleOp      */ _statement.Set(_returnStatement);
                /*  50 PlainRuleOp      */ _returnStatement.Set(__Matchers[137]);
                /*  51 PlainRuleOp      */ _expression.Set(_addlevelExpression);
                /*  52 PlainRuleOp      */ _addlevelExpression.Set(__Matchers[138]);
                /*  53 PlainRuleOp      */ _addExpression.Set(__Matchers[140]);
                /*  54 PlainRuleOp      */ _subExpression.Set(__Matchers[142]);
                ...
                /* 104 OptionalOp       */ __Matchers[104].Set(_extends);
                /* 105 OptionalOp       */ __Matchers[105].Set(_caseTypes);
                /* 106 SeqOp            */ __Matchers[106].Set(_prelude, __Matchers[103], _name, _parameters, __Matchers[104], __Matchers[105], _classBody);
                /* 108 SeqOp            */ __Matchers[108].Set(__Matchers[107], _type);
                /* 110 SeqOp            */ __Matchers[110].Set(__Matchers[109], _caseTypeList);
                /* 112 SeqOp            */ __Matchers[112].Set(__Matchers[111], _type);
                /* 113 StarOp           */ __Matchers[113].Set(__Matchers[112]);
                /* 114 SeqOp            */ __Matchers[114].Set(_type, __Matchers[113]);
                /* 115 SeqOp            */ __Matchers[115].Set(__Matchers[64], _usings, _declarations, __Matchers[65]);
                /* 117 SeqOp            */ __Matchers[117].Set(_prelude, __Matchers[116], _name, __Matchers[104], _classBody);
                /* 118 StarOp           */ __Matchers[118].Set(_attribute);
                /* 119 OptionalOp       */ __Matchers[119].Set(_attributeArguments);
                /* 120 SeqOp            */ __Matchers[120].Set(_name, __Matchers[119]);
                /* 123 SeqOp            */ __Matchers[123].Set(__Matchers[121], __Matchers[122]);
                /* 124 AltOp            */ __Matchers[124].Set(_unionType, _intersectionlevelType);
                /* 125 SeqOp            */ __Matchers[125].Set(_unionlevelType, __Matchers[111], _intersectionlevelType);
                /* 126 AltOp            */ __Matchers[126].Set(_intersectionType, _primaryType);
                /* 128 SeqOp            */ __Matchers[128].Set(_intersectionlevelType, __Matchers[127], _primaryType);
                /* 129 OptionalOp       */ __Matchers[129].Set(_parameterList);
                /* 130 SeqOp            */ __Matchers[130].Set(__Matchers[121], __Matchers[129], __Matchers[122]);
                /* 131 SeqOp            */ __Matchers[131].Set(__Matchers[84], _parameter);
                /* 132 StarOp           */ __Matchers[132].Set(__Matchers[131]);
                /* 133 SeqOp            */ __Matchers[133].Set(_parameter, __Matchers[132]);
                /* 134 SeqOp            */ __Matchers[134].Set(_type, _name);
                /* 135 StarOp           */ __Matchers[135].Set(_statement);
                /* 137 SeqOp            */ __Matchers[137].Set(__Matchers[136], _expression, __Matchers[62]);
                /* 138 AltOp            */ __Matchers[138].Set(_addExpression, _subExpression, _primaryExpression);
                /* 140 SeqOp            */ __Matchers[140].Set(_addlevelExpression, __Matchers[139], _primaryExpression);
                /* 142 SeqOp            */ __Matchers[142].Set(_addlevelExpression, __Matchers[141], _primaryExpression);
