// <generated from="C:\\Dev\\Knut\\Six\\Six.Six\\Six.six" at="16.02.2022 12:11:06" />
    ...
    public partial class SixParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[433])
            {
                ...
                /* 227 AltOp            */ __Matchers[227] = new Mx.Alt(this, 227, "alt(>primitive-declaration|>operator-declaration|>universal-declaration)") { Builder = nodes => nodes[0] };
                /* 228 AltOp            */ __Matchers[228] = new Mx.Alt(this, 228, "alt(>function-declaration|>class-declaration|>interface-declaration|>object-declaration|>alias-declaration|>attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 229 AltOp            */ __Matchers[229] = new Mx.Alt(this, 229, "alt(>universal-declaration|>constructor-declaration|>let-declaration|>var-declaration)") { Builder = nodes => nodes[0] };
                /* 230 StringOp         */ __Matchers[230] = new Mx.Keyword(this, 230, "'builtin'", "builtin") { Creator = node => new RLiteral(node) };
                /* 231 SeqOp            */ __Matchers[231] = new Mx.Seq(this, 231, "_231:(>prelude,'builtin',>name,';')") { Builder = nodes => new CPrimitiveDeclaration(nodes) };
                ...
                /* 236 SeqOp            */ __Matchers[236] = new Mx.Seq(this, 236, "_236:(>prelude,'prefix',>type,>prefix-operator,'(',>definitive-parameter,')',>function-body)") { Builder = nodes => new CPrefixDeclaration(nodes) };
                ...
                /* 239 AltOp            */ __Matchers[239] = new Mx.Alt(this, 239, "alt('-'|'!')") { Builder = nodes => nodes[0] };
                /* 240 StringOp         */ __Matchers[240] = new Mx.Keyword(this, 240, "'infix'", "infix") { Creator = node => new RLiteral(node) };
                /* 241 SeqOp            */ __Matchers[241] = new Mx.Seq(this, 241, "_241:(>prelude,'infix',>type,>infix-operator,'(',>definitive-parameter,',',>definitive-parameter,')',>function-body)") { Builder = nodes => new CInfixDeclaration(nodes) };
                ...
                /* 255 AltOp            */ __Matchers[255] = new Mx.Alt(this, 255, "alt('+'|'-'|'*'|'/'|'%'|'<'|'<='|'>'|'>='|'=='|'!='|'==='|'!=='|'|'|'&'|'^')") { Builder = nodes => nodes[0] };
                /* 256 OptionalOp       */ __Matchers[256] = new Mx.Optional(this, 256, "?(>type)") { Builder = nodes => new ROptional<ICType>(nodes) };
                ...
                /* 262 SeqOp            */ __Matchers[262] = new Mx.Seq(this, 262, "_262:(>prelude,'var',?(>type),>name,'=',>expression,';')") { Builder = nodes => new CVarDeclaration(nodes) };
                /* 263 StringOp         */ __Matchers[263] = new Mx.Keyword(this, 263, "'let'", "let") { Creator = node => new RLiteral(node) };
                /* 264 SeqOp            */ __Matchers[264] = new Mx.Seq(this, 264, "_264:(>prelude,'let',?(>type),>name,'=',>expression,';')") { Builder = nodes => new CLetDeclaration(nodes) };
                /* 265 StringOp         */ __Matchers[265] = new Mx.Keyword(this, 265, "'class'", "class") { Creator = node => new RLiteral(node) };
                /* 266 OptionalOp       */ __Matchers[266] = new Mx.Optional(this, 266, "?(>parameters)") { Builder = nodes => new ROptional<CParameters>(nodes) };
                ...
                /* 270 SeqOp            */ __Matchers[270] = new Mx.Seq(this, 270, "_270:(>prelude,'class',>name,?(>generic-parameters),?(>parameters),?(>extends),?(>satisfies),?(>case-types),?(>constraints),>block-body)") { Builder = nodes => new CClassDeclaration(nodes) };
                /* 271 StringOp         */ __Matchers[271] = new Mx.Keyword(this, 271, "'interface'", "interface") { Creator = node => new RLiteral(node) };
                /* 272 SeqOp            */ __Matchers[272] = new Mx.Seq(this, 272, "_272:(>prelude,'interface',>name,?(>generic-parameters),?(>parameters),?(>satisfies),?(>case-types),?(>constraints),>block-body)") { Builder = nodes => new CInterfaceDeclaration(nodes) };
                ...
                /* 281 AltOp            */ __Matchers[281] = new Mx.Alt(this, 281, "alt(>expression-body|>block-body|>null-body|>builtin-body)") { Builder = nodes => nodes[0] };
                /* 282 SeqOp            */ __Matchers[282] = new Mx.Seq(this, 282, "_282:('{',>usings,>statelarations,'}')") { Builder = nodes => new CBlockBody(nodes) };
                /* 283 StarOp           */ __Matchers[283] = new Mx.Star(this, 283, "*(>statelaration)") { Builder = nodes => new CStatelarations(nodes) };
                /* 284 AltOp            */ __Matchers[284] = new Mx.Alt(this, 284, "alt(>statement|>nested-declaration)") { Builder = nodes => nodes[0] };
                /* 285 SeqOp            */ __Matchers[285] = new Mx.Seq(this, 285, "_285:(>function-specifier,';')") { Builder = nodes => new CExpressionBody(nodes) };
                /* 286 SeqOp            */ __Matchers[286] = new Mx.Seq(this, 286, "_286:(';')") { Builder = nodes => new CNullBody(nodes) };
                /* 287 SeqOp            */ __Matchers[287] = new Mx.Seq(this, 287, "_287:('=>','builtin',';')") { Builder = nodes => new CBuiltinBody(nodes) };
                /* 288 SeqOp            */ __Matchers[288] = new Mx.Seq(this, 288, "_288:('=>',>expression)") { Builder = nodes => new CFunctionSpecifier(nodes) };
                /* 289 StringOp         */ __Matchers[289] = new Mx.String(this, 289, "':'", ":") { Creator = node => new RLiteral(node) };
                /* 290 SeqOp            */ __Matchers[290] = new Mx.Seq(this, 290, "_290:(':',>extend-type)") { Builder = nodes => new CExtends(nodes) };
                /* 291 AltOp            */ __Matchers[291] = new Mx.Alt(this, 291, "alt(>type|>constructor)") { Builder = nodes => nodes[0] };
                /* 292 SeqOp            */ __Matchers[292] = new Mx.Seq(this, 292, "_292:(>primary-type,>arguments)") { Builder = nodes => new CConstructor(nodes) };
                ...
                /* 318 AltOp            */ __Matchers[318] = new Mx.Alt(this, 318, "alt(>nullable-type|>reference|>type-selector|>callable-type|>empty-type|>tuple-type|>nothing-type)") { Builder = nodes => nodes[0] };
                ...
                /* 321 SeqOp            */ __Matchers[321] = new Mx.Seq(this, 321, "_321:(>primary-type,'.',>reference)") { Builder = nodes => new CTypeSelector(nodes) };
                /* 322 OptionalOp       */ __Matchers[322] = new Mx.Optional(this, 322, "?(>callable-arguments)") { Builder = nodes => new ROptional<ICCallableArguments>(nodes) };
                /* 323 SeqOp            */ __Matchers[323] = new Mx.Seq(this, 323, "_323:(>primary-type,'(',?(>callable-arguments),')')") { Builder = nodes => new CCallableType(nodes) };
                /* 324 SeqOp            */ __Matchers[324] = new Mx.Seq(this, 324, "_324:(',',>type-list-type)") { Builder = nodes => new RSequence(nodes) };
                /* 325 StarOp           */ __Matchers[325] = new Mx.Star(this, 325, "*(_324:(',',>type-list-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 326 SeqOp            */ __Matchers[326] = new Mx.Seq(this, 326, "_326:(>type-list-type,*(_324:(',',>type-list-type)))") { Builder = nodes => new CTypeList(nodes) };
                /* 327 AltOp            */ __Matchers[327] = new Mx.Alt(this, 327, "alt(>type|>defaulted-type)") { Builder = nodes => nodes[0] };
                /* 328 SeqOp            */ __Matchers[328] = new Mx.Seq(this, 328, "_328:(>type,'=')") { Builder = nodes => new CDefaultedType(nodes) };
                ...
                /* 331 SeqOp            */ __Matchers[331] = new Mx.Seq(this, 331, "_331:('[',']')") { Builder = nodes => new CEmptyType(nodes) };
                /* 332 SeqOp            */ __Matchers[332] = new Mx.Seq(this, 332, "_332:('[',>type-list,']')") { Builder = nodes => new CTupleType(nodes) };
                /* 333 StringOp         */ __Matchers[333] = new Mx.Keyword(this, 333, "'Nothing'", "Nothing") { Creator = node => new RLiteral(node) };
                /* 334 SeqOp            */ __Matchers[334] = new Mx.Seq(this, 334, "_334:('Nothing')") { Builder = nodes => new CNothingType(nodes) };
                /* 335 OptionalOp       */ __Matchers[335] = new Mx.Optional(this, 335, "?(>parameter-list)") { Builder = nodes => new ROptional<CParameterList>(nodes) };
                /* 336 SeqOp            */ __Matchers[336] = new Mx.Seq(this, 336, "_336:('(',?(>parameter-list),')')") { Builder = nodes => new CParameters(nodes) };
                /* 337 SeqOp            */ __Matchers[337] = new Mx.Seq(this, 337, "_337:(',',>parameter)") { Builder = nodes => new RSequence(nodes) };
                /* 338 StarOp           */ __Matchers[338] = new Mx.Star(this, 338, "*(_337:(',',>parameter))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 339 SeqOp            */ __Matchers[339] = new Mx.Seq(this, 339, "_339:(>parameter,*(_337:(',',>parameter)))") { Builder = nodes => new CParameterList(nodes) };
                /* 340 OptionalOp       */ __Matchers[340] = new Mx.Optional(this, 340, "?(>parameter-type)") { Builder = nodes => new ROptional<ICParameterType>(nodes) };
                ...
                /* 351 SeqOp            */ __Matchers[351] = new Mx.Seq(this, 351, "_351:(>name,'=',>expression,';')") { Builder = nodes => new CAssignStatement(nodes) };
                ...
                /*  32 PlainRuleOp      */ _topDeclaration.Set(__Matchers[227]);
                /*  33 PlainRuleOp      */ _universalDeclaration.Set(__Matchers[228]);
                /*  34 PlainRuleOp      */ _nestedDeclaration.Set(__Matchers[229]);
                /*  35 PlainRuleOp      */ _primitiveDeclaration.Set(__Matchers[231]);
                /*  36 PlainRuleOp      */ _operatorDeclaration.Set(__Matchers[232]);
                /*  37 PlainRuleOp      */ _prefixDeclaration.Set(__Matchers[236]);
                /*  38 PlainRuleOp      */ _prefixOperator.Set(__Matchers[239]);
                /*  39 PlainRuleOp      */ _infixDeclaration.Set(__Matchers[241]);
                /*  40 PlainRuleOp      */ _infixOperator.Set(__Matchers[255]);
                /*  41 PlainRuleOp      */ _functionDeclaration.Set(__Matchers[259]);
                /*  42 PlainRuleOp      */ _attributeDeclaration.Set(__Matchers[260]);
                /*  43 PlainRuleOp      */ _varDeclaration.Set(__Matchers[262]);
                /*  44 PlainRuleOp      */ _letDeclaration.Set(__Matchers[264]);
                ...
                /*  51 PlainRuleOp      */ _attributeBody.Set(__Matchers[281]);
                /*  52 PlainRuleOp      */ _blockBody.Set(__Matchers[282]);
                /*  53 PlainRuleOp      */ _statelarations.Set(__Matchers[283]);
                /*  54 PlainRuleOp      */ _statelaration.Set(__Matchers[284]);
                /*  55 PlainRuleOp      */ _expressionBody.Set(__Matchers[285]);
                /*  56 PlainRuleOp      */ _nullBody.Set(__Matchers[286]);
                /*  57 PlainRuleOp      */ _builtinBody.Set(__Matchers[287]);
                /*  58 PlainRuleOp      */ _functionSpecifier.Set(__Matchers[288]);
                /*  59 PlainRuleOp      */ _extends.Set(__Matchers[290]);
                /*  60 PlainRuleOp      */ _extendType.Set(__Matchers[291]);
                /*  61 PlainRuleOp      */ _constructor.Set(__Matchers[292]);
                ...
                /*  78 PlainRuleOp      */ _typeSelector.Set(__Matchers[321]);
                /*  79 PlainRuleOp      */ _callableType.Set(__Matchers[323]);
                /*  80 PlainRuleOp      */ _callableArguments.Set(_typeList);
                /*  81 PlainRuleOp      */ _typeList.Set(__Matchers[326]);
                /*  82 PlainRuleOp      */ _typeListType.Set(__Matchers[327]);
                /*  83 PlainRuleOp      */ _defaultedType.Set(__Matchers[328]);
                /*  84 PlainRuleOp      */ _emptyType.Set(__Matchers[331]);
                /*  85 PlainRuleOp      */ _tupleType.Set(__Matchers[332]);
                /*  86 PlainRuleOp      */ _nothingType.Set(__Matchers[334]);
                /*  87 PlainRuleOp      */ _parameters.Set(__Matchers[336]);
                /*  88 PlainRuleOp      */ _parameterList.Set(__Matchers[339]);
                /*  89 PlainRuleOp      */ _parameter.Set(_valueParameter);
                /*  90 PlainRuleOp      */ _valueParameter.Set(__Matchers[342]);
                /*  91 PlainRuleOp      */ _definitiveParameter.Set(__Matchers[343]);
                /*  92 PlainRuleOp      */ _valueDefault.Set(__Matchers[344]);
                /*  93 PlainRuleOp      */ _parameterType.Set(_type);
                /*  94 PlainRuleOp      */ _arguments.Set(__Matchers[346]);
                /*  95 PlainRuleOp      */ _argumentList.Set(__Matchers[349]);
                /*  96 PlainRuleOp      */ _statement.Set(__Matchers[350]);
                /*  97 PlainRuleOp      */ _assignStatement.Set(__Matchers[351]);
                /*  98 PlainRuleOp      */ _expressionStatement.Set(__Matchers[352]);
                /*  99 PlainRuleOp      */ _ifStatement.Set(__Matchers[356]);
                /* 100 PlainRuleOp      */ _elseIf.Set(__Matchers[358]);
                /* 101 PlainRuleOp      */ _elseBlock.Set(__Matchers[359]);
                /* 102 PlainRuleOp      */ _forStatement.Set(__Matchers[361]);
                /* 103 PlainRuleOp      */ _whileStatement.Set(__Matchers[363]);
                /* 104 PlainRuleOp      */ _returnStatement.Set(__Matchers[366]);
                /* 105 PlainRuleOp      */ _throwStatement.Set(__Matchers[368]);
                /* 106 PlainRuleOp      */ _assertStatement.Set(__Matchers[370]);
                /* 107 PlainRuleOp      */ _expression.Set(__Matchers[371]);
                /* 108 PlainRuleOp      */ _levelCoalesceExpression.Set(__Matchers[372]);
                /* 109 PlainRuleOp      */ _thenExpression.Set(__Matchers[374]);
                /* 110 PlainRuleOp      */ _elseExpression.Set(__Matchers[375]);
                /* 111 PlainRuleOp      */ _levelDisjunctionExpression.Set(__Matchers[376]);
                /* 112 PlainRuleOp      */ _disjunctionExpression.Set(__Matchers[378]);
                /* 113 PlainRuleOp      */ _levelConjunctionExpression.Set(__Matchers[379]);
                /* 114 PlainRuleOp      */ _conjunctionExpression.Set(__Matchers[381]);
                /* 115 PlainRuleOp      */ _levelNotExpression.Set(__Matchers[382]);
                /* 116 PlainRuleOp      */ _notExpression.Set(__Matchers[383]);
                /* 117 PlainRuleOp      */ _levelEqualityExpression.Set(__Matchers[384]);
                /* 118 PlainRuleOp      */ _equalExpression.Set(__Matchers[385]);
                /* 119 PlainRuleOp      */ _notEqualExpression.Set(__Matchers[386]);
                /* 120 PlainRuleOp      */ _identicalExpression.Set(__Matchers[387]);
                /* 121 PlainRuleOp      */ _notIdenticalExpression.Set(__Matchers[388]);
                /* 122 PlainRuleOp      */ _levelCompareExpression.Set(__Matchers[389]);
                /* 123 PlainRuleOp      */ _lessExpression.Set(__Matchers[390]);
                /* 124 PlainRuleOp      */ _lessEqualExpression.Set(__Matchers[391]);
                /* 125 PlainRuleOp      */ _greaterExpression.Set(__Matchers[392]);
                /* 126 PlainRuleOp      */ _greaterEqualExpression.Set(__Matchers[393]);
                /* 127 PlainRuleOp      */ _levelAddExpression.Set(__Matchers[394]);
                /* 128 PlainRuleOp      */ _addExpression.Set(__Matchers[395]);
                /* 129 PlainRuleOp      */ _subExpression.Set(__Matchers[396]);
                /* 130 PlainRuleOp      */ _levelMulExpression.Set(__Matchers[397]);
                /* 131 PlainRuleOp      */ _mulExpression.Set(__Matchers[398]);
                /* 132 PlainRuleOp      */ _divExpression.Set(__Matchers[399]);
                /* 133 PlainRuleOp      */ _remExpression.Set(__Matchers[400]);
                /* 134 PlainRuleOp      */ _levelUnionExpression.Set(__Matchers[401]);
                /* 135 PlainRuleOp      */ _unionExpression.Set(__Matchers[402]);
                /* 136 PlainRuleOp      */ _complementExpression.Set(__Matchers[404]);
                /* 137 PlainRuleOp      */ _levelExclusiveExpression.Set(__Matchers[405]);
                /* 138 PlainRuleOp      */ _exclusiveExpression.Set(__Matchers[406]);
                /* 139 PlainRuleOp      */ _levelIntersectionExpression.Set(__Matchers[407]);
                /* 140 PlainRuleOp      */ _intersectionExpression.Set(__Matchers[408]);
                /* 141 PlainRuleOp      */ _levelNegateExpression.Set(__Matchers[409]);
                /* 142 PlainRuleOp      */ _negateExpression.Set(__Matchers[410]);
                /* 143 PlainRuleOp      */ _primaryExpression.Set(__Matchers[411]);
                /* 144 PlainRuleOp      */ _groupedExpression.Set(__Matchers[412]);
                /* 145 PlainRuleOp      */ _callExpression.Set(__Matchers[413]);
                /* 146 PlainRuleOp      */ _selectExpression.Set(__Matchers[414]);
                /* 147 PlainRuleOp      */ _nullsafeSelectExpression.Set(__Matchers[416]);
                /* 148 PlainRuleOp      */ _literal.Set(_naturalLiteral);
                /* 149 PlainRuleOp      */ _stringExpression.Set(__Matchers[417]);
                /* 150 PlainRuleOp      */ _stringLiteral.Set(__Matchers[418]);
                /* 151 PlainRuleOp      */ _stringInterpolation.Set(__Matchers[420]);
                /* 152 PlainRuleOp      */ _interpolationPart.Set(__Matchers[421]);
                /* 153 PlainRuleOp      */ _ifExpression.Set(__Matchers[422]);
                /* 154 PlainRuleOp      */ _ifThen.Set(__Matchers[423]);
                /* 155 PlainRuleOp      */ _ifElse.Set(__Matchers[424]);
                /* 156 PlainRuleOp      */ _conditionalExpression.Set(__Matchers[425]);
                /* 157 PlainRuleOp      */ _conditions.Set(__Matchers[426]);
                /* 158 PlainRuleOp      */ _conditionList.Set(__Matchers[429]);
                /* 159 PlainRuleOp      */ _condition.Set(__Matchers[430]);
                /* 160 PlainRuleOp      */ _isCondition.Set(__Matchers[432]);
                ...
                /* 227 AltOp            */ __Matchers[227].Set(_primitiveDeclaration, _operatorDeclaration, _universalDeclaration);
                /* 228 AltOp            */ __Matchers[228].Set(_functionDeclaration, _classDeclaration, _interfaceDeclaration, _objectDeclaration, _aliasDeclaration, _attributeDeclaration);
                /* 229 AltOp            */ __Matchers[229].Set(_universalDeclaration, _constructorDeclaration, _letDeclaration, _varDeclaration);
                /* 231 SeqOp            */ __Matchers[231].Set(_prelude, __Matchers[230], _name, __Matchers[173]);
                /* 232 AltOp            */ __Matchers[232].Set(_prefixDeclaration, _infixDeclaration);
                /* 236 SeqOp            */ __Matchers[236].Set(_prelude, __Matchers[233], _type, _prefixOperator, __Matchers[234], _definitiveParameter, __Matchers[235], _functionBody);
                /* 239 AltOp            */ __Matchers[239].Set(__Matchers[237], __Matchers[238]);
                /* 241 SeqOp            */ __Matchers[241].Set(_prelude, __Matchers[240], _type, _infixOperator, __Matchers[234], _definitiveParameter, __Matchers[190], _definitiveParameter, __Matchers[235], _functionBody);
                /* 255 AltOp            */ __Matchers[255].Set(__Matchers[242], __Matchers[237], __Matchers[243], __Matchers[244], __Matchers[245], __Matchers[207], __Matchers[246], __Matchers[209], __Matchers[247], __Matchers[248], __Matchers[249], __Matchers[250], __Matchers[251], __Matchers[252], __Matchers[253], __Matchers[254]);
                /* 256 OptionalOp       */ __Matchers[256].Set(_type);
                /* 257 OptionalOp       */ __Matchers[257].Set(_genericParameters);
                /* 258 OptionalOp       */ __Matchers[258].Set(_constraints);
                /* 259 SeqOp            */ __Matchers[259].Set(_prelude, __Matchers[256], _name, __Matchers[257], _parameters, __Matchers[258], _functionBody);
                /* 260 SeqOp            */ __Matchers[260].Set(_prelude, __Matchers[256], _name, _attributeBody);
                /* 262 SeqOp            */ __Matchers[262].Set(_prelude, __Matchers[261], __Matchers[256], _name, __Matchers[198], _expression, __Matchers[173]);
                /* 264 SeqOp            */ __Matchers[264].Set(_prelude, __Matchers[263], __Matchers[256], _name, __Matchers[198], _expression, __Matchers[173]);
                /* 266 OptionalOp       */ __Matchers[266].Set(_parameters);
                ...
                /* 270 SeqOp            */ __Matchers[270].Set(_prelude, __Matchers[265], _name, __Matchers[257], __Matchers[266], __Matchers[267], __Matchers[268], __Matchers[269], __Matchers[258], _blockBody);
                /* 272 SeqOp            */ __Matchers[272].Set(_prelude, __Matchers[271], _name, __Matchers[257], __Matchers[266], __Matchers[268], __Matchers[269], __Matchers[258], _blockBody);
                /* 274 SeqOp            */ __Matchers[274].Set(_prelude, __Matchers[273], _name, __Matchers[267], __Matchers[268], _blockBody);
                /* 277 SeqOp            */ __Matchers[277].Set(_prelude, __Matchers[275], _name, __Matchers[257], __Matchers[258], __Matchers[276], _type, __Matchers[173]);
                ...
                /* 281 AltOp            */ __Matchers[281].Set(_expressionBody, _blockBody, _nullBody, _builtinBody);
                /* 282 SeqOp            */ __Matchers[282].Set(__Matchers[179], _usings, _statelarations, __Matchers[181]);
                /* 283 StarOp           */ __Matchers[283].Set(_statelaration);
                /* 284 AltOp            */ __Matchers[284].Set(_statement, _nestedDeclaration);
                /* 285 SeqOp            */ __Matchers[285].Set(_functionSpecifier, __Matchers[173]);
                /* 286 SeqOp            */ __Matchers[286].Set(__Matchers[173]);
                /* 287 SeqOp            */ __Matchers[287].Set(__Matchers[276], __Matchers[230], __Matchers[173]);
                /* 288 SeqOp            */ __Matchers[288].Set(__Matchers[276], _expression);
                /* 290 SeqOp            */ __Matchers[290].Set(__Matchers[289], _extendType);
                /* 291 AltOp            */ __Matchers[291].Set(_type, _constructor);
                /* 292 SeqOp            */ __Matchers[292].Set(_primaryType, _arguments);
                /* 294 SeqOp            */ __Matchers[294].Set(__Matchers[293], _unionTypeList);
                /* 295 PlusOp           */ __Matchers[295].Set(_constraint);
                /* 297 SeqOp            */ __Matchers[297].Set(__Matchers[296], _name, __Matchers[257], __Matchers[269], __Matchers[268]);
                /* 298 SeqOp            */ __Matchers[298].Set(__Matchers[190], _type);
                ...
                /* 303 SeqOp            */ __Matchers[303].Set(__Matchers[252], _type);
                ...
                /* 312 SeqOp            */ __Matchers[312].Set(__Matchers[252], _intersectionType);
                /* 313 StarOp           */ __Matchers[313].Set(__Matchers[312]);
                /* 314 SeqOp            */ __Matchers[314].Set(_intersectionType, __Matchers[313]);
                /* 315 SeqOp            */ __Matchers[315].Set(__Matchers[253], _primaryType);
                /* 316 StarOp           */ __Matchers[316].Set(__Matchers[315]);
                /* 317 SeqOp            */ __Matchers[317].Set(_primaryType, __Matchers[316]);
                /* 318 AltOp            */ __Matchers[318].Set(_nullableType, _reference, _typeSelector, _callableType, _emptyType, _tupleType, _nothingType);
                /* 320 SeqOp            */ __Matchers[320].Set(_primaryType, __Matchers[319]);
                /* 321 SeqOp            */ __Matchers[321].Set(_primaryType, __Matchers[201], _reference);
                /* 322 OptionalOp       */ __Matchers[322].Set(_callableArguments);
                /* 323 SeqOp            */ __Matchers[323].Set(_primaryType, __Matchers[234], __Matchers[322], __Matchers[235]);
                /* 324 SeqOp            */ __Matchers[324].Set(__Matchers[190], _typeListType);
                /* 325 StarOp           */ __Matchers[325].Set(__Matchers[324]);
                /* 326 SeqOp            */ __Matchers[326].Set(_typeListType, __Matchers[325]);
                /* 327 AltOp            */ __Matchers[327].Set(_type, _defaultedType);
                /* 328 SeqOp            */ __Matchers[328].Set(_type, __Matchers[198]);
                /* 331 SeqOp            */ __Matchers[331].Set(__Matchers[329], __Matchers[330]);
                /* 332 SeqOp            */ __Matchers[332].Set(__Matchers[329], _typeList, __Matchers[330]);
                /* 334 SeqOp            */ __Matchers[334].Set(__Matchers[333]);
                /* 335 OptionalOp       */ __Matchers[335].Set(_parameterList);
                /* 336 SeqOp            */ __Matchers[336].Set(__Matchers[234], __Matchers[335], __Matchers[235]);
                /* 337 SeqOp            */ __Matchers[337].Set(__Matchers[190], _parameter);
                /* 338 StarOp           */ __Matchers[338].Set(__Matchers[337]);
                /* 339 SeqOp            */ __Matchers[339].Set(_parameter, __Matchers[338]);
                /* 340 OptionalOp       */ __Matchers[340].Set(_parameterType);
                /* 341 OptionalOp       */ __Matchers[341].Set(_valueDefault);
                /* 342 SeqOp            */ __Matchers[342].Set(_prelude, __Matchers[340], _name, __Matchers[341]);
                /* 343 SeqOp            */ __Matchers[343].Set(_prelude, _parameterType, _name);
                /* 344 SeqOp            */ __Matchers[344].Set(__Matchers[198], _expression);
                /* 345 OptionalOp       */ __Matchers[345].Set(_argumentList);
                /* 346 SeqOp            */ __Matchers[346].Set(__Matchers[234], __Matchers[345], __Matchers[235]);
                /* 347 SeqOp            */ __Matchers[347].Set(__Matchers[190], _expression);
                ...
                /* 351 SeqOp            */ __Matchers[351].Set(_name, __Matchers[198], _expression, __Matchers[173]);
                /* 352 SeqOp            */ __Matchers[352].Set(_expression, __Matchers[173]);
                ...
                /* 361 SeqOp            */ __Matchers[361].Set(__Matchers[360], __Matchers[234], _pattern, __Matchers[223], _expression, __Matchers[235], _blockBody, __Matchers[355]);
                /* 363 SeqOp            */ __Matchers[363].Set(__Matchers[362], _conditions, _blockBody);
                /* 365 OptionalOp       */ __Matchers[365].Set(_expression);
                /* 366 SeqOp            */ __Matchers[366].Set(__Matchers[364], __Matchers[365], __Matchers[173]);
                /* 368 SeqOp            */ __Matchers[368].Set(__Matchers[367], __Matchers[365], __Matchers[173]);
                /* 370 SeqOp            */ __Matchers[370].Set(__Matchers[307], __Matchers[369], _conditions, __Matchers[173]);
                ...
                /* 383 SeqOp            */ __Matchers[383].Set(__Matchers[238], _levelNotExpression);
                ...
                /* 385 SeqOp            */ __Matchers[385].Set(_levelCompareExpression, __Matchers[248], _levelCompareExpression);
                /* 386 SeqOp            */ __Matchers[386].Set(_levelCompareExpression, __Matchers[249], _levelCompareExpression);
                /* 387 SeqOp            */ __Matchers[387].Set(_levelCompareExpression, __Matchers[250], _levelCompareExpression);
                ...
                /* 390 SeqOp            */ __Matchers[390].Set(_levelAddExpression, __Matchers[207], _levelAddExpression);
                /* 391 SeqOp            */ __Matchers[391].Set(_levelAddExpression, __Matchers[246], _levelAddExpression);
                /* 392 SeqOp            */ __Matchers[392].Set(_levelAddExpression, __Matchers[209], _levelAddExpression);
                /* 393 SeqOp            */ __Matchers[393].Set(_levelAddExpression, __Matchers[247], _levelAddExpression);
                /* 394 AltOp            */ __Matchers[394].Set(_addExpression, _subExpression, _levelMulExpression);
                /* 395 SeqOp            */ __Matchers[395].Set(_levelAddExpression, __Matchers[242], _levelMulExpression);
                /* 396 SeqOp            */ __Matchers[396].Set(_levelAddExpression, __Matchers[237], _levelMulExpression);
                /* 397 AltOp            */ __Matchers[397].Set(_mulExpression, _divExpression, _remExpression, _levelUnionExpression);
                /* 398 SeqOp            */ __Matchers[398].Set(_levelMulExpression, __Matchers[243], _levelUnionExpression);
                /* 399 SeqOp            */ __Matchers[399].Set(_levelMulExpression, __Matchers[244], _levelUnionExpression);
                /* 400 SeqOp            */ __Matchers[400].Set(_levelMulExpression, __Matchers[245], _levelUnionExpression);
                /* 401 AltOp            */ __Matchers[401].Set(_unionExpression, _complementExpression, _levelExclusiveExpression);
                /* 402 SeqOp            */ __Matchers[402].Set(_levelUnionExpression, __Matchers[252], _levelExclusiveExpression);
                ...
                /* 406 SeqOp            */ __Matchers[406].Set(_levelExclusiveExpression, __Matchers[254], _levelIntersectionExpression);
                /* 407 AltOp            */ __Matchers[407].Set(_intersectionExpression, _levelNegateExpression);
                /* 408 SeqOp            */ __Matchers[408].Set(_levelIntersectionExpression, __Matchers[253], _levelNegateExpression);
                /* 409 AltOp            */ __Matchers[409].Set(_negateExpression, _primaryExpression);
                /* 410 SeqOp            */ __Matchers[410].Set(__Matchers[237], _levelNegateExpression);
                ...
                /* 412 SeqOp            */ __Matchers[412].Set(__Matchers[234], _expression, __Matchers[235]);
                /* 413 SeqOp            */ __Matchers[413].Set(_primaryExpression, _arguments);
                /* 414 SeqOp            */ __Matchers[414].Set(_primaryExpression, __Matchers[201], _reference);
                ...
                /* 426 SeqOp            */ __Matchers[426].Set(__Matchers[234], _conditionList, __Matchers[235]);
                /* 427 SeqOp            */ __Matchers[427].Set(__Matchers[190], _condition);
                ...
                /* 431 OptionalOp       */ __Matchers[431].Set(__Matchers[238]);
