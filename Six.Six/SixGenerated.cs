    ...
    public partial class SixParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[434])
            {
                ...
                /* 235 SeqOp            */ __Matchers[235] = new Mx.Seq(this, 235, "_235:(>prelude,'prefix',>type,>prefix-operator,'(',')',>function-body)") { Builder = nodes => new CPrefixDeclaration(nodes) };
                ...
                /* 240 SeqOp            */ __Matchers[240] = new Mx.Seq(this, 240, "_240:(>prelude,'infix',>type,>infix-operator,'(',>definitive-parameter,')',>function-body)") { Builder = nodes => new CInfixDeclaration(nodes) };
                ...
                /* 255 OptionalOp       */ __Matchers[255] = new Mx.Optional(this, 255, "?(>generic-parameters)") { Builder = nodes => new ROptional<CGenericParameters>(nodes) };
                /* 256 OptionalOp       */ __Matchers[256] = new Mx.Optional(this, 256, "?(>constraints)") { Builder = nodes => new ROptional<CConstraints>(nodes) };
                /* 257 SeqOp            */ __Matchers[257] = new Mx.Seq(this, 257, "_257:(>prelude,>type,>name,?(>generic-parameters),>parameters,?(>constraints),>function-body)") { Builder = nodes => new CFunctionDeclaration(nodes) };
                /* 258 SeqOp            */ __Matchers[258] = new Mx.Seq(this, 258, "_258:(>prelude,>type,>name,>attribute-body)") { Builder = nodes => new CAttributeDeclaration(nodes) };
                /* 259 StringOp         */ __Matchers[259] = new Mx.Keyword(this, 259, "'var'", "var") { Creator = node => new RLiteral(node) };
                /* 260 OptionalOp       */ __Matchers[260] = new Mx.Optional(this, 260, "?(>type)") { Builder = nodes => new ROptional<ICType>(nodes) };
                ...
                /* 265 OptionalOp       */ __Matchers[265] = new Mx.Optional(this, 265, "?(>extends)") { Builder = nodes => new ROptional<CExtends>(nodes) };
                /* 266 OptionalOp       */ __Matchers[266] = new Mx.Optional(this, 266, "?(>satisfies)") { Builder = nodes => new ROptional<CSatisfies>(nodes) };
                /* 267 OptionalOp       */ __Matchers[267] = new Mx.Optional(this, 267, "?(>case-types)") { Builder = nodes => new ROptional<CCaseTypes>(nodes) };
                /* 268 SeqOp            */ __Matchers[268] = new Mx.Seq(this, 268, "_268:(>prelude,'class',>name,?(>generic-parameters),?(>extends),?(>satisfies),?(>case-types),?(>constraints),>class-body)") { Builder = nodes => new CClassDeclaration(nodes) };
                /* 269 StringOp         */ __Matchers[269] = new Mx.Keyword(this, 269, "'interface'", "interface") { Creator = node => new RLiteral(node) };
                /* 270 SeqOp            */ __Matchers[270] = new Mx.Seq(this, 270, "_270:(>prelude,'interface',>name,?(>generic-parameters),?(>satisfies),?(>case-types),?(>constraints),>interface-body)") { Builder = nodes => new CInterfaceDeclaration(nodes) };
                /* 271 StringOp         */ __Matchers[271] = new Mx.Keyword(this, 271, "'object'", "object") { Creator = node => new RLiteral(node) };
                /* 272 SeqOp            */ __Matchers[272] = new Mx.Seq(this, 272, "_272:(>prelude,'object',>name,?(>extends),?(>satisfies),>class-body)") { Builder = nodes => new CObjectDeclaration(nodes) };
                /* 273 StringOp         */ __Matchers[273] = new Mx.Keyword(this, 273, "'alias'", "alias") { Creator = node => new RLiteral(node) };
                /* 274 StringOp         */ __Matchers[274] = new Mx.String(this, 274, "'=>'", "=>") { Creator = node => new RLiteral(node) };
                /* 275 SeqOp            */ __Matchers[275] = new Mx.Seq(this, 275, "_275:(>prelude,'alias',>name,?(>generic-parameters),?(>constraints),'=>',>type,';')") { Builder = nodes => new CAliasDeclaration(nodes) };
                /* 276 StringOp         */ __Matchers[276] = new Mx.Keyword(this, 276, "'new'", "new") { Creator = node => new RLiteral(node) };
                /* 277 OptionalOp       */ __Matchers[277] = new Mx.Optional(this, 277, "?(>name)") { Builder = nodes => new ROptional<ICName>(nodes) };
                /* 278 SeqOp            */ __Matchers[278] = new Mx.Seq(this, 278, "_278:(>prelude,'new',?(>name),>parameters,?(>extends),>function-body)") { Builder = nodes => new CConstructorDeclaration(nodes) };
                /* 279 StarOp           */ __Matchers[279] = new Mx.Star(this, 279, "*(>class-member)") { Builder = nodes => new RStar<ICClassMember>(nodes) };
                /* 280 SeqOp            */ __Matchers[280] = new Mx.Seq(this, 280, "_280:('{',>usings,*(>class-member),'}')") { Builder = nodes => new CClassBody(nodes) };
                /* 281 StarOp           */ __Matchers[281] = new Mx.Star(this, 281, "*(>interface-member)") { Builder = nodes => new RStar<ICInterfaceMember>(nodes) };
                /* 282 SeqOp            */ __Matchers[282] = new Mx.Seq(this, 282, "_282:('{',>usings,*(>interface-member),'}')") { Builder = nodes => new CInterfaceBody(nodes) };
                /* 283 AltOp            */ __Matchers[283] = new Mx.Alt(this, 283, "alt(>universal-declaration|>constructor-declaration|>operator-declaration|>attribute-declaration|>let-declaration|>var-declaration)") { Builder = nodes => nodes[0] };
                /* 284 AltOp            */ __Matchers[284] = new Mx.Alt(this, 284, "alt(>universal-declaration|>constructor-declaration|>attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 285 AltOp            */ __Matchers[285] = new Mx.Alt(this, 285, "alt(>calc-body|>block-body|>null-body)") { Builder = nodes => nodes[0] };
                ...
                /* 292 StringOp         */ __Matchers[292] = new Mx.String(this, 292, "':'", ":") { Creator = node => new RLiteral(node) };
                /* 293 SeqOp            */ __Matchers[293] = new Mx.Seq(this, 293, "_293:(':',>extended-type)") { Builder = nodes => new CExtends(nodes) };
                /* 294 StringOp         */ __Matchers[294] = new Mx.Keyword(this, 294, "'is'", "is") { Creator = node => new RLiteral(node) };
                /* 295 SeqOp            */ __Matchers[295] = new Mx.Seq(this, 295, "_295:('is',>union-type-list)") { Builder = nodes => new CSatisfies(nodes) };
                /* 296 PlusOp           */ __Matchers[296] = new Mx.Plus(this, 296, "+(>constraint)") { Builder = nodes => new CConstraints(nodes) };
                /* 297 StringOp         */ __Matchers[297] = new Mx.Keyword(this, 297, "'where'", "where") { Creator = node => new RLiteral(node) };
                /* 298 SeqOp            */ __Matchers[298] = new Mx.Seq(this, 298, "_298:('where',>name,?(>generic-parameters),?(>case-types),?(>satisfies))") { Builder = nodes => new CConstraint(nodes) };
                ...
                /* 301 SeqOp            */ __Matchers[301] = new Mx.Seq(this, 301, "_301:(>type,*(_299:(',',>type)))") { Builder = nodes => new CUnionTypeList(nodes) };
                /* 302 StringOp         */ __Matchers[302] = new Mx.Keyword(this, 302, "'of'", "of") { Creator = node => new RLiteral(node) };
                /* 303 SeqOp            */ __Matchers[303] = new Mx.Seq(this, 303, "_303:('of',>case-type-list)") { Builder = nodes => new CCaseTypes(nodes) };
                ...
                /* 306 SeqOp            */ __Matchers[306] = new Mx.Seq(this, 306, "_306:(>type,*(_304:('|',>type)))") { Builder = nodes => new CCaseTypeList(nodes) };
                /* 307 SeqOp            */ __Matchers[307] = new Mx.Seq(this, 307, "_307:(>name)") { Builder = nodes => new CNamePattern(nodes) };
                /* 308 OptionalOp       */ __Matchers[308] = new Mx.Optional(this, 308, "?(>string-literal)") { Builder = nodes => new ROptional<ICStringLiteral>(nodes) };
                /* 309 StarOp           */ __Matchers[309] = new Mx.Star(this, 309, "*(>attribute)") { Builder = nodes => new RStar<CAttribute>(nodes) };
                /* 310 SeqOp            */ __Matchers[310] = new Mx.Seq(this, 310, "_310:(?(>string-literal),*(>attribute))") { Builder = nodes => new CPrelude(nodes) };
                /* 311 OptionalOp       */ __Matchers[311] = new Mx.Optional(this, 311, "?(>arguments)") { Builder = nodes => new ROptional<CArguments>(nodes) };
                /* 312 SeqOp            */ __Matchers[312] = new Mx.Seq(this, 312, "_312:(>attribute-name,?(>arguments))") { Builder = nodes => new CAttribute(nodes) };
                /* 313 SeqOp            */ __Matchers[313] = new Mx.Seq(this, 313, "_313:('|',>intersection-type)") { Builder = nodes => new RSequence(nodes) };
                /* 314 StarOp           */ __Matchers[314] = new Mx.Star(this, 314, "*(_313:('|',>intersection-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 315 SeqOp            */ __Matchers[315] = new Mx.Seq(this, 315, "_315:(>intersection-type,*(_313:('|',>intersection-type)))") { Builder = nodes => new CUnionType(nodes) };
                /* 316 SeqOp            */ __Matchers[316] = new Mx.Seq(this, 316, "_316:('&',>primary-type)") { Builder = nodes => new RSequence(nodes) };
                /* 317 StarOp           */ __Matchers[317] = new Mx.Star(this, 317, "*(_316:('&',>primary-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 318 SeqOp            */ __Matchers[318] = new Mx.Seq(this, 318, "_318:(>primary-type,*(_316:('&',>primary-type)))") { Builder = nodes => new CIntersectionType(nodes) };
                /* 319 AltOp            */ __Matchers[319] = new Mx.Alt(this, 319, "alt(>nullable-type|>array-type|>reference|>type-selector|>callable-type|>empty-type|>tuple-type|>nothing-type)") { Builder = nodes => nodes[0] };
                /* 320 StringOp         */ __Matchers[320] = new Mx.String(this, 320, "'?'", "?") { Creator = node => new RLiteral(node) };
                /* 321 SeqOp            */ __Matchers[321] = new Mx.Seq(this, 321, "_321:(>primary-type,'?')") { Builder = nodes => new CNullableType(nodes) };
                ...
                /* 324 SeqOp            */ __Matchers[324] = new Mx.Seq(this, 324, "_324:(>primary-type,'[',']')") { Builder = nodes => new CArrayType(nodes) };
                ...
                /* 333 SeqOp            */ __Matchers[333] = new Mx.Seq(this, 333, "_333:('[',']')") { Builder = nodes => new CEmptyType(nodes) };
                /* 334 SeqOp            */ __Matchers[334] = new Mx.Seq(this, 334, "_334:('[',>type-list,']')") { Builder = nodes => new CTupleType(nodes) };
                /* 335 StringOp         */ __Matchers[335] = new Mx.Keyword(this, 335, "'Nothing'", "Nothing") { Creator = node => new RLiteral(node) };
                /* 336 SeqOp            */ __Matchers[336] = new Mx.Seq(this, 336, "_336:('Nothing')") { Builder = nodes => new CNothingType(nodes) };
                ...
                /* 342 OptionalOp       */ __Matchers[342] = new Mx.Optional(this, 342, "?(>value-default)") { Builder = nodes => new ROptional<CValueDefault>(nodes) };
                /* 343 SeqOp            */ __Matchers[343] = new Mx.Seq(this, 343, "_343:(>prelude,>parameter-type,>name,?(>value-default))") { Builder = nodes => new CValueParameter(nodes) };
                /* 344 SeqOp            */ __Matchers[344] = new Mx.Seq(this, 344, "_344:(>prelude,>parameter-type,>name)") { Builder = nodes => new CDefinitiveParameter(nodes) };
                /* 345 SeqOp            */ __Matchers[345] = new Mx.Seq(this, 345, "_345:('=',>expression)") { Builder = nodes => new CValueDefault(nodes) };
                ...
                /* 348 SeqOp            */ __Matchers[348] = new Mx.Seq(this, 348, "_348:(',',>expression)") { Builder = nodes => new RSequence(nodes) };
                /* 349 StarOp           */ __Matchers[349] = new Mx.Star(this, 349, "*(_348:(',',>expression))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 350 SeqOp            */ __Matchers[350] = new Mx.Seq(this, 350, "_350:(>expression,*(_348:(',',>expression)))") { Builder = nodes => new CArgumentList(nodes) };
                /* 351 AltOp            */ __Matchers[351] = new Mx.Alt(this, 351, "alt(>assign-statement|>expression-statement|>if-statement|>for-statement|>while-statement|>assert-statement|>return-statement|>throw-statement)") { Builder = nodes => nodes[0] };
                /* 352 SeqOp            */ __Matchers[352] = new Mx.Seq(this, 352, "_352:(>primary-expression,'=',>expression,';')") { Builder = nodes => new CAssignStatement(nodes) };
                /* 353 SeqOp            */ __Matchers[353] = new Mx.Seq(this, 353, "_353:(>expression,';')") { Builder = nodes => new CExpressionStatement(nodes) };
                /* 354 StringOp         */ __Matchers[354] = new Mx.Keyword(this, 354, "'if'", "if") { Creator = node => new RLiteral(node) };
                /* 355 StarOp           */ __Matchers[355] = new Mx.Star(this, 355, "*(>else-if)") { Builder = nodes => new RStar<CElseIf>(nodes) };
                /* 356 OptionalOp       */ __Matchers[356] = new Mx.Optional(this, 356, "?(>else-block)") { Builder = nodes => new ROptional<CElseBlock>(nodes) };
                /* 357 SeqOp            */ __Matchers[357] = new Mx.Seq(this, 357, "_357:('if',>conditions,>block-body,*(>else-if),?(>else-block))") { Builder = nodes => new CIfStatement(nodes) };
                /* 358 StringOp         */ __Matchers[358] = new Mx.Keyword(this, 358, "'else'", "else") { Creator = node => new RLiteral(node) };
                /* 359 SeqOp            */ __Matchers[359] = new Mx.Seq(this, 359, "_359:('else','if',>conditions,>block-body)") { Builder = nodes => new CElseIf(nodes) };
                /* 360 SeqOp            */ __Matchers[360] = new Mx.Seq(this, 360, "_360:('else',>block-body)") { Builder = nodes => new CElseBlock(nodes) };
                /* 361 StringOp         */ __Matchers[361] = new Mx.Keyword(this, 361, "'for'", "for") { Creator = node => new RLiteral(node) };
                /* 362 SeqOp            */ __Matchers[362] = new Mx.Seq(this, 362, "_362:('for','(',>pattern,'in',>expression,')',>block-body,?(>else-block))") { Builder = nodes => new CForStatement(nodes) };
                /* 363 StringOp         */ __Matchers[363] = new Mx.Keyword(this, 363, "'while'", "while") { Creator = node => new RLiteral(node) };
                /* 364 SeqOp            */ __Matchers[364] = new Mx.Seq(this, 364, "_364:('while',>conditions,>block-body)") { Builder = nodes => new CWhileStatement(nodes) };
                /* 365 StringOp         */ __Matchers[365] = new Mx.Keyword(this, 365, "'return'", "return") { Creator = node => new RLiteral(node) };
                /* 366 OptionalOp       */ __Matchers[366] = new Mx.Optional(this, 366, "?(>expression)") { Builder = nodes => new ROptional<ICExpression>(nodes) };
                /* 367 SeqOp            */ __Matchers[367] = new Mx.Seq(this, 367, "_367:('return',?(>expression),';')") { Builder = nodes => new CReturnStatement(nodes) };
                /* 368 StringOp         */ __Matchers[368] = new Mx.Keyword(this, 368, "'throw'", "throw") { Creator = node => new RLiteral(node) };
                /* 369 SeqOp            */ __Matchers[369] = new Mx.Seq(this, 369, "_369:('throw',?(>expression),';')") { Builder = nodes => new CThrowStatement(nodes) };
                /* 370 StringOp         */ __Matchers[370] = new Mx.Keyword(this, 370, "'assert'", "assert") { Creator = node => new RLiteral(node) };
                /* 371 SeqOp            */ __Matchers[371] = new Mx.Seq(this, 371, "_371:(?(>string-literal),'assert',>conditions,';')") { Builder = nodes => new CAssertStatement(nodes) };
                /* 372 AltOp            */ __Matchers[372] = new Mx.Alt(this, 372, "alt(>if-expression|>level-coalesce-expression)") { Builder = nodes => nodes[0] };
                /* 373 AltOp            */ __Matchers[373] = new Mx.Alt(this, 373, "alt(>then-expression|>else-expression|>level-disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 374 StringOp         */ __Matchers[374] = new Mx.Keyword(this, 374, "'then'", "then") { Creator = node => new RLiteral(node) };
                /* 375 SeqOp            */ __Matchers[375] = new Mx.Seq(this, 375, "_375:(>level-coalesce-expression,'then',>level-disjunction-expression)") { Builder = nodes => new CThenExpression(nodes) };
                /* 376 SeqOp            */ __Matchers[376] = new Mx.Seq(this, 376, "_376:(>level-coalesce-expression,'else',>level-disjunction-expression)") { Builder = nodes => new CElseExpression(nodes) };
                /* 377 AltOp            */ __Matchers[377] = new Mx.Alt(this, 377, "alt(>disjunction-expression|>level-conjunction-expression)") { Builder = nodes => nodes[0] };
                /* 378 StringOp         */ __Matchers[378] = new Mx.String(this, 378, "'||'", "||") { Creator = node => new RLiteral(node) };
                /* 379 SeqOp            */ __Matchers[379] = new Mx.Seq(this, 379, "_379:(>level-disjunction-expression,'||',>level-conjunction-expression)") { Builder = nodes => new CDisjunctionExpression(nodes) };
                /* 380 AltOp            */ __Matchers[380] = new Mx.Alt(this, 380, "alt(>conjunction-expression|>level-not-expression)") { Builder = nodes => nodes[0] };
                /* 381 StringOp         */ __Matchers[381] = new Mx.String(this, 381, "'&&'", "&&") { Creator = node => new RLiteral(node) };
                /* 382 SeqOp            */ __Matchers[382] = new Mx.Seq(this, 382, "_382:(>level-conjunction-expression,'&&',>level-not-expression)") { Builder = nodes => new CConjunctionExpression(nodes) };
                /* 383 AltOp            */ __Matchers[383] = new Mx.Alt(this, 383, "alt(>not-expression|>level-equality-expression)") { Builder = nodes => nodes[0] };
                /* 384 SeqOp            */ __Matchers[384] = new Mx.Seq(this, 384, "_384:('!',>level-not-expression)") { Builder = nodes => new CNotExpression(nodes) };
                /* 385 AltOp            */ __Matchers[385] = new Mx.Alt(this, 385, "alt(>equal-expression|>not-equal-expression|>identical-expression|>not-identical-expression|>level-compare-expression)") { Builder = nodes => nodes[0] };
                /* 386 SeqOp            */ __Matchers[386] = new Mx.Seq(this, 386, "_386:(>level-compare-expression,'==',>level-compare-expression)") { Builder = nodes => new CEqualExpression(nodes) };
                ...
                /* 388 SeqOp            */ __Matchers[388] = new Mx.Seq(this, 388, "_388:(>level-compare-expression,'===',>level-compare-expression)") { Builder = nodes => new CIdenticalExpression(nodes) };
                /* 389 SeqOp            */ __Matchers[389] = new Mx.Seq(this, 389, "_389:(>level-compare-expression,'!==',>level-compare-expression)") { Builder = nodes => new CNotIdenticalExpression(nodes) };
                /* 390 AltOp            */ __Matchers[390] = new Mx.Alt(this, 390, "alt(>less-expression|>less-equal-expression|>greater-expression|>greater-equal-expression|>level-add-expression)") { Builder = nodes => nodes[0] };
                /* 391 SeqOp            */ __Matchers[391] = new Mx.Seq(this, 391, "_391:(>level-add-expression,'<',>level-add-expression)") { Builder = nodes => new CLessExpression(nodes) };
                /* 392 SeqOp            */ __Matchers[392] = new Mx.Seq(this, 392, "_392:(>level-add-expression,'<=',>level-add-expression)") { Builder = nodes => new CLessEqualExpression(nodes) };
                /* 393 SeqOp            */ __Matchers[393] = new Mx.Seq(this, 393, "_393:(>level-add-expression,'>',>level-add-expression)") { Builder = nodes => new CGreaterExpression(nodes) };
                /* 394 SeqOp            */ __Matchers[394] = new Mx.Seq(this, 394, "_394:(>level-add-expression,'>=',>level-add-expression)") { Builder = nodes => new CGreaterEqualExpression(nodes) };
                /* 395 AltOp            */ __Matchers[395] = new Mx.Alt(this, 395, "alt(>add-expression|>sub-expression|>level-mul-expression)") { Builder = nodes => nodes[0] };
                /* 396 SeqOp            */ __Matchers[396] = new Mx.Seq(this, 396, "_396:(>level-add-expression,'+',>level-mul-expression)") { Builder = nodes => new CAddExpression(nodes) };
                /* 397 SeqOp            */ __Matchers[397] = new Mx.Seq(this, 397, "_397:(>level-add-expression,'-',>level-mul-expression)") { Builder = nodes => new CSubExpression(nodes) };
                /* 398 AltOp            */ __Matchers[398] = new Mx.Alt(this, 398, "alt(>mul-expression|>div-expression|>rem-expression|>level-union-expression)") { Builder = nodes => nodes[0] };
                /* 399 SeqOp            */ __Matchers[399] = new Mx.Seq(this, 399, "_399:(>level-mul-expression,'*',>level-union-expression)") { Builder = nodes => new CMulExpression(nodes) };
                /* 400 SeqOp            */ __Matchers[400] = new Mx.Seq(this, 400, "_400:(>level-mul-expression,'/',>level-union-expression)") { Builder = nodes => new CDivExpression(nodes) };
                /* 401 SeqOp            */ __Matchers[401] = new Mx.Seq(this, 401, "_401:(>level-mul-expression,'%',>level-union-expression)") { Builder = nodes => new CRemExpression(nodes) };
                /* 402 AltOp            */ __Matchers[402] = new Mx.Alt(this, 402, "alt(>union-expression|>complement-expression|>level-exclusive-expression)") { Builder = nodes => nodes[0] };
                /* 403 SeqOp            */ __Matchers[403] = new Mx.Seq(this, 403, "_403:(>level-union-expression,'|',>level-exclusive-expression)") { Builder = nodes => new CUnionExpression(nodes) };
                /* 404 StringOp         */ __Matchers[404] = new Mx.String(this, 404, "'~'", "~") { Creator = node => new RLiteral(node) };
                /* 405 SeqOp            */ __Matchers[405] = new Mx.Seq(this, 405, "_405:(>level-union-expression,'~',>level-exclusive-expression)") { Builder = nodes => new CComplementExpression(nodes) };
                /* 406 AltOp            */ __Matchers[406] = new Mx.Alt(this, 406, "alt(>exclusive-expression|>level-intersection-expression)") { Builder = nodes => nodes[0] };
                /* 407 SeqOp            */ __Matchers[407] = new Mx.Seq(this, 407, "_407:(>level-exclusive-expression,'^',>level-intersection-expression)") { Builder = nodes => new CExclusiveExpression(nodes) };
                /* 408 AltOp            */ __Matchers[408] = new Mx.Alt(this, 408, "alt(>intersection-expression|>level-negate-expression)") { Builder = nodes => nodes[0] };
                /* 409 SeqOp            */ __Matchers[409] = new Mx.Seq(this, 409, "_409:(>level-intersection-expression,'&',>level-negate-expression)") { Builder = nodes => new CIntersectionExpression(nodes) };
                /* 410 AltOp            */ __Matchers[410] = new Mx.Alt(this, 410, "alt(>negate-expression|>primary-expression)") { Builder = nodes => nodes[0] };
                /* 411 SeqOp            */ __Matchers[411] = new Mx.Seq(this, 411, "_411:('-',>level-negate-expression)") { Builder = nodes => new CNegateExpression(nodes) };
                /* 412 AltOp            */ __Matchers[412] = new Mx.Alt(this, 412, "alt(>reference|>literal|>string-expression|>call-expression|>select-expression|>nullsafe-select-expression|>grouped-expression)") { Builder = nodes => nodes[0] };
                /* 413 SeqOp            */ __Matchers[413] = new Mx.Seq(this, 413, "_413:('(',>expression,')')") { Builder = nodes => new CGroupedExpression(nodes) };
                ...
                /* 431 AltOp            */ __Matchers[431] = new Mx.Alt(this, 431, "alt(>is-condition|>expression)") { Builder = nodes => nodes[0] };
                /* 432 OptionalOp       */ __Matchers[432] = new Mx.Optional(this, 432, "?('!')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 433 SeqOp            */ __Matchers[433] = new Mx.Seq(this, 433, "_433:(?('!'),'is',>type,>name)") { Builder = nodes => new CIsCondition(nodes) };
                ...
                /*  35 PlainRuleOp      */ _operatorDeclaration.Set(__Matchers[231]);
                /*  36 PlainRuleOp      */ _prefixDeclaration.Set(__Matchers[235]);
                /*  37 PlainRuleOp      */ _prefixOperator.Set(__Matchers[238]);
                /*  38 PlainRuleOp      */ _infixDeclaration.Set(__Matchers[240]);
                /*  39 PlainRuleOp      */ _infixOperator.Set(__Matchers[254]);
                /*  40 PlainRuleOp      */ _functionDeclaration.Set(__Matchers[257]);
                /*  41 PlainRuleOp      */ _attributeDeclaration.Set(__Matchers[258]);
                /*  42 PlainRuleOp      */ _varDeclaration.Set(__Matchers[261]);
                /*  43 PlainRuleOp      */ _letDeclaration.Set(__Matchers[263]);
                /*  44 PlainRuleOp      */ _classDeclaration.Set(__Matchers[268]);
                /*  45 PlainRuleOp      */ _interfaceDeclaration.Set(__Matchers[270]);
                /*  46 PlainRuleOp      */ _objectDeclaration.Set(__Matchers[272]);
                /*  47 PlainRuleOp      */ _aliasDeclaration.Set(__Matchers[275]);
                /*  48 PlainRuleOp      */ _constructorDeclaration.Set(__Matchers[278]);
                /*  49 PlainRuleOp      */ _classBody.Set(__Matchers[280]);
                /*  50 PlainRuleOp      */ _interfaceBody.Set(__Matchers[282]);
                /*  51 PlainRuleOp      */ _classMember.Set(__Matchers[283]);
                /*  52 PlainRuleOp      */ _interfaceMember.Set(__Matchers[284]);
                /*  53 PlainRuleOp      */ _functionBody.Set(__Matchers[285]);
                /*  54 PlainRuleOp      */ _attributeBody.Set(__Matchers[285]);
                /*  55 PlainRuleOp      */ _blockBody.Set(__Matchers[286]);
                /*  56 PlainRuleOp      */ _statelarations.Set(__Matchers[287]);
                /*  57 PlainRuleOp      */ _statelaration.Set(__Matchers[288]);
                /*  58 PlainRuleOp      */ _calcBody.Set(__Matchers[289]);
                /*  59 PlainRuleOp      */ _nullBody.Set(__Matchers[290]);
                /*  60 PlainRuleOp      */ _functionSpecifier.Set(__Matchers[291]);
                /*  61 PlainRuleOp      */ _extends.Set(__Matchers[293]);
                /*  62 PlainRuleOp      */ _extendedType.Set(_type);
                /*  63 PlainRuleOp      */ _satisfies.Set(__Matchers[295]);
                /*  64 PlainRuleOp      */ _constraints.Set(__Matchers[296]);
                /*  65 PlainRuleOp      */ _constraint.Set(__Matchers[298]);
                /*  66 PlainRuleOp      */ _unionTypeList.Set(__Matchers[301]);
                /*  67 PlainRuleOp      */ _caseTypes.Set(__Matchers[303]);
                /*  68 PlainRuleOp      */ _caseTypeList.Set(__Matchers[306]);
                /*  69 PlainRuleOp      */ _pattern.Set(_namePattern);
                /*  70 PlainRuleOp      */ _namePattern.Set(__Matchers[307]);
                /*  71 PlainRuleOp      */ _prelude.Set(__Matchers[310]);
                /*  72 PlainRuleOp      */ _attribute.Set(__Matchers[312]);
                /*  73 DfaRuleOp        */ _attributeName.Set(_attributeName_DFA);
                /*  74 PlainRuleOp      */ _type.Set(_unionType);
                /*  75 PlainRuleOp      */ _unionType.Set(__Matchers[315]);
                /*  76 PlainRuleOp      */ _intersectionType.Set(__Matchers[318]);
                /*  77 PlainRuleOp      */ _primaryType.Set(__Matchers[319]);
                /*  78 PlainRuleOp      */ _nullableType.Set(__Matchers[321]);
                /*  79 PlainRuleOp      */ _arrayType.Set(__Matchers[324]);
                ...
                /*  86 PlainRuleOp      */ _emptyType.Set(__Matchers[333]);
                /*  87 PlainRuleOp      */ _tupleType.Set(__Matchers[334]);
                /*  88 PlainRuleOp      */ _nothingType.Set(__Matchers[336]);
                /*  89 PlainRuleOp      */ _parameters.Set(__Matchers[338]);
                /*  90 PlainRuleOp      */ _parameterList.Set(__Matchers[341]);
                /*  91 PlainRuleOp      */ _parameter.Set(_valueParameter);
                /*  92 PlainRuleOp      */ _valueParameter.Set(__Matchers[343]);
                /*  93 PlainRuleOp      */ _definitiveParameter.Set(__Matchers[344]);
                /*  94 PlainRuleOp      */ _valueDefault.Set(__Matchers[345]);
                /*  95 PlainRuleOp      */ _parameterType.Set(_type);
                /*  96 PlainRuleOp      */ _arguments.Set(__Matchers[347]);
                /*  97 PlainRuleOp      */ _argumentList.Set(__Matchers[350]);
                /*  98 PlainRuleOp      */ _statement.Set(__Matchers[351]);
                /*  99 PlainRuleOp      */ _assignStatement.Set(__Matchers[352]);
                /* 100 PlainRuleOp      */ _expressionStatement.Set(__Matchers[353]);
                /* 101 PlainRuleOp      */ _ifStatement.Set(__Matchers[357]);
                /* 102 PlainRuleOp      */ _elseIf.Set(__Matchers[359]);
                /* 103 PlainRuleOp      */ _elseBlock.Set(__Matchers[360]);
                /* 104 PlainRuleOp      */ _forStatement.Set(__Matchers[362]);
                /* 105 PlainRuleOp      */ _whileStatement.Set(__Matchers[364]);
                /* 106 PlainRuleOp      */ _returnStatement.Set(__Matchers[367]);
                /* 107 PlainRuleOp      */ _throwStatement.Set(__Matchers[369]);
                /* 108 PlainRuleOp      */ _assertStatement.Set(__Matchers[371]);
                /* 109 PlainRuleOp      */ _expression.Set(__Matchers[372]);
                /* 110 PlainRuleOp      */ _levelCoalesceExpression.Set(__Matchers[373]);
                /* 111 PlainRuleOp      */ _thenExpression.Set(__Matchers[375]);
                /* 112 PlainRuleOp      */ _elseExpression.Set(__Matchers[376]);
                /* 113 PlainRuleOp      */ _levelDisjunctionExpression.Set(__Matchers[377]);
                /* 114 PlainRuleOp      */ _disjunctionExpression.Set(__Matchers[379]);
                /* 115 PlainRuleOp      */ _levelConjunctionExpression.Set(__Matchers[380]);
                /* 116 PlainRuleOp      */ _conjunctionExpression.Set(__Matchers[382]);
                /* 117 PlainRuleOp      */ _levelNotExpression.Set(__Matchers[383]);
                /* 118 PlainRuleOp      */ _notExpression.Set(__Matchers[384]);
                /* 119 PlainRuleOp      */ _levelEqualityExpression.Set(__Matchers[385]);
                /* 120 PlainRuleOp      */ _equalExpression.Set(__Matchers[386]);
                /* 121 PlainRuleOp      */ _notEqualExpression.Set(__Matchers[387]);
                /* 122 PlainRuleOp      */ _identicalExpression.Set(__Matchers[388]);
                /* 123 PlainRuleOp      */ _notIdenticalExpression.Set(__Matchers[389]);
                /* 124 PlainRuleOp      */ _levelCompareExpression.Set(__Matchers[390]);
                /* 125 PlainRuleOp      */ _lessExpression.Set(__Matchers[391]);
                /* 126 PlainRuleOp      */ _lessEqualExpression.Set(__Matchers[392]);
                /* 127 PlainRuleOp      */ _greaterExpression.Set(__Matchers[393]);
                /* 128 PlainRuleOp      */ _greaterEqualExpression.Set(__Matchers[394]);
                /* 129 PlainRuleOp      */ _levelAddExpression.Set(__Matchers[395]);
                /* 130 PlainRuleOp      */ _addExpression.Set(__Matchers[396]);
                /* 131 PlainRuleOp      */ _subExpression.Set(__Matchers[397]);
                /* 132 PlainRuleOp      */ _levelMulExpression.Set(__Matchers[398]);
                /* 133 PlainRuleOp      */ _mulExpression.Set(__Matchers[399]);
                /* 134 PlainRuleOp      */ _divExpression.Set(__Matchers[400]);
                /* 135 PlainRuleOp      */ _remExpression.Set(__Matchers[401]);
                /* 136 PlainRuleOp      */ _levelUnionExpression.Set(__Matchers[402]);
                /* 137 PlainRuleOp      */ _unionExpression.Set(__Matchers[403]);
                /* 138 PlainRuleOp      */ _complementExpression.Set(__Matchers[405]);
                /* 139 PlainRuleOp      */ _levelExclusiveExpression.Set(__Matchers[406]);
                /* 140 PlainRuleOp      */ _exclusiveExpression.Set(__Matchers[407]);
                /* 141 PlainRuleOp      */ _levelIntersectionExpression.Set(__Matchers[408]);
                /* 142 PlainRuleOp      */ _intersectionExpression.Set(__Matchers[409]);
                /* 143 PlainRuleOp      */ _levelNegateExpression.Set(__Matchers[410]);
                /* 144 PlainRuleOp      */ _negateExpression.Set(__Matchers[411]);
                /* 145 PlainRuleOp      */ _primaryExpression.Set(__Matchers[412]);
                /* 146 PlainRuleOp      */ _groupedExpression.Set(__Matchers[413]);
                /* 147 PlainRuleOp      */ _callExpression.Set(__Matchers[414]);
                /* 148 PlainRuleOp      */ _selectExpression.Set(__Matchers[415]);
                /* 149 PlainRuleOp      */ _nullsafeSelectExpression.Set(__Matchers[417]);
                /* 150 PlainRuleOp      */ _literal.Set(_naturalLiteral);
                /* 151 PlainRuleOp      */ _stringExpression.Set(__Matchers[418]);
                /* 152 PlainRuleOp      */ _stringLiteral.Set(__Matchers[419]);
                /* 153 PlainRuleOp      */ _stringInterpolation.Set(__Matchers[421]);
                /* 154 PlainRuleOp      */ _interpolationPart.Set(__Matchers[422]);
                /* 155 PlainRuleOp      */ _ifExpression.Set(__Matchers[423]);
                /* 156 PlainRuleOp      */ _ifThen.Set(__Matchers[424]);
                /* 157 PlainRuleOp      */ _ifElse.Set(__Matchers[425]);
                /* 158 PlainRuleOp      */ _conditionalExpression.Set(__Matchers[426]);
                /* 159 PlainRuleOp      */ _conditions.Set(__Matchers[427]);
                /* 160 PlainRuleOp      */ _conditionList.Set(__Matchers[430]);
                /* 161 PlainRuleOp      */ _condition.Set(__Matchers[431]);
                /* 162 PlainRuleOp      */ _isCondition.Set(__Matchers[433]);
                ...
                /* 240 SeqOp            */ __Matchers[240].Set(_prelude, __Matchers[239], _type, _infixOperator, __Matchers[233], _definitiveParameter, __Matchers[234], _functionBody);
                /* 254 AltOp            */ __Matchers[254].Set(__Matchers[241], __Matchers[236], __Matchers[242], __Matchers[243], __Matchers[244], __Matchers[209], __Matchers[245], __Matchers[211], __Matchers[246], __Matchers[247], __Matchers[248], __Matchers[249], __Matchers[250], __Matchers[251], __Matchers[252], __Matchers[253]);
                /* 255 OptionalOp       */ __Matchers[255].Set(_genericParameters);
                /* 256 OptionalOp       */ __Matchers[256].Set(_constraints);
                /* 257 SeqOp            */ __Matchers[257].Set(_prelude, _type, _name, __Matchers[255], _parameters, __Matchers[256], _functionBody);
                /* 258 SeqOp            */ __Matchers[258].Set(_prelude, _type, _name, _attributeBody);
                /* 260 OptionalOp       */ __Matchers[260].Set(_type);
                /* 261 SeqOp            */ __Matchers[261].Set(_prelude, __Matchers[259], __Matchers[260], _name, __Matchers[200], _expression, __Matchers[175]);
                /* 263 SeqOp            */ __Matchers[263].Set(_prelude, __Matchers[262], __Matchers[260], _name, __Matchers[200], _expression, __Matchers[175]);
                /* 265 OptionalOp       */ __Matchers[265].Set(_extends);
                /* 266 OptionalOp       */ __Matchers[266].Set(_satisfies);
                /* 267 OptionalOp       */ __Matchers[267].Set(_caseTypes);
                /* 268 SeqOp            */ __Matchers[268].Set(_prelude, __Matchers[264], _name, __Matchers[255], __Matchers[265], __Matchers[266], __Matchers[267], __Matchers[256], _classBody);
                /* 270 SeqOp            */ __Matchers[270].Set(_prelude, __Matchers[269], _name, __Matchers[255], __Matchers[266], __Matchers[267], __Matchers[256], _interfaceBody);
                /* 272 SeqOp            */ __Matchers[272].Set(_prelude, __Matchers[271], _name, __Matchers[265], __Matchers[266], _classBody);
                /* 275 SeqOp            */ __Matchers[275].Set(_prelude, __Matchers[273], _name, __Matchers[255], __Matchers[256], __Matchers[274], _type, __Matchers[175]);
                /* 277 OptionalOp       */ __Matchers[277].Set(_name);
                /* 278 SeqOp            */ __Matchers[278].Set(_prelude, __Matchers[276], __Matchers[277], _parameters, __Matchers[265], _functionBody);
                /* 279 StarOp           */ __Matchers[279].Set(_classMember);
                /* 280 SeqOp            */ __Matchers[280].Set(__Matchers[181], _usings, __Matchers[279], __Matchers[183]);
                /* 281 StarOp           */ __Matchers[281].Set(_interfaceMember);
                /* 282 SeqOp            */ __Matchers[282].Set(__Matchers[181], _usings, __Matchers[281], __Matchers[183]);
                /* 283 AltOp            */ __Matchers[283].Set(_universalDeclaration, _constructorDeclaration, _operatorDeclaration, _attributeDeclaration, _letDeclaration, _varDeclaration);
                /* 284 AltOp            */ __Matchers[284].Set(_universalDeclaration, _constructorDeclaration, _attributeDeclaration);
                /* 285 AltOp            */ __Matchers[285].Set(_calcBody, _blockBody, _nullBody);
                ...
                /* 290 SeqOp            */ __Matchers[290].Set(__Matchers[175]);
                /* 291 SeqOp            */ __Matchers[291].Set(__Matchers[274], _expression);
                /* 293 SeqOp            */ __Matchers[293].Set(__Matchers[292], _extendedType);
                /* 295 SeqOp            */ __Matchers[295].Set(__Matchers[294], _unionTypeList);
                /* 296 PlusOp           */ __Matchers[296].Set(_constraint);
                /* 298 SeqOp            */ __Matchers[298].Set(__Matchers[297], _name, __Matchers[255], __Matchers[267], __Matchers[266]);
                /* 299 SeqOp            */ __Matchers[299].Set(__Matchers[192], _type);
                /* 300 StarOp           */ __Matchers[300].Set(__Matchers[299]);
                /* 301 SeqOp            */ __Matchers[301].Set(_type, __Matchers[300]);
                /* 303 SeqOp            */ __Matchers[303].Set(__Matchers[302], _caseTypeList);
                /* 304 SeqOp            */ __Matchers[304].Set(__Matchers[251], _type);
                /* 305 StarOp           */ __Matchers[305].Set(__Matchers[304]);
                /* 306 SeqOp            */ __Matchers[306].Set(_type, __Matchers[305]);
                /* 307 SeqOp            */ __Matchers[307].Set(_name);
                /* 308 OptionalOp       */ __Matchers[308].Set(_stringLiteral);
                /* 309 StarOp           */ __Matchers[309].Set(_attribute);
                /* 310 SeqOp            */ __Matchers[310].Set(__Matchers[308], __Matchers[309]);
                /* 311 OptionalOp       */ __Matchers[311].Set(_arguments);
                /* 312 SeqOp            */ __Matchers[312].Set(_attributeName, __Matchers[311]);
                /* 313 SeqOp            */ __Matchers[313].Set(__Matchers[251], _intersectionType);
                /* 314 StarOp           */ __Matchers[314].Set(__Matchers[313]);
                /* 315 SeqOp            */ __Matchers[315].Set(_intersectionType, __Matchers[314]);
                /* 316 SeqOp            */ __Matchers[316].Set(__Matchers[252], _primaryType);
                /* 317 StarOp           */ __Matchers[317].Set(__Matchers[316]);
                /* 318 SeqOp            */ __Matchers[318].Set(_primaryType, __Matchers[317]);
                /* 319 AltOp            */ __Matchers[319].Set(_nullableType, _arrayType, _reference, _typeSelector, _callableType, _emptyType, _tupleType, _nothingType);
                /* 321 SeqOp            */ __Matchers[321].Set(_primaryType, __Matchers[320]);
                /* 324 SeqOp            */ __Matchers[324].Set(_primaryType, __Matchers[322], __Matchers[323]);
                /* 325 SeqOp            */ __Matchers[325].Set(_primaryType, __Matchers[203], _reference);
                /* 326 OptionalOp       */ __Matchers[326].Set(_callableArguments);
                /* 327 SeqOp            */ __Matchers[327].Set(_primaryType, __Matchers[233], __Matchers[326], __Matchers[234]);
                ...
                /* 333 SeqOp            */ __Matchers[333].Set(__Matchers[322], __Matchers[323]);
                /* 334 SeqOp            */ __Matchers[334].Set(__Matchers[322], _typeList, __Matchers[323]);
                /* 336 SeqOp            */ __Matchers[336].Set(__Matchers[335]);
                /* 337 OptionalOp       */ __Matchers[337].Set(_parameterList);
                /* 338 SeqOp            */ __Matchers[338].Set(__Matchers[233], __Matchers[337], __Matchers[234]);
                /* 339 SeqOp            */ __Matchers[339].Set(__Matchers[192], _parameter);
                /* 340 StarOp           */ __Matchers[340].Set(__Matchers[339]);
                /* 341 SeqOp            */ __Matchers[341].Set(_parameter, __Matchers[340]);
                /* 342 OptionalOp       */ __Matchers[342].Set(_valueDefault);
                /* 343 SeqOp            */ __Matchers[343].Set(_prelude, _parameterType, _name, __Matchers[342]);
                /* 344 SeqOp            */ __Matchers[344].Set(_prelude, _parameterType, _name);
                /* 345 SeqOp            */ __Matchers[345].Set(__Matchers[200], _expression);
                /* 346 OptionalOp       */ __Matchers[346].Set(_argumentList);
                /* 347 SeqOp            */ __Matchers[347].Set(__Matchers[233], __Matchers[346], __Matchers[234]);
                /* 348 SeqOp            */ __Matchers[348].Set(__Matchers[192], _expression);
                /* 349 StarOp           */ __Matchers[349].Set(__Matchers[348]);
                /* 350 SeqOp            */ __Matchers[350].Set(_expression, __Matchers[349]);
                /* 351 AltOp            */ __Matchers[351].Set(_assignStatement, _expressionStatement, _ifStatement, _forStatement, _whileStatement, _assertStatement, _returnStatement, _throwStatement);
                /* 352 SeqOp            */ __Matchers[352].Set(_primaryExpression, __Matchers[200], _expression, __Matchers[175]);
                /* 353 SeqOp            */ __Matchers[353].Set(_expression, __Matchers[175]);
                /* 355 StarOp           */ __Matchers[355].Set(_elseIf);
                /* 356 OptionalOp       */ __Matchers[356].Set(_elseBlock);
                /* 357 SeqOp            */ __Matchers[357].Set(__Matchers[354], _conditions, _blockBody, __Matchers[355], __Matchers[356]);
                /* 359 SeqOp            */ __Matchers[359].Set(__Matchers[358], __Matchers[354], _conditions, _blockBody);
                /* 360 SeqOp            */ __Matchers[360].Set(__Matchers[358], _blockBody);
                /* 362 SeqOp            */ __Matchers[362].Set(__Matchers[361], __Matchers[233], _pattern, __Matchers[225], _expression, __Matchers[234], _blockBody, __Matchers[356]);
                /* 364 SeqOp            */ __Matchers[364].Set(__Matchers[363], _conditions, _blockBody);
                /* 366 OptionalOp       */ __Matchers[366].Set(_expression);
                /* 367 SeqOp            */ __Matchers[367].Set(__Matchers[365], __Matchers[366], __Matchers[175]);
                /* 369 SeqOp            */ __Matchers[369].Set(__Matchers[368], __Matchers[366], __Matchers[175]);
                /* 371 SeqOp            */ __Matchers[371].Set(__Matchers[308], __Matchers[370], _conditions, __Matchers[175]);
                /* 372 AltOp            */ __Matchers[372].Set(_ifExpression, _levelCoalesceExpression);
                /* 373 AltOp            */ __Matchers[373].Set(_thenExpression, _elseExpression, _levelDisjunctionExpression);
                /* 375 SeqOp            */ __Matchers[375].Set(_levelCoalesceExpression, __Matchers[374], _levelDisjunctionExpression);
                /* 376 SeqOp            */ __Matchers[376].Set(_levelCoalesceExpression, __Matchers[358], _levelDisjunctionExpression);
                /* 377 AltOp            */ __Matchers[377].Set(_disjunctionExpression, _levelConjunctionExpression);
                /* 379 SeqOp            */ __Matchers[379].Set(_levelDisjunctionExpression, __Matchers[378], _levelConjunctionExpression);
                /* 380 AltOp            */ __Matchers[380].Set(_conjunctionExpression, _levelNotExpression);
                /* 382 SeqOp            */ __Matchers[382].Set(_levelConjunctionExpression, __Matchers[381], _levelNotExpression);
                /* 383 AltOp            */ __Matchers[383].Set(_notExpression, _levelEqualityExpression);
                /* 384 SeqOp            */ __Matchers[384].Set(__Matchers[237], _levelNotExpression);
                /* 385 AltOp            */ __Matchers[385].Set(_equalExpression, _notEqualExpression, _identicalExpression, _notIdenticalExpression, _levelCompareExpression);
                /* 386 SeqOp            */ __Matchers[386].Set(_levelCompareExpression, __Matchers[247], _levelCompareExpression);
                /* 387 SeqOp            */ __Matchers[387].Set(_levelCompareExpression, __Matchers[248], _levelCompareExpression);
                ...
                /* 390 AltOp            */ __Matchers[390].Set(_lessExpression, _lessEqualExpression, _greaterExpression, _greaterEqualExpression, _levelAddExpression);
                /* 391 SeqOp            */ __Matchers[391].Set(_levelAddExpression, __Matchers[209], _levelAddExpression);
                /* 392 SeqOp            */ __Matchers[392].Set(_levelAddExpression, __Matchers[245], _levelAddExpression);
                /* 393 SeqOp            */ __Matchers[393].Set(_levelAddExpression, __Matchers[211], _levelAddExpression);
                /* 394 SeqOp            */ __Matchers[394].Set(_levelAddExpression, __Matchers[246], _levelAddExpression);
                /* 395 AltOp            */ __Matchers[395].Set(_addExpression, _subExpression, _levelMulExpression);
                /* 396 SeqOp            */ __Matchers[396].Set(_levelAddExpression, __Matchers[241], _levelMulExpression);
                /* 397 SeqOp            */ __Matchers[397].Set(_levelAddExpression, __Matchers[236], _levelMulExpression);
                /* 398 AltOp            */ __Matchers[398].Set(_mulExpression, _divExpression, _remExpression, _levelUnionExpression);
                /* 399 SeqOp            */ __Matchers[399].Set(_levelMulExpression, __Matchers[242], _levelUnionExpression);
                /* 400 SeqOp            */ __Matchers[400].Set(_levelMulExpression, __Matchers[243], _levelUnionExpression);
                /* 401 SeqOp            */ __Matchers[401].Set(_levelMulExpression, __Matchers[244], _levelUnionExpression);
                /* 402 AltOp            */ __Matchers[402].Set(_unionExpression, _complementExpression, _levelExclusiveExpression);
                /* 403 SeqOp            */ __Matchers[403].Set(_levelUnionExpression, __Matchers[251], _levelExclusiveExpression);
                /* 405 SeqOp            */ __Matchers[405].Set(_levelUnionExpression, __Matchers[404], _levelExclusiveExpression);
                /* 406 AltOp            */ __Matchers[406].Set(_exclusiveExpression, _levelIntersectionExpression);
                /* 407 SeqOp            */ __Matchers[407].Set(_levelExclusiveExpression, __Matchers[253], _levelIntersectionExpression);
                /* 408 AltOp            */ __Matchers[408].Set(_intersectionExpression, _levelNegateExpression);
                /* 409 SeqOp            */ __Matchers[409].Set(_levelIntersectionExpression, __Matchers[252], _levelNegateExpression);
                /* 410 AltOp            */ __Matchers[410].Set(_negateExpression, _primaryExpression);
                /* 411 SeqOp            */ __Matchers[411].Set(__Matchers[236], _levelNegateExpression);
                /* 412 AltOp            */ __Matchers[412].Set(_reference, _literal, _stringExpression, _callExpression, _selectExpression, _nullsafeSelectExpression, _groupedExpression);
                /* 413 SeqOp            */ __Matchers[413].Set(__Matchers[233], _expression, __Matchers[234]);
                /* 414 SeqOp            */ __Matchers[414].Set(_primaryExpression, _arguments);
                /* 415 SeqOp            */ __Matchers[415].Set(_primaryExpression, __Matchers[203], _reference);
                ...
                /* 423 SeqOp            */ __Matchers[423].Set(__Matchers[354], _conditions, _ifThen, _ifElse);
                /* 424 SeqOp            */ __Matchers[424].Set(__Matchers[374], _conditionalExpression);
                /* 425 SeqOp            */ __Matchers[425].Set(__Matchers[358], _conditionalExpression);
                /* 426 AltOp            */ __Matchers[426].Set(_ifExpression, _levelDisjunctionExpression);
                /* 427 SeqOp            */ __Matchers[427].Set(__Matchers[233], _conditionList, __Matchers[234]);
                /* 428 SeqOp            */ __Matchers[428].Set(__Matchers[192], _condition);
                /* 429 StarOp           */ __Matchers[429].Set(__Matchers[428]);
                /* 430 SeqOp            */ __Matchers[430].Set(_condition, __Matchers[429]);
                /* 431 AltOp            */ __Matchers[431].Set(_isCondition, _expression);
                /* 432 OptionalOp       */ __Matchers[432].Set(__Matchers[237]);
                /* 433 SeqOp            */ __Matchers[433].Set(__Matchers[432], __Matchers[294], _type, _name);
