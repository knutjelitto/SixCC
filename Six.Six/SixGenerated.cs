// <generated from="D:\\Six\\Six.Six\\Six.six" at="10.03.2022 06:17:42" />
    ...
    public partial class SixParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[436])
            {
                ...
                /*  61 PlainRuleOp      */ __Matchers[61] = _extendType = new Mx.PlainRule(this, 61, "extend-type") { Builder = nodes => nodes[0] };
                /*  62 PlainRuleOp      */ __Matchers[62] = _constructor = new Mx.PlainRule(this, 62, "constructor") { Builder = nodes => nodes[0] };
                ...
                /* 230 AltOp            */ __Matchers[230] = new Mx.Alt(this, 230, "alt(>function-declaration|>class-declaration|>interface-declaration|>object-declaration|>alias-declaration)") { Builder = nodes => nodes[0] };
                /* 231 AltOp            */ __Matchers[231] = new Mx.Alt(this, 231, "alt(>universal-declaration|>constructor-declaration|>let-declaration|>var-declaration|>operator-declaration|>attribute-declaration)") { Builder = nodes => nodes[0] };
                /* 232 StringOp         */ __Matchers[232] = new Mx.Keyword(this, 232, "'primitive'", "primitive") { Creator = node => new RLiteral(node) };
                /* 233 OptionalOp       */ __Matchers[233] = new Mx.Optional(this, 233, "?(>case-types)") { Builder = nodes => new ROptional<CCaseTypes>(nodes) };
                /* 234 SeqOp            */ __Matchers[234] = new Mx.Seq(this, 234, "_234:(>prelude,'primitive',>name,?(>case-types),>block-body)") { Builder = nodes => new CPrimitiveDeclaration(nodes) };
                ...
                /* 282 AltOp            */ __Matchers[282] = new Mx.Alt(this, 282, "alt(>calc-body|>block-body|>null-body)") { Builder = nodes => nodes[0] };
                /* 283 AltOp            */ __Matchers[283] = new Mx.Alt(this, 283, "alt(>calc-body|>value-body|>block-body|>null-body)") { Builder = nodes => nodes[0] };
                ...
                /* 290 SeqOp            */ __Matchers[290] = new Mx.Seq(this, 290, "_290:('=>',>expression)") { Builder = nodes => new CFunctionSpecifier(nodes) };
                /* 291 SeqOp            */ __Matchers[291] = new Mx.Seq(this, 291, "_291:('=',>expression)") { Builder = nodes => new CValueSpecifier(nodes) };
                /* 292 StringOp         */ __Matchers[292] = new Mx.String(this, 292, "':'", ":") { Creator = node => new RLiteral(node) };
                /* 293 SeqOp            */ __Matchers[293] = new Mx.Seq(this, 293, "_293:(':',>extend-type)") { Builder = nodes => new CExtends(nodes) };
                /* 294 AltOp            */ __Matchers[294] = new Mx.Alt(this, 294, "alt(>type|>constructor)") { Builder = nodes => nodes[0] };
                /* 295 SeqOp            */ __Matchers[295] = new Mx.Seq(this, 295, "_295:(>primary-type,>arguments)") { Builder = nodes => new CConstructor(nodes) };
                ...
                /*  58 PlainRuleOp      */ _functionSpecifier.Set(__Matchers[290]);
                /*  59 PlainRuleOp      */ _valueSpecifier.Set(__Matchers[291]);
                /*  60 PlainRuleOp      */ _extends.Set(__Matchers[293]);
                /*  61 PlainRuleOp      */ _extendType.Set(__Matchers[294]);
                /*  62 PlainRuleOp      */ _constructor.Set(__Matchers[295]);
                ...
                /* 230 AltOp            */ __Matchers[230].Set(_functionDeclaration, _classDeclaration, _interfaceDeclaration, _objectDeclaration, _aliasDeclaration);
                /* 231 AltOp            */ __Matchers[231].Set(_universalDeclaration, _constructorDeclaration, _letDeclaration, _varDeclaration, _operatorDeclaration, _attributeDeclaration);
                ...
                /* 282 AltOp            */ __Matchers[282].Set(_calcBody, _blockBody, _nullBody);
                /* 283 AltOp            */ __Matchers[283].Set(_calcBody, _valueBody, _blockBody, _nullBody);
                ...
                /* 290 SeqOp            */ __Matchers[290].Set(__Matchers[277], _expression);
                /* 291 SeqOp            */ __Matchers[291].Set(__Matchers[200], _expression);
                /* 293 SeqOp            */ __Matchers[293].Set(__Matchers[292], _extendType);
                /* 294 AltOp            */ __Matchers[294].Set(_type, _constructor);
                /* 295 SeqOp            */ __Matchers[295].Set(_primaryType, _arguments);
                /* 297 SeqOp            */ __Matchers[297].Set(__Matchers[296], _unionTypeList);
                /* 298 PlusOp           */ __Matchers[298].Set(_constraint);
                /* 300 SeqOp            */ __Matchers[300].Set(__Matchers[299], _name, __Matchers[259], __Matchers[233], __Matchers[270]);
                /* 301 SeqOp            */ __Matchers[301].Set(__Matchers[192], _type);
                ...
                /* 306 SeqOp            */ __Matchers[306].Set(__Matchers[255], _type);
                ...
                /* 315 SeqOp            */ __Matchers[315].Set(__Matchers[255], _intersectionType);
                /* 316 StarOp           */ __Matchers[316].Set(__Matchers[315]);
                /* 317 SeqOp            */ __Matchers[317].Set(_intersectionType, __Matchers[316]);
                /* 318 SeqOp            */ __Matchers[318].Set(__Matchers[256], _primaryType);
                ...
                /* 327 SeqOp            */ __Matchers[327].Set(_primaryType, __Matchers[203], _reference);
                /* 328 OptionalOp       */ __Matchers[328].Set(_callableArguments);
                /* 329 SeqOp            */ __Matchers[329].Set(_primaryType, __Matchers[237], __Matchers[328], __Matchers[238]);
                /* 330 SeqOp            */ __Matchers[330].Set(__Matchers[192], _typeListType);
                ...
                /* 334 SeqOp            */ __Matchers[334].Set(_type, __Matchers[200]);
                ...
                /* 373 SeqOp            */ __Matchers[373].Set(__Matchers[310], __Matchers[372], _conditions, __Matchers[175]);
