// <generated from="D:\\Six\\Six.Six\\Six.six" at="15.03.2022 06:34:34" />
    ...
    public partial class SixParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[439])
            {
                ...
                /*  59 PlainRuleOp      */ __Matchers[59] = _valueBody = new Mx.PlainRule(this, 59, "value-body") { Builder = nodes => nodes[0] };
                /*  60 PlainRuleOp      */ __Matchers[60] = _nullBody = new Mx.PlainRule(this, 60, "null-body") { Builder = nodes => nodes[0] };
                /*  61 PlainRuleOp      */ __Matchers[61] = _functionSpecifier = new Mx.PlainRule(this, 61, "function-specifier") { Builder = nodes => nodes[0] };
                /*  62 PlainRuleOp      */ __Matchers[62] = _valueSpecifier = new Mx.PlainRule(this, 62, "value-specifier") { Builder = nodes => nodes[0] };
                /*  63 PlainRuleOp      */ __Matchers[63] = _extends = new Mx.PlainRule(this, 63, "extends") { Builder = nodes => nodes[0] };
                /*  64 PlainRuleOp      */ __Matchers[64] = _extendedType = new Mx.PlainRule(this, 64, "extended-type") { Builder = nodes => nodes[0] };
                /*  65 PlainRuleOp      */ __Matchers[65] = _satisfies = new Mx.PlainRule(this, 65, "satisfies") { Builder = nodes => nodes[0] };
                /*  66 PlainRuleOp      */ __Matchers[66] = _constraints = new Mx.PlainRule(this, 66, "constraints") { Builder = nodes => nodes[0] };
                /*  67 PlainRuleOp      */ __Matchers[67] = _constraint = new Mx.PlainRule(this, 67, "constraint") { Builder = nodes => nodes[0] };
                /*  68 PlainRuleOp      */ __Matchers[68] = _unionTypeList = new Mx.PlainRule(this, 68, "union-type-list") { Builder = nodes => nodes[0] };
                /*  69 PlainRuleOp      */ __Matchers[69] = _caseTypes = new Mx.PlainRule(this, 69, "case-types") { Builder = nodes => nodes[0] };
                /*  70 PlainRuleOp      */ __Matchers[70] = _caseTypeList = new Mx.PlainRule(this, 70, "case-type-list") { Builder = nodes => nodes[0] };
                /*  71 PlainRuleOp      */ __Matchers[71] = _pattern = new Mx.PlainRule(this, 71, "pattern") { Builder = nodes => nodes[0] };
                /*  72 PlainRuleOp      */ __Matchers[72] = _namePattern = new Mx.PlainRule(this, 72, "name-pattern") { Builder = nodes => nodes[0] };
                /*  73 PlainRuleOp      */ __Matchers[73] = _prelude = new Mx.PlainRule(this, 73, "prelude") { Builder = nodes => nodes[0] };
                /*  74 PlainRuleOp      */ __Matchers[74] = _attribute = new Mx.PlainRule(this, 74, "attribute") { Builder = nodes => nodes[0] };
                /*  75 DfaRuleOp        */ __Matchers[75] = _attributeName = new Mx.DfaRule(this, 75, "attribute-name") { Creator = node => new CAttributeName(node) };
                /*  76 PlainRuleOp      */ __Matchers[76] = _type = new Mx.PlainRule(this, 76, "type") { Builder = nodes => nodes[0] };
                ...
                /*  81 PlainRuleOp      */ __Matchers[81] = _arrayType = new Mx.PlainRule(this, 81, "array-type") { Builder = nodes => nodes[0] };
                ...
                /*  88 PlainRuleOp      */ __Matchers[88] = _emptyType = new Mx.PlainRule(this, 88, "empty-type") { Builder = nodes => nodes[0] };
                /*  89 PlainRuleOp      */ __Matchers[89] = _tupleType = new Mx.PlainRule(this, 89, "tuple-type") { Builder = nodes => nodes[0] };
                /*  90 PlainRuleOp      */ __Matchers[90] = _nothingType = new Mx.PlainRule(this, 90, "nothing-type") { Builder = nodes => nodes[0] };
                /*  91 PlainRuleOp      */ __Matchers[91] = _parameters = new Mx.PlainRule(this, 91, "parameters") { Builder = nodes => nodes[0] };
                /*  92 PlainRuleOp      */ __Matchers[92] = _parameterList = new Mx.PlainRule(this, 92, "parameter-list") { Builder = nodes => nodes[0] };
                /*  93 PlainRuleOp      */ __Matchers[93] = _parameter = new Mx.PlainRule(this, 93, "parameter") { Builder = nodes => nodes[0] };
                /*  94 PlainRuleOp      */ __Matchers[94] = _valueParameter = new Mx.PlainRule(this, 94, "value-parameter") { Builder = nodes => nodes[0] };
                /*  95 PlainRuleOp      */ __Matchers[95] = _definitiveParameter = new Mx.PlainRule(this, 95, "definitive-parameter") { Builder = nodes => nodes[0] };
                /*  96 PlainRuleOp      */ __Matchers[96] = _valueDefault = new Mx.PlainRule(this, 96, "value-default") { Builder = nodes => nodes[0] };
                /*  97 PlainRuleOp      */ __Matchers[97] = _parameterType = new Mx.PlainRule(this, 97, "parameter-type") { Builder = nodes => nodes[0] };
                /*  98 PlainRuleOp      */ __Matchers[98] = _arguments = new Mx.PlainRule(this, 98, "arguments") { Builder = nodes => nodes[0] };
                /*  99 PlainRuleOp      */ __Matchers[99] = _argumentList = new Mx.PlainRule(this, 99, "argument-list") { Builder = nodes => nodes[0] };
                /* 100 PlainRuleOp      */ __Matchers[100] = _statement = new Mx.PlainRule(this, 100, "statement") { Builder = nodes => nodes[0] };
                /* 101 PlainRuleOp      */ __Matchers[101] = _assignStatement = new Mx.PlainRule(this, 101, "assign-statement") { Builder = nodes => nodes[0] };
                /* 102 PlainRuleOp      */ __Matchers[102] = _expressionStatement = new Mx.PlainRule(this, 102, "expression-statement") { Builder = nodes => nodes[0] };
                /* 103 PlainRuleOp      */ __Matchers[103] = _ifStatement = new Mx.PlainRule(this, 103, "if-statement") { Builder = nodes => nodes[0] };
                /* 104 PlainRuleOp      */ __Matchers[104] = _elseIf = new Mx.PlainRule(this, 104, "else-if") { Builder = nodes => nodes[0] };
                /* 105 PlainRuleOp      */ __Matchers[105] = _elseBlock = new Mx.PlainRule(this, 105, "else-block") { Builder = nodes => nodes[0] };
                /* 106 PlainRuleOp      */ __Matchers[106] = _forStatement = new Mx.PlainRule(this, 106, "for-statement") { Builder = nodes => nodes[0] };
                /* 107 PlainRuleOp      */ __Matchers[107] = _whileStatement = new Mx.PlainRule(this, 107, "while-statement") { Builder = nodes => nodes[0] };
                /* 108 PlainRuleOp      */ __Matchers[108] = _returnStatement = new Mx.PlainRule(this, 108, "return-statement") { Builder = nodes => nodes[0] };
                /* 109 PlainRuleOp      */ __Matchers[109] = _throwStatement = new Mx.PlainRule(this, 109, "throw-statement") { Builder = nodes => nodes[0] };
                /* 110 PlainRuleOp      */ __Matchers[110] = _assertStatement = new Mx.PlainRule(this, 110, "assert-statement") { Builder = nodes => nodes[0] };
                /* 111 PlainRuleOp      */ __Matchers[111] = _expression = new Mx.PlainRule(this, 111, "expression") { Builder = nodes => nodes[0] };
                /* 112 PlainRuleOp      */ __Matchers[112] = _levelCoalesceExpression = new Mx.PlainRule(this, 112, "level-coalesce-expression") { Builder = nodes => nodes[0] };
                /* 113 PlainRuleOp      */ __Matchers[113] = _thenExpression = new Mx.PlainRule(this, 113, "then-expression") { Builder = nodes => nodes[0] };
                /* 114 PlainRuleOp      */ __Matchers[114] = _elseExpression = new Mx.PlainRule(this, 114, "else-expression") { Builder = nodes => nodes[0] };
                /* 115 PlainRuleOp      */ __Matchers[115] = _levelDisjunctionExpression = new Mx.PlainRule(this, 115, "level-disjunction-expression") { Builder = nodes => nodes[0] };
                /* 116 PlainRuleOp      */ __Matchers[116] = _disjunctionExpression = new Mx.PlainRule(this, 116, "disjunction-expression") { Builder = nodes => nodes[0] };
                /* 117 PlainRuleOp      */ __Matchers[117] = _levelConjunctionExpression = new Mx.PlainRule(this, 117, "level-conjunction-expression") { Builder = nodes => nodes[0] };
                /* 118 PlainRuleOp      */ __Matchers[118] = _conjunctionExpression = new Mx.PlainRule(this, 118, "conjunction-expression") { Builder = nodes => nodes[0] };
                /* 119 PlainRuleOp      */ __Matchers[119] = _levelNotExpression = new Mx.PlainRule(this, 119, "level-not-expression") { Builder = nodes => nodes[0] };
                /* 120 PlainRuleOp      */ __Matchers[120] = _notExpression = new Mx.PlainRule(this, 120, "not-expression") { Builder = nodes => nodes[0] };
                /* 121 PlainRuleOp      */ __Matchers[121] = _levelEqualityExpression = new Mx.PlainRule(this, 121, "level-equality-expression") { Builder = nodes => nodes[0] };
                /* 122 PlainRuleOp      */ __Matchers[122] = _equalExpression = new Mx.PlainRule(this, 122, "equal-expression") { Builder = nodes => nodes[0] };
                /* 123 PlainRuleOp      */ __Matchers[123] = _notEqualExpression = new Mx.PlainRule(this, 123, "not-equal-expression") { Builder = nodes => nodes[0] };
                /* 124 PlainRuleOp      */ __Matchers[124] = _identicalExpression = new Mx.PlainRule(this, 124, "identical-expression") { Builder = nodes => nodes[0] };
                /* 125 PlainRuleOp      */ __Matchers[125] = _notIdenticalExpression = new Mx.PlainRule(this, 125, "not-identical-expression") { Builder = nodes => nodes[0] };
                /* 126 PlainRuleOp      */ __Matchers[126] = _levelCompareExpression = new Mx.PlainRule(this, 126, "level-compare-expression") { Builder = nodes => nodes[0] };
                /* 127 PlainRuleOp      */ __Matchers[127] = _lessExpression = new Mx.PlainRule(this, 127, "less-expression") { Builder = nodes => nodes[0] };
                /* 128 PlainRuleOp      */ __Matchers[128] = _lessEqualExpression = new Mx.PlainRule(this, 128, "less-equal-expression") { Builder = nodes => nodes[0] };
                /* 129 PlainRuleOp      */ __Matchers[129] = _greaterExpression = new Mx.PlainRule(this, 129, "greater-expression") { Builder = nodes => nodes[0] };
                /* 130 PlainRuleOp      */ __Matchers[130] = _greaterEqualExpression = new Mx.PlainRule(this, 130, "greater-equal-expression") { Builder = nodes => nodes[0] };
                /* 131 PlainRuleOp      */ __Matchers[131] = _levelAddExpression = new Mx.PlainRule(this, 131, "level-add-expression") { Builder = nodes => nodes[0] };
                /* 132 PlainRuleOp      */ __Matchers[132] = _addExpression = new Mx.PlainRule(this, 132, "add-expression") { Builder = nodes => nodes[0] };
                /* 133 PlainRuleOp      */ __Matchers[133] = _subExpression = new Mx.PlainRule(this, 133, "sub-expression") { Builder = nodes => nodes[0] };
                /* 134 PlainRuleOp      */ __Matchers[134] = _levelMulExpression = new Mx.PlainRule(this, 134, "level-mul-expression") { Builder = nodes => nodes[0] };
                /* 135 PlainRuleOp      */ __Matchers[135] = _mulExpression = new Mx.PlainRule(this, 135, "mul-expression") { Builder = nodes => nodes[0] };
                /* 136 PlainRuleOp      */ __Matchers[136] = _divExpression = new Mx.PlainRule(this, 136, "div-expression") { Builder = nodes => nodes[0] };
                /* 137 PlainRuleOp      */ __Matchers[137] = _remExpression = new Mx.PlainRule(this, 137, "rem-expression") { Builder = nodes => nodes[0] };
                /* 138 PlainRuleOp      */ __Matchers[138] = _levelUnionExpression = new Mx.PlainRule(this, 138, "level-union-expression") { Builder = nodes => nodes[0] };
                /* 139 PlainRuleOp      */ __Matchers[139] = _unionExpression = new Mx.PlainRule(this, 139, "union-expression") { Builder = nodes => nodes[0] };
                /* 140 PlainRuleOp      */ __Matchers[140] = _complementExpression = new Mx.PlainRule(this, 140, "complement-expression") { Builder = nodes => nodes[0] };
                /* 141 PlainRuleOp      */ __Matchers[141] = _levelExclusiveExpression = new Mx.PlainRule(this, 141, "level-exclusive-expression") { Builder = nodes => nodes[0] };
                /* 142 PlainRuleOp      */ __Matchers[142] = _exclusiveExpression = new Mx.PlainRule(this, 142, "exclusive-expression") { Builder = nodes => nodes[0] };
                /* 143 PlainRuleOp      */ __Matchers[143] = _levelIntersectionExpression = new Mx.PlainRule(this, 143, "level-intersection-expression") { Builder = nodes => nodes[0] };
                /* 144 PlainRuleOp      */ __Matchers[144] = _intersectionExpression = new Mx.PlainRule(this, 144, "intersection-expression") { Builder = nodes => nodes[0] };
                /* 145 PlainRuleOp      */ __Matchers[145] = _levelNegateExpression = new Mx.PlainRule(this, 145, "level-negate-expression") { Builder = nodes => nodes[0] };
                /* 146 PlainRuleOp      */ __Matchers[146] = _negateExpression = new Mx.PlainRule(this, 146, "negate-expression") { Builder = nodes => nodes[0] };
                ...
                /* 231 AltOp            */ __Matchers[231] = new Mx.Alt(this, 231, "alt(>function-declaration|>class-declaration|>interface-declaration|>object-declaration|>alias-declaration)") { Builder = nodes => nodes[0] };
                /* 232 AltOp            */ __Matchers[232] = new Mx.Alt(this, 232, "alt(>universal-declaration|>constructor-declaration|>let-declaration|>var-declaration|>operator-declaration|>attribute-declaration)") { Builder = nodes => nodes[0] };
                ...
                /* 288 AltOp            */ __Matchers[288] = new Mx.Alt(this, 288, "alt(>calc-body|>value-body|>block-body|>null-body)") { Builder = nodes => nodes[0] };
                ...
                /* 293 SeqOp            */ __Matchers[293] = new Mx.Seq(this, 293, "_293:(>value-specifier,';')") { Builder = nodes => new CValueBody(nodes) };
                /* 294 SeqOp            */ __Matchers[294] = new Mx.Seq(this, 294, "_294:(';')") { Builder = nodes => new CNullBody(nodes) };
                /* 295 SeqOp            */ __Matchers[295] = new Mx.Seq(this, 295, "_295:('=>',>expression)") { Builder = nodes => new CFunctionSpecifier(nodes) };
                /* 296 SeqOp            */ __Matchers[296] = new Mx.Seq(this, 296, "_296:('=',>expression)") { Builder = nodes => new CValueSpecifier(nodes) };
                /* 297 StringOp         */ __Matchers[297] = new Mx.String(this, 297, "':'", ":") { Creator = node => new RLiteral(node) };
                /* 298 SeqOp            */ __Matchers[298] = new Mx.Seq(this, 298, "_298:(':',>extended-type)") { Builder = nodes => new CExtends(nodes) };
                ...
                /* 309 SeqOp            */ __Matchers[309] = new Mx.Seq(this, 309, "_309:('|',>type)") { Builder = nodes => new RSequence(nodes) };
                /* 310 StarOp           */ __Matchers[310] = new Mx.Star(this, 310, "*(_309:('|',>type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 311 SeqOp            */ __Matchers[311] = new Mx.Seq(this, 311, "_311:(>type,*(_309:('|',>type)))") { Builder = nodes => new CCaseTypeList(nodes) };
                /* 312 SeqOp            */ __Matchers[312] = new Mx.Seq(this, 312, "_312:(>name)") { Builder = nodes => new CNamePattern(nodes) };
                /* 313 OptionalOp       */ __Matchers[313] = new Mx.Optional(this, 313, "?(>string-literal)") { Builder = nodes => new ROptional<ICStringLiteral>(nodes) };
                /* 314 StarOp           */ __Matchers[314] = new Mx.Star(this, 314, "*(>attribute)") { Builder = nodes => new RStar<CAttribute>(nodes) };
                /* 315 SeqOp            */ __Matchers[315] = new Mx.Seq(this, 315, "_315:(?(>string-literal),*(>attribute))") { Builder = nodes => new CPrelude(nodes) };
                /* 316 OptionalOp       */ __Matchers[316] = new Mx.Optional(this, 316, "?(>arguments)") { Builder = nodes => new ROptional<CArguments>(nodes) };
                /* 317 SeqOp            */ __Matchers[317] = new Mx.Seq(this, 317, "_317:(>attribute-name,?(>arguments))") { Builder = nodes => new CAttribute(nodes) };
                /* 318 SeqOp            */ __Matchers[318] = new Mx.Seq(this, 318, "_318:('|',>intersection-type)") { Builder = nodes => new RSequence(nodes) };
                /* 319 StarOp           */ __Matchers[319] = new Mx.Star(this, 319, "*(_318:('|',>intersection-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 320 SeqOp            */ __Matchers[320] = new Mx.Seq(this, 320, "_320:(>intersection-type,*(_318:('|',>intersection-type)))") { Builder = nodes => new CUnionType(nodes) };
                /* 321 SeqOp            */ __Matchers[321] = new Mx.Seq(this, 321, "_321:('&',>primary-type)") { Builder = nodes => new RSequence(nodes) };
                /* 322 StarOp           */ __Matchers[322] = new Mx.Star(this, 322, "*(_321:('&',>primary-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 323 SeqOp            */ __Matchers[323] = new Mx.Seq(this, 323, "_323:(>primary-type,*(_321:('&',>primary-type)))") { Builder = nodes => new CIntersectionType(nodes) };
                /* 324 AltOp            */ __Matchers[324] = new Mx.Alt(this, 324, "alt(>nullable-type|>array-type|>reference|>type-selector|>callable-type|>empty-type|>tuple-type|>nothing-type)") { Builder = nodes => nodes[0] };
                /* 325 StringOp         */ __Matchers[325] = new Mx.String(this, 325, "'?'", "?") { Creator = node => new RLiteral(node) };
                /* 326 SeqOp            */ __Matchers[326] = new Mx.Seq(this, 326, "_326:(>primary-type,'?')") { Builder = nodes => new CNullableType(nodes) };
                ...
                /* 329 SeqOp            */ __Matchers[329] = new Mx.Seq(this, 329, "_329:(>primary-type,'[',']')") { Builder = nodes => new CArrayType(nodes) };
                /* 330 SeqOp            */ __Matchers[330] = new Mx.Seq(this, 330, "_330:(>primary-type,'.',>reference)") { Builder = nodes => new CTypeSelector(nodes) };
                /* 331 OptionalOp       */ __Matchers[331] = new Mx.Optional(this, 331, "?(>callable-arguments)") { Builder = nodes => new ROptional<ICCallableArguments>(nodes) };
                /* 332 SeqOp            */ __Matchers[332] = new Mx.Seq(this, 332, "_332:(>primary-type,'(',?(>callable-arguments),')')") { Builder = nodes => new CCallableType(nodes) };
                /* 333 SeqOp            */ __Matchers[333] = new Mx.Seq(this, 333, "_333:(',',>type-list-type)") { Builder = nodes => new RSequence(nodes) };
                /* 334 StarOp           */ __Matchers[334] = new Mx.Star(this, 334, "*(_333:(',',>type-list-type))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 335 SeqOp            */ __Matchers[335] = new Mx.Seq(this, 335, "_335:(>type-list-type,*(_333:(',',>type-list-type)))") { Builder = nodes => new CTypeList(nodes) };
                /* 336 AltOp            */ __Matchers[336] = new Mx.Alt(this, 336, "alt(>type|>defaulted-type)") { Builder = nodes => nodes[0] };
                /* 337 SeqOp            */ __Matchers[337] = new Mx.Seq(this, 337, "_337:(>type,'=')") { Builder = nodes => new CDefaultedType(nodes) };
                /* 338 SeqOp            */ __Matchers[338] = new Mx.Seq(this, 338, "_338:('[',']')") { Builder = nodes => new CEmptyType(nodes) };
                /* 339 SeqOp            */ __Matchers[339] = new Mx.Seq(this, 339, "_339:('[',>type-list,']')") { Builder = nodes => new CTupleType(nodes) };
                /* 340 StringOp         */ __Matchers[340] = new Mx.Keyword(this, 340, "'Nothing'", "Nothing") { Creator = node => new RLiteral(node) };
                /* 341 SeqOp            */ __Matchers[341] = new Mx.Seq(this, 341, "_341:('Nothing')") { Builder = nodes => new CNothingType(nodes) };
                /* 342 OptionalOp       */ __Matchers[342] = new Mx.Optional(this, 342, "?(>parameter-list)") { Builder = nodes => new ROptional<CParameterList>(nodes) };
                /* 343 SeqOp            */ __Matchers[343] = new Mx.Seq(this, 343, "_343:('(',?(>parameter-list),')')") { Builder = nodes => new CParameters(nodes) };
                /* 344 SeqOp            */ __Matchers[344] = new Mx.Seq(this, 344, "_344:(',',>parameter)") { Builder = nodes => new RSequence(nodes) };
                /* 345 StarOp           */ __Matchers[345] = new Mx.Star(this, 345, "*(_344:(',',>parameter))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 346 SeqOp            */ __Matchers[346] = new Mx.Seq(this, 346, "_346:(>parameter,*(_344:(',',>parameter)))") { Builder = nodes => new CParameterList(nodes) };
                /* 347 OptionalOp       */ __Matchers[347] = new Mx.Optional(this, 347, "?(>value-default)") { Builder = nodes => new ROptional<CValueDefault>(nodes) };
                /* 348 SeqOp            */ __Matchers[348] = new Mx.Seq(this, 348, "_348:(>prelude,>parameter-type,>name,?(>value-default))") { Builder = nodes => new CValueParameter(nodes) };
                /* 349 SeqOp            */ __Matchers[349] = new Mx.Seq(this, 349, "_349:(>prelude,>parameter-type,>name)") { Builder = nodes => new CDefinitiveParameter(nodes) };
                /* 350 SeqOp            */ __Matchers[350] = new Mx.Seq(this, 350, "_350:('=',>expression)") { Builder = nodes => new CValueDefault(nodes) };
                /* 351 OptionalOp       */ __Matchers[351] = new Mx.Optional(this, 351, "?(>argument-list)") { Builder = nodes => new ROptional<CArgumentList>(nodes) };
                /* 352 SeqOp            */ __Matchers[352] = new Mx.Seq(this, 352, "_352:('(',?(>argument-list),')')") { Builder = nodes => new CArguments(nodes) };
                /* 353 SeqOp            */ __Matchers[353] = new Mx.Seq(this, 353, "_353:(',',>expression)") { Builder = nodes => new RSequence(nodes) };
                /* 354 StarOp           */ __Matchers[354] = new Mx.Star(this, 354, "*(_353:(',',>expression))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 355 SeqOp            */ __Matchers[355] = new Mx.Seq(this, 355, "_355:(>expression,*(_353:(',',>expression)))") { Builder = nodes => new CArgumentList(nodes) };
                /* 356 AltOp            */ __Matchers[356] = new Mx.Alt(this, 356, "alt(>assign-statement|>expression-statement|>if-statement|>for-statement|>while-statement|>assert-statement|>return-statement|>throw-statement)") { Builder = nodes => nodes[0] };
                /* 357 SeqOp            */ __Matchers[357] = new Mx.Seq(this, 357, "_357:(>primary-expression,'=',>expression,';')") { Builder = nodes => new CAssignStatement(nodes) };
                /* 358 SeqOp            */ __Matchers[358] = new Mx.Seq(this, 358, "_358:(>expression,';')") { Builder = nodes => new CExpressionStatement(nodes) };
                /* 359 StringOp         */ __Matchers[359] = new Mx.Keyword(this, 359, "'if'", "if") { Creator = node => new RLiteral(node) };
                /* 360 StarOp           */ __Matchers[360] = new Mx.Star(this, 360, "*(>else-if)") { Builder = nodes => new RStar<CElseIf>(nodes) };
                /* 361 OptionalOp       */ __Matchers[361] = new Mx.Optional(this, 361, "?(>else-block)") { Builder = nodes => new ROptional<CElseBlock>(nodes) };
                /* 362 SeqOp            */ __Matchers[362] = new Mx.Seq(this, 362, "_362:('if',>conditions,>block-body,*(>else-if),?(>else-block))") { Builder = nodes => new CIfStatement(nodes) };
                /* 363 StringOp         */ __Matchers[363] = new Mx.Keyword(this, 363, "'else'", "else") { Creator = node => new RLiteral(node) };
                /* 364 SeqOp            */ __Matchers[364] = new Mx.Seq(this, 364, "_364:('else','if',>conditions,>block-body)") { Builder = nodes => new CElseIf(nodes) };
                /* 365 SeqOp            */ __Matchers[365] = new Mx.Seq(this, 365, "_365:('else',>block-body)") { Builder = nodes => new CElseBlock(nodes) };
                /* 366 StringOp         */ __Matchers[366] = new Mx.Keyword(this, 366, "'for'", "for") { Creator = node => new RLiteral(node) };
                /* 367 SeqOp            */ __Matchers[367] = new Mx.Seq(this, 367, "_367:('for','(',>pattern,'in',>expression,')',>block-body,?(>else-block))") { Builder = nodes => new CForStatement(nodes) };
                /* 368 StringOp         */ __Matchers[368] = new Mx.Keyword(this, 368, "'while'", "while") { Creator = node => new RLiteral(node) };
                /* 369 SeqOp            */ __Matchers[369] = new Mx.Seq(this, 369, "_369:('while',>conditions,>block-body)") { Builder = nodes => new CWhileStatement(nodes) };
                /* 370 StringOp         */ __Matchers[370] = new Mx.Keyword(this, 370, "'return'", "return") { Creator = node => new RLiteral(node) };
                /* 371 OptionalOp       */ __Matchers[371] = new Mx.Optional(this, 371, "?(>expression)") { Builder = nodes => new ROptional<ICExpression>(nodes) };
                /* 372 SeqOp            */ __Matchers[372] = new Mx.Seq(this, 372, "_372:('return',?(>expression),';')") { Builder = nodes => new CReturnStatement(nodes) };
                /* 373 StringOp         */ __Matchers[373] = new Mx.Keyword(this, 373, "'throw'", "throw") { Creator = node => new RLiteral(node) };
                /* 374 SeqOp            */ __Matchers[374] = new Mx.Seq(this, 374, "_374:('throw',?(>expression),';')") { Builder = nodes => new CThrowStatement(nodes) };
                /* 375 StringOp         */ __Matchers[375] = new Mx.Keyword(this, 375, "'assert'", "assert") { Creator = node => new RLiteral(node) };
                /* 376 SeqOp            */ __Matchers[376] = new Mx.Seq(this, 376, "_376:(?(>string-literal),'assert',>conditions,';')") { Builder = nodes => new CAssertStatement(nodes) };
                /* 377 AltOp            */ __Matchers[377] = new Mx.Alt(this, 377, "alt(>if-expression|>level-coalesce-expression)") { Builder = nodes => nodes[0] };
                /* 378 AltOp            */ __Matchers[378] = new Mx.Alt(this, 378, "alt(>then-expression|>else-expression|>level-disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 379 StringOp         */ __Matchers[379] = new Mx.Keyword(this, 379, "'then'", "then") { Creator = node => new RLiteral(node) };
                /* 380 SeqOp            */ __Matchers[380] = new Mx.Seq(this, 380, "_380:(>level-coalesce-expression,'then',>level-disjunction-expression)") { Builder = nodes => new CThenExpression(nodes) };
                /* 381 SeqOp            */ __Matchers[381] = new Mx.Seq(this, 381, "_381:(>level-coalesce-expression,'else',>level-disjunction-expression)") { Builder = nodes => new CElseExpression(nodes) };
                /* 382 AltOp            */ __Matchers[382] = new Mx.Alt(this, 382, "alt(>disjunction-expression|>level-conjunction-expression)") { Builder = nodes => nodes[0] };
                /* 383 StringOp         */ __Matchers[383] = new Mx.String(this, 383, "'||'", "||") { Creator = node => new RLiteral(node) };
                /* 384 SeqOp            */ __Matchers[384] = new Mx.Seq(this, 384, "_384:(>level-disjunction-expression,'||',>level-conjunction-expression)") { Builder = nodes => new CDisjunctionExpression(nodes) };
                /* 385 AltOp            */ __Matchers[385] = new Mx.Alt(this, 385, "alt(>conjunction-expression|>level-not-expression)") { Builder = nodes => nodes[0] };
                /* 386 StringOp         */ __Matchers[386] = new Mx.String(this, 386, "'&&'", "&&") { Creator = node => new RLiteral(node) };
                /* 387 SeqOp            */ __Matchers[387] = new Mx.Seq(this, 387, "_387:(>level-conjunction-expression,'&&',>level-not-expression)") { Builder = nodes => new CConjunctionExpression(nodes) };
                /* 388 AltOp            */ __Matchers[388] = new Mx.Alt(this, 388, "alt(>not-expression|>level-equality-expression)") { Builder = nodes => nodes[0] };
                /* 389 SeqOp            */ __Matchers[389] = new Mx.Seq(this, 389, "_389:('!',>level-not-expression)") { Builder = nodes => new CNotExpression(nodes) };
                /* 390 AltOp            */ __Matchers[390] = new Mx.Alt(this, 390, "alt(>equal-expression|>not-equal-expression|>identical-expression|>not-identical-expression|>level-compare-expression)") { Builder = nodes => nodes[0] };
                /* 391 SeqOp            */ __Matchers[391] = new Mx.Seq(this, 391, "_391:(>level-compare-expression,'==',>level-compare-expression)") { Builder = nodes => new CEqualExpression(nodes) };
                /* 392 SeqOp            */ __Matchers[392] = new Mx.Seq(this, 392, "_392:(>level-compare-expression,'!=',>level-compare-expression)") { Builder = nodes => new CNotEqualExpression(nodes) };
                /* 393 SeqOp            */ __Matchers[393] = new Mx.Seq(this, 393, "_393:(>level-compare-expression,'===',>level-compare-expression)") { Builder = nodes => new CIdenticalExpression(nodes) };
                /* 394 SeqOp            */ __Matchers[394] = new Mx.Seq(this, 394, "_394:(>level-compare-expression,'!==',>level-compare-expression)") { Builder = nodes => new CNotIdenticalExpression(nodes) };
                /* 395 AltOp            */ __Matchers[395] = new Mx.Alt(this, 395, "alt(>less-expression|>less-equal-expression|>greater-expression|>greater-equal-expression|>level-add-expression)") { Builder = nodes => nodes[0] };
                /* 396 SeqOp            */ __Matchers[396] = new Mx.Seq(this, 396, "_396:(>level-add-expression,'<',>level-add-expression)") { Builder = nodes => new CLessExpression(nodes) };
                /* 397 SeqOp            */ __Matchers[397] = new Mx.Seq(this, 397, "_397:(>level-add-expression,'<=',>level-add-expression)") { Builder = nodes => new CLessEqualExpression(nodes) };
                /* 398 SeqOp            */ __Matchers[398] = new Mx.Seq(this, 398, "_398:(>level-add-expression,'>',>level-add-expression)") { Builder = nodes => new CGreaterExpression(nodes) };
                /* 399 SeqOp            */ __Matchers[399] = new Mx.Seq(this, 399, "_399:(>level-add-expression,'>=',>level-add-expression)") { Builder = nodes => new CGreaterEqualExpression(nodes) };
                /* 400 AltOp            */ __Matchers[400] = new Mx.Alt(this, 400, "alt(>add-expression|>sub-expression|>level-mul-expression)") { Builder = nodes => nodes[0] };
                /* 401 SeqOp            */ __Matchers[401] = new Mx.Seq(this, 401, "_401:(>level-add-expression,'+',>level-mul-expression)") { Builder = nodes => new CAddExpression(nodes) };
                ...
                /* 405 SeqOp            */ __Matchers[405] = new Mx.Seq(this, 405, "_405:(>level-mul-expression,'/',>level-union-expression)") { Builder = nodes => new CDivExpression(nodes) };
                /* 406 SeqOp            */ __Matchers[406] = new Mx.Seq(this, 406, "_406:(>level-mul-expression,'%',>level-union-expression)") { Builder = nodes => new CRemExpression(nodes) };
                /* 407 AltOp            */ __Matchers[407] = new Mx.Alt(this, 407, "alt(>union-expression|>complement-expression|>level-exclusive-expression)") { Builder = nodes => nodes[0] };
                /* 408 SeqOp            */ __Matchers[408] = new Mx.Seq(this, 408, "_408:(>level-union-expression,'|',>level-exclusive-expression)") { Builder = nodes => new CUnionExpression(nodes) };
                /* 409 StringOp         */ __Matchers[409] = new Mx.String(this, 409, "'~'", "~") { Creator = node => new RLiteral(node) };
                /* 410 SeqOp            */ __Matchers[410] = new Mx.Seq(this, 410, "_410:(>level-union-expression,'~',>level-exclusive-expression)") { Builder = nodes => new CComplementExpression(nodes) };
                /* 411 AltOp            */ __Matchers[411] = new Mx.Alt(this, 411, "alt(>exclusive-expression|>level-intersection-expression)") { Builder = nodes => nodes[0] };
                /* 412 SeqOp            */ __Matchers[412] = new Mx.Seq(this, 412, "_412:(>level-exclusive-expression,'^',>level-intersection-expression)") { Builder = nodes => new CExclusiveExpression(nodes) };
                /* 413 AltOp            */ __Matchers[413] = new Mx.Alt(this, 413, "alt(>intersection-expression|>level-negate-expression)") { Builder = nodes => nodes[0] };
                /* 414 SeqOp            */ __Matchers[414] = new Mx.Seq(this, 414, "_414:(>level-intersection-expression,'&',>level-negate-expression)") { Builder = nodes => new CIntersectionExpression(nodes) };
                /* 415 AltOp            */ __Matchers[415] = new Mx.Alt(this, 415, "alt(>negate-expression|>primary-expression)") { Builder = nodes => nodes[0] };
                /* 416 SeqOp            */ __Matchers[416] = new Mx.Seq(this, 416, "_416:('-',>level-negate-expression)") { Builder = nodes => new CNegateExpression(nodes) };
                /* 417 AltOp            */ __Matchers[417] = new Mx.Alt(this, 417, "alt(>reference|>literal|>string-expression|>call-expression|>select-expression|>nullsafe-select-expression|>grouped-expression)") { Builder = nodes => nodes[0] };
                /* 418 SeqOp            */ __Matchers[418] = new Mx.Seq(this, 418, "_418:('(',>expression,')')") { Builder = nodes => new CGroupedExpression(nodes) };
                /* 419 SeqOp            */ __Matchers[419] = new Mx.Seq(this, 419, "_419:(>primary-expression,>arguments)") { Builder = nodes => new CCallExpression(nodes) };
                /* 420 SeqOp            */ __Matchers[420] = new Mx.Seq(this, 420, "_420:(>primary-expression,'.',>reference)") { Builder = nodes => new CSelectExpression(nodes) };
                /* 421 StringOp         */ __Matchers[421] = new Mx.String(this, 421, "'?.'", "?.") { Creator = node => new RLiteral(node) };
                /* 422 SeqOp            */ __Matchers[422] = new Mx.Seq(this, 422, "_422:(>primary-expression,'?.',>reference)") { Builder = nodes => new CNullsafeSelectExpression(nodes) };
                /* 423 AltOp            */ __Matchers[423] = new Mx.Alt(this, 423, "alt(>string-literal|>string-interpolation)") { Builder = nodes => nodes[0] };
                /* 424 AltOp            */ __Matchers[424] = new Mx.Alt(this, 424, "alt(>plain-string-literal|>verbatim-string-literal)") { Builder = nodes => nodes[0] };
                /* 425 StarOp           */ __Matchers[425] = new Mx.Star(this, 425, "*(>interpolation-part)") { Builder = nodes => new RStar<CInterpolationPart>(nodes) };
                /* 426 SeqOp            */ __Matchers[426] = new Mx.Seq(this, 426, "_426:(>string-start,>expression,*(>interpolation-part),>string-end)") { Builder = nodes => new CStringInterpolation(nodes) };
                /* 427 SeqOp            */ __Matchers[427] = new Mx.Seq(this, 427, "_427:(>string-mid,>expression)") { Builder = nodes => new CInterpolationPart(nodes) };
                /* 428 SeqOp            */ __Matchers[428] = new Mx.Seq(this, 428, "_428:('if',>conditions,>if-then,>if-else)") { Builder = nodes => new CIfExpression(nodes) };
                /* 429 SeqOp            */ __Matchers[429] = new Mx.Seq(this, 429, "_429:('then',>conditional-expression)") { Builder = nodes => new CIfThen(nodes) };
                /* 430 SeqOp            */ __Matchers[430] = new Mx.Seq(this, 430, "_430:('else',>conditional-expression)") { Builder = nodes => new CIfElse(nodes) };
                /* 431 AltOp            */ __Matchers[431] = new Mx.Alt(this, 431, "alt(>if-expression|>level-disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 432 SeqOp            */ __Matchers[432] = new Mx.Seq(this, 432, "_432:('(',>condition-list,')')") { Builder = nodes => new CConditions(nodes) };
                /* 433 SeqOp            */ __Matchers[433] = new Mx.Seq(this, 433, "_433:(',',>condition)") { Builder = nodes => new RSequence(nodes) };
                /* 434 StarOp           */ __Matchers[434] = new Mx.Star(this, 434, "*(_433:(',',>condition))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 435 SeqOp            */ __Matchers[435] = new Mx.Seq(this, 435, "_435:(>condition,*(_433:(',',>condition)))") { Builder = nodes => new CConditionList(nodes) };
                /* 436 AltOp            */ __Matchers[436] = new Mx.Alt(this, 436, "alt(>is-condition|>expression)") { Builder = nodes => nodes[0] };
                /* 437 OptionalOp       */ __Matchers[437] = new Mx.Optional(this, 437, "?('!')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 438 SeqOp            */ __Matchers[438] = new Mx.Seq(this, 438, "_438:(?('!'),'is',>type,>name)") { Builder = nodes => new CIsCondition(nodes) };
                ...
                /*  59 PlainRuleOp      */ _valueBody.Set(__Matchers[293]);
                /*  60 PlainRuleOp      */ _nullBody.Set(__Matchers[294]);
                /*  61 PlainRuleOp      */ _functionSpecifier.Set(__Matchers[295]);
                /*  62 PlainRuleOp      */ _valueSpecifier.Set(__Matchers[296]);
                /*  63 PlainRuleOp      */ _extends.Set(__Matchers[298]);
                /*  64 PlainRuleOp      */ _extendedType.Set(_type);
                /*  65 PlainRuleOp      */ _satisfies.Set(__Matchers[300]);
                /*  66 PlainRuleOp      */ _constraints.Set(__Matchers[301]);
                /*  67 PlainRuleOp      */ _constraint.Set(__Matchers[303]);
                /*  68 PlainRuleOp      */ _unionTypeList.Set(__Matchers[306]);
                /*  69 PlainRuleOp      */ _caseTypes.Set(__Matchers[308]);
                /*  70 PlainRuleOp      */ _caseTypeList.Set(__Matchers[311]);
                /*  71 PlainRuleOp      */ _pattern.Set(_namePattern);
                /*  72 PlainRuleOp      */ _namePattern.Set(__Matchers[312]);
                /*  73 PlainRuleOp      */ _prelude.Set(__Matchers[315]);
                /*  74 PlainRuleOp      */ _attribute.Set(__Matchers[317]);
                /*  75 DfaRuleOp        */ _attributeName.Set(_attributeName_DFA);
                /*  76 PlainRuleOp      */ _type.Set(_unionType);
                /*  77 PlainRuleOp      */ _unionType.Set(__Matchers[320]);
                /*  78 PlainRuleOp      */ _intersectionType.Set(__Matchers[323]);
                /*  79 PlainRuleOp      */ _primaryType.Set(__Matchers[324]);
                /*  80 PlainRuleOp      */ _nullableType.Set(__Matchers[326]);
                /*  81 PlainRuleOp      */ _arrayType.Set(__Matchers[329]);
                /*  82 PlainRuleOp      */ _typeSelector.Set(__Matchers[330]);
                /*  83 PlainRuleOp      */ _callableType.Set(__Matchers[332]);
                /*  84 PlainRuleOp      */ _callableArguments.Set(_typeList);
                /*  85 PlainRuleOp      */ _typeList.Set(__Matchers[335]);
                /*  86 PlainRuleOp      */ _typeListType.Set(__Matchers[336]);
                /*  87 PlainRuleOp      */ _defaultedType.Set(__Matchers[337]);
                /*  88 PlainRuleOp      */ _emptyType.Set(__Matchers[338]);
                /*  89 PlainRuleOp      */ _tupleType.Set(__Matchers[339]);
                /*  90 PlainRuleOp      */ _nothingType.Set(__Matchers[341]);
                /*  91 PlainRuleOp      */ _parameters.Set(__Matchers[343]);
                /*  92 PlainRuleOp      */ _parameterList.Set(__Matchers[346]);
                /*  93 PlainRuleOp      */ _parameter.Set(_valueParameter);
                /*  94 PlainRuleOp      */ _valueParameter.Set(__Matchers[348]);
                /*  95 PlainRuleOp      */ _definitiveParameter.Set(__Matchers[349]);
                /*  96 PlainRuleOp      */ _valueDefault.Set(__Matchers[350]);
                /*  97 PlainRuleOp      */ _parameterType.Set(_type);
                /*  98 PlainRuleOp      */ _arguments.Set(__Matchers[352]);
                /*  99 PlainRuleOp      */ _argumentList.Set(__Matchers[355]);
                /* 100 PlainRuleOp      */ _statement.Set(__Matchers[356]);
                /* 101 PlainRuleOp      */ _assignStatement.Set(__Matchers[357]);
                /* 102 PlainRuleOp      */ _expressionStatement.Set(__Matchers[358]);
                /* 103 PlainRuleOp      */ _ifStatement.Set(__Matchers[362]);
                /* 104 PlainRuleOp      */ _elseIf.Set(__Matchers[364]);
                /* 105 PlainRuleOp      */ _elseBlock.Set(__Matchers[365]);
                /* 106 PlainRuleOp      */ _forStatement.Set(__Matchers[367]);
                /* 107 PlainRuleOp      */ _whileStatement.Set(__Matchers[369]);
                /* 108 PlainRuleOp      */ _returnStatement.Set(__Matchers[372]);
                /* 109 PlainRuleOp      */ _throwStatement.Set(__Matchers[374]);
                /* 110 PlainRuleOp      */ _assertStatement.Set(__Matchers[376]);
                /* 111 PlainRuleOp      */ _expression.Set(__Matchers[377]);
                /* 112 PlainRuleOp      */ _levelCoalesceExpression.Set(__Matchers[378]);
                /* 113 PlainRuleOp      */ _thenExpression.Set(__Matchers[380]);
                /* 114 PlainRuleOp      */ _elseExpression.Set(__Matchers[381]);
                /* 115 PlainRuleOp      */ _levelDisjunctionExpression.Set(__Matchers[382]);
                /* 116 PlainRuleOp      */ _disjunctionExpression.Set(__Matchers[384]);
                /* 117 PlainRuleOp      */ _levelConjunctionExpression.Set(__Matchers[385]);
                /* 118 PlainRuleOp      */ _conjunctionExpression.Set(__Matchers[387]);
                /* 119 PlainRuleOp      */ _levelNotExpression.Set(__Matchers[388]);
                /* 120 PlainRuleOp      */ _notExpression.Set(__Matchers[389]);
                /* 121 PlainRuleOp      */ _levelEqualityExpression.Set(__Matchers[390]);
                /* 122 PlainRuleOp      */ _equalExpression.Set(__Matchers[391]);
                /* 123 PlainRuleOp      */ _notEqualExpression.Set(__Matchers[392]);
                /* 124 PlainRuleOp      */ _identicalExpression.Set(__Matchers[393]);
                /* 125 PlainRuleOp      */ _notIdenticalExpression.Set(__Matchers[394]);
                /* 126 PlainRuleOp      */ _levelCompareExpression.Set(__Matchers[395]);
                /* 127 PlainRuleOp      */ _lessExpression.Set(__Matchers[396]);
                /* 128 PlainRuleOp      */ _lessEqualExpression.Set(__Matchers[397]);
                /* 129 PlainRuleOp      */ _greaterExpression.Set(__Matchers[398]);
                /* 130 PlainRuleOp      */ _greaterEqualExpression.Set(__Matchers[399]);
                /* 131 PlainRuleOp      */ _levelAddExpression.Set(__Matchers[400]);
                /* 132 PlainRuleOp      */ _addExpression.Set(__Matchers[401]);
                /* 133 PlainRuleOp      */ _subExpression.Set(__Matchers[402]);
                /* 134 PlainRuleOp      */ _levelMulExpression.Set(__Matchers[403]);
                /* 135 PlainRuleOp      */ _mulExpression.Set(__Matchers[404]);
                /* 136 PlainRuleOp      */ _divExpression.Set(__Matchers[405]);
                /* 137 PlainRuleOp      */ _remExpression.Set(__Matchers[406]);
                /* 138 PlainRuleOp      */ _levelUnionExpression.Set(__Matchers[407]);
                /* 139 PlainRuleOp      */ _unionExpression.Set(__Matchers[408]);
                /* 140 PlainRuleOp      */ _complementExpression.Set(__Matchers[410]);
                /* 141 PlainRuleOp      */ _levelExclusiveExpression.Set(__Matchers[411]);
                /* 142 PlainRuleOp      */ _exclusiveExpression.Set(__Matchers[412]);
                /* 143 PlainRuleOp      */ _levelIntersectionExpression.Set(__Matchers[413]);
                /* 144 PlainRuleOp      */ _intersectionExpression.Set(__Matchers[414]);
                /* 145 PlainRuleOp      */ _levelNegateExpression.Set(__Matchers[415]);
                /* 146 PlainRuleOp      */ _negateExpression.Set(__Matchers[416]);
                /* 147 PlainRuleOp      */ _primaryExpression.Set(__Matchers[417]);
                /* 148 PlainRuleOp      */ _groupedExpression.Set(__Matchers[418]);
                /* 149 PlainRuleOp      */ _callExpression.Set(__Matchers[419]);
                /* 150 PlainRuleOp      */ _selectExpression.Set(__Matchers[420]);
                /* 151 PlainRuleOp      */ _nullsafeSelectExpression.Set(__Matchers[422]);
                /* 152 PlainRuleOp      */ _literal.Set(_naturalLiteral);
                /* 153 PlainRuleOp      */ _stringExpression.Set(__Matchers[423]);
                /* 154 PlainRuleOp      */ _stringLiteral.Set(__Matchers[424]);
                /* 155 PlainRuleOp      */ _stringInterpolation.Set(__Matchers[426]);
                /* 156 PlainRuleOp      */ _interpolationPart.Set(__Matchers[427]);
                /* 157 PlainRuleOp      */ _ifExpression.Set(__Matchers[428]);
                /* 158 PlainRuleOp      */ _ifThen.Set(__Matchers[429]);
                /* 159 PlainRuleOp      */ _ifElse.Set(__Matchers[430]);
                /* 160 PlainRuleOp      */ _conditionalExpression.Set(__Matchers[431]);
                /* 161 PlainRuleOp      */ _conditions.Set(__Matchers[432]);
                /* 162 PlainRuleOp      */ _conditionList.Set(__Matchers[435]);
                /* 163 PlainRuleOp      */ _condition.Set(__Matchers[436]);
                /* 164 PlainRuleOp      */ _isCondition.Set(__Matchers[438]);
                ...
                /* 231 AltOp            */ __Matchers[231].Set(_functionDeclaration, _classDeclaration, _interfaceDeclaration, _objectDeclaration, _aliasDeclaration);
                /* 232 AltOp            */ __Matchers[232].Set(_universalDeclaration, _constructorDeclaration, _letDeclaration, _varDeclaration, _operatorDeclaration, _attributeDeclaration);
                ...
                /* 240 AltOp            */ __Matchers[240].Set(__Matchers[238], __Matchers[239]);
                /* 242 SeqOp            */ __Matchers[242].Set(_prelude, __Matchers[241], _type, _infixOperator, __Matchers[235], _definitiveParameter, __Matchers[236], _functionBody);
                /* 256 AltOp            */ __Matchers[256].Set(__Matchers[243], __Matchers[238], __Matchers[244], __Matchers[245], __Matchers[246], __Matchers[211], __Matchers[247], __Matchers[213], __Matchers[248], __Matchers[249], __Matchers[250], __Matchers[251], __Matchers[252], __Matchers[253], __Matchers[254], __Matchers[255]);
                ...
                /* 263 SeqOp            */ __Matchers[263].Set(_prelude, __Matchers[261], __Matchers[262], _name, __Matchers[202], _expression, __Matchers[177]);
                /* 265 SeqOp            */ __Matchers[265].Set(_prelude, __Matchers[264], __Matchers[262], _name, __Matchers[202], _expression, __Matchers[177]);
                ...
                /* 277 SeqOp            */ __Matchers[277].Set(_prelude, __Matchers[275], _name, __Matchers[257], __Matchers[258], __Matchers[276], _type, __Matchers[177]);
                ...
                /* 282 SeqOp            */ __Matchers[282].Set(__Matchers[183], _usings, __Matchers[281], __Matchers[185]);
                /* 283 StarOp           */ __Matchers[283].Set(_interfaceMember);
                /* 284 SeqOp            */ __Matchers[284].Set(__Matchers[183], _usings, __Matchers[283], __Matchers[185]);
                ...
                /* 288 AltOp            */ __Matchers[288].Set(_calcBody, _valueBody, _blockBody, _nullBody);
                ...
                /* 293 SeqOp            */ __Matchers[293].Set(_valueSpecifier, __Matchers[177]);
                /* 294 SeqOp            */ __Matchers[294].Set(__Matchers[177]);
                /* 295 SeqOp            */ __Matchers[295].Set(__Matchers[276], _expression);
                /* 296 SeqOp            */ __Matchers[296].Set(__Matchers[202], _expression);
                /* 298 SeqOp            */ __Matchers[298].Set(__Matchers[297], _extendedType);
                ...
                /* 304 SeqOp            */ __Matchers[304].Set(__Matchers[194], _type);
                ...
                /* 309 SeqOp            */ __Matchers[309].Set(__Matchers[253], _type);
                /* 310 StarOp           */ __Matchers[310].Set(__Matchers[309]);
                /* 311 SeqOp            */ __Matchers[311].Set(_type, __Matchers[310]);
                /* 312 SeqOp            */ __Matchers[312].Set(_name);
                /* 313 OptionalOp       */ __Matchers[313].Set(_stringLiteral);
                /* 314 StarOp           */ __Matchers[314].Set(_attribute);
                /* 315 SeqOp            */ __Matchers[315].Set(__Matchers[313], __Matchers[314]);
                /* 316 OptionalOp       */ __Matchers[316].Set(_arguments);
                /* 317 SeqOp            */ __Matchers[317].Set(_attributeName, __Matchers[316]);
                /* 318 SeqOp            */ __Matchers[318].Set(__Matchers[253], _intersectionType);
                /* 319 StarOp           */ __Matchers[319].Set(__Matchers[318]);
                /* 320 SeqOp            */ __Matchers[320].Set(_intersectionType, __Matchers[319]);
                /* 321 SeqOp            */ __Matchers[321].Set(__Matchers[254], _primaryType);
                /* 322 StarOp           */ __Matchers[322].Set(__Matchers[321]);
                /* 323 SeqOp            */ __Matchers[323].Set(_primaryType, __Matchers[322]);
                /* 324 AltOp            */ __Matchers[324].Set(_nullableType, _arrayType, _reference, _typeSelector, _callableType, _emptyType, _tupleType, _nothingType);
                /* 326 SeqOp            */ __Matchers[326].Set(_primaryType, __Matchers[325]);
                /* 329 SeqOp            */ __Matchers[329].Set(_primaryType, __Matchers[327], __Matchers[328]);
                /* 330 SeqOp            */ __Matchers[330].Set(_primaryType, __Matchers[205], _reference);
                /* 331 OptionalOp       */ __Matchers[331].Set(_callableArguments);
                /* 332 SeqOp            */ __Matchers[332].Set(_primaryType, __Matchers[235], __Matchers[331], __Matchers[236]);
                /* 333 SeqOp            */ __Matchers[333].Set(__Matchers[194], _typeListType);
                /* 334 StarOp           */ __Matchers[334].Set(__Matchers[333]);
                /* 335 SeqOp            */ __Matchers[335].Set(_typeListType, __Matchers[334]);
                /* 336 AltOp            */ __Matchers[336].Set(_type, _defaultedType);
                /* 337 SeqOp            */ __Matchers[337].Set(_type, __Matchers[202]);
                /* 338 SeqOp            */ __Matchers[338].Set(__Matchers[327], __Matchers[328]);
                /* 339 SeqOp            */ __Matchers[339].Set(__Matchers[327], _typeList, __Matchers[328]);
                /* 341 SeqOp            */ __Matchers[341].Set(__Matchers[340]);
                /* 342 OptionalOp       */ __Matchers[342].Set(_parameterList);
                /* 343 SeqOp            */ __Matchers[343].Set(__Matchers[235], __Matchers[342], __Matchers[236]);
                /* 344 SeqOp            */ __Matchers[344].Set(__Matchers[194], _parameter);
                /* 345 StarOp           */ __Matchers[345].Set(__Matchers[344]);
                /* 346 SeqOp            */ __Matchers[346].Set(_parameter, __Matchers[345]);
                /* 347 OptionalOp       */ __Matchers[347].Set(_valueDefault);
                /* 348 SeqOp            */ __Matchers[348].Set(_prelude, _parameterType, _name, __Matchers[347]);
                /* 349 SeqOp            */ __Matchers[349].Set(_prelude, _parameterType, _name);
                /* 350 SeqOp            */ __Matchers[350].Set(__Matchers[202], _expression);
                /* 351 OptionalOp       */ __Matchers[351].Set(_argumentList);
                /* 352 SeqOp            */ __Matchers[352].Set(__Matchers[235], __Matchers[351], __Matchers[236]);
                /* 353 SeqOp            */ __Matchers[353].Set(__Matchers[194], _expression);
                /* 354 StarOp           */ __Matchers[354].Set(__Matchers[353]);
                /* 355 SeqOp            */ __Matchers[355].Set(_expression, __Matchers[354]);
                /* 356 AltOp            */ __Matchers[356].Set(_assignStatement, _expressionStatement, _ifStatement, _forStatement, _whileStatement, _assertStatement, _returnStatement, _throwStatement);
                /* 357 SeqOp            */ __Matchers[357].Set(_primaryExpression, __Matchers[202], _expression, __Matchers[177]);
                /* 358 SeqOp            */ __Matchers[358].Set(_expression, __Matchers[177]);
                /* 360 StarOp           */ __Matchers[360].Set(_elseIf);
                /* 361 OptionalOp       */ __Matchers[361].Set(_elseBlock);
                /* 362 SeqOp            */ __Matchers[362].Set(__Matchers[359], _conditions, _blockBody, __Matchers[360], __Matchers[361]);
                /* 364 SeqOp            */ __Matchers[364].Set(__Matchers[363], __Matchers[359], _conditions, _blockBody);
                /* 365 SeqOp            */ __Matchers[365].Set(__Matchers[363], _blockBody);
                /* 367 SeqOp            */ __Matchers[367].Set(__Matchers[366], __Matchers[235], _pattern, __Matchers[227], _expression, __Matchers[236], _blockBody, __Matchers[361]);
                /* 369 SeqOp            */ __Matchers[369].Set(__Matchers[368], _conditions, _blockBody);
                /* 371 OptionalOp       */ __Matchers[371].Set(_expression);
                /* 372 SeqOp            */ __Matchers[372].Set(__Matchers[370], __Matchers[371], __Matchers[177]);
                /* 374 SeqOp            */ __Matchers[374].Set(__Matchers[373], __Matchers[371], __Matchers[177]);
                /* 376 SeqOp            */ __Matchers[376].Set(__Matchers[313], __Matchers[375], _conditions, __Matchers[177]);
                /* 377 AltOp            */ __Matchers[377].Set(_ifExpression, _levelCoalesceExpression);
                /* 378 AltOp            */ __Matchers[378].Set(_thenExpression, _elseExpression, _levelDisjunctionExpression);
                /* 380 SeqOp            */ __Matchers[380].Set(_levelCoalesceExpression, __Matchers[379], _levelDisjunctionExpression);
                /* 381 SeqOp            */ __Matchers[381].Set(_levelCoalesceExpression, __Matchers[363], _levelDisjunctionExpression);
                /* 382 AltOp            */ __Matchers[382].Set(_disjunctionExpression, _levelConjunctionExpression);
                /* 384 SeqOp            */ __Matchers[384].Set(_levelDisjunctionExpression, __Matchers[383], _levelConjunctionExpression);
                /* 385 AltOp            */ __Matchers[385].Set(_conjunctionExpression, _levelNotExpression);
                /* 387 SeqOp            */ __Matchers[387].Set(_levelConjunctionExpression, __Matchers[386], _levelNotExpression);
                /* 388 AltOp            */ __Matchers[388].Set(_notExpression, _levelEqualityExpression);
                /* 389 SeqOp            */ __Matchers[389].Set(__Matchers[239], _levelNotExpression);
                /* 390 AltOp            */ __Matchers[390].Set(_equalExpression, _notEqualExpression, _identicalExpression, _notIdenticalExpression, _levelCompareExpression);
                /* 391 SeqOp            */ __Matchers[391].Set(_levelCompareExpression, __Matchers[249], _levelCompareExpression);
                /* 392 SeqOp            */ __Matchers[392].Set(_levelCompareExpression, __Matchers[250], _levelCompareExpression);
                /* 393 SeqOp            */ __Matchers[393].Set(_levelCompareExpression, __Matchers[251], _levelCompareExpression);
                /* 394 SeqOp            */ __Matchers[394].Set(_levelCompareExpression, __Matchers[252], _levelCompareExpression);
                /* 395 AltOp            */ __Matchers[395].Set(_lessExpression, _lessEqualExpression, _greaterExpression, _greaterEqualExpression, _levelAddExpression);
                /* 396 SeqOp            */ __Matchers[396].Set(_levelAddExpression, __Matchers[211], _levelAddExpression);
                /* 397 SeqOp            */ __Matchers[397].Set(_levelAddExpression, __Matchers[247], _levelAddExpression);
                /* 398 SeqOp            */ __Matchers[398].Set(_levelAddExpression, __Matchers[213], _levelAddExpression);
                /* 399 SeqOp            */ __Matchers[399].Set(_levelAddExpression, __Matchers[248], _levelAddExpression);
                /* 400 AltOp            */ __Matchers[400].Set(_addExpression, _subExpression, _levelMulExpression);
                /* 401 SeqOp            */ __Matchers[401].Set(_levelAddExpression, __Matchers[243], _levelMulExpression);
                /* 402 SeqOp            */ __Matchers[402].Set(_levelAddExpression, __Matchers[238], _levelMulExpression);
                /* 403 AltOp            */ __Matchers[403].Set(_mulExpression, _divExpression, _remExpression, _levelUnionExpression);
                /* 404 SeqOp            */ __Matchers[404].Set(_levelMulExpression, __Matchers[244], _levelUnionExpression);
                /* 405 SeqOp            */ __Matchers[405].Set(_levelMulExpression, __Matchers[245], _levelUnionExpression);
                /* 406 SeqOp            */ __Matchers[406].Set(_levelMulExpression, __Matchers[246], _levelUnionExpression);
                /* 407 AltOp            */ __Matchers[407].Set(_unionExpression, _complementExpression, _levelExclusiveExpression);
                /* 408 SeqOp            */ __Matchers[408].Set(_levelUnionExpression, __Matchers[253], _levelExclusiveExpression);
                /* 410 SeqOp            */ __Matchers[410].Set(_levelUnionExpression, __Matchers[409], _levelExclusiveExpression);
                /* 411 AltOp            */ __Matchers[411].Set(_exclusiveExpression, _levelIntersectionExpression);
                /* 412 SeqOp            */ __Matchers[412].Set(_levelExclusiveExpression, __Matchers[255], _levelIntersectionExpression);
                /* 413 AltOp            */ __Matchers[413].Set(_intersectionExpression, _levelNegateExpression);
                /* 414 SeqOp            */ __Matchers[414].Set(_levelIntersectionExpression, __Matchers[254], _levelNegateExpression);
                /* 415 AltOp            */ __Matchers[415].Set(_negateExpression, _primaryExpression);
                /* 416 SeqOp            */ __Matchers[416].Set(__Matchers[238], _levelNegateExpression);
                /* 417 AltOp            */ __Matchers[417].Set(_reference, _literal, _stringExpression, _callExpression, _selectExpression, _nullsafeSelectExpression, _groupedExpression);
                /* 418 SeqOp            */ __Matchers[418].Set(__Matchers[235], _expression, __Matchers[236]);
                /* 419 SeqOp            */ __Matchers[419].Set(_primaryExpression, _arguments);
                /* 420 SeqOp            */ __Matchers[420].Set(_primaryExpression, __Matchers[205], _reference);
                /* 422 SeqOp            */ __Matchers[422].Set(_primaryExpression, __Matchers[421], _reference);
                /* 423 AltOp            */ __Matchers[423].Set(_stringLiteral, _stringInterpolation);
                /* 424 AltOp            */ __Matchers[424].Set(_plainStringLiteral, _verbatimStringLiteral);
                /* 425 StarOp           */ __Matchers[425].Set(_interpolationPart);
                /* 426 SeqOp            */ __Matchers[426].Set(_stringStart, _expression, __Matchers[425], _stringEnd);
                /* 427 SeqOp            */ __Matchers[427].Set(_stringMid, _expression);
                /* 428 SeqOp            */ __Matchers[428].Set(__Matchers[359], _conditions, _ifThen, _ifElse);
                /* 429 SeqOp            */ __Matchers[429].Set(__Matchers[379], _conditionalExpression);
                /* 430 SeqOp            */ __Matchers[430].Set(__Matchers[363], _conditionalExpression);
                /* 431 AltOp            */ __Matchers[431].Set(_ifExpression, _levelDisjunctionExpression);
                /* 432 SeqOp            */ __Matchers[432].Set(__Matchers[235], _conditionList, __Matchers[236]);
                /* 433 SeqOp            */ __Matchers[433].Set(__Matchers[194], _condition);
                /* 434 StarOp           */ __Matchers[434].Set(__Matchers[433]);
                /* 435 SeqOp            */ __Matchers[435].Set(_condition, __Matchers[434]);
                /* 436 AltOp            */ __Matchers[436].Set(_isCondition, _expression);
                /* 437 OptionalOp       */ __Matchers[437].Set(__Matchers[239]);
                /* 438 SeqOp            */ __Matchers[438].Set(__Matchers[437], __Matchers[299], _type, _name);
