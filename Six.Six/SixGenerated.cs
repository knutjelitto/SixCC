    ...
    public partial class SixParser : Parser
    {
        ...
        private class Implementation : ImplementationCore
        {
                ...
                : base(new Mx.Matcher[454])
            {
                ...
                /* 349 OptionalOp       */ __Matchers[349] = new Mx.Optional(this, 349, "?(>value-default)") { Builder = nodes => new ROptional<CValueDefault>(nodes) };
                /* 350 SeqOp            */ __Matchers[350] = new Mx.Seq(this, 350, "_350:(>prelude,>parameter-type,>name,?(>value-default))") { Builder = nodes => new CValueParameter(nodes) };
                /* 351 SeqOp            */ __Matchers[351] = new Mx.Seq(this, 351, "_351:(>prelude,>parameter-type,>name)") { Builder = nodes => new CDefinitiveParameter(nodes) };
                /* 352 SeqOp            */ __Matchers[352] = new Mx.Seq(this, 352, "_352:('=',>expression)") { Builder = nodes => new CValueDefault(nodes) };
                /* 353 OptionalOp       */ __Matchers[353] = new Mx.Optional(this, 353, "?(>argument-list)") { Builder = nodes => new ROptional<CArgumentList>(nodes) };
                /* 354 SeqOp            */ __Matchers[354] = new Mx.Seq(this, 354, "_354:('(',?(>argument-list),')')") { Builder = nodes => new CArguments(nodes) };
                /* 355 SeqOp            */ __Matchers[355] = new Mx.Seq(this, 355, "_355:(',',>expression)") { Builder = nodes => new RSequence(nodes) };
                /* 356 StarOp           */ __Matchers[356] = new Mx.Star(this, 356, "*(_355:(',',>expression))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 357 SeqOp            */ __Matchers[357] = new Mx.Seq(this, 357, "_357:(>expression,*(_355:(',',>expression)))") { Builder = nodes => new CArgumentList(nodes) };
                /* 358 AltOp            */ __Matchers[358] = new Mx.Alt(this, 358, "alt(>assign-statement|>expression-statement|>if-statement|>for-statement|>while-statement|>assert-statement|>return-statement|>throw-statement)") { Builder = nodes => nodes[0] };
                /* 359 SeqOp            */ __Matchers[359] = new Mx.Seq(this, 359, "_359:(>primary-expression,'=',>expression,';')") { Builder = nodes => new CAssignStatement(nodes) };
                /* 360 SeqOp            */ __Matchers[360] = new Mx.Seq(this, 360, "_360:(>expression,';')") { Builder = nodes => new CExpressionStatement(nodes) };
                /* 361 StringOp         */ __Matchers[361] = new Mx.Keyword(this, 361, "'if'", "if") { Creator = node => new RLiteral(node) };
                /* 362 StarOp           */ __Matchers[362] = new Mx.Star(this, 362, "*(>else-if)") { Builder = nodes => new RStar<CElseIf>(nodes) };
                /* 363 OptionalOp       */ __Matchers[363] = new Mx.Optional(this, 363, "?(>else-block)") { Builder = nodes => new ROptional<CElseBlock>(nodes) };
                /* 364 SeqOp            */ __Matchers[364] = new Mx.Seq(this, 364, "_364:('if',>conditions,>block-body,*(>else-if),?(>else-block))") { Builder = nodes => new CIfStatement(nodes) };
                /* 365 StringOp         */ __Matchers[365] = new Mx.Keyword(this, 365, "'else'", "else") { Creator = node => new RLiteral(node) };
                /* 366 SeqOp            */ __Matchers[366] = new Mx.Seq(this, 366, "_366:('else','if',>conditions,>block-body)") { Builder = nodes => new CElseIf(nodes) };
                /* 367 SeqOp            */ __Matchers[367] = new Mx.Seq(this, 367, "_367:('else',>block-body)") { Builder = nodes => new CElseBlock(nodes) };
                /* 368 StringOp         */ __Matchers[368] = new Mx.Keyword(this, 368, "'for'", "for") { Creator = node => new RLiteral(node) };
                /* 369 SeqOp            */ __Matchers[369] = new Mx.Seq(this, 369, "_369:('for','(',>pattern,'in',>expression,')',>block-body,?(>else-block))") { Builder = nodes => new CForStatement(nodes) };
                /* 370 StringOp         */ __Matchers[370] = new Mx.Keyword(this, 370, "'while'", "while") { Creator = node => new RLiteral(node) };
                /* 371 SeqOp            */ __Matchers[371] = new Mx.Seq(this, 371, "_371:('while',>conditions,>block-body)") { Builder = nodes => new CWhileStatement(nodes) };
                /* 372 StringOp         */ __Matchers[372] = new Mx.Keyword(this, 372, "'return'", "return") { Creator = node => new RLiteral(node) };
                /* 373 OptionalOp       */ __Matchers[373] = new Mx.Optional(this, 373, "?(>expression)") { Builder = nodes => new ROptional<ICExpression>(nodes) };
                /* 374 SeqOp            */ __Matchers[374] = new Mx.Seq(this, 374, "_374:('return',?(>expression),';')") { Builder = nodes => new CReturnStatement(nodes) };
                /* 375 StringOp         */ __Matchers[375] = new Mx.Keyword(this, 375, "'throw'", "throw") { Creator = node => new RLiteral(node) };
                /* 376 SeqOp            */ __Matchers[376] = new Mx.Seq(this, 376, "_376:('throw',?(>expression),';')") { Builder = nodes => new CThrowStatement(nodes) };
                /* 377 StringOp         */ __Matchers[377] = new Mx.Keyword(this, 377, "'assert'", "assert") { Creator = node => new RLiteral(node) };
                /* 378 SeqOp            */ __Matchers[378] = new Mx.Seq(this, 378, "_378:(?(>string-literal),'assert',>conditions,';')") { Builder = nodes => new CAssertStatement(nodes) };
                /* 379 AltOp            */ __Matchers[379] = new Mx.Alt(this, 379, "alt(>if-expression|>level-coalesce-expression)") { Builder = nodes => nodes[0] };
                /* 380 AltOp            */ __Matchers[380] = new Mx.Alt(this, 380, "alt(>then-expression|>else-expression|>level-disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 381 StringOp         */ __Matchers[381] = new Mx.Keyword(this, 381, "'then'", "then") { Creator = node => new RLiteral(node) };
                /* 382 SeqOp            */ __Matchers[382] = new Mx.Seq(this, 382, "_382:(>level-coalesce-expression,'then',>level-disjunction-expression)") { Builder = nodes => new CThenExpression(nodes) };
                /* 383 SeqOp            */ __Matchers[383] = new Mx.Seq(this, 383, "_383:(>level-coalesce-expression,'else',>level-disjunction-expression)") { Builder = nodes => new CElseExpression(nodes) };
                /* 384 AltOp            */ __Matchers[384] = new Mx.Alt(this, 384, "alt(>disjunction-expression|>level-conjunction-expression)") { Builder = nodes => nodes[0] };
                /* 385 StringOp         */ __Matchers[385] = new Mx.String(this, 385, "'||'", "||") { Creator = node => new RLiteral(node) };
                /* 386 SeqOp            */ __Matchers[386] = new Mx.Seq(this, 386, "_386:(>level-disjunction-expression,'||',>level-conjunction-expression)") { Builder = nodes => new CDisjunctionExpression(nodes) };
                /* 387 AltOp            */ __Matchers[387] = new Mx.Alt(this, 387, "alt(>conjunction-expression|>level-not-expression)") { Builder = nodes => nodes[0] };
                /* 388 StringOp         */ __Matchers[388] = new Mx.String(this, 388, "'&&'", "&&") { Creator = node => new RLiteral(node) };
                /* 389 SeqOp            */ __Matchers[389] = new Mx.Seq(this, 389, "_389:(>level-conjunction-expression,'&&',>level-not-expression)") { Builder = nodes => new CConjunctionExpression(nodes) };
                /* 390 AltOp            */ __Matchers[390] = new Mx.Alt(this, 390, "alt(>not-expression|>level-equality-expression)") { Builder = nodes => nodes[0] };
                /* 391 StringOp         */ __Matchers[391] = new Mx.String(this, 391, "'!'", "!") { Creator = node => new RLiteral(node) };
                /* 392 SeqOp            */ __Matchers[392] = new Mx.Seq(this, 392, "_392:('!',>level-not-expression)") { Builder = nodes => new CNotExpression(nodes) };
                /* 393 AltOp            */ __Matchers[393] = new Mx.Alt(this, 393, "alt(>equal-expression|>not-equal-expression|>identical-expression|>not-identical-expression|>level-compare-expression)") { Builder = nodes => nodes[0] };
                /* 394 StringOp         */ __Matchers[394] = new Mx.String(this, 394, "'=='", "==") { Creator = node => new RLiteral(node) };
                /* 395 SeqOp            */ __Matchers[395] = new Mx.Seq(this, 395, "_395:(>level-compare-expression,'==',>level-compare-expression)") { Builder = nodes => new CEqualExpression(nodes) };
                ...
                /* 398 StringOp         */ __Matchers[398] = new Mx.String(this, 398, "'==='", "===") { Creator = node => new RLiteral(node) };
                /* 399 SeqOp            */ __Matchers[399] = new Mx.Seq(this, 399, "_399:(>level-compare-expression,'===',>level-compare-expression)") { Builder = nodes => new CIdenticalExpression(nodes) };
                /* 400 StringOp         */ __Matchers[400] = new Mx.String(this, 400, "'!=='", "!==") { Creator = node => new RLiteral(node) };
                /* 401 SeqOp            */ __Matchers[401] = new Mx.Seq(this, 401, "_401:(>level-compare-expression,'!==',>level-compare-expression)") { Builder = nodes => new CNotIdenticalExpression(nodes) };
                /* 402 AltOp            */ __Matchers[402] = new Mx.Alt(this, 402, "alt(>less-expression|>less-equal-expression|>greater-expression|>greater-equal-expression|>level-add-expression)") { Builder = nodes => nodes[0] };
                /* 403 SeqOp            */ __Matchers[403] = new Mx.Seq(this, 403, "_403:(>level-add-expression,'<',>level-add-expression)") { Builder = nodes => new CLessExpression(nodes) };
                /* 404 StringOp         */ __Matchers[404] = new Mx.String(this, 404, "'<='", "<=") { Creator = node => new RLiteral(node) };
                /* 405 SeqOp            */ __Matchers[405] = new Mx.Seq(this, 405, "_405:(>level-add-expression,'<=',>level-add-expression)") { Builder = nodes => new CLessEqualExpression(nodes) };
                /* 406 SeqOp            */ __Matchers[406] = new Mx.Seq(this, 406, "_406:(>level-add-expression,'>',>level-add-expression)") { Builder = nodes => new CGreaterExpression(nodes) };
                /* 407 StringOp         */ __Matchers[407] = new Mx.String(this, 407, "'>='", ">=") { Creator = node => new RLiteral(node) };
                /* 408 SeqOp            */ __Matchers[408] = new Mx.Seq(this, 408, "_408:(>level-add-expression,'>=',>level-add-expression)") { Builder = nodes => new CGreaterEqualExpression(nodes) };
                /* 409 AltOp            */ __Matchers[409] = new Mx.Alt(this, 409, "alt(>add-expression|>sub-expression|>level-mul-expression)") { Builder = nodes => nodes[0] };
                /* 410 StringOp         */ __Matchers[410] = new Mx.String(this, 410, "'+'", "+") { Creator = node => new RLiteral(node) };
                /* 411 SeqOp            */ __Matchers[411] = new Mx.Seq(this, 411, "_411:(>level-add-expression,'+',>level-mul-expression)") { Builder = nodes => new CAddExpression(nodes) };
                /* 412 StringOp         */ __Matchers[412] = new Mx.String(this, 412, "'-'", "-") { Creator = node => new RLiteral(node) };
                /* 413 SeqOp            */ __Matchers[413] = new Mx.Seq(this, 413, "_413:(>level-add-expression,'-',>level-mul-expression)") { Builder = nodes => new CSubExpression(nodes) };
                /* 414 AltOp            */ __Matchers[414] = new Mx.Alt(this, 414, "alt(>mul-expression|>div-expression|>rem-expression|>level-union-expression)") { Builder = nodes => nodes[0] };
                /* 415 StringOp         */ __Matchers[415] = new Mx.String(this, 415, "'*'", "*") { Creator = node => new RLiteral(node) };
                /* 416 SeqOp            */ __Matchers[416] = new Mx.Seq(this, 416, "_416:(>level-mul-expression,'*',>level-union-expression)") { Builder = nodes => new CMulExpression(nodes) };
                /* 417 StringOp         */ __Matchers[417] = new Mx.String(this, 417, "'/'", "/") { Creator = node => new RLiteral(node) };
                /* 418 SeqOp            */ __Matchers[418] = new Mx.Seq(this, 418, "_418:(>level-mul-expression,'/',>level-union-expression)") { Builder = nodes => new CDivExpression(nodes) };
                /* 419 StringOp         */ __Matchers[419] = new Mx.String(this, 419, "'%'", "%") { Creator = node => new RLiteral(node) };
                /* 420 SeqOp            */ __Matchers[420] = new Mx.Seq(this, 420, "_420:(>level-mul-expression,'%',>level-union-expression)") { Builder = nodes => new CRemExpression(nodes) };
                /* 421 AltOp            */ __Matchers[421] = new Mx.Alt(this, 421, "alt(>union-expression|>complement-expression|>level-exclusive-expression)") { Builder = nodes => nodes[0] };
                /* 422 SeqOp            */ __Matchers[422] = new Mx.Seq(this, 422, "_422:(>level-union-expression,'|',>level-exclusive-expression)") { Builder = nodes => new CUnionExpression(nodes) };
                /* 423 StringOp         */ __Matchers[423] = new Mx.String(this, 423, "'~'", "~") { Creator = node => new RLiteral(node) };
                /* 424 SeqOp            */ __Matchers[424] = new Mx.Seq(this, 424, "_424:(>level-union-expression,'~',>level-exclusive-expression)") { Builder = nodes => new CComplementExpression(nodes) };
                /* 425 AltOp            */ __Matchers[425] = new Mx.Alt(this, 425, "alt(>exclusive-expression|>level-intersection-expression)") { Builder = nodes => nodes[0] };
                /* 426 StringOp         */ __Matchers[426] = new Mx.String(this, 426, "'^'", "^") { Creator = node => new RLiteral(node) };
                /* 427 SeqOp            */ __Matchers[427] = new Mx.Seq(this, 427, "_427:(>level-exclusive-expression,'^',>level-intersection-expression)") { Builder = nodes => new CExclusiveExpression(nodes) };
                /* 428 AltOp            */ __Matchers[428] = new Mx.Alt(this, 428, "alt(>intersection-expression|>level-negate-expression)") { Builder = nodes => nodes[0] };
                /* 429 SeqOp            */ __Matchers[429] = new Mx.Seq(this, 429, "_429:(>level-intersection-expression,'&',>level-negate-expression)") { Builder = nodes => new CIntersectionExpression(nodes) };
                /* 430 AltOp            */ __Matchers[430] = new Mx.Alt(this, 430, "alt(>negate-expression|>primary-expression)") { Builder = nodes => nodes[0] };
                /* 431 SeqOp            */ __Matchers[431] = new Mx.Seq(this, 431, "_431:('-',>level-negate-expression)") { Builder = nodes => new CNegateExpression(nodes) };
                /* 432 AltOp            */ __Matchers[432] = new Mx.Alt(this, 432, "alt(>reference|>literal|>string-expression|>call-expression|>select-expression|>nullsafe-select-expression|>grouped-expression)") { Builder = nodes => nodes[0] };
                /* 433 SeqOp            */ __Matchers[433] = new Mx.Seq(this, 433, "_433:('(',>expression,')')") { Builder = nodes => new CGroupedExpression(nodes) };
                /* 434 SeqOp            */ __Matchers[434] = new Mx.Seq(this, 434, "_434:(>primary-expression,>arguments)") { Builder = nodes => new CCallExpression(nodes) };
                /* 435 SeqOp            */ __Matchers[435] = new Mx.Seq(this, 435, "_435:(>primary-expression,'.',>reference)") { Builder = nodes => new CSelectExpression(nodes) };
                /* 436 StringOp         */ __Matchers[436] = new Mx.String(this, 436, "'?.'", "?.") { Creator = node => new RLiteral(node) };
                /* 437 SeqOp            */ __Matchers[437] = new Mx.Seq(this, 437, "_437:(>primary-expression,'?.',>reference)") { Builder = nodes => new CNullsafeSelectExpression(nodes) };
                /* 438 AltOp            */ __Matchers[438] = new Mx.Alt(this, 438, "alt(>string-literal|>string-interpolation)") { Builder = nodes => nodes[0] };
                /* 439 AltOp            */ __Matchers[439] = new Mx.Alt(this, 439, "alt(>plain-string-literal|>verbatim-string-literal)") { Builder = nodes => nodes[0] };
                /* 440 StarOp           */ __Matchers[440] = new Mx.Star(this, 440, "*(>interpolation-part)") { Builder = nodes => new RStar<CInterpolationPart>(nodes) };
                /* 441 SeqOp            */ __Matchers[441] = new Mx.Seq(this, 441, "_441:(>string-start,>expression,*(>interpolation-part),>string-end)") { Builder = nodes => new CStringInterpolation(nodes) };
                /* 442 SeqOp            */ __Matchers[442] = new Mx.Seq(this, 442, "_442:(>string-mid,>expression)") { Builder = nodes => new CInterpolationPart(nodes) };
                /* 443 SeqOp            */ __Matchers[443] = new Mx.Seq(this, 443, "_443:('if',>conditions,>if-then,>if-else)") { Builder = nodes => new CIfExpression(nodes) };
                /* 444 SeqOp            */ __Matchers[444] = new Mx.Seq(this, 444, "_444:('then',>conditional-expression)") { Builder = nodes => new CIfThen(nodes) };
                /* 445 SeqOp            */ __Matchers[445] = new Mx.Seq(this, 445, "_445:('else',>conditional-expression)") { Builder = nodes => new CIfElse(nodes) };
                /* 446 AltOp            */ __Matchers[446] = new Mx.Alt(this, 446, "alt(>if-expression|>level-disjunction-expression)") { Builder = nodes => nodes[0] };
                /* 447 SeqOp            */ __Matchers[447] = new Mx.Seq(this, 447, "_447:('(',>condition-list,')')") { Builder = nodes => new CConditions(nodes) };
                /* 448 SeqOp            */ __Matchers[448] = new Mx.Seq(this, 448, "_448:(',',>condition)") { Builder = nodes => new RSequence(nodes) };
                /* 449 StarOp           */ __Matchers[449] = new Mx.Star(this, 449, "*(_448:(',',>condition))") { Builder = nodes => new RStar<RSequence>(nodes) };
                /* 450 SeqOp            */ __Matchers[450] = new Mx.Seq(this, 450, "_450:(>condition,*(_448:(',',>condition)))") { Builder = nodes => new CConditionList(nodes) };
                /* 451 AltOp            */ __Matchers[451] = new Mx.Alt(this, 451, "alt(>is-condition|>expression)") { Builder = nodes => nodes[0] };
                /* 452 OptionalOp       */ __Matchers[452] = new Mx.Optional(this, 452, "?('!')") { Builder = nodes => new ROptional<RLiteral>(nodes) };
                /* 453 SeqOp            */ __Matchers[453] = new Mx.Seq(this, 453, "_453:(?('!'),'is',>type,>name)") { Builder = nodes => new CIsCondition(nodes) };
                ...
                /*  92 PlainRuleOp      */ _valueParameter.Set(__Matchers[350]);
                /*  93 PlainRuleOp      */ _definitiveParameter.Set(__Matchers[351]);
                /*  94 PlainRuleOp      */ _valueDefault.Set(__Matchers[352]);
                /*  95 PlainRuleOp      */ _parameterType.Set(_type);
                /*  96 PlainRuleOp      */ _arguments.Set(__Matchers[354]);
                /*  97 PlainRuleOp      */ _argumentList.Set(__Matchers[357]);
                /*  98 PlainRuleOp      */ _statement.Set(__Matchers[358]);
                /*  99 PlainRuleOp      */ _assignStatement.Set(__Matchers[359]);
                /* 100 PlainRuleOp      */ _expressionStatement.Set(__Matchers[360]);
                /* 101 PlainRuleOp      */ _ifStatement.Set(__Matchers[364]);
                /* 102 PlainRuleOp      */ _elseIf.Set(__Matchers[366]);
                /* 103 PlainRuleOp      */ _elseBlock.Set(__Matchers[367]);
                /* 104 PlainRuleOp      */ _forStatement.Set(__Matchers[369]);
                /* 105 PlainRuleOp      */ _whileStatement.Set(__Matchers[371]);
                /* 106 PlainRuleOp      */ _returnStatement.Set(__Matchers[374]);
                /* 107 PlainRuleOp      */ _throwStatement.Set(__Matchers[376]);
                /* 108 PlainRuleOp      */ _assertStatement.Set(__Matchers[378]);
                /* 109 PlainRuleOp      */ _expression.Set(__Matchers[379]);
                /* 110 PlainRuleOp      */ _levelCoalesceExpression.Set(__Matchers[380]);
                /* 111 PlainRuleOp      */ _thenExpression.Set(__Matchers[382]);
                /* 112 PlainRuleOp      */ _elseExpression.Set(__Matchers[383]);
                /* 113 PlainRuleOp      */ _levelDisjunctionExpression.Set(__Matchers[384]);
                /* 114 PlainRuleOp      */ _disjunctionExpression.Set(__Matchers[386]);
                /* 115 PlainRuleOp      */ _levelConjunctionExpression.Set(__Matchers[387]);
                /* 116 PlainRuleOp      */ _conjunctionExpression.Set(__Matchers[389]);
                /* 117 PlainRuleOp      */ _levelNotExpression.Set(__Matchers[390]);
                /* 118 PlainRuleOp      */ _notExpression.Set(__Matchers[392]);
                /* 119 PlainRuleOp      */ _levelEqualityExpression.Set(__Matchers[393]);
                /* 120 PlainRuleOp      */ _equalExpression.Set(__Matchers[395]);
                /* 121 PlainRuleOp      */ _notEqualExpression.Set(__Matchers[397]);
                /* 122 PlainRuleOp      */ _identicalExpression.Set(__Matchers[399]);
                /* 123 PlainRuleOp      */ _notIdenticalExpression.Set(__Matchers[401]);
                /* 124 PlainRuleOp      */ _levelCompareExpression.Set(__Matchers[402]);
                /* 125 PlainRuleOp      */ _lessExpression.Set(__Matchers[403]);
                /* 126 PlainRuleOp      */ _lessEqualExpression.Set(__Matchers[405]);
                /* 127 PlainRuleOp      */ _greaterExpression.Set(__Matchers[406]);
                /* 128 PlainRuleOp      */ _greaterEqualExpression.Set(__Matchers[408]);
                /* 129 PlainRuleOp      */ _levelAddExpression.Set(__Matchers[409]);
                /* 130 PlainRuleOp      */ _addExpression.Set(__Matchers[411]);
                /* 131 PlainRuleOp      */ _subExpression.Set(__Matchers[413]);
                /* 132 PlainRuleOp      */ _levelMulExpression.Set(__Matchers[414]);
                /* 133 PlainRuleOp      */ _mulExpression.Set(__Matchers[416]);
                /* 134 PlainRuleOp      */ _divExpression.Set(__Matchers[418]);
                /* 135 PlainRuleOp      */ _remExpression.Set(__Matchers[420]);
                /* 136 PlainRuleOp      */ _levelUnionExpression.Set(__Matchers[421]);
                /* 137 PlainRuleOp      */ _unionExpression.Set(__Matchers[422]);
                /* 138 PlainRuleOp      */ _complementExpression.Set(__Matchers[424]);
                /* 139 PlainRuleOp      */ _levelExclusiveExpression.Set(__Matchers[425]);
                /* 140 PlainRuleOp      */ _exclusiveExpression.Set(__Matchers[427]);
                /* 141 PlainRuleOp      */ _levelIntersectionExpression.Set(__Matchers[428]);
                /* 142 PlainRuleOp      */ _intersectionExpression.Set(__Matchers[429]);
                /* 143 PlainRuleOp      */ _levelNegateExpression.Set(__Matchers[430]);
                /* 144 PlainRuleOp      */ _negateExpression.Set(__Matchers[431]);
                /* 145 PlainRuleOp      */ _primaryExpression.Set(__Matchers[432]);
                /* 146 PlainRuleOp      */ _groupedExpression.Set(__Matchers[433]);
                /* 147 PlainRuleOp      */ _callExpression.Set(__Matchers[434]);
                /* 148 PlainRuleOp      */ _selectExpression.Set(__Matchers[435]);
                /* 149 PlainRuleOp      */ _nullsafeSelectExpression.Set(__Matchers[437]);
                /* 150 PlainRuleOp      */ _literal.Set(_naturalLiteral);
                /* 151 PlainRuleOp      */ _stringExpression.Set(__Matchers[438]);
                /* 152 PlainRuleOp      */ _stringLiteral.Set(__Matchers[439]);
                /* 153 PlainRuleOp      */ _stringInterpolation.Set(__Matchers[441]);
                /* 154 PlainRuleOp      */ _interpolationPart.Set(__Matchers[442]);
                /* 155 PlainRuleOp      */ _ifExpression.Set(__Matchers[443]);
                /* 156 PlainRuleOp      */ _ifThen.Set(__Matchers[444]);
                /* 157 PlainRuleOp      */ _ifElse.Set(__Matchers[445]);
                /* 158 PlainRuleOp      */ _conditionalExpression.Set(__Matchers[446]);
                /* 159 PlainRuleOp      */ _conditions.Set(__Matchers[447]);
                /* 160 PlainRuleOp      */ _conditionList.Set(__Matchers[450]);
                /* 161 PlainRuleOp      */ _condition.Set(__Matchers[451]);
                /* 162 PlainRuleOp      */ _isCondition.Set(__Matchers[453]);
                ...
                /* 349 OptionalOp       */ __Matchers[349].Set(_valueDefault);
                /* 350 SeqOp            */ __Matchers[350].Set(_prelude, _parameterType, _name, __Matchers[349]);
                ...
                /* 358 AltOp            */ __Matchers[358].Set(_assignStatement, _expressionStatement, _ifStatement, _forStatement, _whileStatement, _assertStatement, _returnStatement, _throwStatement);
                /* 359 SeqOp            */ __Matchers[359].Set(_primaryExpression, __Matchers[200], _expression, __Matchers[175]);
                /* 360 SeqOp            */ __Matchers[360].Set(_expression, __Matchers[175]);
                /* 362 StarOp           */ __Matchers[362].Set(_elseIf);
                /* 363 OptionalOp       */ __Matchers[363].Set(_elseBlock);
                ...
                /* 376 SeqOp            */ __Matchers[376].Set(__Matchers[375], __Matchers[373], __Matchers[175]);
                /* 378 SeqOp            */ __Matchers[378].Set(__Matchers[315], __Matchers[377], _conditions, __Matchers[175]);
                /* 379 AltOp            */ __Matchers[379].Set(_ifExpression, _levelCoalesceExpression);
                /* 380 AltOp            */ __Matchers[380].Set(_thenExpression, _elseExpression, _levelDisjunctionExpression);
                /* 382 SeqOp            */ __Matchers[382].Set(_levelCoalesceExpression, __Matchers[381], _levelDisjunctionExpression);
                /* 383 SeqOp            */ __Matchers[383].Set(_levelCoalesceExpression, __Matchers[365], _levelDisjunctionExpression);
                /* 384 AltOp            */ __Matchers[384].Set(_disjunctionExpression, _levelConjunctionExpression);
                /* 386 SeqOp            */ __Matchers[386].Set(_levelDisjunctionExpression, __Matchers[385], _levelConjunctionExpression);
                /* 387 AltOp            */ __Matchers[387].Set(_conjunctionExpression, _levelNotExpression);
                /* 389 SeqOp            */ __Matchers[389].Set(_levelConjunctionExpression, __Matchers[388], _levelNotExpression);
                /* 390 AltOp            */ __Matchers[390].Set(_notExpression, _levelEqualityExpression);
                /* 392 SeqOp            */ __Matchers[392].Set(__Matchers[391], _levelNotExpression);
                /* 393 AltOp            */ __Matchers[393].Set(_equalExpression, _notEqualExpression, _identicalExpression, _notIdenticalExpression, _levelCompareExpression);
                /* 395 SeqOp            */ __Matchers[395].Set(_levelCompareExpression, __Matchers[394], _levelCompareExpression);
                /* 397 SeqOp            */ __Matchers[397].Set(_levelCompareExpression, __Matchers[396], _levelCompareExpression);
                /* 399 SeqOp            */ __Matchers[399].Set(_levelCompareExpression, __Matchers[398], _levelCompareExpression);
                /* 401 SeqOp            */ __Matchers[401].Set(_levelCompareExpression, __Matchers[400], _levelCompareExpression);
                /* 402 AltOp            */ __Matchers[402].Set(_lessExpression, _lessEqualExpression, _greaterExpression, _greaterEqualExpression, _levelAddExpression);
                /* 403 SeqOp            */ __Matchers[403].Set(_levelAddExpression, __Matchers[209], _levelAddExpression);
                /* 405 SeqOp            */ __Matchers[405].Set(_levelAddExpression, __Matchers[404], _levelAddExpression);
                /* 406 SeqOp            */ __Matchers[406].Set(_levelAddExpression, __Matchers[211], _levelAddExpression);
                /* 408 SeqOp            */ __Matchers[408].Set(_levelAddExpression, __Matchers[407], _levelAddExpression);
                /* 409 AltOp            */ __Matchers[409].Set(_addExpression, _subExpression, _levelMulExpression);
                /* 411 SeqOp            */ __Matchers[411].Set(_levelAddExpression, __Matchers[410], _levelMulExpression);
                /* 413 SeqOp            */ __Matchers[413].Set(_levelAddExpression, __Matchers[412], _levelMulExpression);
                /* 414 AltOp            */ __Matchers[414].Set(_mulExpression, _divExpression, _remExpression, _levelUnionExpression);
                /* 416 SeqOp            */ __Matchers[416].Set(_levelMulExpression, __Matchers[415], _levelUnionExpression);
                /* 418 SeqOp            */ __Matchers[418].Set(_levelMulExpression, __Matchers[417], _levelUnionExpression);
                /* 420 SeqOp            */ __Matchers[420].Set(_levelMulExpression, __Matchers[419], _levelUnionExpression);
                /* 421 AltOp            */ __Matchers[421].Set(_unionExpression, _complementExpression, _levelExclusiveExpression);
                /* 422 SeqOp            */ __Matchers[422].Set(_levelUnionExpression, __Matchers[310], _levelExclusiveExpression);
                /* 424 SeqOp            */ __Matchers[424].Set(_levelUnionExpression, __Matchers[423], _levelExclusiveExpression);
                /* 425 AltOp            */ __Matchers[425].Set(_exclusiveExpression, _levelIntersectionExpression);
                /* 427 SeqOp            */ __Matchers[427].Set(_levelExclusiveExpression, __Matchers[426], _levelIntersectionExpression);
                /* 428 AltOp            */ __Matchers[428].Set(_intersectionExpression, _levelNegateExpression);
                /* 429 SeqOp            */ __Matchers[429].Set(_levelIntersectionExpression, __Matchers[323], _levelNegateExpression);
                ...
                /* 438 AltOp            */ __Matchers[438].Set(_stringLiteral, _stringInterpolation);
                /* 439 AltOp            */ __Matchers[439].Set(_plainStringLiteral, _verbatimStringLiteral);
                /* 440 StarOp           */ __Matchers[440].Set(_interpolationPart);
                /* 441 SeqOp            */ __Matchers[441].Set(_stringStart, _expression, __Matchers[440], _stringEnd);
                /* 442 SeqOp            */ __Matchers[442].Set(_stringMid, _expression);
                /* 443 SeqOp            */ __Matchers[443].Set(__Matchers[361], _conditions, _ifThen, _ifElse);
                ...
                /* 451 AltOp            */ __Matchers[451].Set(_isCondition, _expression);
                /* 452 OptionalOp       */ __Matchers[452].Set(__Matchers[391]);
                /* 453 SeqOp            */ __Matchers[453].Set(__Matchers[452], __Matchers[300], _type, _name);
