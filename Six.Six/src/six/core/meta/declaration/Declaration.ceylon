...
"""
shared sealed interface Declaration of AnnotatedDeclaration | TypeParameter
{    
    """
    ...
    """
    The qualified name of this declaration. This includes the container qualified name. For example,
    the [[Declaration]] class' qualified name is "ceylon.language.meta.declaration::Declaration".
    """
