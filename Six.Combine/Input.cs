...
namespace Six.Combine
{
    ...
    public class Input : IInput
    {
        ...
        /// </summary>
        public char Current { get { return _source[Position]; } }

        /// <summary>
        /// Gets a value indicating whether the end of the source is reached.
        /// </summary>
        public bool AtEnd { get { return Position == _source.Length; } }
        ...
        public bool Equals(IInput? that)
        {
            return that is Input other
                && string.Equals(_source, other.Source) && Position == other.Position;
        }
