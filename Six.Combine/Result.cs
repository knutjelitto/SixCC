...
namespace Six.Combine
{
    ...
    public static class Result
    {
        ...
        public static IResult<T> Failure<T>(IInput remainder, string message, params string[] expectations)
        {
            return new Result<T>(remainder, message, expectations);
        }

        public static IResult<U> Failure<T, U>(IResult<T> result)
        {
            return new Result<U>(result.Remainder, result.Message, result.Expectations);
        }
    }
    ...
    internal class Result<T> : IResult<T>
    {
        ...
        public override string ToString()
        {
            ...
            if (Expectations.Any())
            {
                ...
                expMsg = " expected " + string.Join(" or ", Expectations);
            }
