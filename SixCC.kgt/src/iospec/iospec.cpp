...
const std::vector<out_able> outputable =
{
    ...
    { "blab",       blab_output,        ".blab",        (ast_features)0,                        (rrd_features)0 },
    { "bnf",        bnf_output,         ".bnf",         (ast_features)0,                        (rrd_features)0 },
    { "dot",        dot_output,         ".dot",         (ast_features)0,                        (rrd_features)0 },
    { "ebnf-html5", ebnf_html5_output,  "-ebnf.html",   (ast_features)0,                        (rrd_features)0 },
    { "ebnf-xhtml5",ebnf_xhtml5_output, "-ebnf-x.html", (ast_features)0,                        (rrd_features)0 },
    ...
    { "json",       json_output,        ".json",        (ast_features)0,                        (rrd_features)0 },
    { "rbnf",       rbnf_output,        ".rbnf",        (ast_features)0,                        (rrd_features)0 },
    { "sid",        sid_output,         ".sid",         (ast_features)0,                        (rrd_features)0 },
    { "svg",        svg_output,         ".svg",         (ast_features)0,                        (rrd_features)0 },
    { "wsn",        wsn_output,         ".wsn",         (ast_features)0,                        (rrd_features)0 },
    { "rrdot",      rrdot_output,       "-rr.dot",      (ast_features)0,                        (rrd_features)0 },
    { "rrdump",     rrdump_output,      "-rr.dump",     (ast_features)0,                        (rrd_features)0 },
    { "rrll",       rrll_output,        "-rr.ll",       (ast_features)0,                        (rrd_features)rrll_rrd_unsupported     },
    { "rrparcon",   rrparcon_output,    "-rr.parcon",   (ast_features)0,                        (rrd_features)rrparcon_rrd_unsupported },
    { "rrta",       rrta_output,        "-rr.ta",       (ast_features)0,                        (rrd_features)rrta_rrd_unsupported     },
