// <generated from="D:\\Six\\SixBot\\Grammars\\T5.six" at="19.01.2022 18:48:09" />
...
using static GeneratedParser.T5ParserAst;
...
namespace GeneratedParser
{
    ...
    {
        public T5Parser()
            : base("T5", new __T5ParserImplementation())
        {
        }

        private class __T5ParserImplementation : ImplementationCore
        {
            public __T5ParserImplementation()
                : base(new Matcher[16])
            {
    ...
    public partial class T5ParserAst
    {
